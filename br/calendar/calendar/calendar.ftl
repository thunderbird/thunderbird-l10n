...
calendar-context-attendance-occurrence-label =
    .value = Ar reveziadenn-mañ
calendar-context-attendance-all-series-label =
    .value = Heuliadennoù klok
...
calendar-search-options-searchfor =
    .value = a endalc'h
calendar-properties-dialog-title = Embann an deiziataer
calendar-server-dialog-name-label =
    .value = Anv an deiziataer:
calendar-publish-dialog-window-title = Brudañ an deiziataer
calendar-publish-url-label = O brudañ an URL
calendar-publish-publish-dialog-button =
    .buttonlabelaccept = Brudañ
...
calendar-error-description =
    .value = Deskrivadur:
calendar-error-prompt-title = C'hoarvezet ez eus bet ur fazi.
