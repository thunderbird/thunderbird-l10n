...
toolbar-add-as-event =
    .title = Eztennañ titouroù deiziataer adalek ar gemennadenn-mañ hag ouzhpennañ anezho d'ho teiziataer evel un darvoud
toolbar-add-as-task-label = Ouzhpennañ e-giz un trevell
toolbar-add-as-task =
    .title = Eztennañ titouroù deiziataer adalek ar gemennadenn-mañ hag ouzhpennañ anezho d'ho teiziataer evel un trevell
