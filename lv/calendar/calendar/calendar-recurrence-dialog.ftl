...
calendar-recurrence-preview-label = Priekšskatījums
calendar-recurrence-next = Nākamais mēnesis
calendar-recurrence-previous = Iepriekšējais mēnesis
calendar-recurrence-today = Šodien
