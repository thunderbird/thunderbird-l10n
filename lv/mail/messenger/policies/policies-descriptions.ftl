...
policy-BlockAboutConfig = Liegt piekļuvi about:config lapai.
policy-BlockAboutProfiles = Liegt piekļuvi about:profiles lapai.
policy-BlockAboutSupport = Liegt piekļuvi about:support lapai.
...
policy-DisableChat = Atspējot tērzēšanas iespēju.
...
policy-DisableMessageForwardingFilters = Neļaut ziņojumu atsijātāju izraisītu automātisku ziņojumu pārvirzīšanu.
...
policy-DisableUpdateSettings = Neļaut lietotājiem mainīt lietotnes atjaunināšanas iestatījumus.
...
policy-PromptForDownloadLocation = Vaicāt, kur saglabāt datnes, kad lejupielādē.
...
policy-WebsiteFilter = Liegt vietņu apmeklēšanu. Vairāk informācijas par pierakstu pieejama dokumentācijā.
