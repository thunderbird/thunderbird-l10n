...
rights-intro-point-5 = Dažas { -brand-short-name } iespējas izmanto tīmeklī balstītus informācijas pakalpojumus, tomēr mēs nevaram nodrošināt, ka tie ir 100% pareizi un bez kļūdām. Vairāk informācijas par šiem pakalpojumiem un to atspējošanu ir pieejama <a data-l10n-name="mozilla-service-terms-link">pakalpojumu noteikumos</a>.
...
rights-locationawarebrowsing =
    <strong>Vietzinīgā pārlūkošana: </strong> vienmēr ar apzinātu piekrišanu.
    Nekāda atrašanās vietas
    informācija nekad netiek sūtīta bez atļaujas. Ja ir vēlēšanās pilnībā
    atspējot šo iespēju, jāveic šādas darbības:
...
rights-locationawarebrowsing-term-4 = Vietzinīgā pārlūkošana tagad ir atspējota
...
rights-webservices-term-1 = { -vendor-short-name }, tā līdzdalībnieki, licenču devēji un partneri strādā pie tā, lai sniegtu vispareizākos un atjauninātus pakalpojumus. Tomēr mēs nevaram nodrošināt, ka šī informācija ir visaptveroša un bez kļūdām. Piemēram, drošās pārlūkošanas pakalpojums var nenoteikt, ka kāda lapa ir bīstama, un var arī kļūdaini uzskatīt kādu drošu lapu par bīstamu, un vietzinīgajā pakalpojumā visas mūsu pakalpojumu nodrošinātāju atgrieztās atrašanās vietas ir tikai aptuvenas, un ne mēs, ne pakalpojumu sniedzēji nenodrošina sniegto atrašanās vietu pilnīgu pareizību.
...
rights-webservices-term-4 = <strong>Pakalpojumi tiek piedāvāti tādi, “kādi tie ir”.  { -vendor-short-name }, tās līdzdalībnieki, licenču devēji un izplatītāji atsakās no jebkāda galvojuma, neatkarīgi no tā, vai tas ir izteikts tieši vai netieši, tajā skaitā jebkādus galvojumus, ka pakalpojumi ir tirgojami un der noteiktiem nolūkiem. Tu uzņemies pilnu atbildību par pakalpojumu izvēli noteiktiem mērķiem, kā arī to kvalitāti un sniegumu. Atsevišķās juridiskajās teritorijās nav ļauta netieši izteikto galvojumu izslēgšana vai ierobežošana, līdz ar to šī atruna var uz Tevi neattiekties.</strong>
rights-webservices-term-5 = <strong>Izņemot gadījumus, kad to pieprasa likumdošana, { -vendor-short-name }, tā līdzdalībnieki, licenču devēji un izplatītāji nebūs atbildīgi par jebkādiem tīšiem, nejaušiem, netiešiem, sodoša rakstura vai ar soda naudu saistītiem bojājumiem, kas jebkādā veidā saistāmi ar { -brand-short-name } un tā pakalpojumu izmantošanu. Kopējā atbildība pēc šiem noteikumiem nepārsniegs $500 (piecus simtus ASV dolāru). Atsevišķās juridiskajās teritorijās nav ļauta bojājumu izslēgšana vai ierobežošana, līdz ar to šī atruna un ierobežojumi var uz Tevi neattiekties.</strong>
