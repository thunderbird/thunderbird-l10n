...
filelink-label = Datnes saite
    .aria-label = Iestatīt datnes saiti
filelink-description = { -brand-short-name } ļauj izveidot failu saites mākoņa kontu, lai ērti nosūtītu lielus pielikumus.
address-book-add-label = Adrešu grāmata
    .aria-label = Pievienot adrešu grāmatu
...
import-title = Ievietot no citas programmas
