...
general-files-and-attachment-header = Datnes un pielikumi
...
chat-status-title = Stāvoklis
chat-notifications-title = Paziņojumi
chat-pane-styling-header = Stils
manage-languages-button =
    .label = Pārvaldīt valodas…
    .accesskey = v
choose-messenger-language-description = Jāizvēlas { -brand-short-name } izmantojamās valodas izvēļņu, ziņojumu un paziņojumu attēlošanai.
...
gloda-show-results-as-list-label =
    .label = Pēc noklusējuma rādīt visaptverošās meklēšanas iznākumu kā sarakstu
    .accesskey = s
datetime-formatting-legend = Datuma un laika formatēšana
language-selector-legend = Valoda
allow-hw-accel =
    .label = Izmantot aparatūrisku paātrināšanu, kad pieejama
    .accesskey = a
store-type-label =
    .value = Jaunu kontu vēstuļu krātuves veids:
    .accesskey = k
mbox-store-label =
    .label = Viena datne katrai mapei (mbox)
maildir-store-label =
    .label = Viena datne katram ziņojumam (maildir)
...
always-check-default =
    .label = Palaišanas laikā vienmēr pārbaudīt, vai { -brand-short-name } ir  noklusējuma pasta klients
    .accesskey = v
...
always-ask-label =
    .label = Vienmēr vaicāt, kur saglabāt datnes
    .accesskey = V
