...
proxy-password-prompt =
    ...
    .accesskey = N
    .tooltiptext = Šī iespēja nemanot autentificēs Tevi starpniekserveros, kuriem saglabāti pieteikšanās dati. Ja autentifikācija neizdosies, tiks parādīta uzvedne.
proxy-remote-dns =
