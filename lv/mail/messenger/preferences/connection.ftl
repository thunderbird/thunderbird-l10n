...
proxy-password-prompt =
    ...
    .accesskey = N
    .tooltiptext = Šī iespēja nemanot autentificēs Tevi starpniekserveros, kuriem saglabāti pieteikšanās dati. Ja autentificēšanās neizdosies, tiks parādīta uzvedne.
proxy-remote-dns =
