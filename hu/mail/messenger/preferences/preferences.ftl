...
general-email-notifications-header = E-mail-értesítések
...
general-files-and-attachment-description = Válassza ki, hogy mely fájlok legyenek mentve, és azok hol legyenek mentve a számítógépén.
general-tags-header = Címkék
general-reading-and-viewing-header = Olvasás és megtekintés
general-reading-and-display-header = Olvasás és megjelenítés
general-updates-header = Frissítések
general-network-and-storage-header = Hálózat és tárhely
general-search-performance-label = Keresés és teljesítmény
compose-writing-emails-header = E-mailek írása
...
compose-message-formatting-title = Üzenetformázás
compose-address-autocomplete-header = Cím automatikus kiegészítése
...
choose-display-language-description = Állítsa be a menük, gombok és értesítések megjelenítési nyelvét.
...
manual-storage-limit-label =
    .label = Állítsa be kézzel a tárolási korlátokat az ideiglenes fájlokhoz
    .accesskey = t
clear-temp-files-button =
    .label = Ideiglenes fájlok törlése
    .accesskey = I
clear-temp-files-shutdown-label =
    .label = Ideiglenes fájlok törlése a { -brand-short-name } bezárásakor
    .accesskey = I
...
show-start-page-label =
    .label = Kezdőoldal megjelenítése a { -brand-short-name } megnyitásakor
    .accesskey = K
start-page-label =
...
start-in-tray-label =
    ...
    .accesskey = i
new-message-arrival-legend = Új üzenet érkezésekor:
...
mail-play-button =
    .label = Lejátszás
    .accesskey = L
change-dock-icon-description = Alkalmazásjelvények és értesítések
change-dock-icon = Az alkalmazásikon beállításainak módosítása
app-icon-options =
    .label = Alkalmazásikon beállításai…
    .accesskey = A
new-email-alert-label =
    .label = Értesítés megjelenítése az új e-mailekről
    .accesskey = e
customize-alerts-label =
    .label = Figyelmeztetések testreszabása…
    .accesskey = F
...
use-custom-sound-label =
    .label = Egyéni hang használata a figyelmeztetésekhez
    .accesskey = E
mail-select-audio-button =
    .label = Hang kiválasztása…
    .accesskey = H
enable-global-search-label =
    .label = Keresés bekapcsolása az összes e-mail-fiókban
    .accesskey = K
gloda-results-plain-list-label =
    .label = Keresési eredmények megjelenítése sima listaként
    .accesskey = K
...
gloda-show-results-as-list-label =
    .label = Globális keresési találatok alapértelmezett megjelenítése listaként
    .accesskey = l
datetime-formatting-legend = Dátum és idő formázás
display-language-legend = Megjelenítési nyelv
allow-graphics-accel =
    .label = Grafikus gyorsítás használata a simább görgetés és a jobb teljesítmény érdekében
    .accesskey = h
storage-format-label =
    .value = Új fiókok tárolási formátuma:
    .accesskey = f
mbox-store-single-label =
    .label = Mappánként egy fájl (mbox)
...
hide-titlebar-label =
    .label = Címsor elrejtése
    .accesskey = C
hide-titlebar-description = Eltávolítja az ablak nevét megjelenítő címsort, így több hely marad a képernyőn
hide-tabbar-single-tab-label =
    .label = A lapsáv elrejtése, ha csak egyetlen lap van nyitva
    .accesskey = A
auto-hide-tabbar-second-tab-description = Automatikusan elrejti a lapokat, amíg meg nem nyit egy második lapot.
system-settings-legend = Rendszerbeállítások
check-email-app-label =
    .label = Megnyitáskor mindig ellenőrizze, hogy a { -brand-short-name } az alapértelmezett levelezőalkalmazás
    .accesskey = a
edit-defaults-apps-button =
    .label = Alapértelmezések szerkesztése…
    .accesskey = A
...
update-settings-title = Frissítési beállítások
install-updates-automatically-label =
    .label = Frissítések automatikus telepítése (ajánlott)
    .accesskey = F
install-updates-automatically-description = A legújabb biztonsági javításokkal biztonságban tartja a { -brand-short-name }öt.
check-updates-ask-label =
    .label = Frissítések keresése, de kérdezzen rá telepítés előtt
    .accesskey = k
...
update-application-background-enabled =
    ...
    .accesskey = H
show-history-button =
    .label = Előzmények megjelenítése
    .accesskey = E
...
connection-config-description = Állítsa be, hogy a { -brand-short-name } hogyan kapcsolódik az internethez.
connection-options-button =
    .label = Kapcsolat beállításai…
    .accesskey = K
offline-mode-legend = Kapcsolat nélküli mód
offline-settings-label = Kapcsolat nélküli munka beállításai
...
offline-settings-button =
    ...
    .accesskey = K
temporary-storage-legend = Ideiglenes tárolás
offline-compact-remove-deleted =
    .label = Adatok eltávolítása a mappákból, ha már törölték azokat, hogy tárhelyet szabadítson fel
    .accesskey = A
offline-compact-ask-cleanup =
    .label = Rákérdezés a mappák tisztítása előtt
    .accesskey = R
diskspace-legend = Lemezterület
offline-compact-folder =
    .label = Az összes mappa tömörítése, ha a megtakarított hely több lenne, mint
    .accesskey = t
...
use-cache-before =
    .value = Legfeljebb
    .accesskey = L
use-temp-storage-after = MB tárhely az ideiglenes fájlok számára
...
underline-text-links-label =
    .label = Hivatkozások aláhúzása az üzenetekben
    .accesskey = H
...
customize-fonts-button =
    .label = Betűkészletek testreszabása…
    .accesskey = B
font-options-button =
    .label = Speciális…
    .accesskey = c
...
convert-emoticons-label =
    ...
    .accesskey = H
display-text-formatting-label = Idézett szöveg formázása
...
mark-read-when-opened =
    .label = Megnyitáskor azonnal
    .accesskey = M
show-attachments-inline-label =
    .label = Mellékletek megjelenítése az üzenettörzsön belül
    .accesskey = M
mark-read-no-delay =
...
display-name-only-label =
    .label = Csak a címjegyzékbe mentett névjegyek megjelenítendő nevének megjelenítése
    .accesskey = C
...
show-conversation-view-label =
    .label = Beszélgetési nézet megjelenítése
    .accesskey = B
conversation-view-preview-description = Ez egy korai előnézeti funkció. A kapcsolódó üzeneteket egybe csoportosítja, de lehet, hogy nem mindig az elvárt módon működik.
...
dark-mode-message-appearance = Üzenetek megjelenése
dark-mode-checkbox-label =
    .label = Sötét mód használata az üzenetszövegekhez
    .accesskey = S
dark-mode-message-text-description = Sötét hátteret alkalmaz az összes bejövő üzenetre, még akkor is, ha a feladó világos színekkel formázta azokat.
...
dark-message-mode-toggle-label =
    ...
    .accesskey = k
dark-mode-toggle-description = Lehetővé teszi, hogy olvasás közben gyorsan visszakapcsolja az e-maileket világos módba, a fő beállítások módosítása nélkül.
general-folder-settings-header = Mappabeállítások
recent-folders-legend = Legutóbbi mappák
recent-folders-description = Szabályozza, hogy a legutóbb használt mappák hogyan jelenjenek meg az üzenetek áthelyezésekor.
...
recent-destinations-legend = Legutóbbi célok
recent-destinations-description = Beállítások a legutóbbi üzeneteket tartalmazó mappák felsorolásához és rendezéséhez.
recent-sort-order-label = Rendezési sorrend:
    .accesskey = R
recent-sort-order-mru =
    .label = Legfrissebb
recent-sort-order-alphabetic =
    .label = Betűrend
max-recent-label = Legutóbbi mappák maximális száma:
    .accesskey = m
...
account-hub-manual-config-checkbox-label =
    .label = Az új kézi beállítási folyamat használata a Fiókközpontban
    .accesskey = b
account-hub-manual-config-checkbox-description = Új fiókközponti kézi beállítási folyamat
new-calendar-legend = Új naptáresemény párbeszédablak
new-calendar-checkbox-label =
    .label = Naptáresemények megtekintése az új párbeszédablakban
new-calendar-checkbox-description = Új kísérleti párbeszédablak a naptáresemények megtekintéséhez
...
as-attachment-label =
    .label = Mellékletként
add-file-type-label =
    .label = Fájltípus hozzáadása a mellékelt üzenetekhez
    .accesskey = F
extension-label =
    .label = Kiterjesztés hozzáadása a fájlnévhez
    .accesskey = K
forward-messages-label =
    .value = Üzenetek továbbítása mint:
    .accesskey = Ü
forward-inline-label =
    .label = Az üzenetben (beágyazva)
...
autosave-draft-label =
    .label = Egy piszkozat automatikus mentése
    .accesskey = a
...
spellcheck-while-typing-label =
    .label = Helyesírás-ellenőrzés gépelés közben
    .accesskey = H
...
ignore-sender-styles-label =
    .label = A feladó betűkészleteinek és színeinek figyelmen kívül hagyása
    .accesskey = b
...
paragraph-spacing-label =
    .label = Az Enter megnyomásával új bekezdés kezdődik, nagyobb térközzel
    .accesskey = A
...
compose-format-automatic-description = Formázott szöveg küldése, ha stílusokat ad hozzá (például félkövér vagy hivatkozások), vagy sima szövegé, ha nem.
compose-format-both-option =
    .label = Formázott szöveg (HTML) és egyszerű szöveg is
compose-format-both-description = Mindig mindkét verziót elküldi, így a címzett levelezőprogramja kiválaszthatja, hogy melyiket jelenítse meg.
compose-format-html-option =
    .label = Csak formázott szöveg (HTML)
compose-format-html-description = Megtartja az egyéni betűkészleteket, színeket és képeket, de előfordulhat, hogy egyes régebbi levelezőprogramokban nem megfelelően jelennek meg.
compose-format-plain-option =
    .label = Csak egyszerű szöveg
compose-format-plain-description = Eltávolít minden formázást, színt és képet. Ideális az olyan egyszerű szöveges e-mailekhez, amelyek mindenhol működnek.
autocomplete-matches-description = A címzett nevének vagy e-mail-címének beírásakor keresés a következő helyeken:
company-network-directory-label =
    .label = Vállalati vagy hálózati címjegyzék
    .accesskey = V
...
manage-directories-label =
    .label = Címtárak kezelése…
    .accesskey = e
collect-outgoing-label =
    .label = Kimenő e-mail-címek automatikus mentése ide:
    .accesskey = a
collect-outgoing-description = A kézileg létrehozott vagy e-mailekből hozzáadott új névjegyek mentési helye.
save-added-contacts-label =
    .value = A kézileg hozzáadott névjegyek mentése ide:
    .accesskey = k
save-added-contacts-description = Az e-mailekből hozzáadott új névjegyek mentési helye.
show-directory-startup-label =
    .value = Könyvtár megjelenítése a címjegyzék ablakában a { -brand-short-name } megnyitásakor
    .accesskey = K
...
email-picker-label =
    ...
    .accesskey = e
email-picker-description = Az elküldött üzenetekből mentett új névjegyek helye.
default-add-address-book-label =
    .value = Alapértelmezett címjegyzék a kézileg hozzáadott névjegyekhez:
    .accesskey = A
default-add-address-book-description = A beérkezett üzenetekből mentett új névjegyek helye.
...
attachment-label =
    ...
    .accesskey = m
edit-keywords-label =
    .label = Kulcsszavak szerkesztése…
    .accesskey = K
offer-share-large-files-label =
    .label = Hivatkozásos fájlmegosztás felajánlása, ha a fájlméret ennél nagyobb:
...
search-preferences-input2 =
    ...
    .style = width: 15.4em
managed-by-organization-notice = A { -brand-short-name }öt a szervezete kezeli.
...
accent-color-selection-label =
    .value = Az elsődleges gomb és a kiemelések színe
accent-color-label =
...
appearance-view-style-select =
    .value = Válassza ki a nézet stílusát:
...
appearance-radio-card-view =
    .label = Kártyanézet
card-view-options-legend = Kártyanézet beállításai
...
default-message-list-new-folders-description = Adja meg az alapértelmezett rendezési és témacsoport-kezelési beállításokat az új mappákhoz
...
default-flag-grouped =
    .label = Csoportosítás
default-sort-by-label = Üzenetek rendezése:
...
default-sort-newest-bottom =
    .label = Új üzenetek alul
default-sort-new-messages-top =
    .label = Új üzenetek felül
apply-view-settings-label = Ezen nézetbeállítások alkalmazása ezekre:
apply-view-settings-to-all-folders-button =
    .label = Összes mappa és almappa
    .accesskey = m
select-apply-sort-folders-button =
    .label = Mappák kiválasztása
    .accesskey = v
