...
policy-AppUpdateURL = Egyéni alkalmazásfrissítési webcím beállítása.
policy-Authentication = Az integrált hitelesítés beállítása az azt támogató webhelyek számára.
policy-BackgroundAppUpdate2 = Háttérfrissítő engedélyezése vagy letiltása.
...
policy-DisableCommunity = Ne jelenítsen meg közösségi funkciókat a felületen (például „Adományozás”, „Csatlakozás”, „Ötletek megosztása” stb.)
...
policy-DisableFileLink = A Filelink funkció letiltása.
...
policy-DisableMessageForwardingFilters = Megakadályozás, hogy az üzenetszűrők automatikusan továbbítsák az üzeneteket.
...
policy-DisableUpdateSettings = Megakadályozás, hogy a felhasználó módosítsa az alkalmazásfrissítési beállításokat.
...
policy-InAppNotification = Értesítési típusok engedélyezése vagy letiltása.
