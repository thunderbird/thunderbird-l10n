...
account-settings-color-label = Szín:
    .accesskey = n
account-settings-reset-color-button =
    .title = Szín visszaállítása
delete-account-button =
    .label = Törlés
default-account-button =
    .label = Alapértelmezett
outgoing-server-name = Kimenő kiszolgáló:
    .accesskey = K
...
ews-override-oauth-details =
    .label = Office365 beállítások felülbírálása:
    .accesskey = O
ews-applicationid-label =
    .value = Alkalmazás azonosítója:
    .accesskey = A
ews-tenantid-label =
    .value = Bérlőazonosító:
    .accesskey = B
ews-redirecturi-label =
    .value = Átirányítási URI:
    .accesskey = r
ews-endpointhost-label =
    .value = Végpontkiszolgáló:
    .accesskey = V
