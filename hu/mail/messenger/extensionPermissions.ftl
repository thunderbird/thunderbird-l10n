...
webext-perms-description-messages-send = Tömeges e-mailek küldése programozottan az Ön nevében, vizuális visszajelzés nélkül. Használja a Tevékenységkezelőt a kiegészítő előzményeinek áttekintéséhez.
webext-perms-description-messages-save = E-mail-üzenetek mentése piszkozatként vagy sablonként, programozottan, az Ön közreműködése nélkül
