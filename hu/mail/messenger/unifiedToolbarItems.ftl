...
toolbar-spam-label = Levélszemét
toolbar-spam =
    .title = A kijelölt üzenetek megjelölése levélszemétként
toolbar-not-spam-label = Nem levélszemét
toolbar-not-spam =
    .title = A kijelölt üzenetek megjelölése nem levélszemétként
...
toolbar-add-address-book-label = Címjegyzék hozzáadása
