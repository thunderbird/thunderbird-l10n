...
quick-filter-bar-tag-mode-none =
    .label = Csak címkézetlen
    .title = Címke nélküli üzenetek
...
folder-pane-header-toggle-full-path =
    .label = Teljes útvonal megjelenítése
folder-pane-header-hide-local-folders =
    .label = Helyi mappák elrejtése
folder-pane-mode-header-all = Minden mappa
folder-pane-mode-header-unread = Olvasatlan mappák
...
threadpane-column-header-a11y-select =
    .aria-label = Üzenetek kiválasztása
