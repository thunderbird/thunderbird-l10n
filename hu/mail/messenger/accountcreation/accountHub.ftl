...
account-hub-servers-username-label = Felhasználónév:
account-hub-result-server-label = Kiszolgáló:
account-hub-result-port-label = Port:
account-hub-result-security-label = Biztonság:
account-hub-result-authentication-type-label = Hitelesítés:
account-hub-result-authentication-none = Nincs
    .title = Nincs
account-hub-result-authentication-password = Normál jelszó
    .title = Normál jelszó
account-hub-result-authentication-encrypted-password = Titkosított jelszó
    .title = Titkosított jelszó
account-hub-result-authentication-gssapi = Kerberos
    .title = Kerberos
account-hub-result-authentication-ntlm = NTLM
    .title = NTLM
account-hub-result-authentication-external = Külső
    .title = Külső
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = Nincs
account-hub-result-auth-password = Normál jelszó
account-hub-result-auth-encrypted-password = Titkosított jelszó
account-hub-result-auth-gssapi = Kerberos
account-hub-result-auth-ntlm = NTLM
account-hub-result-auth-external = Külső
...
account-hub-exchange-service-url-label = Adja meg a szolgáltatás webcímét
...
account-hub-password-label = Jelszó
    .accesskey = J
    .title = Nem kötelező, csak a felhasználónév ellenőrzéséhez használatos
account-hub-remember-password = Jelszó megjegyzése
    .accesskey = m
account-hub-exchange-label = Az Ön bejelentkezése
    .accesskey = b
account-hub-installing-addon = Kiegészítő letöltése és telepítése…
account-hub-success-addon = A kiegészítő telepítése sikeresen megtörtént
account-hub-success-half-manual = Az adott kiszolgáló vizsgálata a következő beállításokat találta:
account-hub-result-security-no-encryption = Nincs titkosítás
    .title = Nincs titkosítás
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = Nincs titkosítás
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = Hitelesítés sikertelen. Ellenőrizze a felhasználónevet és a jelszót.
...
account-hub-exchange-config-unverifiable = A konfigurációt nem lehetett megerősíteni. Ha a felhasználóneve és a jelszava helyes, akkor valószínű, hogy a kiszolgáló adminisztrátora letiltotta a fiókjának kiválasztott konfigurációját. Próbáljon meg másik protokollt választani.
account-hub-advanced-setup-button = Speciális beállítások
    .accesskey = S
# Variables:
#  $domain (String): The name of the server where the configuration was found, e.g. rackspace.com.
account-hub-exchange-dialog-question = A { -brand-short-name } megtalálta a fiókinformációit ehhez: { $domain }. Folytatja és elküldi a hitelesítő adatait?
account-hub-creation-error-title = Hiba a fiók létrehozásakor
account-hub-error-server-exists = Már van bejövő kiszolgáló.
account-hub-confirm-advanced-title = Speciális beállítások megerősítése
account-hub-confirm-advanced-description = Ez a párbeszédpanel bezáródik, és létrejön egy fiók a jelenlegi beállításokkal, még akkor is, ha a konfiguráció hibás. Folytatja?
account-hub-addon-install-title = Telepítés
...
account-hub-result-graph-api-description = A Microsoft Graph API használata a mappák és a levelek szinkronizálásához a Microsoft 365-tel
account-hub-result-graph-shortname = Exchange (Graph)
account-hub-result-graph-description = A Microsoft Graph API használata a mappák és a levelek szinkronizálásához
...
account-hub-config-success-title = A fiókbeállítások automatikusan megtalálva.
account-hub-config-success-description-db = A konfiguráció megtalálva a Mozilla ISPDB-ben.
account-hub-config-success-description-exchange = A Microsoft Exchange kiszolgáló konfigurációja megtalálva.
...
address-book-add-remote-icon2 =
    .alt = Távoli címjegyzék hozzáadása
address-book-add-remote-icon =
    .alt = Új távoli címjegyzék hozzáadása
address-book-add-remote = Távoli címjegyzék hozzáadása
address-book-add-remote-carddav-description = Kapcsolódás egy CardDAV-címjegyzékhez
...
address-book-add-ldap-icon2 =
    .alt = LDAP-címjegyzék hozzáadása
address-book-add-ldap-button = LDAP-címjegyzék hozzáadása
...
account-hub-exchange-type-account-type = Fiók típusa
account-hub-card-graph-title = Microsoft Graph
account-hub-card-graph-description = A Microsoft Graph egy modern kapcsolódási mód a Microsoft 365-höz.
account-hub-card-ews-title = Exchange Web Services
account-hub-card-ews-tag = Örökölt
account-hub-card-ews-description = Az Exchange Web Services (EWS) kapcsolódik a Microsoft Exchange szolgáltatáshoz a levelek szinkronizálásához.
# This is shown after the type description, so "it" is referring to the type (either Microsoft Graph or Exchange Web Services).
account-hub-card-recommended-description = Ajánlott, mert megegyezik a szolgáltatás webcímével.
account-hub-exchange-type-username = Felhasználónév
account-hub-exchange-type-username-hint = Tipikusan az e-mail-címe vagy az Active Directory egyedi felhasználói neve.
account-hub-exchange-type-authentication = Hitelesítési módszer
# Checkbox that can be unchecked to use a custom OAuth config.
account-hub-exchange-type-default-oauth = Az alapértelmezett Microsoft 365 Copilot hitelesítési beállítások használata
account-hub-exchange-type-oauth-tenant = Bérlőazonosító
account-hub-exchange-type-oauth-app = Alkalmazásazonosító
account-hub-exchange-type-advanced-config = Speciális beállítások
account-hub-exchange-type-title = Válasszon egy fióktípust
