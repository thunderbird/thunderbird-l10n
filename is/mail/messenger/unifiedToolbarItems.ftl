...
toolbar-spam-label = Ruslpóstur
toolbar-spam =
    .title = Merkja valin skilaboð sem ruslpóst
toolbar-not-spam-label = Ekki ruslpóstur
toolbar-not-spam =
    .title = Merkja valin skilaboð sem ekki ruslpóst
...
toolbar-add-address-book-label = Bæta við nafnaskrá
