...
default-app-intro = Nota { -brand-short-name } sem sjálfgefið forrit fyrir:
...
checkbox-net-thunderbird-url-label =
    .label = Sérsniðnir Thunderbird-tenglar (net.thunderbird://)
    .tooltiptext = { unset-default-tooltip }
...
check-on-startup-label =
    ...
    .accesskey = A
system-settings-dialog-title = Kerfisstillingar
