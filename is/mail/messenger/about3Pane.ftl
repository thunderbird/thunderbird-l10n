...
quick-filter-bar-tag-mode-none =
    .label = Aðeins ómerkt
    .title = Einungis skilaboð án merkja
...
folder-pane-header-toggle-full-path =
    .label = Sýna alla slóðina
folder-pane-header-hide-local-folders =
    .label = Fela staðbundnar möppur
folder-pane-mode-header-all = Allar möppur
folder-pane-mode-header-unread = Ólesnar möppur
...
folder-pane-context-reset-sort =
    .label = Endurstilla röð á möppum
    .accesskey = r
# Variables:
