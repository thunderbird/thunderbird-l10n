...
policy-DisableMessageForwardingFilters = Koma í veg fyrir að skilaboðasíur áframsendi skilaboð sjálfkrafa.
...
policy-DisableUpdateSettings = Koma í veg fyrir að notandinn breyti stillingum fyrir uppfærslur á forritum.
