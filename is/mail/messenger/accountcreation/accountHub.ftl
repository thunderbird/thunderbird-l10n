...
account-hub-email-set-up-account-button = Setja upp reikning
account-hub-email-confirm-button = Staðfesta
account-hub-email-find-settings-button = Finna stillingar
account-hub-email-connect-button = Tengjast
account-hub-result-incoming-legend = Móttekið
account-hub-result-outgoing-legend = Útsent
account-hub-all-servers-legend = Allir póstþjónar
...
account-hub-servers-username-label = Notandanafn:
account-hub-result-server-label = Netþjónn:
account-hub-result-port-label = Gátt:
account-hub-result-security-label = Öryggi:
account-hub-result-authentication-type-label = Auðkenning:
account-hub-result-authentication-none = Ekkert
    .title = Ekkert
account-hub-result-authentication-password = Venjulegt lykilorð
    .title = Venjulegt lykilorð
account-hub-result-authentication-encrypted-password = Dulritað lykilorð
    .title = Dulritað lykilorð
account-hub-result-authentication-gssapi = Kerberos
    .title = Kerberos
account-hub-result-authentication-ntlm = NTLM
    .title = NTLM
account-hub-result-authentication-external = Utanaðkomandi
    .title = Utanaðkomandi
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = Ekkert
account-hub-result-auth-password = Venjulegt lykilorð
account-hub-result-auth-encrypted-password = Dulritað lykilorð
account-hub-result-auth-gssapi = Kerberos
account-hub-result-auth-ntlm = NTLM
account-hub-result-auth-external = Utanaðkomandi
...
account-hub-exchange-service-url-label = Settu inn vefslóð þjónustunnar
...
account-hub-password-label = Lykilorð
    .accesskey = k
    .title = Valkvætt, verður einungis notað til að fullgilda notandanafnið
account-hub-remember-password = Muna lykilorð
    .accesskey = M
account-hub-exchange-label = Innskráningin þín
    .accesskey = I
account-hub-installing-addon = Sæki og set upp viðbót...
account-hub-success-addon = Tókst að setja upp viðbótina
account-hub-success-half-manual = Eftirfarandi stillingar fundust með því að kanna tiltekinn póstþjón:
account-hub-result-security-no-encryption = Engin dulritun
    .title = Engin dulritun
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = Engin dulritun
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = Auðkenning mistókst. Athugaðu notandanafnið og lykilorðið
...
account-hub-exchange-config-unverifiable = Ekki var hægt að staðfesta uppsetningu. Ef notendanafnið þitt og lykilorðið þitt er rétt er líklegt að kerfisstjóri netþjónsins hafi gert valda uppsetningu fyrir reikninginn þinn óvirka. Prófaðu að velja aðra samskiptareglu.
account-hub-advanced-setup-button = Ítarleg uppsetning
    .accesskey = u
# Variables:
#  $domain (String): The name of the server where the configuration was found, e.g. rackspace.com.
account-hub-exchange-dialog-question = { -brand-short-name } fann uppsetningarupplýsingar reikningsins þíns á { $domain }. Viltu halda áfram og senda inn auðkennin þín?
account-hub-creation-error-title = Villa við að búa til reikning
account-hub-error-server-exists = Móttökupóstþjónn er þegar til.
account-hub-confirm-advanced-title = Staðfesta ítarlegar stillingar
account-hub-confirm-advanced-description = Þessum glugga verður lokað og reikningur með núverandi stillingum verður stofnaður, jafnvel þótt uppsetningin sé röng. Viltu halda áfram?
account-hub-addon-install-title = Setja inn
...
account-hub-manual-config-imap-title = IMAP-stillingar
account-hub-manual-config-pop3-title = POP3-stillingar
account-hub-manual-config-review-settings-title = Fara yfir uppfærðar stillingar
account-hub-manual-config-incoming-legend = Póstþjónn inn
...
account-hub-email-exchange-settings = Exchange-stillingar
account-hub-email-connect-settings = Tengdu tölvupóststillingarnar þínar
account-hub-email-protocol-select-header = Veldu tegund tölvupóstreiknings
account-hub-email-protocol-select-additional-info = Frekari upplýsingar eru nauðsynlegar til að setja upp þennan reikning.
account-hub-email-protocol-select-notification = Frekari upplýsingar eru nauðsynlegar til að setja upp þennan reikning
...
account-hub-result-graph-api-description = Nota Microsoft Graph API til að samstilla möppur og tölvupóst við Microsoft 365
account-hub-result-graph-shortname = Exchange (Graph)
account-hub-result-graph-description = Nota Microsoft Graph API til að samstilla möppur og tölvupóst
...
account-hub-result-ews-expanded-text = Exchange vefþjónustur
...
account-hub-config-success-title = Reikningsstillingar fundust sjálfkrafa.
account-hub-config-success-description-db = Uppsetning fannst í ISP-gagnagrunni Mozilla.
account-hub-config-success-description-exchange = Stillingar fundust fyrir Microsoft Exchange póstþjón.
account-hub-config-success-description-guess = Uppsetning fannst með því að prófa algeng nöfn póstþjóna.
account-hub-config-success-description-disk = Stillingar fundust í { -brand-short-name } uppsetningu.
...
account-hub-manual-config-error-summary = Endilega lagfærðu eftirfarandi villur:
...
address-book-add-remote-icon2 =
    .alt = Bæta við fjartengdri nafnaskrá
address-book-add-remote-icon =
    .alt = Bæta við nýrri fjartengdri nafnaskrá
address-book-add-remote = Bæta við fjartengdri nafnaskrá
address-book-add-remote-carddav-description = Tengjast við CardDAV-nafnaskrá
...
address-book-add-ldap-icon2 =
    .alt = Bæta við LDAP-nafnaskrá
address-book-add-ldap-button = Bæta við LDAP-nafnaskrá
...
account-hub-exchange-type-account-type = Tegund reiknings
