...
looking-for-messages-account = Leita að nýjum skilaboðum fyrir { $accountName }…
# Feedback message shown in the status bar while we look for new messages in a
# specific folder.
# Variables:
# $folderName (String) - The folder's name.
looking-for-messages-folder = Leita að nýjum skilaboðum í { $folderName }…
...
deleting-message =
    { $number ->
        [one] Eyði einum skilaboðum úr { $folderName }…
       *[other] Eyði { $number } skilaboðum úr { $folderName }…
    }
# Feedback message shown in the status bar while we're deleting messages in a
# specific folder (and waiting for the remote operation to complete).
# Variables:
# $number (Number) - Number of messages being deleted.
# $folderName (String) - The folder's name.
deleting-messages = Eyði { $number } skilaboðum úr { $folderName }…
