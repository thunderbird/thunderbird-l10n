...
toolbar-spam-label = Sbam
toolbar-spam =
    .title = Marcio'r negeseuon a ddewiswyd yn sbam
toolbar-not-spam-label = Nid Sbam
toolbar-not-spam =
    .title = Marcio'r negeseuon a ddewiswyd fel rhai sydd ddim yn sbam
...
toolbar-forward-inline-label = Anfon Ymlaen
...
toolbar-add-address-book-label = Ychwanegu Llyfr Cyfeiriadau
