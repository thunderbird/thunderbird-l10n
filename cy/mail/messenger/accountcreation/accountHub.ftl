...
account-hub-sync-failure = Nid oedd Thunderbird yn gallu dod o hyd i wasanaethau cysylltiedig
...
account-hub-select-all = Dewis popeth
...
account-hub-email-added-success-links-title = Archwiliwch opsiynau ar gyfer diogelwch a phersonoli:
