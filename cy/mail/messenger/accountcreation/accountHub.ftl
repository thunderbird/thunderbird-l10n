...
account-hub-result-imap-description = Cadw eich ffolderi a'ch e-byst wedi'u cydweddu ar eich gweinydd
account-hub-result-pop-description = Cadw eich ffolderi a'ch e-byst ar eich cyfrifiadur
account-hub-result-ews-shortname = Exchange
account-hub-result-ews-description = Defnyddiwch Microsoft Exchange Web Services i gysoni'ch ffolderi a'ch e-byst
account-hub-result-ews-text = Gweinydd
account-hub-result-recommended-label = Cymeradwy
account-hub-edit-configuration = Golygu cyfluniad
