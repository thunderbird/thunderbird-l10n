...
account-hub-email-setup-incoming = Gosodiadau gweinydd sy'n dod i mewn
account-hub-email-setup-outgoing = Gosodiadau gweinydd sy'n mynd allan
account-hub-email-config-found = Dewiswch eich math o gyfrif e-bost
account-hub-email-enter-password = Rhowch eich cyfrinair cyfrif e-bost
account-hub-email-sync-accounts = Cysoni eich calendrau a llyfrau cyfeiriadau
