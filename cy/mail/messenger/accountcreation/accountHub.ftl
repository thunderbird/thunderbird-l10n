...
account-hub-email-set-up-account-button = Sefydlu cyfrif
account-hub-email-confirm-button = Cadarnhau
account-hub-email-find-settings-button = Dod o hyd i osodiadau
...
account-hub-servers-username-label = Enw Defnyddiwr:
account-hub-result-server-label = Gweinydd:
account-hub-result-port-label = Porth:
account-hub-result-security-label = Diogelwch:
account-hub-result-authentication-type-label = Dilysu:
account-hub-result-authentication-none = Dim
    .title = Dim
account-hub-result-authentication-password = Cyfrinair Arferol
    .title = Cyfrinair Arferol
account-hub-result-authentication-encrypted-password = Cyfrinair Amgryptio
    .title = Cyfrinair Amgryptio
account-hub-result-authentication-gssapi = Kerberos
    .title = Kerberos
account-hub-result-authentication-ntlm = NTLM
    .title = NTLM
account-hub-result-authentication-external = Allanol
    .title = Allanol
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = Dim
account-hub-result-auth-password = Cyfrinair Arferol
account-hub-result-auth-encrypted-password = Cyfrinair Amgryptio
account-hub-result-auth-gssapi = Kerberos
account-hub-result-auth-ntlm = NTLM
account-hub-result-auth-external = Allanol
...
account-hub-exchange-service-url-label = Rhowch URL y gwasanaeth
...
account-hub-result-security-no-encryption = Dim Amgryptiad
    .title = Dim Amgryptiad
...
account-hub-credentials-wrong = Methodd y dilysu. Gwiriwch yr enw defnyddiwr a'r cyfrinair
...
account-hub-exchange-config-unverifiable = Doedd dim modd dilysu eich ffurfweddiad. Os yw'ch enw defnyddiwr a'ch cyfrinair yn gywir, mae'n debygol bod gweinyddwr y gweinydd wedi analluogi'r ffurfweddiad a ddewiswyd ar gyfer eich cyfrif. Ceisiwch ddewis protocol arall.
account-hub-advanced-setup-button = Ffurfweddiad uwch
    .accesskey = F
# Variables:
#  $domain (String): The name of the server where the configuration was found, e.g. rackspace.com.
account-hub-exchange-dialog-question = Mae { -brand-short-name } wedi canfod manylion gosod eich cyfrif ar { $domain }. Hoffech chi barhau a chyflwyno'ch manylion?
account-hub-creation-error-title = Gwall wrth Greu Cyfrif
account-hub-error-server-exists = Mae'r gweinydd derbyn yn bodoli eisoes.
account-hub-confirm-advanced-title = Cadarnhau Ffurfweddiad Uwch
account-hub-confirm-advanced-description = Bydd y ddeialog hon yn cael ei chau a bydd cyfrif gyda'r gosodiadau cyfredol yn cael ei greu, hyd yn oed os yw'r ffurfweddiad yn anghywir. Hoffech chi barhau?
account-hub-addon-install-title = Gosod
...
account-hub-same-username-checkbox = Yr un enw defnyddiwr â gweinydd sy'n dod i mewn
...
account-hub-email-exchange-settings = Gosodiadau cyfnewid
...
account-hub-email-protocol-select-notification = Mae angen gwybodaeth ychwanegol i sefydlu'r cyfrif hwn
...
account-hub-result-graph-api-shortname = Microsoft Graff API
account-hub-result-graph-api-description = Defnyddiwch API Graff Microsoft i gysoni'ch ffolderi a'ch e-byst â Microsoft 365
account-hub-result-graph-shortname = Cyfnewid (graff)
account-hub-result-graph-description = Defnyddiwch Microsoft Graph API i gydweddu'ch ffolderi a'ch e-byst
...
account-hub-result-graph-expanded-text = Graff API
...
account-hub-config-success-title = Mae'r gosodiadau cyfrif yn cael eu canfod yn awtomatig.
account-hub-config-success-description-db = Wedi canfod y ffurfweddiad yn Mozilla ISPDB.
account-hub-config-success-description-exchange = Ffurfweddiad wedi'i ganfod ar gyfer gweinydd Microsoft Exchange.
account-hub-config-success-description-guess = Wedi canfod y ffurfweddiad drwy roi cynnig ar enwau gweinydd cyffredin.
account-hub-config-success-description-disk = Wedi canfod y ffurfweddiad yng ngosodiad { -brand-short-name }.
...
address-book-add-remote-icon2 =
    .alt = Ychwanegu llyfr cyfeiriadau o bell
address-book-add-remote-icon =
    .alt = Ychwanegu llyfr cyfeiriadau pell newydd
address-book-add-remote = Ychwanegu Llyfr Cyfeiriadau pell
address-book-add-remote-carddav-description = Cysylltu â llyfr cyfeiriadau CardDAV
...
address-book-add-ldap-icon2 =
    .alt = Ychwanegu llyfr cyfeiriadau LDAP
address-book-add-ldap-button = Ychwanegu Llyfr Cyfeiriadau LDAP
...
account-hub-exchange-type-account-type = Math o gyfrif
account-hub-card-graph-title = Graff Microsoft
account-hub-card-graph-description = Mae Microsoft Graph yn ddull cysylltu modern ar gyfer Microsoft 365.
account-hub-card-ews-title = Exchange Web Services
account-hub-card-ews-tag = Etifeddiaeth
account-hub-card-ews-description = Mae Exchange Web Services (EWS) yn cysylltu â Microsoft Exchange i gysoni'ch post.
# This is shown after the type description, so "it" is referring to the type (either Microsoft Graph or Exchange Web Services).
account-hub-card-recommended-description = Argymhellir oherwydd ei fod yn cyd-fynd â URL eich Gwasanaeth.
account-hub-exchange-type-username = Enw Defnyddiwr
account-hub-exchange-type-username-hint = Fel arfer eich cyfeiriad e-bost neu Active Directory UPN.
account-hub-exchange-type-authentication = Dull Dilysu
# Checkbox that can be unchecked to use a custom OAuth config.
account-hub-exchange-type-default-oauth = Defnyddiwch osodiadau dilysu diofyn Microsoft 365 Copilot
account-hub-exchange-type-oauth-tenant = ID Tenant
account-hub-exchange-type-oauth-app = Enw Rhaglen
account-hub-exchange-type-advanced-config = Ffurfweddiad Uwch
account-hub-exchange-type-title = Dewiswch fath o gyfrif
