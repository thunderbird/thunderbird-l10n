...
account-hub-manual-config-review-settings-title = Adolygwch osodiadau wedi'u diweddaru
...
account-hub-port-help-text = Os bydd yn cael ei adael yn wag, bydd { -brand-short-name } yn ceisio darganfod y porth.
...
account-hub-result-graph-api-description = Defnyddiwch API Microsoft Graph i gydweddu'ch ffolderi a'ch e-byst â Microsoft 365
...
account-hub-manual-config-error-summary = Mae angen datrys y gwallau canlynol:
...
address-book-add-remote-icon2 =
    .alt = Ychwanegu llyfr cyfeiriadau pell
...
account-hub-card-ews-tag = Hen
account-hub-card-ews-description = Mae Exchange Web Services (EWS) yn cysylltu â Microsoft Exchange i gydweddu'ch e-byst.
# This is shown after the type description, so "it" is referring to the type (either Microsoft Graph or Exchange Web Services).
account-hub-card-recommended-description = Mae'n cael ei argymell oherwydd ei fod yn cyd-fynd ag URL eich Gwasanaeth.
...
account-hub-exchange-type-default-oauth = Defnyddiwch osodiadau dilysu arferol Microsoft 365 Copilot
