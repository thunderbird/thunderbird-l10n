...
account-hub-config-success-title = Canfyddir gosodiadau cyfrif yn awtomatig.
account-hub-config-success-description-db = Canfuwyd y ffurfweddiad yn Mozilla ISPDB.
account-hub-config-success-description-exchange = Ffurfweddiad wedi'i ganfod ar gyfer gweinydd Microsoft Exchange.
account-hub-config-success-description-guess = Canfuwyd y ffurfweddiad drwy roi cynnig ar enwau gweinydd cyffredin.
account-hub-config-success-description-disk = Canfuwyd y ffurfweddiad yng ngosodiad { -brand-short-name }.
