...
account-hub-server-tip = Bydd Thunderbird yn ceisio canfod eich enw gwesteiwr yn awtomatig
...
account-hub-address-book-base-dn = Sylfaen DN
account-hub-address-book-bind-dn = Rhwymwch DN
account-hub-ldap-form = Cysylltwch â chyfeiriadur LDAP
