...
account-hub-result-exchange-description = Cysoni ffolderi ac e-byst gyda Exchange neu Office 365
...
account-hub-port-error-text = Rhaid i'r porthladd fod rhwng 1 a 65535
    .title = Rhaid i'r porthladd fod rhwng 1 a 65535
