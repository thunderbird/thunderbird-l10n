...
account-hub-close-button =
    .title = Cau
account-hub-email-manual-configuration = Cyfluniad â llaw
account-hub-notification-unknown-host = Gwybodaeth gosod a ganfuwyd ar barth trydydd parti
...
account-hub-config-success-exchange = Ffurfweddiad ar gyfer Microsoft Exchange wedi ei ganfod
account-hub-config-success-guess = Ffurfweddiad wedi'i ganfod drwy enwau gweinyddion cyffredin
account-hub-config-success-disk = Canfuwyd y ffurfweddiad yng ngosodiad { -brand-short-name }
