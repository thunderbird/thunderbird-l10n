...
oauth-result-footer-text = Angen help? Cysylltwch â'n cefnogaeth.

## Successful authentication

oauth-success-title = Rydych chi'n barod
...
oauth-error-title = Doedd dim modd cwblhau'r mewngofnodi
oauth-error-subtitle = Doedd { -brand-short-name } ddim yn gallu gorffen mewngofnodi gyda'r gosodiadau hyn.
...
oauth-error-body = Ewch yn ôl i { -brand-short-name }, adolygwch eich gosodiadau ffurfweddu cyfrif, a rhowch gynnig arall arni.  Os bydd y broblem yn parhau, ewch i  { $linkStart }Datrys mewngofnodi cyfrif{ $linkEnd } am help.
