...
folder-pane-header-toggle-full-path =
    .label = Dangos Llwybr Llawn
folder-pane-header-hide-local-folders =
    .label = Cuddio Ffolderi Lleol
folder-pane-mode-header-all = Pob Ffolder
folder-pane-mode-header-unread = Ffolderi Heb eu Darllen
folder-pane-mode-header-favorite = Hoff Ffolderi
folder-pane-mode-header-recent = Ffolderi Diweddar
folder-pane-mode-header-smart = Ffolderi Cyfun
