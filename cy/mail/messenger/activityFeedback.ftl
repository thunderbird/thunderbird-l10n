...
looking-for-messages-account = Yn chwilio am negeseuon newydd { $accountName }…
# Feedback message shown in the status bar while we look for new messages in a
# specific folder.
# Variables:
# $folderName (String) - The folder's name.
looking-for-messages-folder = Chwilio am negeseuon newydd yn { $folderName }…
...
deleting-message =
    { $number ->
        [one] Wrthi'n dileu un neges o { $folderName }…
        [zero] Wrthi'n dileu { $number } negeseuon o { $folderName }…
        [two] Wrthi'n dileu { $number } neges o { $folderName }…
        [few] Wrthi'n dileu { $number } neges o { $folderName }…
