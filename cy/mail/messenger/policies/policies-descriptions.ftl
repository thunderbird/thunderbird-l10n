...
policy-DisableMessageForwardingFilters = Atal hidlwyr neges rhag anfon negeseuon ymlaen yn awtomatig.
...
policy-DisableUpdateSettings = Atal y defnyddiwr rhag newid gosodiadau diweddaru cymhwysiad.
