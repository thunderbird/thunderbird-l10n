...
policy-DisableCommunity = Peidio dangos nodweddion cymunedol yn yr UI (fel Cyfrannu, Cymryd Rhan, Rhannu Syniadau ac ati)
...
policy-DisableFileLink = Analluogi'r nodwedd Filelink.
