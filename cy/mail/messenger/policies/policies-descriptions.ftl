...
policy-DisableChat = Analluogu'r nodwedd Sgwrsio.
policy-DisableCommunity = Peidiwch â dangos nodweddion cymunedol yn yr UI (fel Cyfrannu, Cymryd Rhan, Rhannu Syniadau ac ati)
...
policy-DisableFileLink = Analluoga'r nodwedd Filelink.
...
policy-DisableMessageForwardingFilters = Atal hidlwyr negeseuon rhag anfon negeseuon ymlaen yn awtomatig.
...
policy-DisableUpdateSettings = Atal y defnyddiwr rhag newid gosodiadau diweddaru rhaglen.
