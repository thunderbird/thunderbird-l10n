...
cert-error-inline-expired =
    .title = Gwall cysylltu. Daeth tystysgrif { $hostname } i ben ar { $not-after }. Cliciwch i agor gosodiadau diogelwch y gweinydd.
# Variables:
#   $hostname (string) - Hostname (and possibly port) of the server with certificate error.
#   $not-before (string) - Certificate is not valid before this time.
cert-error-inline-not-yet-valid =
    .title = Gwall cysylltu. Ni fydd tystysgrif { $hostname } yn ddilys tan { $not-before }. Cliciwch i agor gosodiadau diogelwch y gweinydd.
# Variables:
#   $hostname (string) - Hostname (and possibly port) of the server with certificate error.
...
certificate-check-test-button = Prawf cysylltiad â gweinydd
...
certificate-checking = Wrthi'n profi cysylltiad â gweinydd { $hostname }…
# Variables:
#   $hostname (string) - Hostname (and possibly port) of a server.
certificate-test-success = Llwyddwyd i sefydlu cysylltiad diogel i { $hostname }.
# Variables:
#   $hostname (string) - Hostname (and possibly port) of a server.
...
# Variables:
#   $hostname (string) - Hostname (and possibly port) of a server.
certificate-check-exception-exists = Mae eithriad tystysgrif { $hostname } yn bodoli.
