...
default-app-intro = Defnyddi { -brand-short-name } fel yr ap arferol ar gyfer:
...
check-default-email-app-label =
    .label = Gwirio pob amser i weld ai { -brand-short-name } yw'r ap e-bost arferol pan gaiff ei agor
    .accesskey = G
