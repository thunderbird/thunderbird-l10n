...
default-app-intro = Defnyddiwch { -brand-short-name } fel yr ap diofyn ar gyfer:
...
checkbox-net-thunderbird-url-label =
    .label = Dolenni Thunderbird cyfaddas (net.thunderbird://)
    .tooltiptext = { unset-default-tooltip }
...
check-on-startup-label =
    ...
    .accesskey = G
system-settings-dialog-title = Gosodiadau system
