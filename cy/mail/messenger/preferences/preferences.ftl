...
general-email-notifications-header = Hysbysiadau e-bost
...
general-files-and-attachment-description = Dewis pa ffeiliau sy'n cael eu cadw a ble maen nhw'n cael eu cadw ar eich cyfrifiadur.
general-tags-header = Tagiau
general-reading-and-viewing-header = Darllen a gweld
general-reading-and-display-header = Darllen a Dangos
general-updates-header = Diweddariadau
general-network-and-storage-header = Rhwydwaith a storio
general-search-performance-label = Chwilio a pherfformiad
compose-writing-emails-header = Ysgrifennu e-byst
...
compose-message-formatting-title = Fformatio negeseuon
compose-address-autocomplete-header = Awtogwblhau cyfeiriadau
...
collection-share-crash-data =
    .label = Anfon adroddiadau chwalfa dienw i { -vendor-short-name }
    .accesskey = A
...
privacy-security-certificates-title = Tystysgrifau diogelwch
...
choose-display-language-description = Dewis yr iaith sy'n cael ei ddefnyddio ar gyfer dewislenni, botymau a hysbysiadau.
...
manual-storage-limit-label =
    .label = Gosod terfynau storio â llaw ffeiliau dros dro
    .accesskey = G
clear-temp-files-button =
    .label = Clirio ffeiliau dros dro
    .accesskey = C
clear-temp-files-shutdown-label =
    .label = Clirio ffeiliau dros dro pan fydd { -brand-short-name } yn cau
    .accesskey = C
...
show-start-page-label =
    .label = Dangos y Dudalen Gychwyn pan fydd { -brand-short-name } yn agor
    .accesskey = D
start-page-label =
...
start-in-tray-label =
    ...
    .accesskey = C
new-message-arrival-legend = Pan fydd neges newydd yn cyrraedd:
...
mail-play-button =
    .label = Chwarae
    .accesskey = h
change-dock-icon-description = Bathodynnau apiau a hysbysiadau
change-dock-icon = Newid dewisiadau eicon yr ap
app-icon-options =
    .label = Dewisiadau Eicon Ap…
    .accesskey = E
new-email-alert-label =
    .label = Dangos rhybudd am e-byst newydd
    .accesskey = D
customize-alerts-label =
    .label = Cyfaddasu rhybuddion…
    .accesskey = A
...
use-custom-sound-label =
    .label = Defnyddio sain cyfaddas rhybuddion
    .accesskey = D
mail-select-audio-button =
    .label = Dewis sain…
    .accesskey = D
enable-global-search-label =
    .label = Troi'r chwilio ymlaen ar bob cyfrif e-bost
    .accesskey = T
gloda-results-plain-list-label =
    .label = Dangos canlyniadau chwilio fel rhestr plaen
    .accesskey = D
...
gloda-show-results-as-list-label =
    .label = Dangos canlyniadau chwilio eang fel rhestr arferol
    .accesskey = D
datetime-formatting-legend = Fformatio Dyddiad ac Amser
display-language-legend = Iaith dangos
allow-graphics-accel =
    .label = Defnyddio cyflymiad graffeg ar gyfer sgrolio a pherfformiad llyfnach
    .accesskey = D
storage-format-label =
    .value = Fformat storio cyfrifon newydd:
    .accesskey = F
mbox-store-single-label =
    .label = Ffeil sengl fesul ffolder (mbox)
...
hide-titlebar-label =
    .label = Cuddio bar teitl
    .accesskey = C
hide-titlebar-description = Yn dileu'r bar uchaf sy'n dangos enw'r ffenestr i arbed gofod sgrin
hide-tabbar-single-tab-label =
    .label = Cuddio'r bar tab pan mai dim ond un tab sydd ar agor
    .accesskey = C
auto-hide-tabbar-second-tab-description = Yn cuddio tabiau'n awtomatig nes i chi agor ail dab.
system-settings-legend = Gosodiadau system
check-email-app-label =
    .label = Gwirio bob tro i weld ai { -brand-short-name } yw'r ap e-bost arferol pan gaiff ei agor
    .accesskey = G
edit-defaults-apps-button =
    .label = Golygu rhagosodiadau…
    .accesskey = G
...
update-settings-title = Diweddaru gosodiadau
install-updates-automatically-label =
    .label = Gosod diweddariadau'n awtomatig (argymell)
    .accesskey = d
install-updates-automatically-description = Yn cadw { -brand-short-name } yn ddiogel gyda'r cywiriadau diogelwch diweddaraf.
check-updates-ask-label =
    .label = Gwirio am ddiweddariadau, ond gofyn cyn gosod
    .accesskey = G
...
connection-config-description = Rheoli sut mae { -brand-short-name } yn cysylltu â'r rhyngrwyd.
connection-options-button =
    .label = Dewisiadau cysylltu…
    .accesskey = D
offline-mode-legend = Modd all-lein
offline-settings-label = Gosodiadau all-lein
...
offline-settings-button =
    .label = All-lein…
    .accesskey = l
temporary-storage-legend = Storio dros dro
offline-compact-remove-deleted =
    .label = Tynnu data o ffolderi pan fyddan nhw eisoes wedi'u dileu i wagio'r storfa
    .accesskey = T
offline-compact-ask-cleanup =
    .label = Gofyn cyn gwagio ffolderi
    .accesskey = G
...
use-cache-before =
    ...
    .accesskey = D
use-temp-storage-after = MB o le ar gyfer ffeiliau dros dro
...
underline-text-links-label =
    .label = Tanlinellu dolenni testun mewn negeseuon
    .accesskey = T
...
convert-emoticons-label =
    ...
    .accesskey = g
display-text-formatting-label = Fformatio testun sy'n cael ei ddyfynnu
...
search-content-types =
    .placeholder = Chwilio mathau o gynnwys
...
always-ask-label =
    ...
    .accesskey = G
use-tags-text = Defnyddio tagiau i gategoreiddio a blaenoriaethu negeseuon.
...
mark-read-when-opened =
    .label = Yn syth pan agorwyd
    .accesskey = s
show-attachments-inline-label =
    .label = Dangos atodiadau o fewn corff neges
    .accesskey = D
mark-read-no-delay =
...
display-name-only-label =
    .label = Dim ond dangos enw dangos cysylltiadau sydd wedi'u cadw yn y llyfr cyfeiriadau
    .accesskey = D
...
show-conversation-view-label =
    .label = Dangos golwg sgwrs
    .accesskey = D
conversation-view-preview-description = Mae hon yn nodwedd rhagolwg cynnar. Mae'n grwpio negeseuon cysylltiedig gyda'i gilydd, ond efallai fydd e ddim bob amser yn gweithio yn ôl y disgwyl.
...
dark-mode-message-appearance = Gwedd y neges
dark-mode-checkbox-label =
    .label = Defnyddio'r modd tywyll ar gyfer neges destun
    .accesskey = D
dark-mode-message-text-description = Yn gosod cefndir tywyll i bob neges derbyn, hyd yn oed os yw'r anfonwr wedi eu fformatio mewn lliwiau golau.
...
dark-message-mode-toggle-label =
    ...
    .accesskey = D
dark-mode-toggle-description = Yn caniatáu i chi newid e-bost yn ôl i'r modd golau yn gyflym wrth ddarllen, heb newid eich prif osodiadau.
general-folder-settings-header = Gosodiadau ffolderi
recent-folders-legend = Ffolderi diweddar
recent-folders-description = Yn rheoli pa mor ddiweddar y mae ffolderi wedi'u defnyddio'n ymddangos wrth symud negeseuon.
dark-message-mode-toggle-description = Dangos togl ym mhennyn y neges i analluogi'r modd neges tywyll yn gyflym
general-folder-options-header = Dewisiadau Rheoli Ffolder
recent-destinations-legend = Cyrchfannau Diweddar
recent-destinations-description = Dewisiadau i restru a threfnu ffolderi ble symudwyd negeseuon yn ddiweddar
recent-sort-order-label = Trefn didoli:
    .accesskey = T
recent-sort-order-mru =
    .label = Mwyaf diweddar
recent-sort-order-alphabetic =
    .label = Yn nhrefn yr wyddor
max-recent-label = Uchafswm nifer y ffolderi diweddar:
    .accesskey = U
...
account-hub-manual-config-checkbox-label =
    .label = Defnyddiwch y llif ffurfweddiad â llaw newydd yn yr Adran Cyfrifon
    .accesskey = D
account-hub-manual-config-checkbox-description = Llif ffurfweddiad â llaw yr adran cyfrifon newydd
new-calendar-legend = Deialog Digwyddiad Calendr Newydd
new-calendar-checkbox-label =
    .label = Gweld digwyddiadau calendr yn y ddeialog newydd
new-calendar-checkbox-description = Deialog calendr newydd arbrofol ar gyfer gwylio digwyddiadau
...
as-attachment-label =
    .label = Fel Atodiad
add-file-type-label =
    .label = Ychwanegu'r math o ffeil at y negeseuon wedi'u hatodi
    .accesskey = Y
extension-label =
    .label = ychwanegu estyniad i enw ffeil
    .accesskey = e
forward-messages-label =
    .value = Anfon negeseuon ymlaen fel:
    .accesskey = A
forward-inline-label =
    .label = O fewn y neges (mewnlin)
...
autosave-draft-label =
    .label = Cadw drafft yn awtomatig bob
    .accesskey = C
...
spellcheck-while-typing-label =
    .label = Gwirio sillafu wrth deipio
    .accesskey = G
...
ignore-sender-styles-label =
    .label = Anwybyddu ffontiau a lliwiau anfonwr
    .accesskey = A
...
paragraph-spacing-label =
    .label = Mae pwyso Enter yn dechrau paragraff newydd gyda bylchau ychwanegol
    .accesskey = M
...
compose-format-automatic-option =
    .label = Awtomatig (argymhelliad)
compose-format-automatic-description = Anfonwch destun wedi'i fformatio os ydych chi'n ychwanegu arddulliau (fel print trwm neu ddolenni), neu destun plaen os nad.
compose-format-both-option =
    .label = Testun cyfoethog (HTML) a thestun plaen
compose-format-both-description = Bob tro'n anfon y ddwy fersiwn fel gall ap e-bost y derbynnydd ddewis pa un i'w ddangos.
compose-format-html-option =
    .label = Dim ond testun cyfoethog (HTML)
compose-format-html-description = Yn cadw ffontiau, lliwiau a delweddau cyfaddas, ond efallai bydd rhai apiau e-bost hŷn ddim yn ei ddangos yn iawn.
compose-format-plain-option =
    .label = Dim ond testun plaen
compose-format-plain-description = Yn dileu pob fformat, lliw a delwedd. Y gorau ar gyfer negeseuon e-bost testun syml sy'n gweithio ym mhobman.
autocomplete-matches-description = Wrth deipio enw neu e-bost derbynnydd, chwilio am gyfatebiaethau yn:
company-network-directory-label =
    .label = Cyfeiriadur cwmni neu rwydwaith
    .accesskey = C
...
manage-directories-label =
    .label = Rheoli cyfeiriaduron…
    .accesskey = R
collect-outgoing-label =
    .label = Cadw cyfeiriadau e-bost allan yn awtomatig i:
    .accesskey = C
collect-outgoing-description = Lle mae cysylltiadau newydd yn cael eu cadw pan gân nhw eu creu â llaw neu eu hychwanegu o e-byst.
save-added-contacts-label =
    .value = Cadw cysylltiadau sydd wedi'u hychwanegu â llaw i:
    .accesskey = A
save-added-contacts-description = Lle mae cysylltiadau newydd yn cael eu cadw o e-byst.
show-directory-startup-label =
    .value = Dangos cyfeiriadur yn ffenestr y llyfr cyfeiriadau wrth agor { -brand-short-name }
    .accesskey = D
...
email-picker-label =
    ...
    .accesskey = Y
email-picker-description = Lleoliad cysylltiadau newydd cadwyd o negeseuon anfonwyd.
default-add-address-book-label =
    .value = Llyfr cyfeiriadau arferol ar gyfer cysylltiadau wedi'u hychwanegu â llaw:
    .accesskey = L
default-add-address-book-description = Lleoliad cysylltiadau newydd wedi'u cadw o negeseuon wedi'u derbyn.
...
attachment-label =
    ...
    .accesskey = w
edit-keywords-label =
    .label = Golygu allweddeiriau…
    .accesskey = G
offer-share-large-files-label =
    .label = Cynnig rhannu ffeiliau trwy ddolen pan fyddan nhw'n fwy na:
...
exceptions-button =
    .label = Eithriadau…
    .accesskey = E
remote-content-privacy-link = Sut mae cynnwys o bell yn effeithio ar breifatrwydd
...
third-party-visited-only =
    .label = O safleoedd yr ymwelwyd â nhw yn unig
third-party-visited =
    .label = O'r ymwelwyd
cookies-button =
    .label = Dangos Cwcis…
...
global-privacy-control-label =
    .label = Gofynnwch i wefannau beidio â gwerthu na rhannu data personol
    .accesskey = G
...
passwords-registered-description = Gall { -brand-short-name } gadw cyfrineiriau ar gyfer cyfrifon cofrestredig.
view-saved-passwords-button =
    .label = Gweld Cyfrineiriau sydd wedi'u Cadw…
    .accesskey = G
primary-password-session-description = Mae Prif Gyfrinair yn diogelu'r holl gyfrineiriau a chaiff ei fewnbynnu unwaith y sesiwn.
use-primary-password-label =
    .label = Defnyddiwch Gyfrinair Cynradd
    .accesskey = D
do-not-track-label =
...
spam-accounts-description = Mae'r gosodiadau hyn yn berthnasol i bob cyfrif. Gellir newid opsiynau cyfrif unigol yng Ngosodiadau Cyfrif.
...
spam-move-folder-label =
    .label = Symudwch i'r ffolder Sbam
    .accesskey = S
spam-delete-immediately-label =
    .label = Dileu ar unwaith
    .accesskey = D
spam-move-label =
...
spam-marked-manually-label =
    .label = Pan gaiff ei farcio â llaw
    .accesskey = P
spam-detected-auto-label =
    .label = Pan gaiff ei ganfod yn awtomatig gan { -brand-short-name }
    .accesskey = P
spam-log-keep-label =
    .label = Cadwch log o ganfod sbam yn awtomatig
    .accesskey = C
...
spam-read-auto-label =
    ...
    .accesskey = P
spam-log-label =
    .label = Galluogi cofnodi hidlydd sbam addasol
    .accesskey = G
spam-log-button =
...
reset-spam-button =
    ...
    .accesskey = A
scam-detection-description = Mae { -brand-short-name } yn gwirio negeseuon am ddolenni potsian ac arwyddion cyffredin o sgamiau e-bost.
scam-detection-label =
    .label = Rhybuddiwch wrth ddarllen e-bost sy'n edrych fel sgam
    .accesskey = R
antivirus-check-description = Yn caniatáu i feddalwedd gwrthfeirws wirio negeseuon sy'n dod i mewn yn unigol cyn iddynt gael eu cadw ar eich cyfrifiadur.
antivirus-isolate-label =
    .label = Caniatáu i feddalwedd gwrthfeirws ynysu e-byst heintiedig sy'n dod i mewn
    .accesskey = C
certificate-verify-description = Pan fydd gweinydd yn gofyn am dystysgrif i wirio'ch hunaniaeth:
certificate-choose-auto =
    .label = Dewiswch dystysgrif yn awtomatig
    .accesskey = D
certificate-ask-every =
    .label = Gofynnwch bob tro
    .accesskey = G
ocsp-check-label =
    .label = Gwiriwch weinyddion dilysu tystysgrifau (OCSP) i gadarnhau bod tystysgrifau'n dal yn gywir.
    .accesskey = G
...
email-e2ee-accounts-info = Dim ond chi a'ch derbynwyr all ddarllen e-byst wedi'u hamgryptio. Gosodwch gyfrifon e-bost a manylion adnabod ar gyfer amgryptio o un pen i'r llall yn y <a data-l10n-name="account-settings-url">Gosodiadau cyfrif</a>.
...
email-e2ee-automatism-intro = Gall { -brand-short-name } droi amgryptio ymlaen os oes allweddi neu dystysgrifau dilys ar gael i bawb sy'n derbyn neges.
email-e2ee-turn-on =
    .label = Trowch amgryptio ymlaen yn awtomatig pan fo modd
email-e2ee-turn-off =
    .label = Diffoddwch amgryptio yn awtomatig pan fydd derbynwyr yn newid ac nid yw amgryptio bellach yn bosibl
email-e2ee-turn-off-notify =
    .label = Dangos hysbysiad pryd bynnag y caiff amgryptio ei ddiffodd yn awtomatig
email-e2ee-automatism-note = Nodyn: Gallwch hefyd droi amgryptio ymlaen neu i ffwrdd â llaw wrth ysgrifennu neges. Mae ymateb i neges wedi'i hamgryptio bob amser yn troi amgryptio ymlaen.
...
remote-content-images-label =
    .label = Caniatáu cynnwys o bell (delweddau ac arddulliau)
    .accesskey = C
...
preferences-doh-setting-automatic =
    .label = Diogelu awtomatig (Argymhellir)
    .accesskey = D
preferences-doh-automatic-desc = Mae { -brand-short-name } yn amgryptio chwilio cyfeiriadau yn awtomatig pan fyddant ar gael. Yn newid yn ôl i chwiliadau rhwydwaith safonol os oes problem cysylltiad neu os yw VPN / rhwydwaith a reolir yn ei gwneud yn ofynnol.
...
preferences-doh-setting-enabled =
    ...
    .accesskey = C
preferences-doh-increased-desc = Bob amser yn defnyddio darparwr a ddewiswyd. Yn defnyddio cysylltiad safonol dim ond os bydd darparwr diogel yn methu.
...
preferences-doh-setting-maximum =
    .label = Amddiffyniad mwyaf posibl
    .accesskey = A
preferences-doh-maximum-desc = Mae angen DNS wedi'i amgryptio yn llym. Ni fydd gwefannau'n llwytho os bydd cysylltiad diogel yn methu.
...
preferences-doh-setting-off =
    .label = Diffodd
    .accesskey = D
preferences-doh-off-standard-desc = Yn defnyddio darparwr rhyngrwyd neu rwydwaith safonol i chwilio am gyfeiriadau gwe
...
preferences-doh-url-custom =
    .label = Cyfaddas
    .accesskey = C
preferences-doh-secure-header = DNS diogel (DNS dros HTTPS)
preferences-doh-secure-description = Mae DNS Diogel yn amgryptio'r ceisiadau chwilio y mae { -brand-short-name } yn eu hanfon i ddod o hyd i wefannau, gan gadw'ch gweithgaredd pori yn breifat rhag unrhyw fonitro rhwydwaith.
...
search-preferences-input2 =
    ...
    .style = width: 15.4em
managed-by-organization-notice = Mae { -brand-short-name } yn cael ei reoli gan sefydliad.
...
accent-color-legend = Lliw Acennu
accent-color-selection-label =
    .value = Dewis lliw ar gyfer botwm cynradd ac amlygiadau
accent-color-label =
    .value = Diffiniwch y lliw sy'n cael ei ddefnyddio ar gyfer y prif fotymau ac elfennau wedi'u hamlygu:
accent-color-os =
    .label = Fel y system weithredu
...
accent-color-teal =
    .label = Gwyrddlas
accent-color-disabled-description = Dyw lliwiau acennu ddim yn cael eu cefnogi yn y modd Cyferbyniad Uchel.
default-message-list-legend = Rhestr Negeseuon
appearance-view-style-select =
    .value = Dewis arddull gweld:
...
appearance-radio-card-view =
    .label = Golwg cerdyn
card-view-options-legend = Dewisiadau golwg cerdyn
...
default-message-list-new-folders-description = Dewis dewisiadau didoli ac edafu arferol ar gyfer ffolderi newydd
...
default-sort-by-label = Trefnu negeseuon yn ôl:
...
default-sort-newest-bottom =
    .label = Negeseuon diweddaraf ar y gwaelod
default-sort-new-messages-top =
    .label = Negeseuon diweddaraf ar y brig
apply-view-settings-label = Gosod y gosodiadau golwg hyn i:
apply-view-settings-to-all-folders-button =
    .label = Pob ffolder ac is-ffolder
    .accesskey = P
select-apply-sort-folders-button =
    .label = Dewis ffolderi
    .accesskey = D
