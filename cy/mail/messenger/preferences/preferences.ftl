...
general-files-and-attachment-description = Dewiswch pa ffeiliau sy'n cael eu cadw a ble maen nhw'n cael eu cadw ar eich cyfrifiadur.
general-tags-header = Tagiau
general-reading-and-viewing-header = Darllen a gwylio
...
compose-message-formatting-title = Fformatio neges
compose-address-autocomplete-header = Cyfeiriad wedi'i gwblhau'n awtomatig
...
choose-display-language-description = Dewiswch yr iaith a ddefnyddir ar gyfer dewislenni, botymau a hysbysiadau.
...
manual-storage-limit-label =
    .label = Gosod terfynau storio â llaw ar gyfer ffeiliau dros dro
    .accesskey = G
...
show-start-page-label =
    .label = Dangoswch y Dudalen Gychwyn pan fydd { -brand-short-name } yn agor
    .accesskey = D
start-page-label =
...
mail-play-button =
    .label = Chwarae
    .accesskey = h
change-dock-icon-description = Bathodynnau ap a hysbysiadau
...
use-custom-sound-label =
    .label = Defnyddiwch sain wedi'i deilwra ar gyfer rhybuddion
    .accesskey = D
mail-select-audio-button =
    .label = Dewiswch sain…
    .accesskey = D
enable-global-search-label =
    .label = Trowch y chwiliad ymlaen ar draws pob cyfrif e-bost
    .accesskey = T
gloda-results-plain-list-label =
    .label = Dangos canlyniadau chwilio fel rhestr blaen
    .accesskey = D
...
display-language-legend = Iaith arddangos
allow-graphics-accel =
    .label = Defnyddiwch gyflymiad graffeg ar gyfer sgrolio a pherfformiad llyfnach
    .accesskey = D
storage-format-label =
    .value = Fformat storio ar gyfer cyfrifon newydd:
    .accesskey = F
...
check-email-app-label =
    .label = Gwiriwch bob amser i weld ai { -brand-short-name } yw'r ap e-bost rhagosodedig pan gaiff ei agor
    .accesskey = G
...
install-updates-automatically-label =
    ...
    .accesskey = G
install-updates-automatically-description = Yn cadw { -brand-short-name } yn ddiogel gyda'r atgyweiriadau diogelwch diweddaraf.
check-updates-ask-label =
    .label = Gwiriwch am ddiweddariadau, ond gofynnwch cyn gosod
    .accesskey = G
...
offline-compact-remove-deleted =
    .label = Tynnwch ddata o ffolderi pan fyddant eisoes wedi'u dileu i ryddhau storfa
    .accesskey = T
offline-compact-ask-cleanup =
    .label = Gofynnwch cyn glanhau ffolderi
    .accesskey = G
...
convert-emoticons-label =
    ...
    .accesskey = g
display-text-formatting-label = Fformatio testun a ddyfynnir
...
always-ask-label =
    ...
    .accesskey = G
use-tags-text = Defnyddiwch dagiau i gategoreiddio a blaenoriaethu negeseuon.
...
show-attachments-inline-label =
    .label = Dangos atodiadau y tu mewn i gorff y neges
    .accesskey = D
mark-read-no-delay =
...
display-name-only-label =
    .label = Dangoswch enw arddangos ar gyfer cysylltiadau sydd wedi'u cadw yn y llyfr cyfeiriadau yn unig
    .accesskey = D
...
show-conversation-view-label =
    ...
    .accesskey = D
conversation-view-preview-description = Mae hon yn nodwedd rhagolwg cynnar. Mae'n grwpio negeseuon cysylltiedig gyda'i gilydd, ond efallai na fydd bob amser yn gweithio yn ôl y disgwyl.
...
dark-mode-message-appearance = Ymddangosiad y neges
dark-mode-checkbox-label =
    .label = Defnyddiwch y modd tywyll ar gyfer neges destun
    .accesskey = D
dark-mode-message-text-description = Yn cymhwyso cefndir tywyll i bob neges sy'n dod i mewn, hyd yn oed os yw'r anfonwr wedi eu fformatio mewn lliwiau golau.
...
dark-message-mode-toggle-label =
    ...
    .accesskey = D
dark-mode-toggle-description = Yn caniatáu ichi newid e-bost yn ôl i'r modd ysgafn yn gyflym wrth ddarllen, heb newid eich prif osodiadau.
general-folder-settings-header = Gosodiadau ffolder
recent-folders-legend = Ffolderi diweddar
recent-folders-description = Yn rheoli pa mor ddiweddar y mae ffolderi a ddefnyddiwyd yn ymddangos wrth symud negeseuon.
...
as-attachment-label =
    .label = Fel Atodiad
add-file-type-label =
    .label = Ychwanegu math o ffeil at y negeseuon sydd ynghlwm
    .accesskey = Y
extension-label =
...
forward-inline-label =
    .label = Y tu mewn i'r neges (mewnol)
...
autosave-draft-label =
    .label = Arbed drafft bob yn awtomatig
    .accesskey = A
...
spellcheck-while-typing-label =
    .label = Gwiriwch sillafu wrth deipio
    .accesskey = G
...
compose-format-automatic-option =
    .label = Awtomatig (argymhellir)
compose-format-automatic-description = Anfonwch destun wedi'i fformatio os ydych chi'n ychwanegu arddulliau (fel print trwm neu ddolenni), neu destun plaen os na wnewch chi.
compose-format-both-option =
    .label = Testun cyfoethog (HTML) a thestun plaen
compose-format-both-description = Bob amser yn anfon y ddwy fersiwn fel y gall ap e-bost y derbynnydd ddewis pa un i'w arddangos.
compose-format-html-option =
    .label = Testun cyfoethog (HTML) yn unig
compose-format-html-description = Yn cadw ffontiau, lliwiau a delweddau arferol, ond efallai na fydd rhai apiau e-bost hŷn yn ei arddangos yn iawn.
compose-format-plain-option =
    .label = Testun plaen yn unig
compose-format-plain-description = Yn dileu pob fformat, lliw a delwedd. Gorau ar gyfer negeseuon e-bost testun syml sy'n gweithio ym mhobman.
autocomplete-matches-description = Wrth deipio enw neu e-bost derbynnydd, chwiliwch am gyfatebiaethau yn:
...
collect-outgoing-label =
    .label = Arbedwch gyfeiriadau e-bost sy'n mynd allan yn awtomatig i:
    .accesskey = A
collect-outgoing-description = Lle mae cysylltiadau newydd yn cael eu cadw pan gânt eu creu â llaw neu eu hychwanegu o e-byst.
save-added-contacts-label =
    .value = Arbedwch gysylltiadau sydd wedi'u hychwanegu â llaw i:
    .accesskey = A
...
offer-share-large-files-label =
    .label = Cynigiwch rannu ffeiliau trwy ddolen pan fyddant yn rhagori ar:
...
accent-color-selection-label =
    .value = Dewiswch liw ar gyfer botwm cynradd ac uchafbwyntiau
accent-color-label =
...
appearance-view-style-select =
    .value = Dewiswch arddull gweld:
appearance-view-style =
    .value = Gweld Arddull:
appearance-radio-table =
    .label = Golygfa tabl
appearance-radio-card-view =
    .label = Golygfa cerdyn
card-view-options-legend = Opsiynau gweld cerdyn
...
default-message-list-new-folders-description = Dewiswch opsiynau didoli ac edafu rhagosodedig ar gyfer ffolderi newydd
