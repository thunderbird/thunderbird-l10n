...
general-folder-options-header = Opsiynau Rheoli Ffolder
recent-destinations-legend = Cyrchfannau Diweddar
recent-destinations-description = Opsiynau ar gyfer rhestru a didoli ffolderi lle y symudwyd negeseuon yn ddiweddar.
