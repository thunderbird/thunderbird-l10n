...
account-hub-manual-config-checkbox-label =
    .label = Defnyddiwch y llif cyfluniad llaw newydd yn Account Hub
    .accesskey = D
account-hub-manual-config-checkbox-description = Llif cyfluniad llaw canolbwynt cyfrif newydd
