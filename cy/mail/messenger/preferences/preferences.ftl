...
email-picker-label =
    ...
    .accesskey = Y
email-picker-description = Lleoliad cysylltiadau newydd a arbedwyd o negeseuon a anfonwyd.
default-add-address-book-label =
    .value = Llyfr cyfeiriadau diofyn ar gyfer cysylltiadau a ychwanegwyd â llaw:
    .accesskey = L
default-add-address-book-description = Lleoliad cysylltiadau newydd a arbedwyd o negeseuon a dderbyniwyd.
