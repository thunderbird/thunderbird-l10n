...
dock-icon-animate-label =
    .label = Animeiddio'r eicon ap ar gyfer negeseuon newydd
    .accesskey = A
...
dock-badge-show-label =
    .value = Dangos bathodyn ar gyfer
total-unread-messages-radio =
    .label = Cyfanswm y negeseuon heb eu darllen
    .accesskey = C
total-new-messages-radio =
    .label = Cyfanswm y negeseuon newydd
    .accesskey = y
notification-badge-system-info = Hefyd, mae modd troi bathodynnau hysbysu ymlaen neu i ffwrdd yng ngosodiadau system y cyfrifiadur.
...
dock-icon-notification-dialog-title = Gosodiadau hysbysiad eicon ap
