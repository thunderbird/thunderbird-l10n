...
http-port-label =
    ...
    .accesskey = P
proxy-https-sharing =
    .label = Defnyddio'r dirprwy hwn ar gyfer cyfeiriadau gwe diogel (HTTPS)
    .accesskey = D
proxy-http-sharing =
...
no-proxy-addresses-label =
    .value = Peidio defnyddio dirprwy ar gyfer y cyfeiriadau hyn:
    .accesskey = P
no-proxy-label =
...
connection-proxy-local-network-desc = Dyw cysylltiadau rhwydwaith lleol (fel localhost) byth yn defnyddio dirprwy.
proxy-auto-login-saved-password =
    .label = Mewngofnodi'n awtomatig os caiff cyfrinair ei gadw
