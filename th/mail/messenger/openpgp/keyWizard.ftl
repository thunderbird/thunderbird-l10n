...
key-wizard-dialog =
    ...
    .buttonlabelextra1 = ย้อนกลับ
key-wizard-warning = <b>หากคุณมีคีย์ส่วนตัว</b>สำหรับที่อยู่อีเมลนี้อยู่แล้ว คุณควรนำเข้า มิฉะนั้นคุณจะไม่สามารถเข้าถึงที่เก็บถาวรอีเมลที่เข้ารหัสลับของคุณ และไม่สามารถอ่านอีเมลที่เข้ารหัสลับขาเข้าจากผู้คนที่ยังใช้คีย์ที่มีอยู่ของคุณได้
...
openpgp-keygen-secret-protection = การป้องกันคีย์ลับ
radio-keygen-no-protection =
    .label = ไม่ป้องกัน
radio-keygen-protect-primary-pass =
    .label = ป้องกันด้วยรหัสผ่านหลัก
radio-keygen-passphrase-protection =
    .label = ป้องกันด้วยวลีรหัสผ่าน:
openpgp-passphrase-repeat = ยืนยันวลีรหัสผ่าน:
...
openpgp-import-success-description = ในการเริ่มใช้คีย์ OpenPGP ที่คุณนำเข้าสำหรับการเข้ารหัสลับอีเมล ให้ปิดกล่องโต้ตอบนี้และเข้าไปที่การตั้งค่าบัญชีของคุณเพื่อเลือกคีย์ดังกล่าว
...
openpgp-import-key-list-amount-2 = { -brand-short-name } พบคีย์จำนวน { $count } คีย์ที่สามารถนำเข้าได้
...
openpgp-import-key-list-caption = คีย์ที่ทำเครื่องหมายให้ถือเป็นคีย์ส่วนตัวจะแสดงอยู่ในส่วน “การเข้ารหัสลับจากต้นทางถึงปลายทาง” ส่วนคีย์อื่น ๆ จะมีอยู่ในตัวจัดการคีย์
openpgp-import-keep-passphrases =
    .label = ใช้การป้องกันด้วยวลีรหัสผ่านสำหรับคีย์ลับที่นำเข้ามา
