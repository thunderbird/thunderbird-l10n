...
msg-compose-partially-encrypted-inlinePGP =
    ข้อความที่คุณกำลังตอบกลับมีทั้งส่วนที่ไม่ได้เข้ารหัสลับและส่วนที่เข้ารหัสลับ หากผู้ส่งไม่สามารถถอดรหัสลับข้อความบางส่วนได้ในตอนแรก คุณอาจกำลังทำให้ข้อมูลลับที่ผู้ส่งไม่สามารถถอดรหัสตัวเองได้ในตอนแรกรั่วไหล
