...
folder-pane-mode-header-all = โฟลเดอร์ทั้งหมด
folder-pane-mode-header-unread = โฟลเดอร์ที่ยังไม่ได้อ่าน
folder-pane-mode-header-favorite = โฟลเดอร์โปรด
folder-pane-mode-header-recent = โฟลเดอร์ล่าสุด
folder-pane-mode-header-smart = โฟลเดอร์แบบรวม
folder-pane-mode-header-tags = ป้ายกำกับ
