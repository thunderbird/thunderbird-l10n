...
account-hub-email-label = ที่อยู่อีเมล
    .accesskey = ม
account-hub-email-input =
    .placeholder = somchai.jaidee@example.com
account-hub-email-warning-icon =
    .title = ที่อยู่อีเมลไม่ถูกต้อง
account-hub-password-label = รหัสผ่าน
    .accesskey = ร
    .title = ไม่จำเป็น รหัสผ่านนี้จะใช้เพื่อตรวจสอบควบคู่ไปกับชื่อผู้ใช้เท่านั้น
account-hub-remember-password = จดจำรหัสผ่าน
    .accesskey = จ
account-hub-exchange-label = ข้อมูลการเข้าสู่ระบบของคุณ
    .accesskey = ข
account-hub-installing-addon = กำลังดาวน์โหลดและติดตั้งส่วนเสริม…
account-hub-success-addon = ติดตั้งส่วนเสริมสำเร็จแล้ว
account-hub-success-half-manual = พบการตั้งค่าต่อไปนี้โดยการตรวจสอบเซิร์ฟเวอร์ที่กำหนด:
account-hub-result-security-no-encryption = ไม่มีการเข้ารหัสลับ
    .title = ไม่มีการเข้ารหัสลับ
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = ไม่มีการเข้ารหัสลับ
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = การยืนยันตัวตนล้มเหลว โปรดตรวจสอบชื่อผู้ใช้และรหัสผ่าน
...
account-hub-exchange-config-unverifiable = ไม่สามารถตรวจสอบความถูกต้องของการกำหนดค่าได้ หากชื่อผู้ใช้และรหัสผ่านของคุณถูกต้อง อาจเป็นเนื่องจากผู้ดูแลเซิร์ฟเวอร์ได้ปิดใช้งานการกำหนดค่าที่เลือกไว้สำหรับบัญชีของคุณ ลองเลือกโปรโตคอลอื่น
account-hub-advanced-setup-button = การกำหนดค่าขั้นสูง
    .accesskey = ข
# Variables:
#  $domain (String): The name of the server where the configuration was found, e.g. rackspace.com.
account-hub-exchange-dialog-question = { -brand-short-name } พบข้อมูลการตั้งค่าบัญชีของคุณบน { $domain } คุณต้องการดำเนินการต่อแล้วส่งข้อมูลประจำตัวของคุณหรือไม่?
account-hub-creation-error-title = เกิดข้อผิดพลาดในการสร้างบัญชี
account-hub-error-server-exists = มีเซิร์ฟเวอร์ขาเข้าอยู่แล้ว
account-hub-confirm-advanced-title = ยืนยันการกำหนดค่าขั้นสูง
account-hub-confirm-advanced-description = กล่องโต้ตอบนี้จะถูกปิดและบัญชีที่มีการตั้งค่าปัจจุบันจะถูกสร้างขึ้น ถึงแม้ว่าจะมีการกำหนดค่าไม่ถูกต้องก็ตาม คุณต้องการดำเนินการต่อหรือไม่?
account-hub-addon-install-title = ติดตั้ง
account-hub-encryption-button = การเข้ารหัสลับจากต้นทางถึงปลายทาง
account-hub-address-books-button = สมุดรายชื่อ
account-hub-calendars-button = ปฏิทิน
