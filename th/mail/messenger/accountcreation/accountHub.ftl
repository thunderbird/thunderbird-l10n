...
account-hub-sync-success = Thunderbird พบบริการที่เชื่อมต่อบางอย่าง
account-hub-sync-failure = Thunderbird ไม่พบบริการที่เชื่อมต่อ
account-hub-unable-to-sync-accounts = Thunderbird ไม่สามารถเชื่อมต่อบริการที่เลือก
