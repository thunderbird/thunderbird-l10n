...
looking-for-messages-account = กำลังมองหาข้อความใหม่สำหรับ { $accountName }…
# Feedback message shown in the status bar while we look for new messages in a
# specific folder.
# Variables:
# $folderName (String) - The folder's name.
looking-for-messages-folder = กำลังมองหาข้อความใหม่ใน { $folderName }…
...
# $folderName (String) - The folder's name.
deleting-message = กำลังลบ { $number } ข้อความจาก { $folderName }…
