...
about-dialog-title = เกี่ยวกับ { -brand-full-name }
release-notes-link = บันทึกประจำรุ่น
update-internal-error = ไม่สามารถตรวจสอบการอัปเดตได้เนื่องจากมีข้อผิดพลาดภายใน การอัปเดตมีอยู่ที่ <a data-l10n-name="manual-link"/>
...
update-manual = การอัปเดตมีอยู่ที่ <a data-l10n-name="manual-link"/>
