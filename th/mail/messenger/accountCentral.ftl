...
import-paragraph2 = { -brand-short-name } ให้คุณนำเข้าข้อความจดหมาย รายการสมุดรายชื่อ ฟีดที่บอกรับ การตั้งค่า และ/หรือตัวกรองจากโปรแกรมเมลอื่นๆ และสมุดรายชื่อในรูปแบบทั่วไปได้
import-label = นำเข้า
