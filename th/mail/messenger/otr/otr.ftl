...
msgevent-encryption-required-part1 = คุณพยายามส่งข้อความที่ไม่ได้เข้ารหัสถึง { $name } ตามนโยบายแล้ว ไม่อนุญาตให้มีข้อความที่ไม่ได้เข้ารหัส
...
msgevent-encryption-error = เกิดข้อผิดพลาดขณะเข้ารหัสข้อความของคุณ ข้อความไม่ได้ถูกส่ง
# Variables:
#   $name (String) - the screen name of a chat contact person
msgevent-connection-ended = { $name } ได้ปิดการเชื่อมต่อที่เข้ารหัสถึงคุณ เพื่อเป็นการหลีกเลี่ยงการส่งข้อความโดยไม่มีการเข้ารหัส ข้อความของคุณจึงไม่ได้ถูกส่ง โปรดสิ้นสุดการสนทนาที่เข้ารหัสของคุณ หรือเริ่มการสนทนาใหม่
# Variables:
#   $name (String) - the screen name of a chat contact person
...
# Variables:
#   $name (String) - the screen name of a chat contact person
msgevent-rcvdmsg-not-private = ข้อความที่เข้ารหัสที่ได้รับจาก { $name } ไม่สามารถอ่านได้ เนื่องจากขณะนี้คุณไม่ได้สื่อสารแบบเป็นส่วนตัว
# Variables:
#   $name (String) - the screen name of a chat contact person
msgevent-rcvdmsg-unreadable = คุณได้รับข้อความที่ถูกเข้ารหัสซึ่งไม่สามารถอ่านได้จาก { $name }
# Variables:
#   $name (String) - the screen name of a chat contact person
...
msgevent-rcvdmsg-unencrypted = ข้อความที่ได้รับจาก { $name } ต่อไปนี้ไม่ได้ถูกเข้ารหัส: { $msg }
# Do not translate 'OTR' (name of an encryption protocol)
# Variables:
#   $name (String) - the screen name of a chat contact person
...
# Variables:
#   $name (String) - the screen name of a chat contact person
context-gone-secure-unverified = เข้ารหัสแล้ว แต่เริ่มการสนทนาที่ยังไม่ยืนยันกับ { $name } แล้ว
# Variables:
#   $name (String) - the screen name of a chat contact person
context-still-secure = การเรียกการสนทนาแบบเข้ารหัสกับ { $name } ใหม่สำเร็จแล้ว
error-enc = เกิดข้อผิดพลาดขณะเข้ารหัสข้อความ
# Variables:
#   $name (String) - the screen name of a chat contact person
error-not-priv = คุณส่งข้อมูลที่เข้ารหัสถึง { $name } ซึ่งไม่ได้ต้องการ
