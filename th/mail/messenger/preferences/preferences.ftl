...
exceptions-button =
    .label = ข้อยกเว้น…
    .accesskey = เ
remote-content-privacy-info = เรียนรู้เพิ่มเติมเกี่ยวกับปัญหาความเป็นส่วนตัวของเนื้อหาระยะไกล
remote-content-info =
...
passwords-button =
    ...
    .accesskey = ร
primary-password-description = รหัสผ่านหลักจะปกป้องรหัสผ่านทั้งหมดของคุณ แต่คุณต้องป้อนเพียงเซสชันละหนึ่งครั้งเท่านั้น
