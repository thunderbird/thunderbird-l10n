...
dark-reader-legend = สีตัวอ่าน
dark-reader-checkbox-label =
    .label = ปรับให้เข้ากับชุดตกแต่งมืด
    .accesskey = ม
dark-reader-checkbox-description = คุณลักษณะทดลองที่จะปรับบานหน้าต่างข้อความให้มีลักษณะตามชุดตกแต่งมืด
