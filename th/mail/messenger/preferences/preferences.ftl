...
appearance-card-style-2 =
    .label = 2 แถว
default-message-list-sorting-legend = การเรียงลำดับและการจัดกระทู้
default-message-list-description = กำหนดค่าตัวเลือกการเรียงลำดับและการจัดกระทู้เริ่มต้นสำหรับโฟลเดอร์ที่สร้างขึ้นใหม่
default-flag-label =
    .value = การจัดกระทู้เริ่มต้น:
