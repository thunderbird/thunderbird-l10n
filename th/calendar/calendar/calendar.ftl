...
calendar-task-filter-current =
    .label = งานปัจจุบัน
    .accesskey = ป
calendar-task-details-title = ชื่อเรื่อง
calendar-task-details-organizer = จาก
calendar-task-details-priority = ความสำคัญ
calendar-task-details-priority-low = ต่ำ
calendar-task-details-priority-normal = ปกติ
calendar-task-details-priority-high = สูง
calendar-task-details-status = สถานะ
calendar-task-details-category = หมวดหมู่
calendar-task-details-repeat = ทำซ้ำ
calendar-task-details-attachments = ไฟล์แนบ
calendar-task-details-start = วันที่เริ่ม
calendar-task-details-due = วันที่ครบกำหนด
calendar-task-mark-completed =
    .label = ทำเครื่องหมายว่าเสร็จสมบูรณ์
    .accesskey = ท
    .tooltiptext = ทำเครื่องหมายงานที่เลือกว่าเสร็จสมบูรณ์
calendar-task-change-priority =
    .label = ความสำคัญ
    .accesskey = ว
    .tooltiptext = เปลี่ยนความสำคัญ
calendar-task-text-filter-field =
    .emptytextbase = กรองงาน #1
...
calendar-progress-level-0 =
    .label = เสร็จสมบูรณ์ 0%
    .accesskey = 0
calendar-progress-level-25 =
    .label = เสร็จสมบูรณ์ 25%
    .accesskey = 2
calendar-progress-level-50 =
    .label = เสร็จสมบูรณ์ 50%
    .accesskey = 5
calendar-progress-level-75 =
    .label = เสร็จสมบูรณ์ 75%
    .accesskey = 7
...
calendar-properties-refresh =
    .value = เรียกปฏิทินใหม่:
calendar-properties-refresh-manual =
    .label = ด้วยตนเอง
calendar-properties-read-only =
    .label = อ่านอย่างเดียว
calendar-properties-show-reminders =
    .label = แสดงการเตือนความจำ
calendar-properties-offline-support =
    .label = การสนับสนุนออฟไลน์
calendar-properties-enable-calendar =
    .label = เปิดใช้ปฏิทินนี้
calendar-properties-provider-missing = ไม่พบผู้ให้บริการสำหรับปฏิทินนี้ สิ่งนี้มักจะเกิดขึ้นหากคุณปิดใช้งานหรือถอนการติดตั้งส่วนเสริมบางตัว
...
calendar-newevent-button =
    .label = เหตุการณ์ใหม่
    .tooltiptext = สร้างเหตุการณ์ใหม่
calendar-newtask-button =
    .label = งานใหม่
    .tooltiptext = สร้างงานใหม่
calendar-unifinder-show-completed-todos =
    .label = แสดงงานที่เสร็จสมบูรณ์
...
calendar-publish-publish-dialog-button =
    .buttonlabelaccept = เผยแพร่
calendar-publish-publish-button = เผยแพร่
calendar-publish-close-button = ปิด
calendar-select-dialog-title = เลือกปฏิทิน
...
calendar-extract-event-button =
    .label = เพิ่มเป็นเหตุการณ์
    .tooltiptext = แยกข้อมูลปฏิทินจากข้อความและเพิ่มลงในปฏิทินของคุณเป็นเหตุการณ์
