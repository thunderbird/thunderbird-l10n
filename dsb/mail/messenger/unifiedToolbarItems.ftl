...
toolbar-spam =
    .title = Wubrane powěsći ako spam markěrowaś
toolbar-not-spam-label = Njejo spam
toolbar-not-spam =
    .title = Wubrane powěsći ako žeden spam markěrowaś
...
toolbar-add-address-book-label = Adresnik pśidaś
