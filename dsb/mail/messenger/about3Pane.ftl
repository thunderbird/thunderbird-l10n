...
folder-pane-header-toggle-full-path =
    .label = Dopołnu sćažku pokazaś
folder-pane-header-hide-local-folders =
    .label = Lokalne zarědniki schowaś
folder-pane-mode-header-all = Wšykne zarědniki
folder-pane-mode-header-unread = Njepśecytane zarědniki
folder-pane-mode-header-favorite = Nejlubše zarědniki
folder-pane-mode-header-recent = Nejnowše zarědniki
folder-pane-mode-header-smart = Zjadnośone zarědniki
folder-pane-mode-header-tags = Wobznamjenja
...
folder-pane-context-reset-sort =
    .label = Pórěd zarědnikow slědk stajiś
    .accesskey = P
# Variables:
