...
policy-DisableMessageForwardingFilters = Tomu zaźjowaś, až se powěsćowe filtry powěsći awtomatiski dalej pósrědnjaju.
...
policy-DisableUpdateSettings = Tomu zajźowaś, až wužywaŕ nastajenja aktualizacije nałoženja změnijo.
...
policy-InAppNotification = Typy powěźeńkow zmóžniś abo znjemóžniś.
...
policy-OfferToSaveLogins = Nastajenje wunuźiś, kótarež { -brand-short-name } zmóžnja, se skłaźone pśizjawjenja a gronidła spomnjeś. Ako true tak teke false se akceptěrujotej.
policy-OfferToSaveLoginsDefault = Stajśo standardnu gódnotu, kótaraž { -brand-short-name } zmóžnja, se skłaźone pśizjawjenja a gronidła spomnjeś. Ako true tak teke false se akceptěrujotej.
...
policy-WebsiteFilter = Woglědowanju k websedłam zajźowaś. Lej dokumentaciju za dalšne drobnostki wó formaśe.
