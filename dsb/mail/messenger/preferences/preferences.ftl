...
general-email-notifications-header = E-mailowe powěźeńki
...
general-files-and-attachment-description = Póstajśo, kótare dataje maju se składowaś a źož se maju na wašom licadle składowaś.
general-tags-header = Wobznamjenja
general-reading-and-viewing-header = Cytanje a woglědanje
general-reading-and-display-header = Cytanje a zwobraznjenje
general-updates-header = Aktualizacije
general-network-and-storage-header = Seś a składowak
general-search-performance-label = Pytanje a wugbaśe
compose-writing-emails-header = Mejlki pisaś
...
compose-message-formatting-title = Formatěrowanje powěsćow
compose-address-autocomplete-header = Awtowudopołnjenje adresow
...
choose-display-language-description = Wubjeŕśo rěc za menije, tłocaški a powěźeńki.
...
manual-storage-limit-label =
    .label = Składowańske limity za temporarne dataje manuelnje nastajiś
    .accesskey = S
clear-temp-files-button =
    .label = Nachylne dataje lašowaś
    .accesskey = N
clear-temp-files-shutdown-label =
    .label = Temporarne dataje lašowaś, gaž se { -brand-short-name } zacynja
    .accesskey = z
...
show-start-page-label =
    .label = Startowy bok pokazaś, gaž se { -brand-short-name } wócynja
    .accesskey = t
start-page-label =
...
close-to-tray-label =
    .label = Gaž se { -brand-short-name } zacynja, jen do wótkładnice pśesunuś
    .accesskey = z
start-in-tray-label =
    .label = { -brand-short-name } we wótkładnicy startowaś
    .accesskey = k
new-message-arrival-legend = Gaž nowa powěsć dochada:
...
use-custom-sound-label =
    .label = Swójski zuk za powěźeńki wužywaś
    .accesskey = S
mail-select-audio-button =
    .label = Awdijo wubraś…
    .accesskey = A
enable-global-search-label =
    .label = Pytanje za wšykne e-mailowe konta zmóžniś
    .accesskey = m
gloda-results-plain-list-label =
    .label = Pytańske wuslědki w jadnorej lisćinje pokazaś
    .accesskey = P
...
gloda-show-results-as-list-label =
    .label = Globalne pytańske wuslědki pó standarźe ako lisćinu pokazaś
    .accesskey = G
datetime-formatting-legend = Formatěrowanje datuma a casa
display-language-legend = Pokazowańska rěc
allow-graphics-accel =
    .label = Grafikowe póspěšenje za pózlažčejše kulanje a lěpše wugbaśe wužywaś
    .accesskey = G
storage-format-label =
    .value = Składowański format za nowe konta:
    .accesskey = S
mbox-store-single-label =
    .label = Jadnotliwa dataja na zarědnik (mbox)
...
enable-autoscroll-label =
    .label = Awtomatiske pśesuwanje zmóžniś
    .accesskey = m
autoscroll-label =
...
hide-titlebar-label =
    .label = Titelowu rědku schowaś
    .accesskey = T
hide-titlebar-description = Wótwónoźijo titelowu rědku, kótaraž mě wokna pokazujo, aby rum na wobrazowce zažarił
hide-tabbar-single-tab-label =
    .label = Schowajśo rejtarikowu rědku, gaž jano jaden rejtarik jo wócynjony
    .accesskey = S
auto-hide-tabbar-second-tab-description = Chowa rejtariki awtomatiski, daniž drugi rejtarik njewócynjaśo.
system-settings-legend = Systemowe nastajenja
check-email-app-label =
    .label = Pśi startowanju pśecej kontrolěrowaś, lěc { -brand-short-name } jo standardny e-mailowe nałoženje
    .accesskey = k
edit-defaults-apps-button =
    .label = Standard wobźěłaś…
    .accesskey = t
...
update-settings-title = Nastajenja aktualizacije
install-updates-automatically-label =
    .label = Aktualizacije awtomatiski instalěrowaś (dopórucone)
    .accesskey = A
install-updates-automatically-description = Źarži { -brand-short-name } wěsty z nejnowšymi wěstotnymi pórěźenjami.
check-updates-ask-label =
    .label = Aktualizacije pytaś, ale se pšašaś, nježli až se instalěruju
    .accesskey = A
...
connection-config-description = Kontrolěrujśo, kak { -brand-short-name } z internetom zwězujo.
connection-options-button =
    .label = Zwiskowe nastajenja…
    .accesskey = Z
offline-mode-legend = Modus offline
offline-settings-label = Nastajenja offline
...
offline-settings-button =
    .label = Offline…
    .accesskey = O
temporary-storage-legend = Temporarne składowanje
offline-compact-remove-deleted =
    .label = Daty ze zarědnikow wótwónoźeś, gaž su južo wulašowane, aby se składowański rum wulichował
    .accesskey = t
offline-compact-ask-cleanup =
    .label = Pšašaś se, nježli až se zarědniki zrumowali
    .accesskey = d
...
use-cache-before =
    .value = Až k
    .accesskey = A
use-temp-storage-after = MB składowańskego ruma za temporarne dataje
...
underline-text-links-label =
    .label = Tekstowe wótkaze w powěsćach pódšmarnuś
    .accesskey = k
...
convert-emoticons-label =
    ...
    .accesskey = E
display-text-formatting-label = Formatěrowanje citěrowanego teksta
...
search-content-types =
    .placeholder = Wopśimjeśowe typy pśepytaś
...
always-ask-label =
    ...
    .accesskey = m
use-tags-text = Wužywajśo wobznamjenja, aby powěsći kategorizěrował a priorizěrował
...
mark-read-when-opened =
    .label = Ned pó wocynjanju
    .accesskey = e
show-attachments-inline-label =
    .label = Pśidanki w powěsćowem teksće pokazaś
    .accesskey = i
mark-read-no-delay =
...
display-name-only-label =
    .label = Pokazane mě jano za kontakty pokazaś, kótarež su se składli w adresniku
    .accesskey = P
...
show-conversation-view-label =
    .label = Rozgronowy naglěd pokazaś
    .accesskey = z
conversation-view-preview-description = Toś ta funkcije jo hyšći w jěsnej fazy. Rědujo pódobne powěsći, ale mógła nic pśecej ako wótcakana funkcioněrowaś.
...
dark-mode-message-appearance = Powěsćowy naglěd
dark-mode-checkbox-label =
    .label = Śamny modus za powěsćowy tekst wužywaś
    .accesskey = m
dark-mode-message-text-description = Nałožujo śamnu slězynu na wšykne dochadajuce powěsći, samo gaby wótpósłaŕ jo je w swětłych barwach formatěrował.
...
dark-message-mode-toggle-label =
    ...
    .accesskey = t
dark-mode-toggle-description = Zmóžnja wam, mejlku pśi cytanju malsnje zasej w swětłem modusu pokazaś, bźez togo, aby trjebał swóje głowne nastajenja změniś.
general-folder-settings-header = Nastajenja zarědnika
recent-folders-legend = Nejnowše zarědniki
recent-folders-description = Póstaja, kak se njedawno wužyte zarědniki pokazuju, gaž powěsći pśesuwaśo.
...
recent-destinations-description = Nastajenja za nalicenje a sortěrowanje zarědnikow, do kótarychž su se powěsći njedawno pśesunuli.
recent-sort-order-label = Sortěrowański pórěd:
    .accesskey = S
recent-sort-order-mru =
    .label = Nejnowše
recent-sort-order-alphabetic =
    .label = Alfabetiski
max-recent-label = Maksimalna licba nejnowšych zarědnikow:
    .accesskey = M
...
account-hub-manual-config-checkbox-label =
    .label = Wužywajśo nowy manuelnu konfiguraciju w kontowem centrumje
    .accesskey = k
account-hub-manual-config-checkbox-description = Nowa manuelna konfiguracija kontowego centruma
new-calendar-legend = Dialog za nowy kalendarjowe tšojenje
new-calendar-checkbox-label =
    .label = Kalendarjowe tšojenja w nowem dialogu pokazaś
new-calendar-checkbox-description = Eksperimentelny nowy kalendarjowy dialog za pokazowanje tšojenjow
...
as-attachment-label =
    .label = Ako pśidank
add-file-type-label =
    .label = Pśipowjesnjonym powěsćam datajowy typ pśidaś
    .accesskey = o
extension-label =
...
autosave-draft-label =
    .label = Nacerjenje awtomatiski składowaś kužde
    .accesskey = N
...
ignore-sender-styles-label =
    .label = Pisma a barwy wótpósłarja ignorěrowaś
    .accesskey = m
...
paragraph-spacing-label =
    .label = Gaž Enter tłocyśo, se nowy wótstawk z pśidatnym wótkłonom zachopijo
    .accesskey = E
...
compose-format-automatic-description = Formatěrowany tekst słaś, jolic stile (na pśikład tucny abo wótkaze) pśidawaśo, abo lutny tekst, jolic nic.
compose-format-both-option =
    .label = Rich Text (HTML) a lutny tekst
compose-format-both-description = Pśecej wobej wersiji słaś, aby e-mailowe nałoženje dostawarja wubraś mógło, kótare se ma pokazaś.
compose-format-html-option =
    .label = Jano Rich text (HTML)
compose-format-html-description = Wobchowajo swójske pisma, barwy a wobraze, někotare starše e-mailowe nałoženja se snaź korektnje njepokazuju.
compose-format-plain-option =
    .label = Jano lutny tekst
compose-format-plain-description = Wótwónoźujo kužde formatěrowanje, barwy a wobraze. Nejlěpše za jadnore tekstowe mejlki, kótarež wšuźi funkcioněruju.
autocomplete-matches-description = Gaž mě abo e-mailowu adresu dostawarja zapódawaśo, pytajśo za wótpowědnikami w:
company-network-directory-label =
    .label = Pśedewześowy abo seśowy zapis
    .accesskey = P
...
manage-directories-label =
    .label = Zapise zastojaś
    .accesskey = Z
collect-outgoing-label =
    .label = E-majlowe adrese pśi słanju awtomatiski składowaś do:
    .accesskey = E
collect-outgoing-description = Tam, źož se nowe kontakty składuju, gaž su se manuelnje napórali abo z mejlkow pśidali.
save-added-contacts-label =
    .value = Manuelnje pśidane kontakty składowaś do:
    .accesskey = M
save-added-contacts-description = Tam, źož se nowe kontakty z mejlkow składuju.
show-directory-startup-label =
    .value = Zapis we woknje adresnika pokazaś, gaž se { -brand-short-name } wócynja
    .accesskey = Z
...
email-picker-label =
    ...
    .accesskey = M
email-picker-description = Městno nowych kontaktow, kótarež su se z pósłanych powěsćow składli.
default-add-address-book-label =
    .value = Standardny adresnik za manuelnje pśidane kontakty:
    .accesskey = S
default-add-address-book-description = Městno nowych kontaktow, kótarež su se z dostatych powěsćow składli.
...
attachment-label =
    ...
    .accesskey = f
edit-keywords-label =
    .label = Klucowe słowa wobźěłaś…
    .accesskey = K
offer-share-large-files-label =
    .label = Z wótkazom źělenje datajow póbitowaś, gaž su wětše ako:
...
preferences-doh-setting-strict =
    ...
    .accesskey = M
preferences-doh-strict-desc = { -brand-short-name } buźo pśecej wěsty DNS wužywaś. Buźośo warnowanje wěstotnego rizika wiźeś, nježli až waš systemowy DNS wužywamy.
...
accent-color-selection-label =
    .value = Wubjeŕśo barwu za primarny tłocašk a wuzwignjenja
accent-color-label =
    .value = Definěrujśo barwu, kótaraž se za primarne tłocaški a wuzwignjone elementy wužywa:
accent-color-os =
    .label = Źěłowemu systemoju slědowaś
accent-color-thunderbird =
    .label = Thunderbird módry
accent-color-purple =
    .label = Purpurowy
accent-color-orange =
    .label = Oranžowy
...
accent-color-teal =
    .label = Módrozeleny
accent-color-disabled-description = Akcentowe barwy se w modusu wusokego kontrasta njepódpěraju.
default-message-list-legend = Lisćina powěsćow
appearance-view-style-select =
    .value = Stil pśedstajanja wubraś
...
card-view-options-legend = Nastajenja kórtowego naglěda
...
default-sort-by-label = Powěsći sortěrowaś pó:
