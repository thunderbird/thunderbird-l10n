...
account-hub-servers-username-label = Wužywaŕske mě:
account-hub-result-server-label = Serwer:
account-hub-result-port-label = Port:
account-hub-result-security-label = Wěstota:
account-hub-result-authentication-type-label = Awtentifikacija
account-hub-result-authentication-none = Žeden
    .title = Žeden
account-hub-result-authentication-password = Normalne gronidło
    .title = Normalne gronidło
account-hub-result-authentication-encrypted-password = Skoděrowane gronidło
    .title = Skoděrowane gronidło
account-hub-result-authentication-gssapi = Kerberos
    .title = Kerberos
account-hub-result-authentication-ntlm = NTLM
    .title = NTLM
account-hub-result-authentication-external = Eksterny
    .title = Eksterny
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = Žeden
account-hub-result-auth-password = Normalne gronidło
account-hub-result-auth-encrypted-password = Skoděrowane gronidło
account-hub-result-auth-gssapi = Kerberos
account-hub-result-auth-ntlm = NTLM
account-hub-result-auth-external = Eksterny
...
account-hub-exchange-service-url-label = Zapódajśo URL słužby
...
account-hub-password-label = Gronidło
    .title = Opcionalne, buźo so jano wužywaś, aby se wužywaŕske mě pśespytało
    .accesskey = G
account-hub-remember-password = Gronidło se spomniś
    .accesskey = m
account-hub-exchange-label = Wašo pśizjawjenje
    .accesskey = z
account-hub-installing-addon = Dodank se ześěgujo a instalěrujo…
account-hub-success-addon = Dodank jo se wuspěšnje zainstalěrował
account-hub-success-half-manual = Slědujuce nastajenja su se pśi testowanju datego serwera namakali:
account-hub-result-security-no-encryption = Žedne koděrowanje
    .title = Žedne koděrowanje
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = Žedne koděrowanje
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = Awtentifikacija njejo se raźiła. Pšosym pśeglědajśo wužywaŕske mě a gronidło
...
account-hub-exchange-config-unverifiable = Konfiguracija njedajo se pśeglědowaś. Jolic wašo wužywaŕske mě a wašo gronidło stej korektnej, jo nejskerjej serwerowy adminsitrator wubranu konfiguraciju za wašo konto znjemóžnił. Wubjeŕśo drugi protokol.
account-hub-advanced-setup-button = Rozšyrjona konfiguracija
    .accesskey = R
# Variables:
#  $domain (String): The name of the server where the configuration was found, e.g. rackspace.com.
account-hub-exchange-dialog-question = { -brand-short-name } jo namakał informacije wó konfiguraciji konta na { $domain }. Cośo pókšacowaś a swóje pśizjawjeńske daty wótpósłaś?
account-hub-creation-error-title = Zmólka pśi napóranju konta
account-hub-error-server-exists = Dochadny serwer južo eksistěrujo.
account-hub-confirm-advanced-title = Rozšyrjonu konfiguraciju wobkšuśiś
account-hub-confirm-advanced-description = Toś ten dialog se zacynijo a konto z aktualnymi nastajenjami se załožyjo, lěcrownož konfiguracija jo wopacna. Cośo pókšacowaś?
account-hub-addon-install-title = Instalěrowaś
...
account-hub-port-help-text = Jolic pólo prozne wóstawa, { -brand-short-name } wopytajo, port namakaś.
...
account-hub-result-ews-expanded-text = Websłužby Exchange
...
account-hub-config-success-title = Kontowe nastajenja su se awtomatiski namakali.
account-hub-config-success-description-db = Konfiguracija jo se namakała w Mozilla ISPDB.
account-hub-config-success-description-exchange = Konfiguracija jo se namakała za serwer Microsoft Exchange.
account-hub-config-success-description-guess = Konfiguracija jo se namakała pśi wopytowanju zwuconych serwerowych mjenjow.
account-hub-config-success-description-disk = Konfiguracija jo se namakała w instalaciji { -brand-short-name }.
