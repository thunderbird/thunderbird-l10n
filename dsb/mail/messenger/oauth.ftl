...
oauth-reauthorize-title = Pśistup znowego awtorizěrowaś
...
oauth-reauthorize-description = { $hostname } se pomina, až pśistup znowego wobkšuśujośo, aby se ze synchronizaciju pókšacowało. Wužywaŕske mě: { $username }
