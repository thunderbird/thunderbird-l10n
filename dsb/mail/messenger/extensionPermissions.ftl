...
webext-perms-description-experiment-access = Toś ten dodank změjo połny, njewobgranicowany pśistup k { -brand-short-name } a swójomu licadłu.
...
webext-perms-description-messages-send = Sćelśo e-mailowe powěsći programatiski z masami w swójom mjenju, bźez wizuelneje reakcije. Wužywajśo zastojnik aktiwity, aby słańsku historiju dodanka pśeglědował.
webext-perms-description-messages-save = Składujśo e-mailowe powěsći ako nacerjenja abo pśedłogi programatiski, bźez wašeje interakcije
