...
details-notification-suppressed-esr-2 =
    .message = Toś ten dodank jo sr znjemóžnił, dokulaž zestarjete API wužywa. Dodanki ze zestarjetymi API mógu kuždy źěl { -brand-product-name } změniś a muse se aktualizěrowaś, pśeglědowaś a pśizwóliś, gažkuli sr { -brand-product-name } změnja. Take dodanki se togodla pśez toś tu wersiju { -brand-product-name } njepódpěra, ale jano pśez { -brand-product-name } ESR, kótaryž mjenjej kodowych změnow dostawa a za jadnolětny ESR-cyklus stabilny wóstawa.
