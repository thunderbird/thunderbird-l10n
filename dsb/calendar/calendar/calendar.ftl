...
calendar-task-filter-title = Pokazaś
...
calendar-publish-publish-button = Wózjawiś
...
calendar-extract-event-button =
    ...
    .tooltiptext = Tšojeńske informacije z powěsći ekstrahěrowaś a je wašomu kalenderoju ako tšojenje pśidaś
calendar-extract-task-button =
    .label = Ako nadawk pśidaś
    .tooltiptext = Tšojeńske informacije z powěsći ekstrahěrowaś a je wašomu kalenderoju ako nadawk pśidaś
