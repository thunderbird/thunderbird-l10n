...
too-new-dbschema-error-text = Waše kalenderowe daty njejsu kompatibelne z wersiju { -brand-short-name }. Kalenderowe daty we wašom profilu su se zaktualizěrowali pśez nowšu wersiju { -brand-short-name }. Zawěsćenje datoweje dataje z mjenim „{ $fileName }“ jo se napórało. Pókšacujo se z nowo napóraneju datoweju dataju.
...
calendar-context-delete-server =
    .label = Kalender wulašowaś…
    .accesskey = u
calendar-context-remove-server =
    .label = Kalender wótpóraś…
    .accesskey = w
calendar-context-unsubscribe-server =
    .label = Kalender wótskazaś…
    .accesskey = s
calendar-context-publish =
    .label = Kalender wózjawiś…
    .accesskey = z
calendar-context-export =
    .label = Kalender eksportěrowaś…
    .accesskey = e
calendar-context-properties =
    .label = Kakosći
    .accesskey = K
calendar-context-showall =
    .label = Wšykne kalendery pokazaś
    .accesskey = l
calendar-context-convert-menu =
    .label = Konwertěrowaś do
    .accesskey = w
...
calendar-context-convert-to-task =
    .label = Nadawk…
    .accesskey = N
calendar-task-filter-title2 = Nadawki filtrowaś
...
calendar-task-filter-next7days =
    .label = Pśiducych sedym dnjow
    .accesskey = P
calendar-task-filter-notstarted =
    .label = Njezachopjone nadawki
    .accesskey = a
calendar-task-filter-overdue =
    .label = Nadawki, kótarež by musali južo dokóńcone byś
    .accesskey = O
calendar-task-filter-completed =
    .label = Dokóńcone nadawki
    .accesskey = k
calendar-task-filter-open =
    .label = Njedokóńcone nadawki
    .accesskey = N
...
calendar-task-filter-current =
    .label = Aktualne nadawki
    .accesskey = a
calendar-task-details-title = titel
calendar-task-details-organizer = wót
calendar-task-details-priority = priorita
calendar-task-details-priority-low = Niska
calendar-task-details-priority-normal = Normalna
calendar-task-details-priority-high = Wusoka
calendar-task-details-status = status
calendar-task-details-category = kategorija
calendar-task-details-repeat = wóspjetowanje
calendar-task-details-attachments = pśidanki
calendar-task-details-start = zachopny datum
calendar-task-details-due = termin
calendar-task-mark-completed =
    .label = Ako dokóńcony markěrowaś
    .tooltiptext = Wubrane nadawki ako dokóńcone markěrowaś
    .accesskey = d
calendar-task-change-priority =
    .label = Priorita
    .tooltiptext = Prioritu změniś
    .accesskey = r
calendar-task-input-filter-field =
    .aria-label = Nadawki filtrowaś
    .emptytextbase = Nadawki filtrowaś #1
    .keylabelmac = <⇧⌘K>
    .keylabelnonmac = <Strg+Umsch+K>
...
calendar-tasks-view-minimonth =
    .label = Mjasecny pśeglěd
    .accesskey = M
calendar-tasks-view-calendarlist =
    .label = Lisćina kalenderow
    .accesskey = L
calendar-tasks-view-filtertasks =
    .label = Nadawki filtrowaś
    .accesskey = f
...
calendar-properties-refresh =
    .value = Kalender aktualizěrowaś:
calendar-properties-refresh-manual =
    .label = Manuelnje
calendar-properties-read-only =
    .label = Jano cytajobny
calendar-properties-show-reminders =
    .label = Dopomnjeśa pokazaś
calendar-properties-offline-support =
    .label = Pódpěra offline
calendar-properties-enable-calendar =
    .label = Toś ten kalendaŕ zmóžniś
calendar-properties-provider-missing = Póbitowaŕ za toś ten kalender njedajo se namakaś. To se cesto stawa, jolic sćo wěste dodanki znjemóžnił abo wótinstalował.
...
calendar-newevent-button =
    .label = Nowe tšojenje
    .tooltiptext = Nowe tšojenje napóraś
calendar-newtask-button =
    .label = Nowy nadawk
    .tooltiptext = Nowy nadawk napóraś
calendar-unifinder-show-completed-todos =
    .label = Dokóńcone nadawki pokazaś
calendar-display-todos-checkbox =
    .label = Nadawki w pśeglěźe
    .accesskey = k
...
calendar-publish-publish-dialog-button =
    .buttonlabelaccept = Wózjawiś
calendar-publish-close-button = Zacyniś
calendar-select-dialog-title = Kalender wubraś
...
calendar-extract-event-button =
    .label = Ako tšojenje pśidaś
    .tooltiptext = Kalenderowe informacije z powěsći ekstrahěrowaś a je wašomu kalenderoju ako tšojenje pśidaś
...
calendar-auth-enter-user-password-for-calendar = “{ $calendarName }” ({ $location }) wašo wužywaŕske mě a gronidło pomina.
# Variables:
#   $username (String) - The account username.
#   $location (String) - The calendar server location.
calendar-auth-enter-password-for = Zapódajśo gronidło za { $username } na { $location }
# Variables:
#   $location (String) - The calendar server location.
calendar-auth-enter-user-password-for = { $location } pomina wašo wužywarske mě a gronidło.
