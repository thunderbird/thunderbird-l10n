...
connection-error-start-tls-not-supported = Serwer njepódpěra koděrowanje, ale waša konfiguracija jo trjebna
...
odnoklassniki-disabled = Odnoklassniki se wěcej njepódpěra, dokulaž Odnoklassniki jo swój zachod XMPP znjemóžnił.
