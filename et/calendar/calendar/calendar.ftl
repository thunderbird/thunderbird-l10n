...
calendar-context-delete-task =
    .label = Kustuta ülesanne
    .accesskey = K
calendar-context-delete-event =
    .label = Kustuta sündmus
    .accesskey = u
...
calendar-context-attendance-occ-needs-action =
    .label = Vajab endiselt otsustamist
    .accesskey = o
...
calendar-context-convert-to-task =
    .label = Ülesandeks…
    .accesskey = Ü
calendar-task-filter-title = Näidatakse
calendar-task-filter-all =
    .label = kõiki
    .accesskey = õ
calendar-task-filter-today =
    .label = tänaseid ülesandeid
    .accesskey = t
calendar-task-filter-next7days =
    .label = järgmist 7 päeva
    .accesskey = j
calendar-task-filter-notstarted =
    .label = alustamata ülesandeid
    .accesskey = a
calendar-task-filter-overdue =
    .label = tähtaja ületanud ülesandeid
    .accesskey = ä
calendar-task-filter-completed =
    .label = täidetud ülesandeid
    .accesskey = d
calendar-task-filter-open =
    .label = pooleliolevaid ülesandeid
    .accesskey = o
...
calendar-task-filter-current =
    .label = jooksvaid ülesandeid
    .accesskey = s
calendar-task-details-title = Pealkiri:
calendar-task-details-organizer = Alates:
calendar-task-details-priority = Prioriteet:
calendar-task-details-priority-low = Madal
calendar-task-details-priority-normal = Tavaline
calendar-task-details-priority-high = Kõrge
calendar-task-details-status = Seisund:
calendar-task-details-category = Kategooria:
calendar-task-details-repeat = Kordumine:
calendar-task-details-attachments = Manused:
calendar-task-details-start = Alguskuupäev
calendar-task-details-due = Tähtaeg
calendar-task-mark-completed =
    .label = Märgi tehtuks
    .accesskey = h
    .tooltiptext = Märgi valitud ülesanded tehtuks
calendar-task-change-priority =
    .label = Prioriteet
    .accesskey = P
    .tooltiptext = Muuda prioriteeti
calendar-task-text-filter-field =
    .emptytextbase = Filtreeri ülesandeid #1
    .keylabelnonmac = <Ctrl+Shift+K>
    .keylabelmac = <⇧⌘K>
calendar-copylink =
    .label = Kopeeri lingi asukoht
    .accesskey = o
...
calendar-tasks-view-calendarlist =
    .label = Kalendrite nimekiri
    .accesskey = n
calendar-tasks-view-filtertasks =
    .label = Filtreeri ülesandeid
    .accesskey = F
...
calendar-properties-refresh =
    .value = Kalendrit värskendatakse:
calendar-properties-refresh-manual =
    .label = käsitsi
calendar-properties-read-only =
    .label = Kirjutuskaitstud
calendar-properties-show-reminders =
    .label = Meeldetuletuste näitamine
calendar-properties-offline-support =
    .label = Puhverdatud
calendar-properties-enable-calendar =
    .label = Lülita kalender sisse
calendar-properties-provider-missing = Sellele kalendrile ei leitud teenusepakkujat. Sageli põhjustab seda mõne lisa keelamine või eemaldamine.
calendar-properties-unsubscribe =
    .label = Lõpeta tellimine
    .accesskey = L
    .buttonlabelextra1 = Lõpeta tellimine
    .buttonaccesskeyextra1 = L
calendar-alarm-dialog-title = Kalendri meeldetuletus
...
calendar-alarm-snooze-all-for =
    .label = Lükka kõik edasi
# LOCALIZATION NOTE (calendar-alarm-snooze-cancel):
# This string is not visible in the UI. It is read by screen readers when the
# user focuses the "Cancel" button in the "Snooze for..." popup of the alarm dialog.
calendar-alarm-snooze-cancel =
    .aria-label = Tühista meeldetuletus
calendar-calendar =
    .label = Kalender
    .accesskey = K
calendar-newevent-button =
    .label = Uus sündmus
    .tooltiptext = Uus sündmus
calendar-newtask-button =
    .label = Uus ülesanne
    .tooltiptext = Uus ülesanne
calendar-unifinder-show-completed-todos =
    .label = Näidatakse täidetud ülesandeid
calendar-display-todos-checkbox =
    .label = Ülesandeid näidatakse vaates
    .accesskey = v
...
calendar-orientation =
    .label = Pööratud vaade
    .accesskey = ö
calendar-todaypane-button =
    .label = Tänaste tegemiste paneel
...
calendar-publish-publish-dialog-button =
    .buttonlabelaccept = Avalda
calendar-publish-publish-button = Avalda
calendar-publish-close-button = Sulge
calendar-select-dialog-title = Kalendri valimine
...
calendar-extract-event-button =
    .label = Lisa sündmusena
    .tooltiptext = Lisab kirjas oleva info põhjal kalendrisse sündmuse
