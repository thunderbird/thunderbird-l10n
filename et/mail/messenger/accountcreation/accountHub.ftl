...
account-hub-username-warning-icon = Kasutajanimi on nõutud
account-hub-address-book-username-error-text = Palun sisesta kasutajanimi
...
account-hub-password-label = Parool
    .accesskey = P
    .title = Valikuline, kasutatakse ainult kasutajanime kontrollimiseks
account-hub-remember-password = Parool peetakse meeles
    .accesskey = o
account-hub-exchange-label = Sinu kasutajatunnus
    .accesskey = k
account-hub-installing-addon = Lisa allalaadimine ja paigaldamine…
account-hub-success-addon = Lisa paigaldamine õnnestus
account-hub-success-half-manual = Antud serveri uurimisel leiti järgmised sätted:
account-hub-result-security-no-encryption = Krüptimine puudub
    .title = Krüptimine puudub
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = Krüptimine puudub
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = Tuvastamine ebaõnnestus. Kontrolli kasutajanime ja parooli.
...
account-hub-exchange-config-unverifiable = Seadistust polnud võimalik kontrollida. Kui kasutajanimi ja parool on õiged, siis on tõenäoline, et serveri administraator on keelanud valitud konfiguratsiooni sinu konto jaoks. Proovi valida mõni muu protokoll.
account-hub-advanced-setup-button = Täpsem seadistamine
    .accesskey = T
# Variables:
#  $domain (String): The name of the server where the configuration was found, e.g. rackspace.com.
account-hub-exchange-dialog-question = { -brand-short-name } leidis sinu konto konfiguratsiooni domeenilt { $domain }. Kas soovid jätkata ning sisestada oma kasutajatunnused?
account-hub-creation-error-title = Viga konto loomisel
account-hub-error-server-exists = Vastuvõttev server on juba olemas.
account-hub-confirm-advanced-title = Täpsema häälestuse kinnitamine
account-hub-confirm-advanced-description = See dialoog suletakse ja luuakse praeguste sätetega konto, isegi kui häälestus on vale. Kas soovid jätkata?
account-hub-addon-install-title = Paigalda
account-hub-encryption-button = Otspunktkrüptimine
account-hub-address-books-button = Aadressiraamatud
account-hub-calendars-button = Kalendrid
...
account-hub-add-address-book = Lisa aadressiraamat
