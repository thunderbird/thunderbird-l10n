...
community-exp =
    ...
    üleilmne kogukond</a>
    , kes töötab koos, et hoida internet avatuna, avalikuna ja ilma igasuguste piiranguteta ligipääsetavana kõigile.
community-2 =
    { -brand-short-name } on loodud <a data-l10n-name="community-mozilla-link">
    { -vendor-short-name }</a>
     <a data-l10n-name="community-credits-link">
    üleilmse kogukonna </a>
     poolt, et hoida internet avatud, avalik ja ilma igasuguste piiranguteta ligipääsetav kõigile.
about-helpus =
