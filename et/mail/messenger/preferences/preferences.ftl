...
general-language-and-fonts-header = Keel ja fondid
...
browsing-gtk-use-non-overlay-scrollbars =
    ...
    .accesskey = K
window-layout-legend = Akna paigutus
...
clear-cache-shutdown-label =
    .label = Sulgemisel tühjendatakse vahemälu
    .accesskey = S
font-legend = Fondid
...
junk-delete-label =
    ...
    .accesskey = t
junk-read-description = Märgi kirjad loetuks
junk-log-label =
...
appearance-card-style-2 =
    .label = 2 rida
default-message-list-sorting-legend = Sorteerimine ja lõimimine
default-sort-date =
    .label = Kuupäev
...
apply-sort-to-all-button =
    .label = Kõigile olemasolevatele kaustadele
    .accesskey = K
...
apply-current-view-error = Praeguste vaateseadete rakendamine ebaõnnestus
apply-current-view-success = Praeguste vaateseadete rakendamine õnnestus
