...
webext-perms-description-experiment-access = Это дополнение будет иметь полный, неограниченный доступ к { -brand-short-name } и вашему компьютеру.
...
webext-perms-description-messages-send = Программно отправляет массовое количество сообщений электронной почты от вашего имени без какой-либо визуальной обратной связи. Используйте менеджер активности для просмотра истории отправки дополнения.
webext-perms-description-messages-save = Сохраняйте почтовые сообщения как черновики или шаблоны программно, без вашего взаимодействия
