...
address-book-list =
    .aria-label = Список адресных книг
...
about-addressbook-column-header-a11y-emailaddresses2 =
    .aria-label = Адреса электронной почты
...
about-addressbook-export-selected-filename = Контакты
...
about-addressbook-photo-dialog-title =
    .aria-label = Управление фотографией контакта.
