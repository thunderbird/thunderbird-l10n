...
default-app-intro = Использовать { -brand-short-name } по умолчанию в качестве:
...
checkbox-net-thunderbird-url-label =
    .label = Настраиваемые ссылки Thunderbird (net.thunderbird://)
    .tooltiptext = { unset-default-tooltip }
...
check-on-startup-label =
    ...
    .accesskey = В
system-settings-dialog-title = Системные настройки
