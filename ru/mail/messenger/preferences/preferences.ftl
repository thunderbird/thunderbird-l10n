...
email-e2ee-enable-info = Настройте учетные записи электронной почты и идентификаторы для сквозного шифрования в настройках учетной записи.
...
email-e2ee-automatism-pre =
    ...
    Автоматическое включение/отключение осуществляется на основе наличия действительных и принятых ключей или сертификатов отправителей.
email-e2ee-auto-on =
