...
toolbar-spam-label = Спам
toolbar-spam =
    .title = Отметить выбранные сообщения как спам
toolbar-not-spam-label = Не спам
toolbar-not-spam =
    .title = Отметить выбранные сообщения как не спам
...
toolbar-add-address-book-label = Добавить адресную книгу
