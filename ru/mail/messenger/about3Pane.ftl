...
folder-pane-header-toggle-full-path =
    .label = Показать полный путь
folder-pane-header-hide-local-folders =
    .label = Скрыть локальные папки
folder-pane-mode-header-all = Все папки
folder-pane-mode-header-unread = Непрочитанные папки
folder-pane-mode-header-favorite = Избранные папки
folder-pane-mode-header-recent = Недавно открытые папки
folder-pane-mode-header-smart = Объединённые папки
folder-pane-mode-header-tags = Метки
