...
account-hub-servers-username-label = Имя пользователя:
account-hub-result-server-label = Сервер:
account-hub-result-port-label = Порт:
account-hub-result-security-label = Безопасность:
account-hub-result-authentication-type-label = Аутентификация:
account-hub-result-authentication-none = Нет
    .title = Нет
account-hub-result-authentication-password = Обычный пароль
    .title = Обычный пароль
account-hub-result-authentication-encrypted-password = Зашифрованный пароль
    .title = Зашифрованный пароль
account-hub-result-authentication-gssapi = Kerberos
    .title = Kerberos
account-hub-result-authentication-ntlm = NTLM
    .title = NTLM
account-hub-result-authentication-external = Внешняя
    .title = Внешняя
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = Нет
account-hub-result-auth-password = Обычный пароль
account-hub-result-auth-encrypted-password = Зашифрованный пароль
account-hub-result-auth-gssapi = Kerberos
account-hub-result-auth-ntlm = NTLM
account-hub-result-auth-external = Внешняя
...
account-hub-exchange-service-url-label = Введите URL службы
...
account-hub-result-security-no-encryption = Без шифрования
...
account-hub-manual-config-imap-title = Параметры IMAP
account-hub-manual-config-pop3-title = Параметры POP3
account-hub-manual-config-review-settings-title = Проверить обновлённые настройки
account-hub-manual-config-incoming-legend = Cервер входящей почты
...
account-hub-port-help-text = Если оставить это поле пустым, { -brand-short-name } попытается найти порт.
...
account-hub-result-graph-api-description = Используйте API Microsoft Graph для синхронизации ваших папок и электронной почты с Microsoft 365
...
account-hub-result-ews-expanded-text = Веб-службы Exchange
...
account-hub-config-success-title = Параметры учётной записи найдены автоматически.
account-hub-config-success-description-db = Найдена конфигурация в Mozilla ISPDB.
account-hub-config-success-description-exchange = Найдена конфигурация для сервера Microsoft Exchange.
account-hub-config-success-description-guess = При проверке типичных имён серверов найдена следующая конфигурация.
account-hub-config-success-description-disk = Найдена конфигурация в установке { -brand-short-name }.
...
account-hub-manual-config-error-summary = Пожалуйста, исправьте следующие ошибки:
...
address-book-add-remote-icon2 =
    .alt = Добавить удалённую адресную книгу
address-book-add-remote-icon =
    .alt = Добавить новую удалённую адресную книгу
address-book-add-remote = Добавить удалённую адресную книгу
address-book-add-remote-carddav-description = Подключиться к адресной книге CardDAV
...
address-book-add-ldap-icon2 =
    .alt = Добавить адресную книгу LDAP
address-book-add-ldap-button = Добавить адресную книгу LDAP
...
account-hub-exchange-type-account-type = Тип учётной записи
account-hub-card-graph-title = Microsoft Graph
account-hub-card-graph-description = Microsoft Graph — это новый метод подключения к Microsoft 365.
account-hub-card-ews-title = Веб-службы Exchange
account-hub-card-ews-tag = Классический
account-hub-card-ews-description = Веб-службы Exchange (EWS) подключаются к Microsoft Exchange для синхронизации вашей почты.
# This is shown after the type description, so "it" is referring to the type (either Microsoft Graph or Exchange Web Services).
account-hub-card-recommended-description = Это рекомендовано, так как соответствует URL вашего сервиса.
account-hub-exchange-type-username = Имя пользователя
account-hub-exchange-type-username-hint = Обычно ваш адрес электронной почты или UPN в Active Directory.
account-hub-exchange-type-authentication = Метод аутентификации
# Checkbox that can be unchecked to use a custom OAuth config.
account-hub-exchange-type-default-oauth = Использовать параметры аутентификации Microsoft 365 Copilot по умолчанию
account-hub-exchange-type-oauth-tenant = ID клиента
account-hub-exchange-type-oauth-app = ID приложения
account-hub-exchange-type-title = Выберите тип учётной записи
