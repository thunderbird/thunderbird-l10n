...
policy-DisableCommunity = Nu afișa funcționalitățile pentru comunitate în interfața utilizatorului (cum ar fi Donează, Implică-te, Împărtășește idei etc.)
...
policy-DisableFileLink = Dezactivează funcția Filelink.
...
policy-DisableMessageForwardingFilters = Blochează redirecționarea automată a mesajelor prin filtrele de mesaje.
...
policy-DisableUpdateSettings = Împiedică utilizatorul să-și modifice setările de actualizare a aplicației.
