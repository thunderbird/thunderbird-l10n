...
account-hub-servers-username-label = Nume de utilizator:
account-hub-result-server-label = Server:
account-hub-result-port-label = Port:
account-hub-result-security-label = Securitate:
account-hub-result-authentication-type-label = Autentificare:
account-hub-result-authentication-none = Niciuna
    .title = Niciuna
account-hub-result-authentication-password = Parolă normală
    .title = Parolă normală
account-hub-result-authentication-encrypted-password = Parolă criptată
    .title = Parolă criptată
...
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = Niciuna
account-hub-result-auth-password = Parolă normală
account-hub-result-auth-encrypted-password = Parolă criptată
...
account-hub-exchange-service-url-label = Introdu adresa URL a serviciului
...
account-hub-password-label = Parolă
    .accesskey = P
    .title = Opțional, va fi folosită numai pentru validarea numelui de utilizator
account-hub-remember-password = Reține parola
    .accesskey = m
account-hub-exchange-label = Datele tale de autentificare
    .accesskey = l
account-hub-installing-addon = Se descarcă și se instalează suplimentul…
account-hub-success-addon = Supliment instalat cu succes
account-hub-success-half-manual = Au fost identificate următoarele setări prin încercarea serverului dat:
account-hub-result-security-no-encryption = Fără criptare
    .title = Fără criptare
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = Fără criptare
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = Autentificare eșuată. Te rugăm să verifici numele de utilizator și parola
...
account-hub-exchange-config-unverifiable = Configurația nu a putut fi verificată. Dacă numele de utilizator și parola sunt corecte, este posibil ca administratorul serverului să fi dezactivat configurația selectată pentru contul tău. Încearcă să selectezi un alt protocol.
account-hub-advanced-setup-button = Configurare avansată
    .accesskey = A
# Variables:
#  $domain (String): The name of the server where the configuration was found, e.g. rackspace.com.
account-hub-exchange-dialog-question = { -brand-short-name } ți-a găsit informațiile de configurare a contului pe { $domain }. Vrei să continui și să trimiți datele de autentificare?
account-hub-creation-error-title = Eroare la crearea contului
account-hub-error-server-exists = Serverul de primire există deja.
account-hub-confirm-advanced-title = Confirmă configurația avansată
account-hub-confirm-advanced-description = Caseta de dialog se va închide și va fi creat un cont cu setările actuale, chiar dacă configurația este incorectă. Vrei să continui?
account-hub-addon-install-title = Instalează
...
account-hub-email-setup-incoming = Setări server de primire
...
account-hub-result-graph-api-description = Folosește API-ul Microsoft Graph pentru a sincroniza dosarele și e-mailurile cu Microsoft 365
...
account-hub-config-success-title = Setările contului au fost găsite automat.
account-hub-config-success-description-db = Configurație găsită în baza de date Mozilla ISP.
account-hub-config-success-description-exchange = S-a găsit configurația pentru un server Microsoft Exchange.
account-hub-config-success-description-guess = Configurație găsită prin încercarea denumirilor uzuale de server.
account-hub-config-success-description-disk = Configurația a fost găsită în instalarea { -brand-short-name }.
...
address-book-add-remote-icon2 =
    .alt = Adaugă o agendă de contacte de la distanță
address-book-add-remote-icon =
    .alt = Adaugă o nouă agendă de contacte de la distanță
address-book-add-remote = Adaugă agenda de contacte de la distanță
address-book-add-remote-carddav-description = Conectează-te la o agendă de contacte CardDav
...
address-book-add-ldap-icon2 =
    .alt = Adaugă o agendă de contacte LDAP
address-book-add-ldap-button = Adaugă o agendă de contacte LDAP
...
account-hub-exchange-type-account-type = Tip cont
account-hub-card-graph-title = Microsoft Graph
account-hub-card-graph-description = Microsoft Graph este o metodă modernă de conectare pentru Microsoft 365.
account-hub-card-ews-title = Servicii Exchange Web
account-hub-card-ews-tag = Perimat
account-hub-card-ews-description = Exchange Web Services (EWS) se conectează la Microsoft Exchange pentru a sincroniza e-mailurile.
# This is shown after the type description, so "it" is referring to the type (either Microsoft Graph or Exchange Web Services).
account-hub-card-recommended-description = Este recomandat deoarece corespunde adresei URL a serviciului tău.
account-hub-exchange-type-username = Nume de utilizator
account-hub-exchange-type-username-hint = De obicei adresa ta de e-mail sau UPN-ul Active Directory.
account-hub-exchange-type-authentication = Metodă de autentificare
# Checkbox that can be unchecked to use a custom OAuth config.
account-hub-exchange-type-default-oauth = Folosește setările implicite de autentificare Microsoft 365 Copilot
account-hub-exchange-type-oauth-tenant = ID chiriaș
account-hub-exchange-type-oauth-app = ID aplicație
account-hub-exchange-type-advanced-config = Configurare avansată
account-hub-exchange-type-title = Alege un tip de cont
