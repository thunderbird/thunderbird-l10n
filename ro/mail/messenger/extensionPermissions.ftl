...
webext-perms-description-messages-send = Trimite automat e-mail-uri în masă în numele tău, fără niciun feedback vizual. Folosește Managerul de activitate ca să verifici istoricul mesajelor trimise de supliment.
webext-perms-description-messages-save = Salvează e-mail-uri ca ciorne sau șabloane în mod automat, fără intervenția ta
