...
chat-description = { -brand-short-name } îți permite să conectezi mai multe conturi de mesagerie instant, oferind suport pentru variate platforme.
...
address-book-add-label = Agendă de contacte
    .aria-label = Adaugă o agendă de contacte
