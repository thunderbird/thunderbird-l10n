...
general-email-notifications-header = Notificări prin e-mail
...
general-files-and-attachment-description = Selectează ce fișiere să fie salvate și unde să fie salvate pe calculator.
general-tags-header = Etichete
general-reading-and-viewing-header = Citire și vizualizare
general-reading-and-display-header = Citire și afișare
general-updates-header = Actualizări
general-network-and-storage-header = Rețea și stocare
general-search-performance-label = Căutare și performanță
compose-writing-emails-header = Scrierea de mesaje prin e-mail
...
compose-message-formatting-title = Formatarea mesajelor
compose-address-autocomplete-header = Completarea automată a adreselor
...
choose-display-language-description = Alege limba utilizată pentru meniuri, butoane și notificări.
...
manual-storage-limit-label =
    .label = Setează manual limitele de spațiului de stocare pentru fișiere temporare
    .accesskey = M
clear-temp-files-button =
    .label = Șterge fișierele temporare
    .accesskey = C
clear-temp-files-shutdown-label =
    .label = Șterge fișierele temporare la închiderea { -brand-short-name }
    .accesskey = s
...
show-start-page-label =
    .label = Afișează pagina de pornire la deschiderea { -brand-short-name }
    .accesskey = W
start-page-label =
...
start-in-tray-label =
    ...
    .accesskey = S
new-message-arrival-legend = La primirea unui mesaj nou:
...
mail-play-button =
    .label = Redă
    .accesskey = R
change-dock-icon-description = Insigne aplicație și notificări
...
new-email-alert-label =
    .label = Afișează o alertă pentru mesaje noi
    .accesskey = S
customize-alerts-label =
    .label = Personalizează alertele…
    .accesskey = C
...
use-custom-sound-label =
    .label = Folosește sunete personalizate pentru alerte
    .accesskey = U
mail-select-audio-button =
    .label = Selectează audio…
    .accesskey = A
enable-global-search-label =
    .label = Activează căutarea pe toate conturile de e-mail
    .accesskey = e
gloda-results-plain-list-label =
    .label = Afișează rezultatele căutării într-o listă simplă
    .accesskey = L
...
gloda-show-results-as-list-label =
    .label = Afișează rezultatele căutării globale ca listă în mod implicit
    .accesskey = L
datetime-formatting-legend = Formatarea datei și a orei
display-language-legend = Limbă de afișare
allow-graphics-accel =
    .label = Folosește accelerarea grafică pentru derulare mai lină și îmbunătățirea performanței
    .accesskey = h
storage-format-label =
    .value = Format de stocare pentru conturi noi:
    .accesskey = T
mbox-store-single-label =
    .label = Un singur fișier per dosar (mbox)
...
enable-autoscroll-label =
    .label = Permite derularea automată
    .accesskey = g
autoscroll-label =
...
hide-titlebar-label =
    .label = Ascunde bara de titlu
    .accesskey = H
hide-titlebar-description = Elimină bara de sus care afișează denumirea ferestrei pentru economie de spațiu pe ecran
hide-tabbar-single-tab-label =
    .label = Ascunde bara de file când este deschisă o singură filă
    .accesskey = T
auto-hide-tabbar-second-tab-description = Ascunde automat filele până ce deschizi o a doua filă.
system-settings-legend = Setări de sistem
...
edit-defaults-apps-button =
    .label = Editează setările implicite…
    .accesskey = u
...
update-settings-title = Actualizează setările
install-updates-automatically-label =
    .label = Instalează automat actualizări (recomandat)
    .accesskey = A
install-updates-automatically-description = Menține { -brand-short-name } în siguranță cu cele mai recente remedii pentru securitate.
check-updates-ask-label =
    .label = Verifică dacă sunt actualizări, dar întreabă înainte de instalare
    .accesskey = C
...
connection-config-description = Controlează cum se conectează { -brand-short-name } la internet.
connection-options-button =
    .label = Opțiuni de conectare…
    .accesskey = S
offline-mode-legend = Mod offline
offline-settings-label = Setări pentru lucru offline
...
offline-settings-button =
    .label = Offline…
    .accesskey = O
temporary-storage-legend = Stocare temporară
offline-compact-remove-deleted =
    .label = Elimină datele din dosare când au fost deja șterse pentru eliberare de spațiu
    .accesskey = a
offline-compact-ask-cleanup =
    .label = Întreabă înainte de a curăța dosarele
    .accesskey = b
...
use-cache-before =
    ...
    .accesskey = U
use-temp-storage-after = MB de spațiu pentru fișiere temporare
...
underline-text-links-label =
    .label = Subliniază linkurile text în mesaje
    .accesskey = k
...
customize-fonts-button =
    .label = Personalizează fonturile…
    .accesskey = f
font-options-button =
    .label = Avansat…
    .accesskey = A
...
convert-emoticons-label =
    ...
    .accesskey = e
display-text-formatting-label = Formatare text citat
...
search-content-types =
    .placeholder = Caută tipuri de conținut
...
always-ask-label =
    ...
    .accesskey = a
use-tags-text = Folosește file pentru categorisirea și prioritizarea mesajelor.
...
mark-read-when-opened =
    .label = Imediat la deschidere
    .accesskey = o
show-attachments-inline-label =
    .label = Afișează atașamentele în corpul mesajului
    .accesskey = m
mark-read-no-delay =
...
display-name-only-label =
    .label = Arată numele afișat numai pentru contactele salvate în agendă
    .accesskey = S
...
show-conversation-view-label =
    .label = Afișare tip conversație
    .accesskey = c
conversation-view-preview-description = Este o funcționalitate de previzualizare timpurie. Grupează mesaje corelate, dar este posibil să nu funcționeze întotdeauna conform așteptărilor.
...
dark-mode-message-appearance = Aspect mesaje
dark-mode-checkbox-label =
    .label = Folosește modul întunecat pentru textul mesajelor
    .accesskey = d
dark-mode-message-text-description = Aplică un fundal întunecat în toate mesajele primite, chiar dacă expeditorul le-a formatat în culori deschise.
...
dark-message-mode-toggle-label =
    ...
    .accesskey = t
dark-mode-toggle-description = Îți permite să treci rapid un mesaj înapoi pe modul luminos în timp ce citești, fără a-ți modifica setările principale.
general-folder-settings-header = Setări dosar
recent-folders-legend = Dosare recente
recent-folders-description = Controlează cum apar dosarele folosite recent când muți mesaje.
...
general-folder-options-header = Opțiuni de gestionare a dosarelor
recent-destinations-legend = Destinații recente
recent-destinations-description = Opțiuni pentru listarea și sortarea dosarelor în care au fost mutate recent mesajele.
recent-sort-order-label = Ordine de sortare:
    .accesskey = S
recent-sort-order-mru =
    .label = Cele mai recente
recent-sort-order-alphabetic =
    .label = Ordine alfabetică
max-recent-label = Număr maxim de dosare recente:
    .accesskey = M
...
account-hub-manual-config-checkbox-label =
    .label = Folosește fluxul nou de configurare manuală din Centrul de conturi
    .accesskey = c
account-hub-manual-config-checkbox-description = Flux nou de configurare manuală în Centrul de conturi
new-calendar-legend = Fereastră de dialog pentru eveniment nou din calendar
new-calendar-checkbox-label =
    .label = Afișează evenimentele din calendar în noua fereastră de dialog
new-calendar-checkbox-description = Fereastră de dialog în versiune experimentală pentru vizualizarea evenimentelor din calendar
...
as-attachment-label =
    .label = Ca atașament
add-file-type-label =
    .label = Adaugă tipul de fișier la mesajele atașate
    .accesskey = e
extension-label =
    .label = adaugă extensia la numele fișierului
    .accesskey = f
forward-messages-label =
    .value = Redirecționează mesajele ca:
    .accesskey = F
forward-inline-label =
    .label = În corpul mesajului (încorporat)
...
autosave-draft-label =
    .label = Salvează automat o ciornă la fiecare
    .accesskey = A
...
spellcheck-while-typing-label =
    .label = Verifică ortografia în timp ce tastezi
    .accesskey = E
...
ignore-sender-styles-label =
    .label = Ignoră fonturile și culorile expeditorului
    .accesskey = d
...
paragraph-spacing-label =
    .label = Apăsarea pe Enter începe un paragraf nou cu spațiere suplimentară
    .accesskey = P
...
compose-format-automatic-option =
    .label = Automat (recomandat)
compose-format-automatic-description = Trimite text formatat dacă adaugi stiluri (cum ar fi caractere aldine sau linkuri) sau text simplu dacă nu adaugi stiluri.
compose-format-both-option =
    .label = Atât text îmbogățit (HTML), cât și text simplu
compose-format-both-description = Trimite întotdeauna ambele versiuni, astfel încât aplicația de e-mail a destinatarului să poată alege pe care să o afișeze.
compose-format-html-option =
    .label = Numai text îmbogățit (HTML)
compose-format-html-description = Păstrează fonturile, culorile și imaginile personalizate, dar este posibil ca unele aplicații mai vechi de e-mail să nu le afișeze corect.
compose-format-plain-option =
    .label = Numai text simplu
compose-format-plain-description = Elimină toată formatarea, culorile și imaginile. Ideal pentru mesaje cu text simplu care merg oriunde.
autocomplete-matches-description = Când tastez numele unui destinatar sau o adresă de e-mail, caută potriviri în:
company-network-directory-label =
    .label = Directorul firmei sau în cel din rețea
    .accesskey = C
directory-server-label =
    .label = Serverul directorului
    .accesskey = D
...
manage-directories-label =
    .label = Gestionează directoarele…
    .accesskey = E
collect-outgoing-label =
    .label = Salvează automat adresele de e-mail din mesaje trimise în:
    .accesskey = A
collect-outgoing-description = Unde sunt salvate contactele noi când sunt create manual sau sunt adăugate din mesaje.
save-added-contacts-label =
    .value = Salvează manual contactele adăugate în:
    .accesskey = m
save-added-contacts-description = Unde sunt salvate contactele noi din mesaje.
show-directory-startup-label =
    .value = Afișează directorul în fereastra agendei de contacte când deschid { -brand-short-name }
    .accesskey = S
...
email-picker-label =
    ...
    .accesskey = a
email-picker-description = Locul persoanelor de contact noi salvate din mesajele trimise.
...
attachment-label =
    ...
    .accesskey = m
edit-keywords-label =
    .label = Editează cuvintele-cheie…
    .accesskey = K
offer-share-large-files-label =
    .label = Oferă partajarea de fișiere prin link când depășesc:
...
exceptions-button =
    .label = Excepții…
    .accesskey = E
remote-content-privacy-info = Află mai multe despre problemele de confidențialitate ale conținutului de la distanță
remote-content-info =
...
search-preferences-input2 =
    ...
    .style = width: 15.4em
managed-by-organization-notice = { -brand-short-name } este gestionat de o organizație.
...
accent-color-legend = Culoare de accent
accent-color-selection-label =
    .value = Selectează culoarea pentru butonul principal și evidențieri
accent-color-label =
    .value = Definește culoarea folosită pentru butoanele principale și elementele evidențiate:
accent-color-os =
    .label = Conform sistemului de operare
accent-color-thunderbird =
    .label = Albastru Thunderbird
accent-color-purple =
    .label = Purpuriu
accent-color-orange =
    .label = Portocaliu
...
accent-color-teal =
    .label = Turcoaz
accent-color-disabled-description = Culorile de accent nu sunt acceptate în modul de Contrast ridicat.
default-message-list-legend = Listă de mesaje
appearance-view-style-select =
    .value = Selectează stilul de vizualizare:
appearance-view-style =
    .value = Stil de vizualizare:
appearance-radio-table =
    .label = Vizualizare tip tabel
appearance-radio-card-view =
    .label = Vizualizare tip cartelă
card-view-options-legend = Opțiuni vizualizare tip cartelă
...
default-message-list-new-folders-description = Selectează sortarea implicită și opțiunile pentru fire de conversație pentru dosarele noi
...
default-sort-by-label = Sortează mesajele după:
...
default-sort-newest-bottom =
    .label = Mesaje noi în partea de jos
default-sort-new-messages-top =
    .label = Mesaje noi în partea de sus
apply-view-settings-label = Aplică aceste setări de vizualizare în:
apply-view-settings-to-all-folders-button =
    .label = Toate dosarele și subdosarele
    .accesskey = A
select-apply-sort-folders-button =
    .label = Selectează dosarele
    .accesskey = S
