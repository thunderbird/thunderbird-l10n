...
connection-internet-proxy-legend = Conexiune la internet și proxy
connection-proxy-legend = Configurează proxyuri pentru accesul la internet
proxy-type-no =
    .label = Fără proxy
    .accesskey = y
proxy-autodetect-network =
    .label = Depistează automat proxy-ul de rețea
    .accesskey = w
proxy-type-wpad =
...
proxy-type-system =
    ...
    .accesskey = u
proxy-manual-setup =
    .label = Configurare manuală proxy:
    .accesskey = m
proxy-type-manual =
...
http-port-label =
    ...
    .accesskey = P
proxy-https-sharing =
    .label = Folosește acest proxy pentru adrese web securizate (HTTPS)
    .accesskey = x
proxy-http-sharing =
...
proxy-auto-script-url =
    .label = URL script de configurare automată:
    .accesskey = A
proxy-type-auto =
...
no-proxy-addresses-label =
    .value = Nu folosi un proxy pentru aceste adrese:
    .accesskey = n
no-proxy-label =
...
connection-proxy-local-network-desc = Conexiunile din rețeaua locală (cum ar fi localhost) nu folosesc niciodată proxy.
proxy-auto-login-saved-password =
    .label = Autentificare automată dacă este salvată o parolă
    .tooltiptext = Opțiunea te autentifică silențios la proxy-uri când ai salvate date de autentificare pentru ele. Vei primi o atenționare dacă autentificarea eșuează.
    .accesskey = i
proxy-socks-remote-dns =
    .label = Rutează cererile de domeniu (DNS) prin proxy SOCKS v5
    .accesskey = d
# Do not translate "localhost", "127.0.0.1/8" and "::1". (You can translate "and".)
