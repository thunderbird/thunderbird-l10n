...
proxy-password-prompt =
    ...
    .accesskey = i
    .tooltiptext = Această opțiune te autentifică silențios la proxyurile pentru care ai credențiale salvate. Îți va fi solicitată autentificarea dacă aceasta eșuează.
proxy-remote-dns =
