...
oauth-reauthorize-title = Zugriff erneut autorisieren
...
oauth-reauthorize-description = { $hostname } benötigt eine erneute Zugriffsbestätigung, um die Synchronisation mit Ihrem Konto fortzusetzen. Benutzername: { $username }
