...
general-email-notifications-header = E-Mail-Benachrichtigung
...
general-files-and-attachment-description = Legen Sie fest, welche Dateien auf Ihrem Computer gespeichert werden und an welchem Speicherort.
general-tags-header = Schlagwörter
general-reading-and-viewing-header = Lesen & Ansehen
general-reading-and-display-header = Lesen & Ansicht
general-updates-header = Updates
general-network-and-storage-header = Netzwerk und Speicherung
general-search-performance-label = Suche & Leistung
compose-writing-emails-header = E-Mails verfassen
...
compose-message-formatting-title = Nachrichtenformatierung
compose-address-autocomplete-header = Adressen-Autovervollständigen
...
collection-improve-header = Daten zur Verbesserung von { -brand-short-name }
collection-community-description = { -brand-short-name } wird von einer weltweiten Gemeinschaft entwickelt. Wenn Sie anonyme Leistungsdaten teilen, können wir Fehler schneller beheben und die Anwendung für alle beschleunigen.
collection-privacy-policy = Lesen Sie unsere Datenschutzrichtlinie
collection-data-sharing-off = <strong>Die Weitergabe von Daten ist deaktiviert.</strong> Bisherige Nutzungsdaten werden innerhalb von 30 Tagen dauerhaft von den Servern von { -vendor-short-name } gelöscht.
...
collection-share-performance =
    .label = Anonyme Leistungsdaten an { -vendor-short-name } senden
    .accesskey = y
collection-share-performance-description = (Umfasst grundlegende technische Angaben wie Ihr Betriebssystem, die Speichernutzung und die Nutzung von Funktionen. { -brand-short-name } erfasst niemals E-Mail-Inhalte, Kontakte oder persönliche Nachrichten.)
...
collection-share-crash-data =
    .label = Anonyme Absturzberichte an { -vendor-short-name } übermitteln
    .accesskey = c
...
privacy-security-certificates-title = Sicherheitszertifikate
...
choose-display-language-description = Wählen Sie die Sprache für Menüs, Schaltflächen und Benachrichtigungen.
...
manual-storage-limit-label =
    .label = Speicherlimit für temporäre Dateien manuell festlegen
    .accesskey = m
clear-temp-files-button =
    .label = Temporäre Dateien löschen
    .accesskey = e
clear-temp-files-shutdown-label =
    .label = Temporäre Dateien beim Schließen von { -brand-short-name } löschen
    .accesskey = T
...
show-start-page-label =
    .label = Beim Start von { -brand-short-name } die Startseite anzeigen
    .accesskey = m
start-page-label =
...
start-in-tray-label =
    ...
    .accesskey = s
new-message-arrival-legend = Beim Eingang einer neuen Nachricht:
...
mail-play-button =
    .label = Probe hören
    .accesskey = P
change-dock-icon-description = App-Symbole und Benachrichtigungen
change-dock-icon = Einstellungen für App-Symbol ändern
app-icon-options =
    .label = Optionen für App-Symbol…
    .accesskey = D
new-email-alert-label =
    .label = Benachrichtigung bei neuen E-Mails anzeigen
    .accesskey = s
customize-alerts-label =
    .label = Benachrichtigungen anpassen…
    .accesskey = c
...
use-custom-sound-label =
    .label = Benutzerdefinierten Klang für Benachrichtigungen verwenden
    .accesskey = u
mail-select-audio-button =
    .label = Audiodatei auswählen…
    .accesskey = A
enable-global-search-label =
    .label = Kontenübergreifende E-Mail-Suche aktivieren
    .accesskey = e
gloda-results-plain-list-label =
    .label = Suchergebnisse in einer einfachen Liste anzeigen
    .accesskey = L
...
gloda-show-results-as-list-label =
    .label = Globale Suchergebnisse standardmäßig als Liste anzeigen
    .accesskey = L
datetime-formatting-legend = Datums- und Uhrzeitformat
display-language-legend = Sprache der Benutzeroberfläche
allow-graphics-accel =
    .label = Grafikbeschleunigung für flüssigeres Scrollen und bessere Leistung verwenden
    .accesskey = h
storage-format-label =
    .value = Speicherformat für neue Konten:
    .accesskey = t
...
hide-titlebar-label =
    .label = Titelleiste ausblenden
    .accesskey = d
hide-titlebar-description = Blendet die Titelleiste mit dem Fensternamen aus, um Bildschirmplatz zu sparen
hide-tabbar-single-tab-label =
    .label = Tab-Leiste ausblenden, wenn nur ein einziger Tab geöffnet ist
    .accesskey = T
auto-hide-tabbar-second-tab-description = Blendet Tabs automatisch aus, bis Sie einen zweiten Tab öffnen.
system-settings-legend = Systemeinstellungen
...
edit-defaults-apps-button =
    .label = Standardeinstellungen bearbeiten…
    .accesskey = u
...
update-settings-title = Aktualisierungseinstellungen
install-updates-automatically-label =
    .label = Updates automatisch installieren (empfohlen)
    .accesskey = U
install-updates-automatically-description = Schützt { -brand-short-name } mit den neuesten Sicherheitsupdates.
check-updates-ask-label =
    .label = Nach Updates suchen, Installation jedoch erst nach Bestätigung starten
    .accesskey = c
...
connection-config-description = Festlegen, wie sich { -brand-short-name } mit dem Internet verbindet.
connection-options-button =
    .label = Verbindungseinstellungen…
    .accesskey = s
offline-mode-legend = Offline-Modus
offline-settings-label = Offline-Einstellungen
...
offline-settings-button =
    .label = Offline…
    .accesskey = O
temporary-storage-legend = Temporäre Speicherung
offline-compact-remove-deleted =
    .label = Daten aus Ordnern entfernen, wenn sie bereits gelöscht wurden, um Speicherplatz freizugeben
    .accesskey = a
offline-compact-ask-cleanup =
    .label = Vor dem Bereinigen von Ordnern nachfragen
    .accesskey = B
...
use-cache-before =
    ...
    .accesskey = U
use-temp-storage-after = MB Speicherplatz für temporäre Dateien
...
underline-text-links-label =
    .label = Textlinks in Nachrichten unterstreichen
    .accesskey = k
...
convert-emoticons-label =
    ...
    .accesskey = m
display-text-formatting-label = Formatierung für Zitate
...
search-content-types =
    .placeholder = Inhaltstypen durchsuchen
...
always-ask-label =
    ...
    .accesskey = J
use-tags-text = Schlagwörter zum Kategorisieren und Priorisieren von Nachrichten verwenden
...
mark-read-when-opened =
    .label = Sofort nach dem Öffnen
    .accesskey = o
show-attachments-inline-label =
    .label = Anhänge direkt im Nachrichtentext anzeigen
    .accesskey = m
mark-read-no-delay =
...
mark-read-after-viewing =
    .label = Nach einer Anzeigedauer von
    .accesskey = v
...
display-name-only-label =
    .label = Bei Kontakten im Adressbuch nur den Anzeigenamen anzeigen
    .accesskey = s
...
show-conversation-view-label =
    .label = Gesprächsansicht anzeigen
    .accesskey = c
conversation-view-preview-description = Diese Funktion befindet sich noch in einer frühen Vorschauphase. Sie fasst zusammengehörige Nachrichten zusammen, funktioniert aber möglicherweise nicht immer wie erwartet.
...
dark-mode-message-appearance = Nachrichtendarstellung
dark-mode-checkbox-label =
    .label = Nachrichtentext im Dunkelmodus anzeigen
    .accesskey = d
dark-mode-message-text-description = Zeigt alle eingehenden Nachrichten vor einem dunklen Hintergrund an, selbst wenn der Absender helle Farben verwendet hat.
...
dark-message-mode-toggle-label =
    ...
    .accesskey = t
dark-mode-toggle-description = Ermöglicht es Ihnen, eine E-Mail beim Lesen schnell wieder im hellen Modus anzuzeigen, ohne Ihre Haupteinstellungen zu ändern.
general-folder-settings-header = Ordnereinstellungen
recent-folders-legend = Zuletzt verwendete Ordner
recent-folders-description = Legt fest, wie zuletzt verwendete Ordner beim Verschieben von Nachrichten angezeigt werden.
...
general-folder-options-header = Ordnerverwaltungsoptionen
recent-destinations-legend = Letzte Ziele
recent-destinations-description = Optionen zum Auflisten und Sortieren von Ordnern, in die kürzlich Nachrichten verschoben wurden.
recent-sort-order-label = Sortierreihenfolge:
    .accesskey = S
recent-sort-order-mru =
    .label = Neueste
recent-sort-order-alphabetic =
    .label = Alphabetisch
max-recent-label = Maximale Anzahl kürzlich verwendeter Ordner:
    .accesskey = M
...
account-hub-manual-config-checkbox-label =
    .label = Verwenden Sie die neue manuelle Konfiguration in der Kontenverwaltung
    .accesskey = K
account-hub-manual-config-checkbox-description = Neue manuelle Konfiguration der Kontenverwaltung
new-calendar-legend = Dialog für neuen Kalendereintrag
new-calendar-checkbox-label =
    .label = Kalendereinträge im neuen Dialog anzeigen
new-calendar-checkbox-description = Experimenteller neuer Kalender-Dialog zum Anzeigen von Einträgen
...
as-attachment-label =
    .label = Als Anhang
add-file-type-label =
    .label = Dateityp bei angehängten Nachrichten ergänzen
    .accesskey = e
extension-label =
    .label = Dateinamenserweiterung hinzufügen
    .accesskey = D
forward-messages-label =
    .value = Nachrichten weiterleiten als:
    .accesskey = a
forward-inline-label =
    .label = Im Nachrichtentext (inline)
...
autosave-draft-label =
    .label = Entwurf automatisch speichern alle
    .accesskey = a
...
spellcheck-while-typing-label =
    .label = Rechtschreibung während der Eingabe prüfen
    .accesskey = e
...
ignore-sender-styles-label =
    .label = Schriftarten und Farben des Absenders ignorieren
    .accesskey = d
...
paragraph-spacing-label =
    .label = Mit der Eingabetaste beginnen Sie einen neuen Absatz mit zusätzlichem Abstand
    .accesskey = A
...
compose-format-automatic-description = Formatierten Text senden, wenn Sie Formatierungen wie Fettdruck oder Links verwenden, andernfalls reinen Text.
compose-format-both-option =
    .label = Rich Text (HTML) und normalen Text
compose-format-both-description = Immer beide Versionen senden, sodass die E-Mail-Anwendung des Empfängers die passende Darstellung auswählen kann.
compose-format-html-option =
    .label = Nur Rich Text (HTML)
compose-format-html-description = Behält benutzerdefinierte Schriftarten, Farben und Bilder bei, wird aber in einigen älteren E-Mail-Anwendungen möglicherweise nicht korrekt dargestellt.
compose-format-plain-option =
    .label = Nur Reintext
compose-format-plain-description = Entfernt sämtliche Formatierungen, Farben und Bilder. Ideal für einfache Text-E-Mails, die überall funktionieren.
autocomplete-matches-description = Beim Eingeben des Namens oder der E-Mail-Adresse eines Empfängers nach Treffern suchen in:
company-network-directory-label =
    .label = Unternehmens- oder Netzwerkverzeichnis
    .accesskey = c
directory-server-label =
    .label = Verzeichnisserver
    .accesskey = V
...
collect-outgoing-label =
    ...
    .accesskey = A
collect-outgoing-description = Speicherort für neue Kontakte, die manuell erstellt oder aus E-Mails übernommen werden.
save-added-contacts-label =
    .value = Manuell hinzugefügte Kontakte speichern in:
    .accesskey = M
save-added-contacts-description = Speicherort für neue Kontakte aus E-Mails.
show-directory-startup-label =
    .value = Beim Start von { -brand-short-name } diesen Ordner im Adressbuchfenster anzeigen
    .accesskey = s
...
email-picker-label =
    .label = Adressen beim Senden automatisch hinzufügen zu:
    .accesskey = A
email-picker-description = Die Adresse neuer Kontakte, die aus gesendeten Nachrichten gespeichert wurden.
default-add-address-book-label =
    .value = Standardadressbuch für manuell hinzugefügte Kontakte:
    .accesskey = d
default-add-address-book-description = Der Speicherort neuer Kontakte, die aus empfangenen Nachrichten gespeichert wurden.
...
attachment-label =
    ...
    .accesskey = u
edit-keywords-label =
    .label = Schlüsselwörter bearbeiten…
    .accesskey = S
offer-share-large-files-label =
    .label = Teilen per Link anbieten, wenn Dateien größer sind als:
...
exceptions-button =
    .label = Ausnahmen…
    .accesskey = A
remote-content-privacy-link = Auswirkungen externer Inhalte auf den Datenschutz
...
third-party-visited-only =
    .label = Nur von besuchten Websites
third-party-visited =
...
global-privacy-control-label =
    .label = Websites anweisen, persönliche Daten weder zu verkaufen noch weiterzugeben
    .accesskey = n
...
passwords-registered-description = { -brand-short-name } kann Passwörter für bestehende Konten speichern.
view-saved-passwords-button =
    .label = Gespeicherte Passwörter anzeigen…
    .accesskey = s
primary-password-session-description = Ein Hauptpasswort schützt alle gespeicherten Passwörter und muss einmal pro Sitzung eingegeben werden.
...
spam-accounts-description = Diese Einstellungen gelten für alle Konten. Optionen für einzelne Konten können in den Kontoeinstellungen geändert werden.
...
spam-move-folder-label =
    .label = In den Spam-Ordner verschieben
    .accesskey = O
...
spam-marked-manually-label =
    .label = Bei manueller Markierung
    .accesskey = m
spam-detected-auto-label =
    .label = Bei automatischer Erkennung durch { -brand-short-name }
    .accesskey = t
spam-log-keep-label =
    .label = Automatische Spam-Erkennung protokollieren
    .accesskey = e
...
reset-spam-button =
    ...
    .accesskey = r
scam-detection-description = { -brand-short-name } prüft Nachrichten auf Phishing-Links und typische Anzeichen für E-Mail-Betrug.
scam-detection-label =
    .label = Beim Lesen einer verdächtigen E-Mail warnen
    .accesskey = t
antivirus-check-description = Ermöglicht Antivirensoftware, eingehende Nachrichten einzeln zu prüfen, bevor sie auf Ihrem Computer gespeichert werden.
antivirus-isolate-label =
    .label = Antivirenprogrammen erlauben, infizierte eingehende E-Mails zu isolieren
    .accesskey = A
certificate-verify-description = Wenn ein Server ein Zertifikat zur Bestätigung Ihrer Identität anfordert:
certificate-choose-auto =
    .label = Zertifikat automatisch auswählen
    .accesskey = h
certificate-ask-every =
    .label = jedes Mal nachfragen
    .accesskey = a
ocsp-check-label =
    .label = Zertifikatsprüfserver (OCSP) abfragen, um die Gültigkeit von Zertifikaten zu bestätigen.
    .accesskey = v
...
email-e2ee-accounts-info = Verschlüsselte E-Mails können nur von Ihnen und den Empfängern gelesen werden. Richten Sie E-Mail-Konten und Identitäten für die Ende-zu-Ende-Verschlüsselung in den <a data-l10n-name="account-settings-url">Kontoeinstellungen</a> ein.
...
email-e2ee-automatism-intro = { -brand-short-name } kann die Verschlüsselung automatisch aktivieren, wenn für alle Empfänger einer Nachricht gültige, akzeptierte Schlüssel oder Zertifikate verfügbar sind.
email-e2ee-turn-on =
    .label = Verschlüsselung nach Möglichkeit automatisch aktivieren
email-e2ee-turn-off =
    .label = Verschlüsselung automatisch deaktivieren, wenn sich die Empfängerliste ändert und keine Verschlüsselung mehr möglich ist
email-e2ee-turn-off-notify =
    .label = Benachrichtigung anzeigen, wenn die Verschlüsselung automatisch deaktiviert wird
email-e2ee-automatism-note = Hinweis: Beim Verfassen einer Nachricht können Sie die Verschlüsselung auch manuell ein- oder ausschalten. Beim Antworten auf eine verschlüsselte Nachricht wird die Verschlüsselung immer aktiviert.
...
remote-content-images-label =
    .label = Externe Inhalte zulassen (Bilder und Formatierungen)
    .accesskey = m
...
preferences-doh-setting-automatic =
    .label = Automatischer Schutz (empfohlen)
    .accesskey = p
preferences-doh-automatic-desc = { -brand-short-name } verschlüsselt Adressabfragen automatisch, sofern möglich. Bei Verbindungsproblemen oder wenn ein VPN bzw. ein verwaltetes Netzwerk dies erfordert, werden wieder standardmäßige Netzwerkabfragen verwendet.
...
preferences-doh-setting-enabled =
    ...
    .accesskey = E
preferences-doh-increased-desc = Verwendet immer den ausgewählten Anbieter. Nutzt die Standardverbindung nur, wenn der sichere Anbieter nicht erreichbar ist.
...
preferences-doh-setting-maximum =
    ...
    .accesskey = M
preferences-doh-maximum-desc = Erfordert ausnahmslos verschlüsseltes DNS. Websites werden nicht geladen, wenn die sichere Verbindung fehlschlägt.
...
preferences-doh-setting-off =
    .label = Aus
    .accesskey = A
preferences-doh-off-standard-desc = Verwendet den üblichen Internetanbieter oder das Netzwerk, um Webadressen aufzulösen
...
preferences-doh-url-custom =
    ...
    .accesskey = B
preferences-doh-secure-header = Sicheres DNS (DNS über HTTPS)
preferences-doh-secure-description = Sicheres DNS verschlüsselt die von { -brand-short-name } gesendeten Anfragen zum Auffinden von Websites und schützt so Ihre Surfaktivitäten vor der Überwachung im Netzwerk.
...
search-preferences-input2 =
    ...
    .style = width: 15.4em
managed-by-organization-notice = { -brand-short-name } wird durch eine Organisation verwaltet.
...
qr-export-passwords-legend = Passwörter
qr-export-include-passwords-label = Kontopasswörter in den QR-Code aufnehmen
qr-export-web-sign-in-note = <strong>Hinweis:</strong> Bei Konten mit Web-Anmeldung (z. B. Gmail oder Yahoo) müssen Sie sich auf Ihrem Gerät erneut authentifizieren.
qr-export-private-transfer-note = <strong>Private Übertragung:</strong> Ihre Einstellungen und Passwörter werden direkt von diesem Computer auf Ihr Smartphone übertragen. Dabei werden keine Daten an Mozilla-Server gesendet oder dort gespeichert.
qr-export-screen-privacy-tip = <strong>Tipp:</strong> Schützen Sie Ihren Bildschirm vor fremden Blicken, solange der QR-Code angezeigt wird.
...
qr-export-pane-header-mobile = Auf { -brand-product-name } für Mobilgeräte exportieren
qr-export-description-email-accounts = Übertragen Sie Ihre E-Mail-Konten per QR-Code von diesem Computer auf { -brand-product-name } auf Ihrem Smartphone.
qr-export-get-app-google-play = <a data-l10n-name="app-link">{ -brand-product-name } bei Google Play herunterladen</a>
qr-export-select-accounts-title = Zu exportierende Konten auswählen:
qr-export-missing-accounts-support = Fehlt ein Konto? Konten, die { -brand-product-name } für Android nicht unterstützt, können nicht ausgewählt werden. <a data-l10n-name="account-support-link">Unterstützte Kontotypen anzeigen</a>
...
accent-color-selection-label =
    .value = Farbe für primäre Schaltflächen und Hervorhebungen auswählen
accent-color-label =
...
appearance-view-style-select =
    .value = Darstellungsart auswählen:
...
appearance-radio-card-view =
    .label = Kartenansicht
card-view-options-legend = Einstellungen für die Kartenansicht
...
default-message-list-new-folders-description = Standardsortierung und Konversationsansicht für neue Ordner festlegen
...
default-sort-by-label = Nachrichten sortieren nach:
...
default-sort-newest-bottom =
    .label = Neueste Nachrichten zuletzt
default-sort-new-messages-top =
    .label = Neueste Nachrichten zuerst
apply-view-settings-label = Diese Darstellungseinstellungen gelten für:
apply-view-settings-to-all-folders-button =
    .label = Alle Ordner und Unterordner
    .accesskey = A
