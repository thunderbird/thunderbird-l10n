...
default-app-intro = { -brand-short-name } als Standard-Anwendung verwenden für:
...
checkbox-net-thunderbird-url-label =
    .label = Benutzerdefinierte Thunderbird-Links (net.thunderbird://)
    .tooltiptext = { unset-default-tooltip }
...
check-on-startup-label =
    ...
    .accesskey = B
system-settings-dialog-title = Systemeinstellungen
