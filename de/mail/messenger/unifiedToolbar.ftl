...
search-bar-placeholder-search-shortcut =
    { PLATFORM() ->
       ...
       *[other] <kbd>Strg</kbd>+<kbd>K</kbd>
    }
# This is the empty text for the quick filter text search box.
# The goal is to convey to the user that typing in the box will filter the
# messages and that there is a hotkey they can press to get to the box faster.
search-bar-placeholder-with-key = Suchen… { search-bar-placeholder-search-shortcut }
...
customize-search-bar2 =
    ...
    .placeholder = Schaltflächen der Suchwerkzeugleiste…
