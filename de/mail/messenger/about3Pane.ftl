...
folder-pane-header-toggle-full-path =
    .label = Vollständigen Pfad anzeigen
folder-pane-header-hide-local-folders =
    .label = Lokale Ordner verstecken
folder-pane-mode-header-all = Alle Ordner
folder-pane-mode-header-unread = Ungelesene Ordner
folder-pane-mode-header-favorite = Favoriten-Ordner
folder-pane-mode-header-recent = Letzte Ordner
folder-pane-mode-header-smart = Gruppierte Ordner
folder-pane-mode-header-tags = Schlagwörter
...
threadpane-column-header-a11y-select =
    .aria-label = Nachrichten auswählen
...
folder-pane-context-reset-sort =
    .label = Ordnerreihenfolge zurücksetzen
    .accesskey = r
# Variables:
