...
looking-for-messages-folder = Es wird nach neuen Nachrichten für { $accountName } gesucht…
...
# $folderName (String) - The folder's name.
deleting-messages = { $number } Nachricht(en) aus { $ordnerName } werden gelöscht…
