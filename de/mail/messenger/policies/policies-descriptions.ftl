...
policy-DisableChat = Chat-Funktion deaktivieren.
policy-DisableCommunity = Gemeinschafts-Funktionen in der Benutzeroberfläche ausblenden (z.&thinsp;B. Spenden, Mitmachen, Ideen teilen usw.)
...
policy-DisableFileLink = Filelink-Funktion deaktivieren
...
policy-DisableMessageForwardingFilters = Nachrichtenfilter an der automatischen Weiterleitung von Nachrichten hindern
...
policy-DisableUpdateSettings = Verhindert, dass Benutzer die Einstellungen für Anwendungs-Updates ändern.
