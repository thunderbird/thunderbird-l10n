...
toolbar-spam =
    .title = Gewählte Nachrichten als Spam einstufen
toolbar-not-spam-label = Kein Spam
toolbar-not-spam =
    .title = Gewählte Nachrichten als „Kein Spam“ einstufen
...
toolbar-add-address-book-label = Adressbuch hinzufügen
