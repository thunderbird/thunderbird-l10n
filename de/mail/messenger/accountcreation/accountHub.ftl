...
account-hub-servers-username-label = Benutzername:
account-hub-result-server-label = Server:
account-hub-result-port-label = Port:
account-hub-result-security-label = Sicherheit:
account-hub-result-authentication-type-label = Authentifizierung:
account-hub-result-authentication-none = Keine
    .title = Keine
account-hub-result-authentication-password = Normales Passwort
    .title = Normales Passwort
account-hub-result-authentication-encrypted-password = Verschlüsseltes Passwort
    .title = Verschlüsseltes Passwort
...
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = Keine
account-hub-result-auth-password = Passwort, normal
account-hub-result-auth-encrypted-password = Verschlüsseltes Passwort
...
account-hub-exchange-service-url-label = Geben Sie die URL des Dienstes ein
...
account-hub-password-label = Passwort
    .title = Freiwillig, wird zur Bestätigung des Benutzernamens verwendet
    .accesskey = P
account-hub-remember-password = Passwort speichern
    .accesskey = s
account-hub-exchange-label = Ihr Benutzername
    .accesskey = B
account-hub-installing-addon = Add-on wird heruntergeladen und installiert…
account-hub-success-addon = Add-on erfolgreich installiert
account-hub-success-half-manual = Folgende Einstellungen wurden durch Untersuchen des genannten Servers gefunden:
account-hub-result-security-no-encryption = Keine Verschlüsselung
    .title = Keine Verschlüsselung
...
account-hub-confirm-advanced-description = Dieser Dialog wird geschlossen und ein Konto wird basierend auf den derzeitigen Einstellungen erstellt, selbst wenn diese fehlerhaft sind. Wollen Sie fortfahren?
account-hub-addon-install-title = Installieren
...
account-hub-manual-config-imap-title = IMAP-Einstellungen
account-hub-manual-config-pop3-title = POP3-Einstellungen
account-hub-manual-config-review-settings-title = Aktualisierte Einstellungen überprüfen
account-hub-manual-config-incoming-legend = Posteingangs-Server
...
account-hub-oauth-unsupported-title = Zusätzliche Konfiguration ist erforderlich
# Note: 'Advanced configuration' is the text of the link/button at the bottom of the form (e.g., account-hub-exchange-type-advanced-config)
# 'Account Settings' is the text of the menu option/tab name accessible outside Account Hub
account-hub-oauth-unsupported-description = { -brand-short-name } kann OAuth2 für diesen Hostnamen nicht automatisch konfigurieren. Wählen Sie Erweiterte Konfiguration, um das Konto zu erstellen, schließen Sie dann die Einrichtung in den Konto-Einstellungen ab. <a data-l10n-name="oauth-support-link">Holen Sie sich Hilfe bei der OAuth2-Einrichtung.</a>
account-hub-username-help-text = Häufig Ihre vollständige E-Mail-Adresse
account-hub-port-help-text = Wenn Sie das Feld leer lassen, versucht { -brand-short-name }, den Port automatisch zu ermitteln.
...
account-hub-result-graph-api-description = Verwenden Sie die Microsoft-Graph-API, um Ihre Ordner und E-Mails mit Microsoft 365 zu synchronisieren
account-hub-result-graph-shortname = Exchange (Graph)
account-hub-result-graph-description = Verwenden Sie die Microsoft-Graph-API, um Ihre Ordner und E-Mails zu synchronisieren
...
account-hub-result-ews-expanded-text = Exchange-Web-Dienste
...
account-hub-config-success-title = Kontoeinstellungen automatisch gefunden.
account-hub-config-success-description-db = Konfiguration in Mozilla ISPDB gefunden.
account-hub-config-success-description-exchange = Einstellungen für Microsoft Exchange-Server wurden gefunden.
account-hub-config-success-description-guess = Einstellungen wurden durch Ausprobieren typischer Serverbezeichnungen gefunden
account-hub-config-success-description-disk = Einstellungen wurden in der { -brand-short-name }-Installation gefunden.
...
account-hub-manual-config-error-summary = Bitte beheben Sie die folgenden Fehler:
...
account-hub-select-security-warning = <span data-l10n-name="error-text">Warnung: Unsicherer Mail-Server erkannt.</span> Dieser Server ist nicht verschlüsselt, sodass Ihr Passwort und Ihre Daten offengelegt werden. Kontaktieren Sie Ihren Administrator, um die Verbindung zu sichern oder fahren Sie auf eigene Gefahr fort. <a data-l10n-name="error-link">Weitere Informationen finden Sie in den FAQ.</a>
...
address-book-add-remote-icon2 =
    .alt = Externes Adressbuch hinzufügen
address-book-add-remote-icon =
    .alt = Ein neues externes Adressbuch hinzufügen
address-book-add-remote = Externes Adressbuch hinzufügen
address-book-add-remote-carddav-description = Mit CardDAV-Adressbuch verbinden
...
address-book-add-ldap-icon2 =
    .alt = Ein LDAP-Adressbuch hinzufügen
address-book-add-ldap-button = LDAP-Adressbuch hinzufügen
...
account-hub-card-graph-description = Microsoft Graph ist eine moderne Verbindungsmethode für Microsoft 365.
account-hub-card-ews-title = Exchange-Web-Dienste
account-hub-card-ews-tag = Veraltet
account-hub-card-ews-description = Exchange-Web-Dienste (EWS) verbindet sich mit Microsoft Exchange, um Ihre Mails zu synchronisieren.
# This is shown after the type description, so "it" is referring to the type (either Microsoft Graph or Exchange Web Services).
account-hub-card-recommended-description = Sie wird empfohlen, da sie mit Ihrer Dienst-URL übereinstimmt.
account-hub-exchange-type-username = Benutzername
account-hub-exchange-type-username-hint = Üblicherweise Ihre E-Mail-Adresse oder der Active-Directory-UPN.
account-hub-exchange-type-authentication = Authentifizierungsmethode
# Checkbox that can be unchecked to use a custom OAuth config.
account-hub-exchange-type-default-oauth = Standard-Microsoft-365-Copilot-Authentifizierungseinstellungen verwenden
account-hub-exchange-type-oauth-tenant = Tenant-ID
account-hub-exchange-type-oauth-app = App-ID
account-hub-exchange-type-title = Wählen Sie einen Kontotyp
