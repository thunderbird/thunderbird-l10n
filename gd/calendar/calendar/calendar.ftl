...
calendar-task-input-filter-field =
    .aria-label = Criathraich na saothraichean
...
calendar-search-options-searchfor =
    .value = anns a bheil
calendar-properties-dialog-title = Deasaich am mìosachan
calendar-server-dialog-name-label =
    .value = Ainm a' mhìosachain:
calendar-publish-dialog-window-title = Foillsich mìosachan
calendar-publish-url-label = An URL foillseachaidh
calendar-publish-publish-dialog-button =
    .buttonlabelaccept = Foillsich
...
calendar-error-description =
    .value = Tuairisgeul:
calendar-error-prompt-title = Thachair mearachd
