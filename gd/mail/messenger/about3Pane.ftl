...
threadpane-column-header-a11y-id =
    .aria-label = An t-òrdugh san d' fhuaradh iad
...
threadpane-column-header-a11y-select =
    .aria-label = Tagh teachdaireachdan
