...
menu-move-to-folder-again =
    .label = Gluais gu "{ $folderName }" a-rithist
    .accesskey = t
# Variables:
# $folderName (String) - The name of the folder to which the message(s) will be copied.
# Note: The access key should be a letter that occurs before $folderName in the translated string.
menu-copy-to-folder-again =
    .label = Cuir lethbhreac dheth gu "{ $folderName }" a-rithist
    .accesskey = t
menu-move-to =
    .label = Gluais gu
    .accesskey = G
...
message-priority-lowest = As ìsle
message-priority-low = Ìseal
# Normal priority is often blank, depending on the consumers of these strings.
message-priority-normal = Àbhaisteach
message-priority-high = Àrd
message-priority-highest = As àirde
message-flag-replied = Air freagairt ris
message-flag-forwarded = Air a shìneadh air adhart
message-flag-redirected = Air ath-stiùireadh
message-flag-new = Ùr
message-flag-read = Air a leughadh
message-flag-starred = Le rionnag ris
# Grouped By Date thread pane titles
message-group-today = An-diugh
message-group-yesterday = An-dè
message-group-last-seven-days = Na 7 làithean seo chaidh
message-group-last-fourteen-days = An cola-deug seo chaidh
message-group-older = Seann-phost
message-group-future-date = San àm ri teachd
# Different Grouped By Sort thread pane titles
message-group-untagged = Teachdaireachdan gun taga
message-group-no-status = Gun chor
message-group-no-priority = Gun phrìomhachas
message-group-no-attachments = Gun cheanglachan
message-group-attachments = Ceanglachain
message-group-not-starred = Gun rionnag
message-group-starred = Le rionnag ris
...
tags-label-1 = Cudromach
tags-label-2 = Obair
tags-label-3 = Pearsanta
tags-label-4 = Ri dhèanamh
tags-label-5 = An ceann tamaill
tags-add-new =
    .label = Taga ùr…
    .accesskey = T
tags-manage =
    ...
    .accesskey = S
tags-remove-all =
    .label = Thoir air falbh a h-uile taga
    .accesskey = 0
# Variables:
