...
calendar-task-filter-next7days =
    .label = Na Seacht Lá Romhainn
    .accesskey = N
calendar-task-filter-notstarted =
    .label = Tascanna Gan Tosú
    .accesskey = a
calendar-task-filter-overdue =
    .label = Tascanna Déanacha
    .accesskey = D
calendar-task-filter-completed =
    .label = Tascanna Críochnaithe
    .accesskey = C
calendar-task-filter-open =
    .label = Tascanna Neamhiomlána
    .accesskey = m
...
calendar-task-filter-current =
    .label = Tascanna Reatha
    .accesskey = R
calendar-task-details-title = teideal
calendar-task-details-organizer = ó
calendar-task-details-priority = tosaíocht
calendar-task-details-priority-low = Íseal
calendar-task-details-priority-normal = Gnáth
calendar-task-details-priority-high = Ard
calendar-task-details-status = stádas
calendar-task-details-category = catagóir
calendar-task-details-repeat = athdhéanamh
calendar-task-details-attachments = iatáin
calendar-task-details-start = dáta tosaithe
calendar-task-details-due = dáta dlite
calendar-task-mark-completed =
    .label = Marcáil "Críochnaithe"
    .accesskey = o
    .tooltiptext = Marcáil na tascanna roghnaithe mar chríochnaithe
calendar-task-change-priority =
    .label = Tosaíocht
    .accesskey = T
    .tooltiptext = Athraigh an tosaíocht
calendar-task-text-filter-field =
    .emptytextbase = Scag tascanna #1
...
calendar-progress-level-0 =
    .label = 0% Críochnaithe
    .accesskey = 0
calendar-progress-level-25 =
    .label = 25% Críochnaithe
    .accesskey = 2
calendar-progress-level-50 =
    .label = 50% Críochnaithe
    .accesskey = 5
calendar-progress-level-75 =
    .label = 75% Críochnaithe
    .accesskey = 7
calendar-progress-level-100 =
    .label = 100% Críochnaithe
    .accesskey = 1
...
calendar-properties-refresh =
    .value = Athnuaigh an Féilire:
calendar-properties-refresh-manual =
    .label = De Láimh
calendar-properties-read-only =
    .label = Inléite Amháin
calendar-properties-show-reminders =
    .label = Taispeáin Meabhrúcháin
calendar-properties-offline-support =
    .label = Tacaíocht As Líne
calendar-properties-provider-missing = Níorbh fhéidir soláthraí an fhéilire seo a aimsiú. Tarlaíonn sé seo go minic má tá breiseáin áirithe díchumasaithe nó díshuiteáilte agat.
...
calendar-newevent-button =
    .label = Imeacht Nua
    .tooltiptext = Cruthaigh imeacht nua
calendar-newtask-button =
    .label = Tasc Nua
    .tooltiptext = Cruthaigh tasc nua
calendar-unifinder-show-completed-todos =
    .label = Taispeáin tascanna críochnaithe
calendar-display-todos-checkbox =
    .label = Tascanna san Amharc
    .accesskey = c
calendar-completed-tasks-checkbox =
    .label = Taispeáin Tascanna críochnaithe
    .accesskey = c
calendar-only-workday-checkbox =
    .label = Laethanta oibre amháin
    .accesskey = r
calendar-orientation =
    .label = Rothlaigh an tAmharc
    .accesskey = o
calendar-todaypane-button =
    .label = Pána Inniu
    .tooltiptext = Taispeáin Pána Inniu
calendar-search-options-searchfor =
    .value = ina bhfuil
calendar-properties-dialog-title = Cuir Féilire in Eagar
calendar-server-dialog-title-edit =
    .title = Cuir Féilire in Eagar
calendar-server-dialog-name-label =
    .value = Ainm an Fhéilire:
calendar-publish-dialog-window-title = Foilsigh Féilire
calendar-publish-dialog-title =
    .title = Foilsigh Féilire
calendar-publish-url-label = URL Foilsithe
calendar-publish-publish-dialog-button =
    .buttonlabelaccept = Foilsigh
calendar-publish-close-button = Dún
calendar-select-dialog-title = Roghnaigh Féilire
...
calendar-error-description =
    .value = Cur Síos:
calendar-error-prompt-title = Tharla earráid
calendar-error-title =
    .title = Tharla earráid
calendar-extract-event-button =
    .label = Cuir leis mar imeacht
    .tooltiptext = Bain faisnéis faoin imeacht as an teachtaireacht agus cuir le d'fhéilire é
