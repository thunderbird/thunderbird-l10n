...
no-email-provider-error = Níl cumraíocht chuntais ríomhphoist in XML an chomhaid chumraíochta.
outgoing-not-smtp-error = Ní mór an freastalaí amach a bheith den chineál SMTP.

## ConfigVerifier.sys.mjs

cannot-login-error = Ní féidir logáil isteach ar an bhfreastalaí. Is é is dóichí go bhfuil an chumraíocht, an t-ainm úsáideora nó an focal faire mícheart.
