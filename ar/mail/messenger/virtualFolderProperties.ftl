...
virtual-folder-name = الاسم:
    .accesskey = س
virtual-folder-description = أنشئ كمجلد فرعي تحت:
    .accesskey = ف
virtual-folder-folder-selection-caption = اختر ملفات للبحث:
...
virtual-folder-search-online =
    ...
    .accesskey = ص
virtual-folder-search-term-caption = اضبط معايير البحث المُستخدمة في مجلد البحث المحفوظ هذا:
...
virtual-folder-list-title = اختر مجلدات
virtual-folder-list-desc = اختر مجلدات للبحث:
