...
folder-pane-get-all-messages-menuitem =
    ...
    .accesskey = ج
folder-pane-mode-header-all = كل المجلدات
folder-pane-mode-header-unread = المجلدات غير المقروءة
