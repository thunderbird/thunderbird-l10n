...
policy-DisableDataCollectionSettings = Tillad ikke denne bruger at ændre indstillinger for dataindsamling.
...
policy-DisableQRExport = Deaktiver generering af QR-koden til eksport af kontoindstillinger og loginoplysninger.
...
policy-DisableUpdateSettings = Tillad ikke brugeren at ændre indstillinger for programopdateringer.
