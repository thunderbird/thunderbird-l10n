...
general-folder-options-header = Indstillinger for mappehåndtering
recent-destinations-legend = Seneste mapper
recent-destinations-description = Indstillinger for visning og sortering af mapper, som meddelelser for nyligt er flyttet til.
recent-sort-order-label = Sorteringsrækkefølge:
    .accesskey = S
recent-sort-order-mru =
    .label = Seneste
recent-sort-order-alphabetic =
    .label = Alfabetisk
max-recent-label = Maks. antal seneste mapper
    .accesskey = M
...
account-hub-manual-config-checkbox-label =
    .label = Brug den nye manuelle konfigurationsproces i Kontocenter
    .accesskey = k
account-hub-manual-config-checkbox-description = Ny manuel konfigurationsproces i Kontocenter
...
email-picker-label =
    ...
    .accesskey = A
email-picker-description = Placeringen af nye kontakter gemt fra sendte meddelelser.
default-add-address-book-label =
    .value = Standardadressebog for manuelt tilføjede kontakter:
    .accesskey = S
default-add-address-book-description = Placeringen af nye kontakter gemt fra modtagne meddelelser.
...
accent-color-legend = Accentfarve
accent-color-label =
    .value = Bestem farven, der bruges til de vigtigste knapper og fremhævede elementer:
accent-color-os =
...
accent-color-teal =
    .label = Blågrøn
accent-color-disabled-description = Accentfarver understøttes ikke i højkontrast-tilstand.
