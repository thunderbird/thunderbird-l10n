...
quick-filter-bar-tag-mode-none =
    .label = Kun uden mærkater
    .title = Kun meddelelser uden mærkater
...
folder-pane-mode-header-unread = Ulæste mapper
folder-pane-mode-header-favorite = Favoritmapper
folder-pane-mode-header-recent = Seneste mapper
folder-pane-mode-header-smart = Samlede mapper
folder-pane-mode-header-tags = Mærkater
