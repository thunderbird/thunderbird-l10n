...
account-hub-servers-username-label = Brugernavn:
...
account-hub-result-authentication-none = Ingen
    .title = Ingen
account-hub-result-authentication-password = Almindelig adgangskode
    .title = Almindelig adgangskode
account-hub-result-authentication-encrypted-password = Krypteret adgangskode
    .title = Krypteret adgangskode
account-hub-result-authentication-gssapi = Kerberos
    .title = Kerberos
account-hub-result-authentication-ntlm = NTLM
    .title = NTLM
account-hub-result-authentication-external = Eksternt
    .title = Eksternt
...
account-hub-result-auth-external = Eksternt
...
account-hub-email-label = Mailadresse
    .accesskey = M
account-hub-email-input =
    .placeholder = jane.hansen@eksempel.dk
account-hub-email-warning-icon =
    .title = Ugyldig mailadresse
account-hub-password-label = Adgangskode
    .accesskey = d
    .title = Valgfri, vil kun blive brugt til at validere brugernavnet
account-hub-remember-password = Husk adgangskode
    .accesskey = H
account-hub-exchange-label = Dit login
    .accesskey = l
account-hub-installing-addon = Henter og installerer tilføjelse…
account-hub-success-addon = Tilføjelsen blev installeret
account-hub-success-half-manual = Følgende indstillinger blev fundet ved at forespørge serveren:
...
account-hub-credentials-wrong = Godkendelse mislykkedes. Kontroller brugernavn og adgangskode
...
account-hub-config-success-title = Kontoindstillinger fundet automatisk.
account-hub-config-success-description-db = Konfiguration fundet i Mozilla ISPDB.
account-hub-config-success-description-exchange = Fandt konfiguration for en Microsoft Exchange-server.
account-hub-config-success-description-guess = Konfiguration fundet ved at prøve almindelige servernavne.
account-hub-config-success-description-disk = Konfiguration fundet i { -brand-short-name }-installation.
account-hub-config-success-description-isp = Konfiguration fundet hos mailudbyderen.
account-hub-config-success-description-read-more = Her kan du læse om, <a data-l10n-name="automated-setup-link">hvordan automatisk mail-opsætning fungerer.</a>
...
account-hub-select-security-warning = <span data-l10n-name="error-text">Advarsel: Usikker mailserver registreret.</span> Denne server benytter ikke kryptering, hvilket eksponerer din adgangskode og data. Kontakt din administrator for at sikre forbindelsen eller accepter risikoen og fortsæt. <a data-l10n-name="error-link">Se mere i FAQ.</a>
