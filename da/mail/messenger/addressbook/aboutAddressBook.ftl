...
address-book-list =
    .aria-label = Liste over adressebøger
...
about-addressbook-export-selected-filename = Kontakter
...
about-addressbook-photo-dialog-title =
    .aria-label = Administrer billedet for denne kontakt.
