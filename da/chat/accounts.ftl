...
account-manager-no-accounts-description = Klik på knappen { add-account-label } og lad { -brand-short-name } føre dig gennem processen med at konfigurere en.
...
add-account-label = Tilføj konto
