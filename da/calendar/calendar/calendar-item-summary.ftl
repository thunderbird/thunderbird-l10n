...
calendar-item-summary-status-tentative = Foreløbig
calendar-item-summary-status-confirmed = Bekræftet
calendar-item-summary-event-status-cancelled = Annulleret
calendar-item-summary-todo-status-cancelled = Annulleret
calendar-item-summary-status-needs-action = Skal håndteres
calendar-item-summary-status-in-process = Påbegyndt
calendar-item-summary-status-completed = Færdiggjort den
