...
folder-pane-mode-header-all = Akk ikaramen
folder-pane-mode-header-unread = Ikaramen ur nettwaɣri ara
...
threadpane-column-header-unread-button =
    .title = Asmizzwer s waddad n tɣuri
