...
multi-message-undelete-button =
    .label = Sefsex tukksa
    .tooltiptext = Sefsex tukksa
# Variables:
#   $count - total number of conversations (threads or solitary messages) selected
num-conversations =
    { $count ->
        [one] { $count } adiwenni
       *[other] { $count } idiwenniyen
    }
# Variables:
...
num-unread =
    { $count ->
        [one] , { $count } ur ittwaɣri ara
       *[other] , { $count } ur ttwaɣran ara
    }
...
max-count-exceeded = (Tamawt: { $total } iznan ttwafernen,  { $shown } imezwura ad ttwaseknen)
...
max-thread-count-exceeded = (Tamawt: { $total } asqerdec yettwafernen,  { $shown } imezwura ad ttwaseknen)
