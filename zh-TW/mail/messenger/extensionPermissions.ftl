...
webext-perms-description-experiment-access = 此附加元件將對 { -brand-short-name } 與您的電腦有完整不受限制的存取權。
...
webext-perms-description-messagesModifyPermanent = 永久修改您的信件原始碼（包含標頭、內文、附件）
...
webext-perms-description-messages-send = 不提供任何視覺提示，就用您的身分自動化批次傳送多封訊息。請使用活動管理員確認附加元件的寄信紀錄。
webext-perms-description-messages-save = 不需要您的互動，就自動將郵件訊息儲存為附件或範本
