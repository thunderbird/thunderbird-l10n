...
rights-intro-point-1 = { -brand-short-name } 是依照 <a data-l10n-name="mozilla-public-license-link">Mozilla Public License</a> 中的條件所提供給您的。這表示您可以使用、複製，或散布 { -brand-short-name } 給其他人。歡迎您自行修改 { -brand-short-name } 的原始碼以滿足您的需求；Mozilla Public License 也同時賦予您散布修改版本的權利。
