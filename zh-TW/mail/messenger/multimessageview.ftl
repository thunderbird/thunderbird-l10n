...
at-least-num-ignored = ，忽略 { $count }+ 個
...
max-count-exceeded = （註：已選擇 { $total } 封郵件，僅顯示前 { $shown } 封）
...
max-thread-count-exceeded = （註：已選擇 { $total } 個討論串，僅顯示前 { $shown } 個）
