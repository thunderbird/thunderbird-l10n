...
address-book-sync-existing-icon =
    .alt = 使用現有帳號同步通訊錄
address-book-sync-existing = 從現有帳號同步
address-book-add-remote-icon =
    .alt = 新增新的遠端通訊錄
address-book-add-remote = 新增遠端通訊錄
address-book-add-remote-description = 連結遠端 CardDav 通訊錄
...
address-book-add-ldap-description = 連結遠端 LDAP 通訊錄
account-hub-fetching-sync-accounts = 正在尋找通訊錄與行事歷…
