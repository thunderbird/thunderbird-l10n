...
account-hub-result-security-label = 安全:
account-hub-result-authentication-type-label = 驗證:
...
account-hub-result-auth-external = 外部
...
account-hub-result-graph-expanded-text = 圖表 API
