...
account-hub-name-error-text = 請輸入名稱
account-hub-hostname-error-text = 主機名稱為空白或無效。僅可輸入字母、數字、 - 與 。是允許的
    .title = 主機名稱為空白或無效。僅可輸入字母、數字、 - 與 。是允許的
account-hub-port-error-text = Port必須在 1 到 65535 之間
    .title = Port必須在 1 到 65535 之間
account-hub-username-error-text = 使用者名稱是必要的
    .title = 使用者名稱是必要的
account-hub-oauth-pending = 正在等待登入視窗中的授權…
