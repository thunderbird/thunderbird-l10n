...
spam-detecting-legend = 偵測垃圾信
spam-storage-deletion-legend = 儲存空間與刪除
spam-classification-legend = 選取範圍
spam-actions-legend = 目的地與保留時間
global-spam-preferences-button =
    .label = 全域垃圾信設定…
    .accesskey = G
manage-spam-title = 管理垃圾信
manage-spam-header =
    .value = 管理垃圾信
training-description-learns = 開啟此功能後，{ -brand-short-name } 會學習您標示為垃圾郵件或非垃圾郵件的訊息。訓練次數越多，{ -brand-short-name } 偵測垃圾郵件的準確度就越高。
spam-auto-detection-checkbox =
    .label = 開啟此帳號的垃圾信自動偵測功能
    .accesskey = E
