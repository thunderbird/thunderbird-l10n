...
collection-improve-header = 收集資料以改善 { -brand-short-name }
collection-community-description = { -brand-short-name } 是由全球性的社群所打造。分享匿名的效能資料可幫助我們更快地修復 Bug也讓每個人都可以使用更快的應用程式。
...
exceptions-button =
    .label = 例外網站…
    .accesskey = E
remote-content-privacy-link = 遠端內容如何影響隱私
...
view-saved-passwords-button =
    .label = 檢視已存密碼…
    .accesskey = 檢
primary-password-session-description = 主控密碼可保護所有密碼且每個作業階段只能輸入一次。
