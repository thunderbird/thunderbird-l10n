...
dark-message-mode-checkbox-label =
    .label = 開啟暗色訊息模式
    .accesskey = d
dark-message-mode-checkbox-description = 實驗性功能可讓郵件內文使用暗色佈景主題
dark-message-mode-toggle-label =
    .label = 顯示暗色訊息模式切換
    .accesskey = t
dark-message-mode-toggle-description = 在訊息標題中顯示開關即可快速停用暗色訊息模式
...
default-message-list-description = 為新建立的資料夾指定預設排序與討論串選項。
default-flag-label =
    .value = 是否預設使用討論串：
...
default-sort-ascending =
    .label = 由小到大
default-sort-ascending-description = 新訊息會在底部顯示
default-sort-descending =
    .label = 由大到小
default-sort-descending-description = 新訊息會在頂端顯示
apply-sort-label = 套用下列設定:
...
apply-current-view-success = 已成功套用目前的畫面設定
