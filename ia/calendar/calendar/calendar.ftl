...
calendar-task-input-filter-field =
    .aria-label = Filtrar le activitates
...
calendar-search-options-searchfor =
    .value = contine
calendar-properties-dialog-title = Rediger le calendario
calendar-server-dialog-name-label =
    .value = Nomine de calendario:
calendar-publish-dialog-window-title = Publicar agenda
...
calendar-error-description =
    .value = Description:
calendar-error-prompt-title = Un error occurreva
...
calendar-auth-enter-user-password-for-calendar = “{ $calendarName }” ({ $location }) require tu nomine de usator e contrasigno.
# Variables:
