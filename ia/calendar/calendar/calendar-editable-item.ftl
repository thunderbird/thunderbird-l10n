...
calendar-editable-item-reminder-icon-alarm =
    .alt = Un alerta de rememoration es programmate
calendar-editable-item-reminder-icon-suppressed-alarm =
    .alt = Un alerta de rememoration es programmate, ma actualmente supprimite
calendar-editable-item-reminder-icon-email =
    .alt = Un aviso de email es programmate
calendar-editable-item-reminder-icon-audio =
    .alt = Un alerta audio de rememoration es programmate
