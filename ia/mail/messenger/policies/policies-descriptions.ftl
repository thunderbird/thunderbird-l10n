...
policy-DisableChat = Disactivar le function de Chat.
policy-DisableCommunity = Non monstrar in le interfacie de usator functiones de communitate  (tal como Face un donation, Collabora, Condivide ideas etc.)
policy-DisableDataCollectionSettings = Impedi al usator de cambiar parametros de collecta de datos.
...
policy-DisableFileLink = Disactivar le function Filelink.
...
policy-DisableMessageForwardingFilters = Impedir al filtros del messages de automaticamente inultrar messages.
...
policy-DisableExperimentalFeatures = Disactivar functiones experimental in Thunderbird.
...
policy-DisableUpdateSettings = Impedir al usator de cambiar le configurationes de actualisation del applicationes.
