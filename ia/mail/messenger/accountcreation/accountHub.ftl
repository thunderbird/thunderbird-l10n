...
account-hub-servers-username-label = Nomine de usator:
account-hub-result-server-label = Servitor:
...
account-hub-result-authentication-none = Necun
    .title = Necun
account-hub-result-authentication-password = Contrasigno normal
    .title = Contrasigno normal
account-hub-result-authentication-encrypted-password = Contrasigno cryptate
    .title = Contrasigno cryptate
...
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = Necun
account-hub-result-auth-password = Contrasigno normal
account-hub-result-auth-encrypted-password = Contrasigno cryptate
...
account-hub-exchange-service-url-label = Mesme nomine de usator que le servitor de arrivata
...
account-hub-privacy-policy = Politica de confidentialitate
account-hub-welcome = Benvenite a
account-hub-welcome-brand = { -brand-short-name }
account-hub-welcome-text = Benvenite a { -brand-short-name }
account-hub-name-warning-icon =
    .title = Insere tu nomine
account-hub-email-label = Adresse email
    .accesskey = e
account-hub-email-input =
    .placeholder = johannes.esposito@example.com
account-hub-email-warning-icon =
    .title = Adresse email non valide
account-hub-password-label = Contrasigno
    .title = Optional, solo essera usate pro validar le nomine de usator
    .accesskey = C
account-hub-remember-password = Rememorar le contrasigno
    .accesskey = m
account-hub-exchange-label = Tu credentiales
    .accesskey = c
account-hub-installing-addon = Discargamento e installation del additivo…
account-hub-success-addon = Additivo installate con successo
account-hub-success-half-manual = Le sequente parametros ha essite trovate probante le servitor date:
account-hub-result-security-no-encryption = Nulle cryptation
    .title = Nulle cryptation
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = Nulle cryptation
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = Authentication fallite. Verifica le nomine de usator e le contrasigno
...
account-hub-exchange-config-unverifiable = Le configuration non pote esser verificate. Si tu nomine de usator e contrasigno es correcte, il es probabile que le administrator del servitor ha disactivate le configuration seligite pro tu conto. Prova seliger un altere protocollo.
account-hub-advanced-setup-button = Configuration avantiate
    .accesskey = a
# Variables:
#  $domain (String): The name of the server where the configuration was found, e.g. rackspace.com.
account-hub-exchange-dialog-question = { -brand-short-name } ha trovate informationes de installation de tu conto sur { $domain }. Vole tu continuar e inviar tu credentiales?
account-hub-creation-error-title = Error al creation del conto
account-hub-error-server-exists = Le servitor de arrivata jam existe.
account-hub-confirm-advanced-title = Confirmar configuration avantiate
account-hub-confirm-advanced-description = Iste fenestra de dialogo sera claudite e un conto con le actual parametros sera create, mesmo si le configuration es incorrecte. Vole tu continuar?
...
account-hub-port-help-text = Si lassate vacue, { -brand-short-name } tentara de discoperir le porta.
...
address-book-add-remote-carddav-description = Connecter un libro de adresses CardDAV
