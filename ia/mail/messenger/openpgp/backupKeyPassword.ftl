...
set-password-window-title = Elige un contrasigno pro facer un copia de securitate de tu clave OpenPGP
...
set-password-backup-pw-label = Contrasigno reserva de clave secrete:
set-password-backup-pw2-label = Contrasigno reserva de clave secrete: (de novo)
