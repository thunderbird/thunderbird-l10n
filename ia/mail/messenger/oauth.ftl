...
oauth-reauthorize-title = Authorisar novemente le accesso
...
oauth-reauthorize-description = { $hostname } besonia que tu ancora confirma le accesso pro mantener le synchronisation con tu conto. Nomine de usator: { $username }
