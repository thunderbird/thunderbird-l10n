...
trust-addresses-header-label =
    .value = Confider adresses e-mail in iste libros de adresses:
    .accesskey = d
...
spam-detecting-legend = Detegente spam
spam-storage-deletion-legend = Immagazinage e deletion
...
manage-spam-header =
    .value = Gerer le spam
training-description-learns = Quando active, { -brand-short-name } apprende del messages que tu marca como spam o non spam. Quanto plus tu lo traina, tanto melio { -brand-short-name } detege spam.
spam-auto-detection-checkbox =
    .label = Activar automatic spam detection pro iste conto
    .accesskey = e
