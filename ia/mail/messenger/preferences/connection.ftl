...
connection-internet-proxy-legend = Connexion a internet e proxy
connection-proxy-legend = Configurar proxies pro acceder a Internet
proxy-type-no =
    .label = Nulle proxy
    .accesskey = y
proxy-autodetect-network =
    .label = Automaticamente deteger proxy de rete
    .accesskey = d
proxy-type-wpad =
...
http-port-label =
    ...
    .accesskey = p
proxy-https-sharing =
    .label = Usar iste proxy pro adresses web secur (HTTPS)
    .accesskey = x
proxy-http-sharing =
...
proxy-auto-script-url =
    .label = URL de script pro installation automatic:
    .accesskey = a
proxy-type-auto =
...
no-proxy-addresses-label =
    .value = Non usar un proxy pro iste adresses:
    .accesskey = n
no-proxy-label =
