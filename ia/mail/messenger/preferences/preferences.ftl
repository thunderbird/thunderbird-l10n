...
general-email-notifications-header = Avisos de e-mail
...
general-files-and-attachment-description = Selige que files es salvate e ubi illos es salvate sur tu computator.
general-tags-header = Etiquettas
general-reading-and-viewing-header = Leger e visualisar
general-reading-and-display-header = Leger e monstrar
general-updates-header = Actualisationes
general-network-and-storage-header = Rete e immagazinage
general-search-performance-label = Recerca e prestationes
compose-writing-emails-header = Scriber e-mails
...
compose-message-formatting-title = Formattation de messages
compose-address-autocomplete-header = Automaticamente completar adresse
...
privacy-security-certificates-title = Certificatos de securitate
...
choose-display-language-description = Eliger le lingua usate pro menus, buttones, e avisos.
...
manual-storage-limit-label =
    .label = Manualmente stabilir le limites de immagazinage pro files temporari
    .accesskey = M
clear-temp-files-button =
    .label = Vacuar files temporari
    .accesskey = V
clear-temp-files-shutdown-label =
    .label = Vacuar files temporari quando { -brand-short-name } claude
    .accesskey = c
...
show-start-page-label =
    .label = Monstrar le pagina initial quando { -brand-short-name } aperi
    .accesskey = m
start-page-label =
...
close-to-tray-label =
    .label = Quando { -brand-short-name } es claudite, mover lo al zona del avisos
    .accesskey = c
start-in-tray-label =
    .label = Initialisar { -brand-short-name } ora
    .accesskey = I
new-message-arrival-legend = Quando un nove message arriva:
...
use-custom-sound-label =
    .label = Usar sono personalisate pro avisos
    .accesskey = U
mail-select-audio-button =
    .label = Seliger audio…
    .accesskey = a
enable-global-search-label =
    .label = Activar recerca inter tote le contos de e-mail
    .accesskey = e
gloda-results-plain-list-label =
    .label = Monstrar resultatos del recerca como lista simple
    .accesskey = l
...
gloda-show-results-as-list-label =
    .label = De ordinario monstrar le resultatos del recerca mundial lista
    .accesskey = l
datetime-formatting-legend = Formato de data e hora
display-language-legend = Lingua del interfacie de usator
allow-graphics-accel =
    .label = Usar acceleration graphic pro rolamento e prestationes plus dulce
    .accesskey = h
storage-format-label =
    .value = Formato de immagazinage pro nove contos:
    .accesskey = T
mbox-store-single-label =
    .label = File singule per plica (mbox)
...
enable-autoscroll-label =
    .label = Activar rolamento automatic
    .accesskey = g
autoscroll-label =
...
hide-titlebar-label =
    .label = Celar bar de titulo
    .accesskey = C
hide-titlebar-description = Remove le barra superior monstrante le nomine del fenestra pro sparniar spatio de schermo
hide-tabbar-single-tab-label =
    .label = Celar le barra de schedas solo quando es aperte un singule scheda
    .accesskey = C
auto-hide-tabbar-second-tab-description = Automaticamente cela tu schedas usque tu aperi un secunda scheda.
system-settings-legend = Configurationes de systema
check-email-app-label =
    .label = Verificar sempre si { -brand-short-name } es le application de e-mail predefinite quando aperite
    .accesskey = V
edit-defaults-apps-button =
    .label = Rediger valores predefinite…
    .accesskey = p
...
update-settings-title = Actualisar configurationes
install-updates-automatically-label =
    .label = Automaticamente installa le actualisationes (recommendate)
    .accesskey = A
install-updates-automatically-description = Mantene { -brand-short-name } secur con le ultime correctiones de securitate.
check-updates-ask-label =
    .label = Controlar actualisationes, ma demandar ante installar
    .accesskey = C
...
connection-config-description = Controlar como { -brand-short-name } se connecte a internet.
connection-options-button =
    .label = Optiones de connexion…
    .accesskey = s
offline-mode-legend = Modo foras de linea
offline-settings-label = Parametros offline
...
offline-settings-button =
    .label = Offline…
    .accesskey = O
temporary-storage-legend = Immagazinage temporari
offline-compact-remove-deleted =
    .label = Remover datos de plicas quando illos ha jam essite delite pro liberar immagazinage
    .accesskey = a
offline-compact-ask-cleanup =
    .label = Demandar ante nettar plicas
    .accesskey = a
...
use-cache-before =
    .value = Usar usque
    .accesskey = U
use-temp-storage-after = MB de spatio pro files temporari
...
underline-text-links-label =
    .label = Sublinear texto ligamines in messages
    .accesskey = g
...
customize-fonts-button =
    .label = Personalisar typos de character…
    .accesskey = t
font-options-button =
    .label = Avantiate…
    .accesskey = A
...
convert-emoticons-label =
    ...
    .accesskey = e
display-text-formatting-label = Formattation de texto citate
...
search-content-types =
    .placeholder = Typos de recerca de contento
...
always-ask-label =
    ...
    .accesskey = S
use-tags-text = Usar tags pro classificar messages per categoria e prioritate.
...
mark-read-when-opened =
    .label = Immediatemente quando aperite
    .accesskey = a
show-attachments-inline-label =
    .label = Monstrar annexos intra le corpore del message
    .accesskey = m
mark-read-no-delay =
...
display-name-only-label =
    .label = Solo visualisar nomine a monstrar pro le contactos reservate in le libro de adresses
    .accesskey = S
...
show-conversation-view-label =
    .label = Monstrar vista del conversation
    .accesskey = c
conversation-view-preview-description = Isto es un functionalitate de previsualisation precoce. Illo gruppa insimul le messages correlate, ma illo poterea non sempre functionar como expectate.
...
dark-mode-message-appearance = Apparentia de message
dark-mode-checkbox-label =
    .label = Usar modo obscur pro  texto del message
    .accesskey = o
dark-mode-message-text-description = Se applica un fundo obscur a tote le messages in ingresso, mesmo si le expeditor los formattava in colores clar.
...
dark-message-mode-toggle-label =
    ...
    .accesskey = c
dark-mode-toggle-description = Te permitte de rapidemente cambiar un e-mail retro a modo clar legente, sin cambiar tu configurationes principal.
general-folder-settings-header = Configurationes del plica
recent-folders-legend = Plicas recente
recent-folders-description = Controla como appare le plicas recentemente usate movente messages.
...
general-folder-options-header = Optiones de gestion del plicas
recent-destinations-legend = Destinationes recente
recent-destinations-description = Optiones pro listar e ordinar plicas ubi messages era recentemente movite.
...
recent-sort-order-alphabetic =
    .label = Alphabetic
max-recent-label = Numero maxime de plicas recente:
    .accesskey = M
...
account-hub-manual-config-checkbox-label =
    .label = Usar le nove fluxo de configuration manual in Centro de conto
    .accesskey = c
account-hub-manual-config-checkbox-description = Fluxo de configuration manual del nove centro de conto
new-calendar-legend = Fenestra de dialogo de Nove evento de agenda
new-calendar-checkbox-label =
    .label = Vide eventos de agenda in le nove fenestra de dialogo
new-calendar-checkbox-description = Nove fenestra de dialogo experimental de agenda pro visualisar eventos
...
as-attachment-label =
    .label = Como annexo
add-file-type-label =
    .label = Adder typo de file a messages attachate
    .accesskey = e
extension-label =
    .label = adder extension al nomine de file
    .accesskey = a
forward-messages-label =
    .value = Inviar in addition messages como:
    .accesskey = a
forward-inline-label =
    .label = Intra le message (in linea)
...
autosave-draft-label =
    .label = Automaticamente salvar un minuta cata
    .accesskey = A
...
spellcheck-while-typing-label =
    .label = Verificar orthographia scribente
    .accesskey = e
...
ignore-sender-styles-label =
    .label = Ignorar typos de character e colores del  expeditor
    .accesskey = d
...
paragraph-spacing-label =
    .label = Pressar Enter lancea un nove paragrapho con spatiamento ulterior
    .accesskey = P
...
compose-format-automatic-option =
    .label = Automatic (recommendate)
compose-format-automatic-description = Invia texto formattate si tu adde stilos (como hardite o ligamines), o texto simple si tu non.
compose-format-both-option =
    .label = Ambe texto ric (HTML) e texto simple
...
compose-format-html-option =
    .label = Texto ric (HTML) solo
compose-format-html-description = Mantene typos de characteres, colores, e imagines personalisate, ma alcun plus vetere applicationes de e-mail non pote monstrar lo correctemente.
compose-format-plain-option =
    .label = Texto simple solo
compose-format-plain-description = Remove tote le formattation, colores, e imagines. Optime pro e-mails de texto simple que functiona ubique.
autocomplete-matches-description = Scribente un nomine o e-mail de destinatario , illo cerca concordantias in:
company-network-directory-label =
    .label = Directorio o rete del compania
    .accesskey = c
...
manage-directories-label =
    .label = Gerer directorios…
    .accesskey = e
collect-outgoing-label =
    .label = Automaticamente salvar in exito adresses e-mail a:
    .accesskey = a
collect-outgoing-description = Ubi nove contactos es salvate quando create manualmente o addite ab le e-mails.
save-added-contacts-label =
    .value = Salvar manualmente contactos addite a:
    .accesskey = m
save-added-contacts-description = Ubi nove contactos es salvate ab le e-mails.
show-directory-startup-label =
    .value = Monstrar directorio in le fenestra de libro de adresses aperiente { -brand-short-name }
    .accesskey = s
...
email-picker-label =
    ...
    .accesskey = A
email-picker-description = Le position del nove contactos salvate ab le messages inviate.
default-add-address-book-label =
    .value = Libro de adresses predefinite pro contactos mnualmente addite.
    .accesskey = L
default-add-address-book-description = Le position del nove contactos salvate ab le messages recepite.
...
attachment-label =
    ...
    .accesskey = o
edit-keywords-label =
    .label = Rediger parolas clave…
    .accesskey = c
offer-share-large-files-label =
    .label = Offerer a condivider files per ligamine quando illos excede:
...
preferences-doh-setting-automatic =
    .label = Protection automatic (Recommendate)
    .accesskey = d
preferences-doh-automatic-desc = { -brand-short-name } automaticamente crypta le recercas de adresse quando disponibile. Passa retro a recercas de rete standard si il ha un problema de connexion o si un rete gerite per VPN lo require.
...
preferences-doh-setting-enabled =
    ...
    .accesskey = a
preferences-doh-increased-desc = Sempre usa le fornitor eligite. Usa le connexion standard solo si tu fornitor secur falle.
...
search-preferences-input2 =
    ...
    .style = width: 15.4em
managed-by-organization-notice = { -brand-short-name } es gerite per un organisation.
...
accent-color-selection-label =
    .value = Seliger color pro button e evidentia primari
accent-color-label =
    .value = Definir le color usate pro buttones principal e elementos evidentiate:
accent-color-os =
    .label = Sequer systema operative
...
accent-color-teal =
    .label = Folia de té
accent-color-disabled-description = Le colores accentual non es supportate in Modalitate alte contrasto.
default-message-list-legend = Lista de messages
appearance-view-style-select =
    .value = Seliger stilo de vista:
appearance-view-style =
    .value = Stilo de vista:
appearance-radio-table =
    .label = Vista de tabella
appearance-radio-card-view =
    .label = Vista del schedas
card-view-options-legend = Vista del optiones de schedas
...
default-message-list-new-folders-description = Seliger optiones predefinite de arrangiamento e discussion pro nove plicas
...
default-sort-by-label = Arrangiar messages per:
...
default-sort-newest-bottom =
    .label = Messages plus nove al fundo
default-sort-new-messages-top =
    .label = Messages plus nove al culmine
apply-view-settings-label = Applicar iste parametros de visualisation a:
apply-view-settings-to-all-folders-button =
    .label = Tote le plicas e sub-plicas
    .accesskey = T
select-apply-sort-folders-button =
    .label = Tote plicas e sub-plicas
    .accesskey = s
