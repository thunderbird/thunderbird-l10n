...
system-integration-dialog-title = Integration de systema
system-integration-dialog =
    .buttonlabelaccept = Stabilir como predeterminate
    .buttonlabelcancel = Saltar integration
    .buttonlabelcancel2 = Cancellar
default-app-intro = Usar { -brand-short-name } como le application predefinite pro:
...
checkbox-net-thunderbird-url-label =
    .label = Ligamines personalisate a Thunderbird (net.thunderbird://)
    .tooltiptext = { unset-default-tooltip }
...
check-on-startup-label =
    ...
    .accesskey = s
system-settings-dialog-title = Configurationes de systema
