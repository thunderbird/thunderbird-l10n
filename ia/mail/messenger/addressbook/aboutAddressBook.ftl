...
books-pane-import-button = Importar
    .title = Importa libros de adresses
...
about-addressbook-export-selected-filename = Contactos
...
about-addressbook-confirm-remove-contacts-multi =
    { $count ->
        [one] Desira tu vermente deler iste { $count } contacto del lista { $list }?
...
about-addressbook-confirm-delete-contacts-single = Desira tu vermente deler le contacto { $name }?
# Variables:
# $count (Number) - The number of contacts to be deleted.
about-addressbook-confirm-delete-contacts-multi =
    { $count ->
        [one] Desira tu vermente deler { $count } contacto?
...
about-addressbook-selection-contacts-header2 =
    { $count ->
        [one] { $count } contacto eligite
       *[other] { $count } contactos eligite
    }
# Variables:
# $count (Number) - The number of selected lists
about-addressbook-selection-lists-header2 =
    { $count ->
        [one] { $count } lista seligite
       *[other] { $count } listas seligite
    }
...
about-addressbook-photo-dialog-title =
    .aria-label = Gerer le photo pro iste contacto.
...
ab-search-dialog-matches-found =
    .value =
        { $count ->
            [one] { $count } concordantia trovate
           *[other] { $count } concordantias trovate
        }
ab-search-dialog-no-matches-found =
    .value = Nulle correspondentia trovate
...
ab-search-dialog-delete-button =
    .label = Deler
    .accesskey = D
ab-search-dialog-title = Recerca avantiate in libro de adresses
