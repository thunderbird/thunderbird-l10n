...
looking-for-messages-account = Cercante nove messages pro { $accountName }…
# Feedback message shown in the status bar while we look for new messages in a
# specific folder.
# Variables:
# $folderName (String) - The folder's name.
looking-for-messages-folder = Cercante nove messages in { $folderName }…
...
deleting-message =
    { $number ->
        [one] Cancellation de un message de { $folderName }…
       *[other] Cancellation de { $number } messages de { $folderName }…
    }
# Feedback message shown in the status bar while we're deleting messages in a
# specific folder (and waiting for the remote operation to complete).
# Variables:
# $number (Number) - Number of messages being deleted.
# $folderName (String) - The folder's name.
deleting-messages = Cancellation de { $number } message(s) de { $folderName }…
