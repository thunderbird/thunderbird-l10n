...
folder-pane-header-toggle-full-path =
    .label = Monstrar route complete
folder-pane-header-hide-local-folders =
    .label = Celar le dossiers local
folder-pane-mode-header-all = Tote le plicas
folder-pane-mode-header-unread = Plicas non legite
folder-pane-mode-header-favorite = Plicas favorite
folder-pane-mode-header-recent = Plicas recente
folder-pane-mode-header-smart = Plicas unificate
folder-pane-mode-header-tags = Etiquettas
