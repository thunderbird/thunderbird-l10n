...
folder-pane-mode-header-all = Tote le dossiers
folder-pane-mode-header-unread = Dossiers non legite
folder-pane-mode-header-favorite = Dossiers favorite
folder-pane-mode-header-recent = Dossiers recente
folder-pane-mode-header-smart = Dossiers unificate
