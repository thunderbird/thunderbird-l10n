...
calendar-creation-initial-description = Il calendario può essere salvato sul proprio computer o essere salvato su un server in modo da potervi accedere in remoto o condividerlo con i propri amici o collaboratori.
...
calendar-creation-network-loading = Attendere mentre i calendari vengono scoperti.
