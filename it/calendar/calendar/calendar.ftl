...
prompt-remove-attachments-title = Rimuovi allegati
# LOCALIZATION NOTE (prompt-remove-attachments-text):
#  $count will be replaced with number of attachments
prompt-remove-attachments-text =
    { $count ->
        [one] Rimuovere { $count } allegato?
       *[other] Rimuovere { $count } allegati?
    }
...
calendar-context-attendance-occ-needs-action =
    .label = Azione ancora necessaria
    .accesskey = z
...
calendar-context-new-server =
    .label = Nuovo calendario…
    .accesskey = N
calendar-context-delete-server =
    .label = Elimina calendario…
    .accesskey = E
calendar-context-remove-server =
    .label = Rimuovi calendario… (conserva i dati)
    .accesskey = R
calendar-context-unsubscribe-server =
    .label = Rimuovi sottoscrizione a calendario…
    .accesskey = c
calendar-context-publish =
    .label = Pubblica calendario…
    .accesskey = u
calendar-context-export =
    .label = Esporta calendario…
    .accesskey = s
calendar-context-properties =
    .label = Proprietà
    .accesskey = P
calendar-context-showall =
    .label = Mostra tutti i calendari
    .accesskey = M
...
calendar-context-convert-to-task =
    .label = Attività…
    .accesskey = A
calendar-task-filter-title2 = Filtra attività
...
calendar-task-filter-next7days =
    .label = Prossimi sette giorni
    .accesskey = P
calendar-task-filter-notstarted =
    .label = Attività non iniziate
    .accesskey = n
...
calendar-task-filter-current =
    ...
    .accesskey = c
calendar-task-details-title = titolo
calendar-task-details-organizer = da
calendar-task-details-priority = priorità
calendar-task-details-priority-low = Bassa
...
calendar-task-details-repeat = ripetizione
calendar-task-details-attachments = allegati
calendar-task-details-start = data di inizio
calendar-task-details-due = data di scadenza
calendar-task-mark-completed =
    .label = Completata
    .tooltiptext = Segna le attività selezionate come completate
    .accesskey = o
calendar-task-change-priority =
    .label = Priorità
    .tooltiptext = Cambia la priorità
    .accesskey = P
calendar-task-input-filter-field =
    .aria-label = Filtra attività
    .emptytextbase = Filtra attività #1
    .keylabelmac = <⇧⌘K>
...
calendar-tasks-view-calendarlist =
    .label = Lista calendari
    .accesskey = L
calendar-tasks-view-filtertasks =
    .label = Filtra attività
    .accesskey = F
...
calendar-properties-refresh =
    .value = Aggiorna calendario:
calendar-properties-refresh-manual =
    .label = Manualmente
calendar-properties-read-only =
    .label = Sola lettura
calendar-properties-show-reminders =
    .label = Mostra allarmi
calendar-properties-offline-support =
    .label = Supporto non in linea
calendar-properties-enable-calendar =
    .label = Attiva questo calendario
calendar-properties-provider-missing = Impossibile trovare il gestore di questo calendario. Questo accade spesso quando vengono disattivati o disinstallati alcuni componenti aggiuntivi.
calendar-properties-unsubscribe =
    .buttonlabelextra1 = Rimuovi sottoscrizione
    .buttonaccesskeyextra1 = R
    .label = Rimuovi sottoscrizione
    .accesskey = R
calendar-alarm-dialog-title = Allarmi calendario
...
calendar-alarm-snooze-cancel =
    .aria-label = Elimina posposizione
calendar-calendar =
    .label = Calendario
    .accesskey = C
calendar-newevent-button =
    .label = Nuovo evento
    .tooltiptext = Crea un nuovo evento
calendar-newtask-button =
    .label = Nuova attività
    .tooltiptext = Crea una nuova attività
calendar-unifinder-show-completed-todos =
    .label = Mostra attività completate
calendar-display-todos-checkbox =
    .label = Attività nella vista
    .accesskey = A
...
calendar-todaypane-button =
    .label = Pannello Oggi
    .tooltiptext = Visualizza pannello Oggi
calendar-search-options-searchfor =
    .value = contiene
calendar-properties-dialog-title = Modifica calendario
calendar-server-dialog-name-label =
    .value = Nome calendario:
calendar-publish-dialog-window-title = Pubblica calendario
calendar-publish-url-label = URL di pubblicazione
calendar-publish-publish-dialog-button =
    .buttonlabelaccept = Pubblica
calendar-publish-close-button = Chiudi
calendar-select-dialog-title = Seleziona calendario
...
calendar-error-description =
    .value = Descrizione:
calendar-error-prompt-title = Si è verificato un errore
calendar-extract-event-button =
    .label = Aggiungi come evento
    .tooltiptext = Estrai le informazioni del calendario dal messaggio e aggiungile al calendario personale come evento
...
calendar-auth-enter-user-password-for-calendar = “{ $calendarName }” ({ $location }) richiede nome utente e password.
# Variables:
#   $username (String) - The account username.
#   $location (String) - The calendar server location.
calendar-auth-enter-password-for = Inserisci la password per { $username } su { $location }
# Variables:
#   $location (String) - The calendar server location.
calendar-auth-enter-user-password-for = { $location } richiede nome utente e password.
