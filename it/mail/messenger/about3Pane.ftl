...
folder-pane-header-toggle-full-path =
    .label = Mostra percorso completo
folder-pane-header-hide-local-folders =
    .label = Nascondi cartelle locali
folder-pane-mode-header-all = Tutte le cartelle
folder-pane-mode-header-unread = Cartelle non lette
...
threadpane-cell-read-status =
    .aria-label = Stato lettura
threadpane-new-cell-label = Nuovo
