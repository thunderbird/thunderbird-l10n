...
toolbar-spam =
    .title = Contrassegna i messaggi selezionati come spam
toolbar-not-spam-label = Non spam
toolbar-not-spam =
    .title = Contrassegna i messaggi selezionati come non spam
...
toolbar-mark-as-label = Contrassegna
toolbar-mark-as =
    .title = Contrassegna i messaggi
...
toolbar-add-address-book-label = Aggiungi rubrica
