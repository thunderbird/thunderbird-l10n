...
webext-perms-description-messages-send = Inviare automaticamente messaggi email in blocco per conto tuo, senza alcun riscontro visivo. Usa il Gestore attività per consultare la cronologia di invio del componente aggiuntivo.
webext-perms-description-messages-save = Salvare i messaggi di posta elettronica come bozze o modelli in modo programmatico, senza interazione con l’utente
...
webext-perms-description-messengerSettings = Leggere le impostazioni di { -brand-short-name }
