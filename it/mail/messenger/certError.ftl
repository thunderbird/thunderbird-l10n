...
cert-error-domain-mismatch = Il certificato per { $hostname } non è valido per quel server. È possibile che qualcuno stia tentando di sostituirsi al server e non dovresti continuare.
# Variables:
#   $hostname (string) - Hostname of the server with certificate error.
