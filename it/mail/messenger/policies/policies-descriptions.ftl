...
policy-DisableChat = Disattiva la funzione Chat.
policy-DisableCommunity = Non mostrare nell’interfaccia le funzionalità dedicate alla comunità (ad esempio Fai una donazione, Collabora con noi, Condividi idee ecc.)
policy-DisableDataCollectionSettings = Impedisce all’utente di modificare le impostazioni relative alla raccolta dei dati.
...
policy-DisableFileLink = Disattiva la funzione Filelink.
...
policy-DisableMessageForwardingFilters = Impedisci ai filtri di inoltrare automaticamente i messaggi.
...
policy-DisableExperimentalFeatures = Disattiva le funzionalità sperimentali di Thunderbird.
policy-DisableQRExport = Disattiva la generazione del codice QR per esportare le impostazioni e le credenziali dell’account.
...
policy-DisableUpdateSettings = Impedisci all’utente di modificare le impostazioni relative all’aggiornamento dell’applicazione.
...
policy-InAppNotification = Attiva o disattiva i tipi di notifica.
