...
general-email-notifications-header = Notifiche via email
...
general-files-and-attachment-description = Seleziona quali file verranno salvati e dove verranno salvati sul computer.
...
compose-writing-emails-header = Scrivere email
...
compose-message-formatting-title = Formattazione del messaggio
compose-address-autocomplete-header = Completamento automatico dell’indirizzo
...
choose-display-language-description = Scegli la lingua utilizzata per menu, pulsanti e notifiche.
...
display-language-legend = Lingua di visualizzazione
...
hide-titlebar-label =
    ...
    .accesskey = N
hide-titlebar-description = Rimuove la barra in alto che mostra il nome della finestra per risparmiare spazio sullo schermo
