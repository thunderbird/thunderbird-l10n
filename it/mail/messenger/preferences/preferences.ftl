...
edit-defaults-apps-button =
    .label = Modifica impostazioni predefinite…
    .accesskey = M
...
check-updates-ask-label =
    .label = Verificare la disponibilità di aggiornamenti, ma chiedere prima dell’installazione
    .accesskey = V
...
connection-options-button =
    ...
    .accesskey = O
offline-mode-legend = Non in linea
...
convert-emoticons-label =
    ...
    .accesskey = a
display-text-formatting-label = Formattazione testo tra virgolette
...
always-ask-label =
    ...
    .accesskey = C
use-tags-text = Utilizza i tag per classificare e assegnare priorità ai messaggi.
...
mark-read-after-viewing =
    .label = Dopo aver visualizzato per
    .accesskey = D
...
display-name-only-label =
    .label = Mostra solo il nome visualizzato per i contatti salvati nella rubrica
    .accesskey = M
...
show-conversation-view-label =
    ...
    .accesskey = M
conversation-view-preview-description = Questa è una funzione di anteprima anticipata. Raggruppa i messaggi correlati, ma potrebbe non funzionare sempre come previsto.
...
dark-mode-message-appearance = Aspetto del messaggio
...
dark-message-mode-toggle-label =
    ...
    .accesskey = M
dark-mode-toggle-description = Riporta rapidamente un’email alla modalità luminosa durante la lettura, senza modificare le impostazioni principali.
general-folder-settings-header = Impostazioni cartella
recent-folders-legend = Cartelle recenti
recent-folders-description = Controlla la modalità di visualizzazione delle cartelle utilizzate di recente durante lo spostamento dei messaggi.
...
paragraph-spacing-label =
    .label = Premendo Invio si apre un nuovo paragrafo con spaziatura extra
    .accesskey = P
...
compose-format-automatic-description = Invia testo formattato se aggiungi stili (ad esempio grassetto o link), o testo semplice in caso contrario.
compose-format-both-option =
    .label = Sia RTF (HTML) che testo semplice
compose-format-both-description = Invia sempre entrambe le versioni in modo che l’app di posta elettronica del destinatario possa scegliere quale visualizzare.
compose-format-html-option =
    .label = Solo RTF (HTML).
compose-format-html-description = Mantiene caratteri, colori e immagini personalizzati, ma alcune app di posta elettronica meno recenti potrebbero non visualizzarli correttamente.
compose-format-plain-option =
    .label = Solo testo semplice
compose-format-plain-description = Rimuove tutta la formattazione, i colori e le immagini. Ideale per semplici email di testo che funzionano ovunque.
autocomplete-matches-description = Quando si digita il nome o l’email di un destinatario, cercare corrispondenze in:
company-network-directory-label =
    .label = Directory aziendale o di rete
    .accesskey = D
directory-server-label =
    .label = Server di directory
    .accesskey = S
...
collect-outgoing-label =
    ...
    .accesskey = S
collect-outgoing-description = Dove vengono salvati i nuovi contatti creati manualmente o aggiunti tramite email.
save-added-contacts-label =
    .value = Salva i contatti aggiunti manualmente in:
    .accesskey = S
save-added-contacts-description = Dove vengono salvati i nuovi contatti dalle email.
...
offer-share-large-files-label =
    .label = Proponi di condividere i file tramite link quando superano:
...
accent-color-selection-label =
    .value = Seleziona il colore per il pulsante principale e le luci
accent-color-label =
...
appearance-radio-card-view =
    .label = Vista scheda
card-view-options-legend = Opzioni di visualizzazione scheda
...
default-message-list-new-folders-description = Seleziona le opzioni di ordinamento e threading predefinite per le nuove cartelle
