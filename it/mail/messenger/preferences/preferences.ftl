...
dark-message-mode-checkbox-label =
    .label = Attiva la modalità messaggio scuro
    .accesskey = A
dark-message-mode-checkbox-description = Funzionalità sperimentale per adattare il corpo del messaggio a temi oscuri
dark-message-mode-toggle-label =
    .label = Attiva/disattiva modalità messaggio scuro
    .accesskey = A
dark-message-mode-toggle-description = Mostra un interruttore nell’intestazione del messaggio per disattivare rapidamente la modalità oscuramento
dark-reader-legend = Colori del lettore
...
apply-sort-label = Applica queste impostazioni a:
