...
new-calendar-legend = Finestra di dialogo Nuovo evento del calendario
new-calendar-checkbox-label =
    .label = Visualizza gli eventi del calendario nella nuova finestra di dialogo
new-calendar-checkbox-description = Sperimentale nuova finestra di dialogo del calendario per visualizzare gli eventi
