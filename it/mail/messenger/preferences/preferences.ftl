...
account-hub-manual-config-checkbox-label =
    .label = Utilizza il nuovo flusso di configurazione manuale in Account Hub
    .accesskey = U
account-hub-manual-config-checkbox-description = Flusso di configurazione manuale del nuovo hub account
