...
address-display-description = Formato di visualizzazione indirizzo preferito:
...
junk-delete-label =
    ...
    .accesskey = E
junk-read-label =
    .label = Contrassegna come già letti tutti i messaggi riconosciuti come posta indesiderata
    .accesskey = m
