...
general-email-notifications-header = Notifiche email
...
general-files-and-attachment-description = Scegli quali file salvare e in quale posizione sul computer.
general-tags-header = Etichette
general-reading-and-viewing-header = Lettura e visualizzazione
general-reading-and-display-header = Lettura e visualizzazione
general-updates-header = Aggiornamenti
general-network-and-storage-header = Rete e archiviazione
general-search-performance-label = Ricerca e prestazioni
compose-writing-emails-header = Scrittura delle email
...
compose-message-formatting-title = Formattazione dei messaggi
compose-address-autocomplete-header = Completamento automatico degli indirizzi
...
collection-improve-header = Dati raccolti per migliorare { -brand-short-name }
collection-community-description = { -brand-short-name } è realizzato da una comunità globale. La condivisione di dati anonimi sulle prestazioni ci aiuta a correggere i bug più velocemente e rendere l’app più veloce per tutti.
collection-privacy-policy = Leggi l’informativa sulla privacy Mozilla
collection-data-sharing-off = <strong>La condivisione dei dati è disattivata.</strong> I dati di utilizzo precedenti verranno eliminati definitivamente dai server di { -vendor-short-name } entro 30 giorni.
...
collection-share-performance =
    .label = Condividi dati anonimi sulle prestazioni con { -vendor-short-name }
    .accesskey = C
collection-share-performance-description = (Include informazioni tecniche di base come il sistema operativo, l’utilizzo della memoria e l’attività delle funzioni. { -brand-short-name } non raccoglie mai contenuti di posta elettronica, contatti o messaggi personali.)
...
collection-share-crash-data =
    .label = Invia segnalazioni anonime di arresto anomalo a { -vendor-short-name }
    .accesskey = I
...
privacy-security-certificates-title = Certificati di sicurezza
...
choose-display-language-description = Scegli la lingua da utilizzare per menu, pulsanti e notifiche.
manage-languages-button =
    .label = Gestisci lingue…
    .accesskey = G
choose-messenger-language-description = Sceglile lingue utilizzate per visualizzare menu, messaggi e notifiche di { -brand-short-name }
...
manual-storage-limit-label =
    .label = Imposta manualmente i limiti di archiviazione per i file temporanei
    .accesskey = s
clear-temp-files-button =
    .label = Cancella i file temporanei
    .accesskey = C
clear-temp-files-shutdown-label =
    .label = Cancella i file temporanei alla chiusura di { -brand-short-name }
    .accesskey = h
...
show-start-page-label =
    .label = Mostra la pagina iniziale all’apertura di { -brand-short-name }
    .accesskey = M
start-page-label =
...
close-to-tray-label =
    .label = Quando { -brand-short-name } viene chiuso, spostalo nella barra delle applicazioni
    .accesskey = Q
start-in-tray-label =
    .label = Avvia { -brand-short-name } nella barra delle applicazioni
    .accesskey = A
new-message-arrival-legend = Quando arriva un nuovo messaggio:
...
use-custom-sound-label =
    .label = Utilizza un suono personalizzato per gli avvisi
    .accesskey = U
mail-select-audio-button =
    .label = Seleziona audio…
    .accesskey = u
enable-global-search-label =
    .label = Attiva la ricerca in tutti gli account di posta
    .accesskey = A
gloda-results-plain-list-label =
    .label = Mostra i risultati di ricerca come un elenco semplice
    .accesskey = s
...
gloda-show-results-as-list-label =
    .label = Mostra i risultati della ricerca globale come un elenco per impostazione predefinita
    .accesskey = M
datetime-formatting-legend = Formattazione data e ora
display-language-legend = Lingua dell’interfaccia
allow-graphics-accel =
    .label = Utilizza l’accelerazione grafica per prestazioni e scorrimento più fluidi
    .accesskey = z
storage-format-label =
    .value = Formato di archiviazione per i nuovi account:
    .accesskey = F
mbox-store-single-label =
    .label = Singolo file per cartella (mbox)
...
enable-autoscroll-label =
    .label = Attiva scorrimento automatico
    .accesskey = u
autoscroll-label =
...
hide-titlebar-label =
    .label = Nascondi la barra del titolo
    .accesskey = t
hide-titlebar-description = Nasconde la barra superiore con il nome della finestra per liberare spazio sullo schermo
hide-tabbar-single-tab-label =
    .label = Nascondi la barra delle schede quando è aperta una sola scheda
    .accesskey = N
auto-hide-tabbar-second-tab-description = Nasconde automaticamente le schede finché non ne apri una seconda.
system-settings-legend = Impostazioni di sistema
check-email-app-label =
    .label = Verifica sempre se { -brand-short-name } è l’app di posta elettronica predefinita quando viene aperta
    .accesskey = V
edit-defaults-apps-button =
    .label = Modifica app predefinite…
    .accesskey = d
...
update-settings-title = Aggiorna impostazioni
install-updates-automatically-label =
    .label = Installa automaticamente gli aggiornamenti (consigliato)
    .accesskey = u
install-updates-automatically-description = Mantiene { -brand-short-name } al sicuro con le ultime correzioni di sicurezza.
check-updates-ask-label =
    .label = Verifica la disponibilità di aggiornamenti, ma chiedi prima dell’installazione
    .accesskey = c
...
connection-config-description = Controlla come { -brand-short-name } si connette a Internet.
connection-options-button =
    .label = Opzioni di connessione…
    .accesskey = O
offline-mode-legend = Modalità non in linea
offline-settings-label = Impostazioni non in linea
...
offline-settings-button =
    .label = Non in linea…
    .accesskey = N
temporary-storage-legend = Archiviazione temporanea
offline-compact-remove-deleted =
    .label = Rimuovi i dati dalle cartelle quando sono già stati eliminati per liberare spazio di archiviazione
    .accesskey = z
offline-compact-ask-cleanup =
    .label = Chiedi prima di pulire le cartelle
    .accesskey = u
...
use-cache-before =
    ...
    .accesskey = U
use-temp-storage-after = MB di spazio per i file temporanei
...
underline-text-links-label =
    .label = Sottolinea i link nei messaggi
    .accesskey = k
...
convert-emoticons-label =
    ...
    .accesskey = a
display-text-formatting-label = Formattazione del testo citato
...
search-content-types =
    .placeholder = Cerca tipi di contenuto
...
always-ask-label =
    ...
    .accesskey = C
use-tags-text = Utilizza le etichette per classificare e assegnare priorità ai messaggi.
...
mark-read-when-opened =
    .label = Immediatamente all’apertura
    .accesskey = I
show-attachments-inline-label =
    .label = Mostra gli allegati all’interno del corpo del messaggio
    .accesskey = o
mark-read-no-delay =
...
display-name-only-label =
    .label = Mostra solo il nome per i contatti salvati nella rubrica
    .accesskey = n
...
show-conversation-view-label =
    .label = Mostra vista conversazione
    .accesskey = z
conversation-view-preview-description = Questa funzionalità è ancora in fase di anteprima. Raggruppa i messaggi correlati, ma potrebbe non funzionare sempre come previsto.
...
dark-mode-message-appearance = Aspetto dei messaggi
dark-mode-checkbox-label =
    .label = Utilizza la modalità scura per il testo del messaggio
    .accesskey = u
dark-mode-message-text-description = Applica uno sfondo scuro a tutti i messaggi in arrivo, anche se il mittente li ha formattati con colori chiari.
...
dark-message-mode-toggle-label =
    ...
    .accesskey = M
dark-mode-toggle-description = Consente di visualizzare rapidamente un’email in modalità chiara durante la lettura, senza modificare le impostazioni principali.
general-folder-settings-header = Impostazioni cartelle
recent-folders-legend = Cartelle recenti
recent-folders-description = Determina come vengono visualizzate le cartelle usate di recente durante lo spostamento dei messaggi.
...
recent-sort-order-alphabetic =
    .label = Alfabetico
max-recent-label = Numero massimo di cartelle recenti:
    .accesskey = m
...
account-hub-manual-config-checkbox-label =
    .label = Utilizza il nuovo flusso di configurazione manuale nel Centro account
    .accesskey = U
account-hub-manual-config-checkbox-description = Flusso di configurazione manuale del nuovo Centro account
new-calendar-legend = Finestra di dialogo per nuovo evento del calendario
new-calendar-checkbox-label =
    .label = Visualizza gli eventi del calendario nella nuova finestra di dialogo
new-calendar-checkbox-description = Versione sperimentale della finestra di dialogo del calendario per visualizzare gli eventi
...
as-attachment-label =
    .label = come allegati
add-file-type-label =
    .label = Aggiungi tipo di file ai messaggi allegati
    .accesskey = A
extension-label =
    .label = Aggiungi l’estensione al nome del file
    .accesskey = e
forward-messages-label =
    .value = Inoltra messaggi come:
    .accesskey = I
forward-inline-label =
    .label = Dentro il messaggio (inline)
...
autosave-draft-label =
    .label = Salva automaticamente una bozza ogni
    .accesskey = S
...
spellcheck-while-typing-label =
    .label = Controlla l’ortografia durante la digitazione
    .accesskey = z
...
ignore-sender-styles-label =
    .label = Ignora caratteri e colori del mittente
    .accesskey = I
...
paragraph-spacing-label =
    .label = Premendo Invio si crea un nuovo paragrafo con una spaziatura maggiore
    .accesskey = m
...
compose-format-automatic-description = Invia il testo formattato se applichi stili (come grassetto o link), altrimenti invialo come testo semplice.
compose-format-both-option =
    .label = Sia testo formattato (HTML) che testo semplice
compose-format-both-description = Invia sempre entrambe le versioni, consentendo all’app di posta elettronica del destinatario di scegliere quale mostrare.
compose-format-html-option =
    .label = Solo testo formattato (HTML)
compose-format-html-description = Mantiene caratteri, colori e immagini personalizzati, ma alcune app di posta meno recenti potrebbero non visualizzarli correttamente.
compose-format-plain-option =
    .label = Solo testo semplice
compose-format-plain-description = Elimina formattazione, colori e immagini. Ideale per email di solo testo compatibili con qualsiasi dispositivo.
autocomplete-matches-description = Quando si digita il nome o l’email di un destinatario, cerca corrispondenze in:
company-network-directory-label =
    .label = Directory aziendale o di rete
    .accesskey = D
...
manage-directories-label =
    .label = Gestisci directory…
    .accesskey = r
collect-outgoing-label =
    .label = Salva automaticamente gli indirizzi email in uscita in:
    .accesskey = u
collect-outgoing-description = Posizione in cui vengono salvati i nuovi contatti creati manualmente o aggiunti dalle email.
save-added-contacts-label =
    .value = Salva i contatti aggiunti manualmente in:
    .accesskey = u
save-added-contacts-description = Dove vengono salvati i nuovi contatti aggiunti dalle email.
show-directory-startup-label =
    .value = Mostra cartella nella finestra della rubrica all’apertura di { -brand-short-name }
    .accesskey = c
...
email-picker-label =
    ...
    .accesskey = A
email-picker-description = La posizione dei nuovi contatti salvati dai messaggi inviati.
default-add-address-book-label =
    .value = Rubrica predefinita per i contatti aggiunti manualmente:
    .accesskey = R
default-add-address-book-description = La posizione dei nuovi contatti salvati dai messaggi ricevuti.
...
attachment-label =
    ...
    .accesskey = m
edit-keywords-label =
    .label = Modifica parole chiave…
    .accesskey = h
offer-share-large-files-label =
    .label = Suggerisci la condivisione dei file tramite link quando superano:
...
exceptions-button =
    .label = Eccezioni…
    .accesskey = E
remote-content-privacy-link = In che modo i contenuti remoti influiscono sulla privacy
remote-content-privacy-info = Ulteriori informazioni sui problemi di privacy dei contenuti remoti
remote-content-info =
...
global-privacy-control-label =
    .label = Chiedi ai siti web di non vendere o condividere dati personali
    .accesskey = C
...
passwords-registered-description = { -brand-short-name } può salvare le password degli account registrati.
view-saved-passwords-button =
    .label = Visualizza password salvate…
    .accesskey = V
primary-password-session-description = Una password principale protegge tutte le password e viene inserita una volta per sessione.
use-primary-password-label =
    .label = Utilizza password principale
    .accesskey = U
do-not-track-label =
...
spam-accounts-description = Queste impostazioni si applicano a tutti gli account. Le opzioni per i singoli account possono essere modificate in Impostazioni account.
...
spam-move-folder-label =
    .label = Sposta nella cartella Spam
    .accesskey = S
spam-delete-immediately-label =
    .label = Elimina immediatamente
    .accesskey = E
spam-move-label =
...
spam-marked-manually-label =
    .label = Se contrassegnato manualmente
    .accesskey = S
spam-detected-auto-label =
    .label = Rilevato automaticamente da { -brand-short-name }
    .accesskey = R
spam-log-keep-label =
    .label = Conserva un registro del rilevamento automatico dello spam
    .accesskey = C
...
reset-spam-button =
    ...
    .accesskey = u
scam-detection-description = { -brand-short-name } verifica la presenza di link di phishing e segnali comuni di frode via email nei messaggi.
scam-detection-label =
    .label = Avvisa quando leggi un’email che sembra truffa
    .accesskey = A
antivirus-check-description = Consente al software antivirus di controllare individualmente i messaggi in arrivo prima che vengano salvati sul computer.
antivirus-isolate-label =
    .label = Consenti al software antivirus di isolare le email infette
    .accesskey = C
certificate-verify-description = Quando un server richiede un certificato per verificare la tua identità:
certificate-choose-auto =
    .label = Scegli automaticamente un certificato
    .accesskey = S
...
email-e2ee-automatism-note = Nota: è anche possibile attivare o disattivare manualmente la crittografia durante la scrittura di un messaggio. La risposta a un messaggio crittato attiva sempre la crittografia.
...
remote-content-images-label =
    .label = Consenti contenuti remoti (immagini e stili)
    .accesskey = C
...
preferences-doh-setting-automatic =
    ...
    .accesskey = P
preferences-doh-automatic-desc = { -brand-short-name } critta automaticamente le ricerche di indirizzi quando disponibili. Ritorna alle ricerche di rete standard in caso di problemi di connessione o se una VPN o una rete gestita lo richiedono.
...
preferences-doh-setting-enabled =
    ...
    .accesskey = P
preferences-doh-increased-desc = Utilizza sempre il provider scelto. Utilizza la connessione standard solo se il provider sicuro non funziona.
...
preferences-doh-setting-maximum =
    .label = Massima protezione
    .accesskey = M
preferences-doh-maximum-desc = Richiede rigorosamente DNS crittato. I siti web non verranno caricati se la connessione sicura non riesce.
...
preferences-doh-setting-off =
    .label = Disattivato
    .accesskey = D
preferences-doh-off-standard-desc = Utilizza un provider Internet o una rete standard per cercare indirizzi web
...
preferences-doh-url-custom =
    ...
    .accesskey = P
preferences-doh-secure-header = DNS sicuro (DNS su HTTPS)
preferences-doh-secure-description = Secure DNS critta le richieste di ricerca inviate da { -brand-short-name } per trovare siti web, mantenendo la tua attività di navigazione privata da qualsiasi monitoraggio della rete.
...
search-preferences-input2 =
    ...
    .style = width: 20em
managed-by-organization-notice = { -brand-short-name } è gestito da un’organizzazione.
...
qr-export-passwords-legend = Password
qr-export-include-passwords-label = Includi le password degli account nel codice QR
qr-export-web-sign-in-note = <strong>Nota:</strong> gli account che utilizzano l’accesso al Web (come Gmail o Yahoo) richiedono nuovamente l’autenticazione sul dispositivo.
qr-export-private-transfer-note = <strong>Trasferimento privato:</strong> le impostazioni e le password vengono spostate direttamente dal computer al telefono. Nulla viene inviato o memorizzato sui server Mozilla.
qr-export-screen-privacy-tip = <strong>Suggerimento:</strong> mantieni lo schermo nascosto mentre il codice QR è visualizzato.
...
accent-color-legend = Colore accento
accent-color-selection-label =
    .value = Scegli il colore dei pulsanti principali e degli elementi in evidenza
accent-color-label =
    .value = Definisci il colore utilizzato per i pulsanti principali e gli elementi evidenziati:
accent-color-os =
    .label = Segui sistema operativo
accent-color-thunderbird =
    .label = Blu Thunderbird
accent-color-purple =
    .label = Viola
accent-color-orange =
    .label = Arancio
...
accent-color-teal =
    .label = Verde acqua
accent-color-disabled-description = Le tonalità di accento non sono disponibili quando è attiva la modalità Contrasto elevato.
default-message-list-legend = Elenco messaggi
appearance-view-style-select =
    .value = Seleziona lo stile di visualizzazione:
appearance-view-style =
    .value = Stile di visualizzazione:
appearance-radio-table =
    .label = Vista tabella
appearance-radio-card-view =
    .label = Visualizzazione a schede
card-view-options-legend = Opzioni di visualizzazione delle schede
...
default-message-list-new-folders-description = Scegli le impostazioni predefinite di ordinamento e raggruppamento in conversazioni per le nuove cartelle
...
default-sort-by-label = Ordina i messaggi per:
...
default-sort-newest-bottom =
    .label = Messaggi più recenti in fondo
default-sort-new-messages-top =
    .label = Messaggi più recenti in alto
apply-view-settings-label = Applica queste impostazioni di visualizzazione a:
apply-view-settings-to-all-folders-button =
    .label = Tutte le cartelle e le sottocartelle
    .accesskey = T
select-apply-sort-folders-button =
    .label = Seleziona cartelle
    .accesskey = S
