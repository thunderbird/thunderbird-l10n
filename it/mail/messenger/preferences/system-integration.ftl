...
default-app-intro = Utilizza { -brand-short-name } come app predefinita per:
...
checkbox-net-thunderbird-url-label =
    .label = Collegamenti personalizzati a Thunderbird (net.thunderbird://)
    .tooltiptext = { unset-default-tooltip }
...
check-on-startup-label =
    ...
    .accesskey = A
system-settings-dialog-title = Impostazioni di sistema
