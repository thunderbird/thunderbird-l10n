...
account-hub-result-graph-shortname = Exchange (grafico)
account-hub-result-graph-description = Utilizza l’API di Microsoft Graph per sincronizzare cartelle ed email
