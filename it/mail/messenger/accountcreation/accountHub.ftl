...
address-book-add-remote-description = Connetti a una rubrica remota di CardDav
...
address-book-add-ldap-icon =
    .alt = Connessione a una rubrica LDAP remota
address-book-add-ldap = Nuova rubrica LDAP
address-book-add-ldap-description = Connessione a una rubrica LDAP remota
