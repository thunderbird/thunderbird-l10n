...
account-hub-email-set-up-account-button = Configura account
account-hub-email-confirm-button = Conferma
account-hub-email-find-settings-button = Trova impostazioni
account-hub-email-connect-button = Connetti
account-hub-result-incoming-legend = In entrata
account-hub-result-outgoing-legend = In uscita
account-hub-all-servers-legend = Tutti i server
...
account-hub-servers-username-label = Nome utente:
account-hub-result-server-label = Server:
account-hub-result-port-label = Porta:
account-hub-result-security-label = Sicurezza:
account-hub-result-authentication-type-label = Autenticazione:
account-hub-result-authentication-none = Nessuna
    .title = Nessuna
account-hub-result-authentication-password = Password normale
    .title = Password normale
account-hub-result-authentication-encrypted-password = Password crittata
    .title = Password crittata
account-hub-result-authentication-gssapi = Kerberos
    .title = Kerberos
account-hub-result-authentication-ntlm = NTLM
    .title = NTLM
account-hub-result-authentication-external = Esterna
    .title = Esterna
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = Nessuna
account-hub-result-auth-password = Password normale
account-hub-result-auth-encrypted-password = Password crittata
account-hub-result-auth-gssapi = Kerberos
account-hub-result-auth-ntlm = NTLM
account-hub-result-auth-external = Esterna
...
account-hub-exchange-service-url-label = Inserire l’indirizzo (URL) del servizio
...
account-hub-welcome = Benvenuti in
...
account-hub-success-addon = Componente aggiuntivo installato correttamente
account-hub-success-half-manual = Sono state rilevate le seguenti impostazioni dal server indicato:
account-hub-result-security-no-encryption = Nessuna cifratura
    .title = Nessuna cifratura
...
account-hub-exchange-dialog-question = { -brand-short-name } ha trovato le informazioni per la configurazione dell’account su { $domain }. Procedere e inviare le tue credenziali?
...
account-hub-manual-config-imap-title = Impostazioni IMAP
account-hub-manual-config-pop3-title = Impostazioni POP3
account-hub-manual-config-review-settings-title = Rivedi le impostazioni aggiornate
account-hub-manual-config-incoming-legend = Server in entrata
account-hub-manual-config-outgoing-legend = Server in uscita
# Label for checkbox that will hide an outgoing username input if it's the same is the incoming
account-hub-same-username-checkbox = Stesso nome utente del server in entrata
# Variables:
...
account-hub-manual-config-security-changed = Impossibile trovare { $oldValue }, ma { $newValue } è disponibile.
# Variables:
...
account-hub-manual-config-port-changed = Impossibile raggiungere la porta { $oldValue }, ma la porta { $newValue } è disponibile.
# Variables:
# $oldValue (String): The value requested before the configuration was tested.
# $newValue (String): The value found after the configuration was tested.
account-hub-manual-config-value-changed = Impossibile utilizzare { $oldValue }, ma { $newValue } è disponibile.
account-hub-protocol-imap = Sincronizzazione tra più dispositivi
account-hub-protocol-microsoft = Exchange o Microsoft 365
account-hub-protocol-pop3 = Scarica sul dispositivo
account-hub-oauth-unsupported-title = È richiesta una configurazione aggiuntiva
# Note: 'Advanced configuration' is the text of the link/button at the bottom of the form (e.g., account-hub-exchange-type-advanced-config)
# 'Account Settings' is the text of the menu option/tab name accessible outside Account Hub
account-hub-oauth-unsupported-description = { -brand-short-name } non può configurare automaticamente OAuth2 per questo nome host. Selezionare Configurazione avanzata per creare l’account, quindi completare la configurazione da Impostazioni account. <a data-l10n-name="oauth-support-link">Richiedi assistenza per la configurazione di OAuth2.</a>
account-hub-username-help-text = Di solito è il tuo indirizzo email completo
...
account-hub-email-exchange-settings = Impostazioni di Exchange
account-hub-email-connect-settings = Collega le tue impostazioni email
account-hub-email-protocol-select-header = Scegli un tipo di account email
account-hub-email-protocol-select-additional-info = Sono necessarie ulteriori informazioni per configurare questo account.
account-hub-email-protocol-select-notification = Sono necessarie ulteriori informazioni per configurare questo account
...
account-hub-result-graph-api-description = Utilizza l’API Microsoft Graph per sincronizzare cartelle ed email con Microsoft 365
account-hub-result-graph-shortname = Exchange (Graph)
account-hub-result-graph-description = Utilizza l’API Microsoft Graph per sincronizzare cartelle ed email
...
account-hub-result-ews-expanded-text = Servizi Web Exchange
...
account-hub-config-success-title = Impostazioni account trovate automaticamente.
account-hub-config-success-description-db = Configurazione trovata in Mozilla ISPDB.
account-hub-config-success-description-exchange = Configurazione rilevata per un server Microsoft Exchange.
...
account-hub-manual-config-error-summary = Risolvi i seguenti errori:
...
address-book-add-remote-icon2 =
    .alt = Aggiungi una rubrica remota
address-book-add-remote-icon =
    .alt = Aggiungi una nuova rubrica remota
address-book-add-remote = Aggiungi rubrica remota
address-book-add-remote-carddav-description = Connetti a una rubrica CardDAV
...
address-book-add-ldap-icon2 =
    .alt = Aggiungi una rubrica LDAP
address-book-add-ldap-button = Aggiungi rubrica LDAP
...
account-hub-exchange-type-account-type = Tipo account
account-hub-card-graph-title = Microsoft Graph
account-hub-card-graph-description = Microsoft Graph è un metodo di connessione moderno per Microsoft 365.
account-hub-card-ews-title = Servizi Web Exchange
account-hub-card-ews-tag = Legacy
account-hub-card-ews-description = Exchange Web Services (EWS) si connette a Microsoft Exchange per sincronizzare la posta.
# This is shown after the type description, so "it" is referring to the type (either Microsoft Graph or Exchange Web Services).
account-hub-card-recommended-description = È consigliato in quanto corrisponde all’URL del servizio.
account-hub-exchange-type-username = Nome utente
account-hub-exchange-type-username-hint = Solitamente il tuo indirizzo email o l’UPN di Active Directory.
account-hub-exchange-type-authentication = Metodo di autenticazione
# Checkbox that can be unchecked to use a custom OAuth config.
account-hub-exchange-type-default-oauth = Utilizza le impostazioni di autenticazione predefinite di Microsoft 365 Copilot
account-hub-exchange-type-oauth-tenant = ID tenant
account-hub-exchange-type-oauth-app = ID app
account-hub-exchange-type-advanced-config = Impostazioni avanzate
account-hub-exchange-type-title = Scegli un tipo di account
