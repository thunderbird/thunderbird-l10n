...
account-hub-exchange-service-url-label = Inserire l’indirizzo del servizio
...
account-hub-result-graph-api-description = Utilizza l’API di Microsoft Graph per sincronizzare cartelle ed email con Microsoft 365
