...
books-pane-create-contact-button = Nuovo contatto
    .title = Crea un nuovo contatto
books-pane-add-book-button =
    .title = Aggiungi rubrica
...
address-book-list =
    .aria-label = Elenco delle rubriche
...
about-addressbook-search-all2 =
    .label = Cerca in tutte le rubriche
...
about-addressbook-export-selected-filename = Contatti
...
about-addressbook-photo-dialog-title =
    .aria-label = Gestisci la foto per questo contatto.
...
ab-search-dialog-matches-found =
    .value =
        { $count ->
            [one] { $count } corrispondenza trovata
           *[other] { $count } corrispondenze trovate
        }
...
ab-search-dialog-delete-button =
    .label = Elimina
    .accesskey = E
ab-search-dialog-title = Ricerca avanzata rubrica
