...
tree-list-view-row-thread-icon =
    .alt = Indicatore messaggio in discussione
    .title = Questo è un messaggio in thread
tree-list-view-row-ignored-thread = Discussione ignorata
tree-list-view-row-ignored-thread-icon =
    .alt = Indicatore messaggio in discussione
    .title = Questo messaggio in thread viene ignorato
tree-list-view-row-ignored-subthread = Sottothread ignorato
tree-list-view-row-ignored-subthread-icon =
    .alt = Indicatore messaggio in discussione
    .title = Questo sottothread viene ignorato
tree-list-view-row-watched-thread = Discussione controllata
tree-list-view-row-watched-thread-icon =
    .alt = Indicatore messaggio in discussione
    .title = Questo messaggio in thread è stato controllato
