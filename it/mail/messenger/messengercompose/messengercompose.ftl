...
compose-invalid-address-title = Indirizzo destinatario non valido
compose-no-recipients = Non sono stati specificati destinatari. Inserire un destinatario o un gruppo di discussione nel campo indirizzo.
# Variables:
# $address - invalid email address
compose-invalid-address = { $address } non è un indirizzo email valido in quanto non è nella forma utente@server. Deve essere corretto prima di inviare l’email.
...
compose-attach-page-title = Indicare l’indirizzo da allegare
compose-attach-page-prompt = Pagina web (URL):
compose-message-part-attachment-name = Parte allegato al messaggio
...
compose-remove-address-row-title = Elimina gli indirizzi in { $field }
# Variables:
# $field - name of the addressing field being removed
compose-remove-address-row-prompt = Eliminare gli indirizzi in { $field }?
...
compose-button-send =
    .label = Invia
    .tooltiptext = Invia il messaggio ora
compose-button-send-later =
    .label = Invia dopo
    .tooltiptext = invia più tardi
