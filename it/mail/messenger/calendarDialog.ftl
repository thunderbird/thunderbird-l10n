...
calendar-dialog-attendees-too-many-guests = Impossibile visualizzare la lista degli invitati in quanto contiene più di 50 elementi.
...
calendar-dialog-reminder-week-before = 1 settimana prima
# Variables:
