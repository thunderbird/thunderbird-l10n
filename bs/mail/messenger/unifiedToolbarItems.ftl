...
toolbar-synchronize-label = Sinhronizuj
toolbar-synchronize =
    .title = Ponovo učitaj kalendare i sinhronizuj promjene
toolbar-delete-event-label = Izbriši
toolbar-delete-event =
    .title = Izbriši odabrane događaje ili zadatke
toolbar-go-to-today-label = Idi na danas
toolbar-go-to-today =
    .title = Idi na danas
toolbar-print-event-label = Štampaj
toolbar-print-event =
    .title = Štampaj događaje ili zadatke
toolbar-new-event-label = Događaj
toolbar-new-event =
    .title = Napravi novi događaj
toolbar-new-task-label = Zadatak
toolbar-new-task =
    .title = Napravi novi zadatak
toolbar-go-back-label = Nazad
toolbar-go-back =
    .title = Idi nazad jednu poruku
toolbar-go-forward-label = Naprijed
toolbar-go-forward =
    .title = Idi naprijed jednu poruku
toolbar-stop-label = Zaustavi
toolbar-stop =
