...
reminder-readonly-notification = Podsjetnici za kalendare samo za čitanje, ne mogu biti odgođeni nego samo odbačeni - dugme '{ $label }' će odgoditi podsjetnike samo za pisajuće kalendare.
