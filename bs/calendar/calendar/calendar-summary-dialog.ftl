...
event-accepted = Prihvatili ste ovaj poziv
# This will be displayed as notification in the summary dialog if the user has
# accepted the event invitation tentatively
event-tentative = Prihvatili ste ovaj poziv privremeno
# This will be displayed as notification in the summary dialog if the user has
# declined the event invitation.
event-declined = Odbili ste ovaj poziv
# This will be displayed as notification in the summary dialog if the user has
...
event-needs-action = Niste još odgovorili na ovaj poziv
# This will be displayed as notification in the summary dialog if the user has
# accepted the assigned task
task-accepted = Prihvatili ste da radite na ovom zadatku
# This will be displayed as notification in the summary dialog if the user has
# accepted tentatively the assigned task.
task-tentative = Privremeno ste prihvatili da radite na ovom zadatku
# This will be displayed as notification in the summary dialog if the user has
