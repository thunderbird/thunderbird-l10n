...
menu-file-get-next-n-news-msgs =
    { $count ->
        [one] Retschaiver il proxim messadi da novitads
       *[other] Retschaiver ils proxims { $count } messadis da novitads
    }
...
allow-remote-content-resource =
    .label = Permetter cuntegn extern da { $origin }
# Variables:
...
tags-label-1 = Impurtant
tags-label-2 = Lavur
tags-label-3 = Persunal
tags-label-4 = Da far
tags-label-5 = Pli tard
tags-add-new =
...
tags-manage =
    ...
    .accesskey = M
tags-remove-all =
    .label = Allontanar tut las etichettas
    .accesskey = 0
# Variables:
