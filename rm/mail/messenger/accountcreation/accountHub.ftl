...
account-hub-result-hostname-label = Num dal host
    .title = Num dal host
account-hub-result-socket-type-label = Segirezza da la connexiun
...
account-hub-result-exchange-url-label = URL dal punct final Exchange
...
account-hub-maximize-button =
    .title = Maximar l’administraziun da contos
account-hub-email-manual-configuration = Configuraziun manuala
account-hub-notification-unknown-host = Infurmaziuns da configuraziun chattadas sin ina domena d’ina terza partida
account-hub-ssl-noencryption = Nagina
account-hub-email-skip-button = Sursiglir
account-hub-finding-sync-accounts = Creà il conto. Tschertgar cudeschets d’adressas e chalenders…
account-hub-name-warning-icon =
    .title = Endatescha per plaschair tes num
account-hub-email-label = Adressa dad e-mail
    .accesskey = e
...
account-hub-password-label = Pled-clav
    .accesskey = P
    .title = Facultativ, vegn mo utilisà per validar il num d'utilisader
account-hub-remember-password = Memorisar il pled-clav
    .accesskey = m
account-hub-exchange-label = Tias datas d'annunzia
    .accesskey = d
account-hub-installing-addon = Telechargiar ed installar il supplement…
account-hub-success-addon = Installà il supplement cun success
account-hub-success-half-manual = La suandanta configuraziun è vegnida chattada cun examinar il server inditgà:
account-hub-result-security-no-encryption = Nagin criptadi
    .title = Nagin criptadi
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = Nagin criptadi
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = L'autentificaziun n'è betg reussida. Controllescha per plaschair il num d'utilisader ed il pled-clav.
...
account-hub-exchange-config-unverifiable = I n'è betg reussì da verifitgar la configuraziun. Sche tes num d'utilisader ed il pled-clav èn corrects, èsi probabel che l'administratur dal server ha deactivà la configuraziun tschernida per tes conto. Emprova da tscherner in auter protocol.
account-hub-advanced-setup-button = Configuraziun avanzada
    .accesskey = a
# Variables:
...
account-hub-result-graph-description = Utilisar l’API Microsoft Graph per sincronisar tes ordinaturs ed e-mails
...
account-hub-config-success-exchange = Chattà ina configuraziun per in server Microsoft Exchange
account-hub-config-success-guess = Chattà ina configuraziun cun empruvar ils nums da server ils pli frequents
account-hub-config-success-disk = Chattà ina configuraziun en l’installaziun da { -brand-short-name }
account-hub-config-success-isp = Chattà ina configuraziun tar il purschider dad e-mail
account-hub-config-success-unknown = Chattà ina configuraziun
...
account-hub-select-security-warning = <span data-l10n-name="error-text">Attenziun: Chattà in server dad e-mail malsegir.</span> Quest server na dispona betg d’in criptadi e revelescha perquai tes pled-clav e tias datas. Contactescha tes administratur per segirar la connexiun u cuntinuescha sin atgna ristga. <a data-l10n-name="faq-link">Vesair las FAQ per ulteriuras infurmaziuns.</a>
