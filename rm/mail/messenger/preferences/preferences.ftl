...
pane-appearance-title = Apparientscha
category-appearance =
...
update-application-background-enabled =
    .label = Cura che { -brand-short-name } na vegn betg exequì
    .accesskey = C
...
dark-message-mode-legend = Stil per la lectura da messadis
...
dark-message-mode-toggle-label =
    ...
    .accesskey = t
dark-message-mode-toggle-description = Mussar ina opziun en il chau-pagina da messadis per deactivar a moda svelta il modus stgir per ils messadis
...
appearance-category-header = Apparientscha
default-message-list-legend = Glista da messadis
default-message-list-description = Definir las opziuns predefinidas per la zavrada e la structura dad ordinaturs creads da nov.
default-flag-label =
    .value = Structura predefinida:
default-flag-unthreaded =
    .label = Betg gruppà
default-flag-threaded =
    .label = Gruppà tenor tema
default-flag-grouped =
    .label = Gruppà tenor zavrada
default-sort-label = Zavrada predefinida tenor:
default-sort-date =
    .label = Data
