...
dark-reader-legend = Colurs dal lectur
dark-reader-checkbox-label =
    .label = Adattar al modus stgir
    .accesskey = d
dark-reader-checkbox-description = Funcziun experimentala per adattar la panela da messadis al modus stgir
