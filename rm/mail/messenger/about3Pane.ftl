...
folder-pane-mode-header-all = Tut ils ordinaturs
folder-pane-mode-header-unread = Ordinaturs nunlegids
...
threadpane-column-header-a11y-id =
    .aria-label = Successiun dad entrada
...
threadpane-column-header-a11y-select =
    .aria-label = Tscherner ils messadis
