...
looking-for-messages-account = Tschertgar novs messadis per { $accountName }…
# Feedback message shown in the status bar while we look for new messages in a
# specific folder.
# Variables:
# $folderName (String) - The folder's name.
looking-for-messages-folder = Tschertgar novs messadis en { $folderName }…
...
# $folderName (String) - The folder's name.
deleting-messages = Stizzar { $number } messadi(s) da { $folderName }…
