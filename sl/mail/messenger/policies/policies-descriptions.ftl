...
policy-DisableChat = Onemogoči možnost klepeta.
policy-DisableDataCollectionSettings = Uporabniku prepreči spreminjanje nastavitev zbiranja podatkov.
...
policy-DisableMessageForwardingFilters = Filtrom za sporočila prepreči samodejno posredovanje sporočil.
...
policy-DisableExperimentalFeatures = Onemogoči poskusne zmožnosti v Thunderbirdu.
...
policy-DisableUpdateSettings = Uporabniku prepreči spreminjanje nastavitev posodobitev aplikacije.
...
policy-InAppNotification = Omogoči ali onemogoči vrste obvestil.
