...
account-hub-email-set-up-account-button = Nastavi račun
account-hub-email-confirm-button = Potrdi
account-hub-email-find-settings-button = Poišči nastavitve
...
account-hub-servers-username-label = Uporabniško ime:
account-hub-result-server-label = Strežnik:
account-hub-result-port-label = Vrata:
account-hub-result-security-label = Varnost:
account-hub-result-authentication-type-label = Overitev:
account-hub-result-authentication-none = Brez
    .title = Brez
account-hub-result-authentication-password = Običajno geslo
    .title = Običajno geslo
account-hub-result-authentication-encrypted-password = Šifrirano geslo
    .title = Šifrirano geslo
account-hub-result-authentication-gssapi = Kerberos
    .title = Kerberos
account-hub-result-authentication-ntlm = NTLM
    .title = NTLM
account-hub-result-authentication-external = Zunanja
    .title = Zunanja
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = Brez
account-hub-result-auth-password = Običajno geslo
account-hub-result-auth-encrypted-password = Šifrirano geslo
account-hub-result-auth-gssapi = Kerberos
account-hub-result-auth-ntlm = NTLM
account-hub-result-auth-external = Zunanja
...
account-hub-select-option =
    .label = Izberite eno od možnosti
...
account-hub-password-label = Geslo
    .accesskey = G
    .title = Neobvezno, uporabljeno bo samo za preveritev veljavnosti uporabniškega imena
account-hub-remember-password = Zapomni si geslo
    .accesskey = Z
account-hub-exchange-label = Vaša prijava
    .accesskey = p
account-hub-installing-addon = Prenašanje in nameščanje dodatka …
account-hub-success-addon = Dodatek je uspešno nameščen
account-hub-success-half-manual = Z zaznavanjem navedenega strežnika so bile najdene naslednje nastavitve:
account-hub-result-security-no-encryption = Brez šifriranja
    .title = Brez šifriranja
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = Brez šifriranja
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = Overitev ni uspela. Preverite uporabniško ime in geslo
...
account-hub-exchange-config-unverifiable = Nastavitve ni bilo mogoče preveriti. Če sta uporabniško ime in geslo pravilna, je skrbnik strežnika verjetno onemogočil izbrano nastavitev za vaš račun. Poskusite izbrati drug protokol.
account-hub-advanced-setup-button = Napredne nastavitve
    .accesskey = a
# Variables:
#  $domain (String): The name of the server where the configuration was found, e.g. rackspace.com.
account-hub-exchange-dialog-question = { -brand-short-name } je našel podatke za nastavitev računa na { $domain }. Ali želite nadaljevati in vnesti svoje prijavne podatke?
account-hub-creation-error-title = Napaka pri ustvarjanju računa
account-hub-error-server-exists = Dohodni strežnik že obstaja.
account-hub-confirm-advanced-title = Potrdite napredne nastavitve
account-hub-confirm-advanced-description = To pogovorno okno se bo zaprlo in ustvaril se bo račun s trenutnimi nastavitvami, tudi če nastavitev ni pravilna. Ali želite nadaljevati?
account-hub-addon-install-title = Namesti
...
account-hub-result-ews-expanded-text = Spletne storitve Exchange
...
account-hub-select-security-warning = <span data-l10n-name="error-text">Opozorilo: zaznan je bil nezavarovan poštni strežnik.</span> Ta strežnik ne uporablja šifriranja, zato so vaše geslo in podatki izpostavljeni prisluškovalcem. Svetujte skrbniku, naj zavaruje povezavo, ali nadaljujte na lastno odgovornost. <a data-l10n-name="error-link">Za več informacij glejte pogosta vprašanja.</a>
...
address-book-add-remote-icon2 =
    .alt = Dodaj oddaljeni imenik
address-book-add-remote-icon =
    .alt = Dodaj nov oddaljeni imenik
address-book-add-remote = Dodaj oddaljeni imenik
address-book-add-remote-carddav-description = Poveži z imenikom CardDAV
...
address-book-add-ldap-icon2 =
    .alt = Dodaj imenik LDAP
address-book-add-ldap-button = Dodaj imenik LDAP
