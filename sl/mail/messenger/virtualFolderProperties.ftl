...
virtual-folder-name = Ime:
    .accesskey = m
virtual-folder-description = Ustvari kot podmapo v:
    .accesskey = U
...
virtual-folder-list-title = Izberi mape
virtual-folder-list-desc = Izberite mape za iskanje:
