...
close-to-tray-label =
    .label = Ob zapiranju premakni { -brand-short-name(sklon: "tozilnik") } v pladenj opravilne vrstice
    .accesskey = c
start-in-tray-label =
    .label = Zaženi { -brand-short-name(sklon: "tozilnik") } v pladnju opravilne vrstice
    .accesskey = Z
...
gloda-show-results-as-list-label =
    .label = Rezultate splošnega iskanja privzeto prikaži kot seznam
    .accesskey = l
...
offline-settings-button =
    .label = Brez povezave …
    .accesskey = B
temporary-storage-legend = Začasna shramba
...
general-folder-options-header = Možnosti upravljanja map
recent-destinations-legend = Nedavni cilji
recent-destinations-description = Možnosti za prikaz in razvrščanje map, v katere so bila nedavno premaknjena sporočila.
recent-sort-order-label = Vrstni red:
    .accesskey = s
recent-sort-order-mru =
    .label = Najnovejše
recent-sort-order-alphabetic =
    .label = Po abecednem redu
max-recent-label = Največje število nedavnih map:
    .accesskey = N
...
email-picker-label =
    ...
    .accesskey = S
email-picker-description = Mesto shranjevanja novih stikov, shranjenih iz poslanih sporočil.
default-add-address-book-label =
    .value = Privzeti imenik za ročno dodane stike:
    .accesskey = d
default-add-address-book-description = Mesto shranjevanja novih stikov, shranjenih iz prejetih sporočil.
...
exceptions-button =
    .label = Izjeme …
    .accesskey = z
remote-content-privacy-info = Več o vprašanjih zasebnosti oddaljene vsebine
remote-content-info =
...
spam-read-auto-label =
    ...
    .accesskey = T
spam-log-label =
    .label = Omogoči dnevnik prilagodljivega filtra neželene pošte
    .accesskey = d
spam-log-button =
...
accent-color-legend = Barva poudarkov
accent-color-label =
    .value = Določite barvo za glavne gumbe in poudarjene elemente:
accent-color-os =
    .label = Sledi operacijskemu sistemu
accent-color-thunderbird =
    .label = Thunderbirdova modra
accent-color-purple =
    .label = Vijolična
accent-color-orange =
    .label = Oranžna
...
accent-color-teal =
    .label = Turkizna
accent-color-disabled-description = V visokokontrastnem načinu barve poudarkov niso podprte.
