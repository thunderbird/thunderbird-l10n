...
default-app-intro = Uporabi { -brand-short-name(sklon: "tozilnik") } kot privzeti program za:
...
checkbox-net-thunderbird-url-label =
    .label = Thunderbirdove povezave po meri (net.thunderbird://)
    .tooltiptext = { unset-default-tooltip }
...
check-default-email-app-label =
    .label = Ob odpiranju vedno preveri, ali je { -brand-short-name } privzeti program za e-pošto
    .accesskey = a
check-on-startup-label =
    .label = Vedno preveri ob zagonu { -brand-short-name }a
    .accesskey = V
system-settings-dialog-title = Sistemske nastavitve
