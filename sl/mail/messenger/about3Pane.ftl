...
quick-filter-bar-tag-mode-none =
    .label = Samo neoznačena
    .title = Samo sporočila brez oznak
...
folder-pane-mode-header-all = Vse mape
folder-pane-mode-header-unread = Neprebrane mape
folder-pane-mode-header-favorite = Priljubljene mape
folder-pane-mode-header-recent = Nedavne mape
folder-pane-mode-header-smart = Poenotene mape
