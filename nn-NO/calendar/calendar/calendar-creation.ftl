...
calendar-creation-panel-network-settings =
    .buttonlabelaccept = Finn kalendrar
...
calendar-creation-location-placeholder =
    .placeholder = URL eller vertsnamn på kalenderserveren
    .default-placeholder = URL eller vertsnamn på kalenderserveren
calendar-creation-network-nocredentials =
    .label = Denne adressa krev ikkje innlogging
calendar-creation-network-loading = Vent medan kalendrane dine blir oppdaga.
calendar-creation-network-notfound = Kan ikkje finne kalendrar på denne adressa. Kontroller innstillingane dine.
