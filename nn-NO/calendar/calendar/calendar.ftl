...
item-modified-on-server-title = Hending endra på tenaren
item-modified-on-server = Denne hendinga er nyleg blitt endra på tenaren.
modify-will-lose-data = Dersom du sender inn endringane dine, overskriv du endringane som er gjort på tenaren.
delete-will-lose-data = Slettar du denne hendinga vil endringane som er gjort på tenaren gå tapt.
...
item-put-error = Det oppstod ein feil ved lagring av hendingar på tenaren.
item-delete-error = Det oppstod ein feil ved sletting av hendingar på tenaren.
...
cal-dav-request-status-code-string-503 = Intern tenarfeil (serveren er mellombels nede?).
