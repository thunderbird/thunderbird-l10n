...
folder-props-window-title = Eigenskapar
...
folder-props-reset-color =
    .tooltiptext = Gjenopprett standardfarge
folder-props-location =
    .value = Adresse:
    .accesskey = A
folder-props-number-of-messages =
    .value = Tal på meldingar:
...
folder-props-include-in-global-search =
    .label = Inkluder meldingar i denne mappa i globalt søkjeresultat
    .accesskey = n
folder-props-check-for-new-messages =
    .label = Ved nedlasting av nye meldingar for denne kontoen, kontroller alltid denne mappa
    .accesskey = d
folder-props-rebuild-summary-explanation = Av og til kan oppsummeringsfila (.msf) verte skada, og meldingar kan sjå ut til å forsvinne, eller sletta meldingar kan bli vist. Å reparere mappa kan rette opp desse problema.
...
folder-props-select-for-offline =
    .label = Vel denne mappa for fråkopla bruk
    .accesskey = V
folder-props-download-now =
    .label = Last ned no
    .accesskey = L
folder-props-select-newsgroup-for-offline =
    .label = Vel denne nyheitsgruppa for fråkopla bruk
    .accesskey = V
...
folder-props-permissions =
    .value = Du har følgande løyve:
folder-props-other-users =
    .value = Andre med tilgang til denne mappa:
folder-props-type =
    .value = Mappetype:
