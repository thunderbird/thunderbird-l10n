...
webext-perms-description-messages-send = Send e-postmeldingar i stort antal på dine vegner utan visuell tilbakemelding. Bruk aktivitetshandsamaren for å sjå gjennom sendehistorikken til tillegget.
webext-perms-description-messages-save = Lagre e-postmeldingar som utkast eller malar programmatisk, utan at du treng å gjere noko.
