...
looking-for-messages-account = Ser etter nye meldingar for { $accountName }…
# Feedback message shown in the status bar while we look for new messages in a
# specific folder.
# Variables:
# $folderName (String) - The folder's name.
looking-for-messages-folder = Ser etter nye meldingar i { $folderName }…
...
deleting-message =
    { $number ->
        [one] Slettar ei melding frå { $folderName }…
       *[other] Slettar { $number } meldingar frå { $folderName }…
    }
