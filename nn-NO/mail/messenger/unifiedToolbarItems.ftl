...
toolbar-spam =
    .title = Merk dei valde meldingane som søppelpost
toolbar-not-spam-label = Ikkje søppelpost
toolbar-not-spam =
    .title = Merk dei valde meldingane som ikkje søppelpost
...
toolbar-add-address-book-label = Legg til adressebok
