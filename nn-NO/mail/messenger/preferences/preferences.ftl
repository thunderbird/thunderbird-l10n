...
gloda-show-results-as-list-label =
    .label = Vis globale søkjeresultater som ei liste, som standard
    .accesskey = V
...
update-settings-title = Oppdater innstillingar
...
offline-mode-legend = Fråkopla modus
offline-settings-label = Innstillingar for fråkopla tilstand
...
recent-sort-order-alphabetic =
    .label = Alfabetisk
max-recent-label = Maksimalt antal nylege mapper:
    .accesskey = M
...
email-picker-label =
    ...
    .accesskey = A
email-picker-description = Plasseringa der nye kontaktar frå sende meldingar blir lagra.
default-add-address-book-label =
    .value = Standard adressebok for manuelt tillagde kontaktar:
    .accesskey = S
default-add-address-book-description = Plasseringa der nye kontaktar frå mottekne meldingar blir lagra.
...
exceptions-button =
    .label = Unntak…
    .accesskey = U
remote-content-privacy-info = Les meir om personvernutfordringane ved eksternt innhald
remote-content-info =
