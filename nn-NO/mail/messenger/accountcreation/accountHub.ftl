...
account-hub-servers-username-label = Brukarnamn:
account-hub-result-server-label = Server:
account-hub-result-port-label = Port:
account-hub-result-security-label = Sikkerheit
account-hub-result-authentication-type-label = Autentisering:
account-hub-result-authentication-none = Ingen
    .title = Ingen
account-hub-result-authentication-password = Vanleg passord
    .title = Vanleg passord
account-hub-result-authentication-encrypted-password = Kryptert passord
...
account-hub-result-auth-password = Vanleg passord
account-hub-result-auth-encrypted-password = Kryptert passord
...
account-hub-exchange-service-url-label = Skriv inn tenesteadressa
...
account-hub-privacy-policy = Personvernpraksis
account-hub-welcome = Velkomen til
account-hub-welcome-brand = { -brand-short-name }
account-hub-welcome-text = Velkomen til { -brand-short-name }
...
account-hub-password-label = Passord
    .title = Valfritt, vil berre brukast for å validere brukarnamnet
    .accesskey = P
account-hub-remember-password = Hugs passord
    .accesskey = H
account-hub-exchange-label = Di innlogging:
    .accesskey = D
account-hub-installing-addon = Lastar ned og installerer utviding…
account-hub-success-addon = Utvidinga vart installert
account-hub-success-half-manual = Følgjande innstillingar vart funne ved undersøking av serveren:
account-hub-result-security-no-encryption = Inga kryptering
    .title = Inga kryptering
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = Inga kryptering
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = Misslykka autentisering. Kontroller brukarnamn og passord
...
account-hub-exchange-config-unverifiable = Klarte ikkje å stadfeste konfigurasjonen. Dersom brukarnamnet og passordet ditt er rett, er det sannsynleg at serveradministratoren har slått av den valde konfigurasjonen for kontoen din. Prøv å velje ein annan protokoll.
account-hub-advanced-setup-button = Avansert konfigurasjon
    .accesskey = A
# Variables:
#  $domain (String): The name of the server where the configuration was found, e.g. rackspace.com.
account-hub-exchange-dialog-question = { -brand-short-name } fann kontooppsettinformasjonen din på { $domain }. Vil du halde fram og sende inn informasjonen din?
account-hub-creation-error-title = Klarte ikkje å opprette konto
account-hub-error-server-exists = Innkomande tenar finst allereie.
account-hub-confirm-advanced-title = Stadfest avansert oppsett
account-hub-confirm-advanced-description = Denne dialogruta vil late seg att og ein konto med dei aktuelle innstillingane vil bli oppretta, sjølv om innstillingane er feil. Vil du fortsetje?
...
account-hub-username-help-text = Ofte den fulle e-postadressa di
account-hub-port-help-text = Viss feltet står tomt, vil { -brand-short-name } prøve å finne porten automatisk.
...
account-hub-result-graph-api-description = Bruk Microsoft Graph API for å synkronisere mapper og e-postar med Microsoft 365
...
account-hub-config-success-title = Kontoinnstillingar funne automatisk.
account-hub-config-success-description-db = Innstillingar funne i Mozilla ISPDB.
...
account-hub-config-success-description-disk = Innstillingar funne i { -brand-short-name }-installasjonen.
account-hub-config-success-description-isp = Konfigurasjon funnen hos e-postleverandøren.
account-hub-config-success-description-read-more = Du kan <a data-l10n-name="automated-setup-link">lese om korleis automatisk oppsett av e-post fungerer.</a>
...
address-book-add-remote-icon2 =
    .alt = Legg til ei ekstern adressebok
address-book-add-remote-icon =
    .alt = Legg til ei ny ekstern adressebok
address-book-add-remote = Legg til ekstern adressebok
address-book-add-remote-carddav-description = Kople til ei CardDAV-adressebok
...
address-book-add-ldap-icon2 =
    .alt = Legg til ei LDAP-addressebok
address-book-add-ldap-button = Legg til LDAP-adressebok
...
account-hub-card-ews-description = Exchange Web Services (EWS) koplar seg til Microsoft Exchange for å synkronisere e-posten din.
# This is shown after the type description, so "it" is referring to the type (either Microsoft Graph or Exchange Web Services).
account-hub-card-recommended-description = Det blir tilrådd fordi det samsvarar med teneste-adressa di.
account-hub-exchange-type-username = Brukarnamn
account-hub-exchange-type-username-hint = Vanlegvis e-postadressa di eller Active Directory UPN.
account-hub-exchange-type-authentication = Autentiseringsmåte
# Checkbox that can be unchecked to use a custom OAuth config.
account-hub-exchange-type-default-oauth = Bruk Microsoft 365 Copilot standardautentiseringsinnstillingar
