...
policy-DisableChat = Slå av chatt-funksjonen
policy-DisableDataCollectionSettings = Hindre brukaren i å endre innstillingar for datainnsamling.
...
policy-DisableMessageForwardingFilters = Hindre meldingsfilter i å vidaresende meldingar automatisk.
...
policy-DisableExperimentalFeatures = Slå av eksperimentelle funksjonar i Thunderbird.
policy-DisableQRExport = Deaktiver generering av QR-kode for å eksportere kontoinnstillingar og påloggingsinformasjon.
...
policy-DisableUpdateSettings = Hindre brukaren i å endre innstillingar for programoppdateringar.
