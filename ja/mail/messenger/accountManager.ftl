...
account-tree-add-account-button = アカウントを追加
account-action-add-newsgroup-account =
    .label = ニュースグループアカウントを追加...
    .accesskey = N
account-tree-create-account-button = 新しいアカウント
...
outgoing-server-settings-description = 複数の差出人情報を管理している場合、使用する送信サーバーをこのリストから選択できます。[既定のサーバーを使用する] を選択すると、このリストの既定のサーバーを使用します。
