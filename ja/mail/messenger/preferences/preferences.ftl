...
hide-titlebar-label =
    .label = タイトルバーを隠す
    .accesskey = H
hide-titlebar-description = ウィンドウ名を表示する上部のタイトルバーを隠して画面領域を節約します
...
check-email-app-label =
    .label = 起動時に { -brand-short-name } が既定のメールアプリとして設定されているか確認する
    .accesskey = A
...
dark-mode-checkbox-label =
    ...
    .accesskey = d
dark-mode-message-text-description = 送信者が明るい配色を背景に指定している場合も、すべての受信メッセージに暗い背景を適用します。
...
account-hub-checkbox-label =
    ...
    .accesskey = C
account-hub-checkbox-description = 新しいメールアカウントの実験的な作成フローです。
...
new-calendar-legend = カレンダーの新しい予定ダイアログ
...
account-hub-ab-checkbox-label =
    ...
    .accesskey = A
account-hub-ab-checkbox-description = 新しいアドレス帳の実験的な作成フローです。
...
compose-format-html-description = メッセージにカスタムフォント、配色、画像を保持しますが、古いメールアプリでは正しく表示できない可能性があります。
compose-format-plain-option =
    .label = プレーンテキスト形式のみ
compose-format-plain-description = すべてのスタイル書式と配色、画像を除去します。どこでも利用できるシンプルなテキストメールに最適です。
...
collect-outgoing-label =
    ...
    .accesskey = A
collect-outgoing-description = 手動またはメールから追加した新しい連絡先を保存するアドレス帳です。
save-added-contacts-label =
    .value = 手動で追加した連絡先を保存する場所:
    .accesskey = m
save-added-contacts-description = メールからの新しい連絡先を保存するアドレス帳です。
show-directory-startup-label =
    .value = { -brand-short-name } の起動時に表示するアドレス帳ウィンドウ内のディレクトリー
    .accesskey = S
...
email-picker-label =
    ...
    .accesskey = A
email-picker-description = 送信したメールからの新しい連絡先の保存場所
default-add-address-book-label =
    .value = 手動で追加した連絡先の既定のアドレス帳:
    .accesskey = D
default-add-address-book-description = 受信したメールからの新しい連絡先の保存場所
...
spam-description = 既定の迷惑メールフィルターの動作を設定します。アカウントごとの迷惑メールフィルターの設定は [アカウント設定] で行います。
spam-marked-label =
...
default-message-list-new-folders-description = 新しいフォルダーの既定の並べ替えとスレッド表示を選択してください
default-message-list-description = 新規作成したフォルダーに設定される既定の並べ替えとスレッド表示のオプションです。
default-flag-label =
    .value = 既定のスレッド表示:
