...
address-book-add-local-icon =
    .alt = 新しいローカルアドレス帳を作成
address-book-add-local = 新しいローカルアドレス帳
address-book-add-local-description = 端末上に新しいローカルアドレス帳を作成します
address-book-add-ldap-icon2 =
    .alt = LDAP アドレス帳を追加
address-book-add-ldap-button = LDAP アドレス帳を追加
address-book-add-ldap-icon =
    .alt = リモート LDAP アドレス帳に接続
address-book-add-ldap = 新しい LDAP アドレス帳
...
account-hub-new-remote-address-book = 新しいリモートアドレス帳
...
account-hub-exchange-type-default-oauth = 既定の Microsoft 365 Copilot 認証設定を使用する
