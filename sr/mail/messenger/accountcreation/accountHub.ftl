...
account-hub-servers-username-label = Корисничко име:
account-hub-result-server-label = Сервер:
account-hub-result-port-label = Порт:
account-hub-result-security-label = Безбедност:
account-hub-result-authentication-type-label = Потврда идентитета:
account-hub-result-authentication-none = Ништа
    .title = Ништа
account-hub-result-authentication-password = Обична лозинка
    .title = Обична лозинка
account-hub-result-authentication-encrypted-password = Шифрована лозинка
    .title = Шифрована лозинка
account-hub-result-authentication-gssapi = Керберос
    .title = Керберос
account-hub-result-authentication-ntlm = NTLM
    .title = NTLM
account-hub-result-authentication-external = Спољно
    .title = Спољно
...
account-hub-password-label = Лозинка
    .accesskey = Л
    .title = По избору, употребљава се за проверу корисничког имеба
account-hub-remember-password = Запамти лозинку
    .accesskey = м
account-hub-exchange-label = Ваша пријава
    .accesskey = и
account-hub-installing-addon = Преузимање и инсталирање додатка…
account-hub-success-addon = Додатак је успешно инсталиран
account-hub-success-half-manual = Следећа подешавања су пронађена испитивањем датог сервера:
account-hub-result-security-no-encryption = Без шифровања
    .title = Без шифровања
...
account-hub-exchange-config-unverifiable = Није могуће потврдити подешавања. Ако су ваше корисничко име и лозинка тачни, вероватно је да је администратор сервера онемогућио изабрана подешавања за ваш налог. Покушајте да изаберете други протокол.
account-hub-advanced-setup-button = Напредно подешавање
    .accesskey = а
# Variables:
#  $domain (String): The name of the server where the configuration was found, e.g. rackspace.com.
account-hub-exchange-dialog-question = { -brand-short-name } је пронашао податке за подешавање вашег налога на { $domain }. Да ли желите да наставите и пошаљете своје акредитиве?
account-hub-creation-error-title = Грешка приликом прављења налога
account-hub-error-server-exists = Долазни сервер већ постоји.
account-hub-confirm-advanced-title = Потврдите напредну конфигурацију
account-hub-confirm-advanced-description = Овај дијалог биће затоврен и тренутна подешавања биће искоришћена за прављење налога, и у случају неисправне конфигурације. Да ли сигурни да желите наставити?
account-hub-addon-install-title = Инсталирај
...
account-hub-result-ews-expanded-text = Exchange веб услуге
