...
oauth-reauthorize-title = Поново дозволи приступ
...
oauth-reauthorize-description = { $hostname } захтева да поново потврдите приступ да би се усклађивање са вашим налогом наставило. Корисничко име: { $username }
