...
quick-filter-bar-tag-mode-none =
    .label = Само неозначене
    .title = Само поруке без ознака
...
folder-pane-header-toggle-full-path =
    .label = Прикажи пуну путању
folder-pane-header-hide-local-folders =
    .label = Сакриј локалне фасцикле
folder-pane-mode-header-all = Све фасцикле
folder-pane-mode-header-unread = Непрочитане фасцикле
...
threadpane-message-forwarded-redirected =
    .alt = Показатељ прослеђивања и преусмеравања
    .title = Порука је прослеђена и преусмерена
threadpane-message-replied-forwarded-redirected =
    .alt = Показатељ одговора, прослеђивања и преусмеравања
    .title = На поруку је одговорено, прослеђена је и преусмерена
...
threadpane-sort-header-unread-count =
    { $unread ->
        [one]
            { $total ->
                [one] <span>1</span> непрочитана од <span>1</span> поруке
               *[other] <span>1</span> непрочитана од <span>{ $total }</span> порука
            }
       *[other]
            { $total ->
                [one] <span>{ $unread }</span> непрочитаних од <span>1</span> поруке
               *[other] <span>{ $unread }</span> непрочитаних од <span>{ $total }</span> порука
            }
    }
# Variables:
# $total (Number) - Number of messages in thread.
threadpane-sort-header-count =
    { $total ->
        [one] <span>1</span> порука
        [few] <span>{ $total }</span> поруке
       *[other] <span>{ $total }</span> порука
    }
threadpane-card-menu-button =
    .title = Мени порука
message-list-placeholder-no-messages = Нема пронађених порука
message-list-placeholder-multiple-folders = Изабрано је више фасцикли
...
folder-pane-context-reset-sort =
    .label = Ресетуј редослед фасцикли
    .accesskey = Р
# Variables:
