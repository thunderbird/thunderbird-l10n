...
calendar-dialog-attendee-summary-going =
    { $count ->
        [one] { $count } присуствује
        [few] { $count } присуствују
       *[other] { $count } присуствују
    }
# Variables:
#   $count (Number): Number of guests that responded "maybe".
calendar-dialog-attendee-summary-maybe =
    { $count ->
        [one] { $count } можда долази
        [few] { $count } можда долази
       *[other] { $count } можда долази
    }
# Variables:
