...
header-containsrepeating-mixed =
    .label = contiene elementos de diferente tipo repetidos
...
buttons-multiple-occurrence-copy =
    .label = Copiar solo ocurrencias seleccionadas
buttons-multiple-occurrence-cut =
    .label = Cortar solo ocurrencias seleccionadas
buttons-multiple-occurrence-delete =
    .label = Eliminar solo ocurrencias seleccionadas
buttons-multiple-occurrence-edit =
    .label = Editar solo ocurrencias seleccionadas
buttons-single-allfollowing-copy =
    .label = Copiar esta y todas las ocurrencias futuras
buttons-single-allfollowing-cut =
    .label = Cortar esta y todas las ocurrencias futuras
buttons-single-allfollowing-delete =
    .label = Eliminar esta y todas las ocurrencias futuras
buttons-single-allfollowing-edit =
    .label = Editar esta y todas las ocurrencias futuras
buttons-multiple-allfollowing-copy =
    .label = Copiar ocurrencias seleccionadas y futuras
buttons-multiple-allfollowing-cut =
    .label = Cortar ocurrencias seleccionadas y futuras
buttons-multiple-allfollowing-delete =
    .label = Eliminar ocurrencias seleccionadas y futuras
buttons-multiple-allfollowing-edit =
    .label = Editar ocurrencias seleccionadas y futuras
...
buttons-multiple-parent-copy =
    .label = Copiar todas las ocurrencias y elementos seleccionados
buttons-multiple-parent-cut =
    .label = Cortar todas las ocurrencias y elementos seleccionados
buttons-multiple-parent-delete =
    .label = Eliminar todas las ocurrencias y elementos seleccionados
