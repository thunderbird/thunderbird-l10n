...
flatpak-desktop-comment = Envía y recibe correo electrónico con { -brand-product-name }
# A generic description of Thunderbird
flatpak-desktop-generic-name = Cliente de correo electrónico
...
flatpak-desktop-action-compose = Escribir nuevo mensaje
