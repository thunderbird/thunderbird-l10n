...
account-hub-result-authentication-none = Ninguno
    .title = Ninguno
...
account-hub-result-authentication-external = Externo
    .title = Externo
account-hub-result-auth-none = Ninguno
    .title = Ninguno
...
account-hub-server-label = URL o nombre de host
account-hub-server-tip = Thunderbird intentará detectar tu nombre de host automáticamente
...
account-hub-remember-password = Recordar contraseña
    .accesskey = m
account-hub-exchange-label = Tu inicio de sesión
    .accesskey = i
...
account-hub-success-half-manual = Se encontraron las siguientes configuraciones probando el servidor proporcionado:
...
account-hub-credentials-wrong = Autenticación fallida. Por favor, comprueba el nombre de usuario y contraseña
...
account-hub-exchange-config-unverifiable = No se pudo verificar la configuración. Si tu nombre de usuario y contraseña son correctos, es probable que el administrador del servidor haya inhabilitado la configuración seleccionada para tu cuenta. Intenta seleccionar otro protocolo.
account-hub-advanced-setup-button = Configuración avanzada
    .accesskey = a
# Variables:
#  $domain (String): The name of the server where the configuration was found, e.g. rackspace.com.
account-hub-exchange-dialog-question = { -brand-short-name } encontró la información de configuración de tu cuenta en { $domain }. ¿Quieres continuar y enviar tus credenciales?
account-hub-creation-error-title = Error al crear la cuenta
...
account-hub-confirm-advanced-description = Este diálogo se cerrará y se creará una cuenta con la configuración actual, aún cuando la configuración sea incorrecta. ¿Deseas continuar?
...
account-hub-sync-accounts-failure = { -brand-short-name } no pudo conectar con los servicios seleccionados
