...
virtual-folder-sources-chosen =
    { $count ->
        [one] { $count } carpeta elegida
       *[other] { $count } carpetas elegidas
    }
virtual-folder-no-search-folders-selected = Debe elegir al menos una carpeta para buscar la carpeta de búsqueda guardada.
virtual-folder-properties-title = Nueva carpeta de búsquedas guardadas
# Variables:
#   $folderName (String): The name of the saved search folder.
virtual-folder-properties-edit-title = Editar propiedades de búsqueda guardada para { $folderName }
...
virtual-folder-search-online =
    ...
    .accesskey = S
virtual-folder-search-term-caption = Configurar el criterio de búsqueda usado para esta carpeta virtual:
...
virtual-folder-list-desc = Seleccionar la carpeta a buscar:
