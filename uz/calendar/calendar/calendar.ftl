...
calendar-task-filter-current =
    .label = Joriy vazifalar
    .accesskey = o
calendar-task-details-title = nomi
calendar-task-details-organizer = boshlanishi
calendar-task-details-priority = muhimligi
calendar-task-details-priority-low = Past
calendar-task-details-priority-normal = O‘rtacha
calendar-task-details-priority-high = Yuqori
calendar-task-details-status = holati
calendar-task-details-category = turkumi
calendar-task-details-repeat = qaytarish
calendar-task-details-attachments = biriktirmalar
calendar-task-details-start = boshlash sanasi
calendar-task-details-due = tugash sanasi
calendar-task-mark-completed =
    .label = Tugallanganni belgilash
    .accesskey = u
    .tooltiptext = Belgilangan vazifalarni tugallangan deb belgilash
calendar-task-change-priority =
    .label = Muhimligi
    .accesskey = h
    .tooltiptext = Muhimligini o‘zgartrisih
calendar-copylink =
    .label = Havola manzilidan nusxa olish
    .accesskey = n
...
calendar-tasks-view-calendarlist =
    .label = Taqvim ro‘yxati
    .accesskey = r
calendar-tasks-view-filtertasks =
    .label = Vazifalarni filterlash
    .accesskey = f
...
calendar-properties-refresh =
    .value = Taqvimni yangilash:
calendar-properties-refresh-manual =
    .label = Qo‘lbola
calendar-properties-read-only =
    .label = Faqat o‘qish uchun
calendar-properties-show-reminders =
    .label = Eslatkichlarni ko‘rsatish
calendar-properties-offline-support =
    .label = Oflayn qo‘llab-quvvatlash
calendar-properties-provider-missing = Ushbu taqvim uchun ta’minotchi topilmadi. Agar siz kerakli qo‘shimcha dasturlarni o‘chirib qo‘ygan yoki o‘chirib tashlagan bo‘lsangiz, bunday holat tez-tez sodir bo‘lib turadi.
calendar-properties-unsubscribe =
    .label = Obunani bekor qilish
    .accesskey = u
...
calendar-newevent-button =
    .label = Yangi tadbir
    .tooltiptext = Yangi tadbir yaratish
calendar-newtask-button =
    .label = Yangi vazifa
    .tooltiptext = Yangi vazifa yaratish
calendar-unifinder-show-completed-todos =
    .label = Tugallangan vazifalarni ko‘rsatish
calendar-display-todos-checkbox =
    .label = Ko‘rinishdagi vazifalar
    .accesskey = z
calendar-completed-tasks-checkbox =
    .label = Tugallangan vazifalarni ko‘rsatish
    .accesskey = T
calendar-only-workday-checkbox =
    .label = Faqat ish haftalari
    .accesskey = i
calendar-orientation =
    .label = Burish ko‘rinishi
    .accesskey = B
calendar-todaypane-button =
    .label = Bugun yon oynasi
    .tooltiptext = Bugun yon oynasini ko‘rsatish
calendar-search-options-searchfor =
    .value = jamlaydi
calendar-properties-dialog-title = Taqvimni tahrirlash
calendar-server-dialog-title-edit =
    .title = Taqvimni tahrirlash
calendar-server-dialog-name-label =
    .value = Taqvim nomi:
calendar-publish-dialog-window-title = Taqvimni e’lon qilish
calendar-publish-dialog-title =
    .title = Taqvimni e’lon qilish
calendar-publish-url-label = URL e’lon qilinmoqda
calendar-publish-publish-dialog-button =
    .buttonlabelaccept = E’lon qilish
calendar-publish-close-button = Yopish
calendar-select-dialog-title = Taqvimni tanlash
...
calendar-error-description =
    .value = Ta’rifi:
calendar-error-prompt-title = Xatolik yuz berdi
calendar-error-title =
    .title = Xatolik yuz berdi
calendar-extract-event-button =
    .label = Tadbir qo‘shish
    .tooltiptext = Taqvim ma’lumotini xabardan ajratib olish va uni taqvimga tadbir sifatida qo‘shish
