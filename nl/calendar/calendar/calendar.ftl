...
too-new-dbschema-error-text = Uw agendagegevens zijn niet compatibel met deze versie van { -brand-short-name }. De agendagegevens in uw profiel zijn bijgewerkt door een nieuwere versie van { -brand-short-name }. Er is een back-up van het gegevensbestand aangemaakt met de naam ‘{ $fileName }’. Er wordt doorgegaan met een nieuw aangemaakt gegevensbestand.
...
calendar-context-convert-to-task =
    .label = Taak…
    .accesskey = T
calendar-task-filter-title2 = Taken filteren
...
calendar-task-filter-next7days =
    .label = Komende zeven dagen
    .accesskey = z
calendar-task-filter-notstarted =
    .label = Niet-begonnen taken
    .accesskey = e
...
calendar-task-details-organizer = van
calendar-task-details-priority = prioriteit
calendar-task-details-priority-low = Laag
calendar-task-details-priority-normal = Normaal
calendar-task-details-priority-high = Hoog
calendar-task-details-status = status
calendar-task-details-category = categorie
calendar-task-details-repeat = herhalen
calendar-task-details-attachments = bijlagen
calendar-task-details-start = begindatum
calendar-task-details-due = einddatum
calendar-task-mark-completed =
    .label = Markeren als voltooid
    .tooltiptext = Geselecteerde taken als voltooid markeren
    .accesskey = o
calendar-task-change-priority =
    .label = Prioriteit
    .tooltiptext = De prioriteit wijzigen
    .accesskey = P
calendar-task-input-filter-field =
    .aria-label = Taken filteren
    .emptytextbase = Taken filteren #1
    .keylabelmac = <⇧⌘K>
...
calendar-properties-refresh =
    .value = Agenda verversen:
calendar-properties-refresh-manual =
    .label = Handmatig
calendar-properties-read-only =
    .label = Alleen-lezen
calendar-properties-show-reminders =
    .label = Herinneringen tonen
calendar-properties-offline-support =
    .label = Offlineondersteuning
calendar-properties-enable-calendar =
    .label = Deze agenda inschakelen
calendar-properties-provider-missing = De provider voor deze agenda kon niet worden gevonden. Dit gebeurt vaak als u bepaalde add-ons hebt uitgeschakeld of gede-installeerd.
calendar-properties-unsubscribe =
    .buttonlabelextra1 = Afmelden
    .buttonaccesskeyextra1 = A
    .label = Afmelden
    .accesskey = A
calendar-alarm-dialog-title = Agendaherinneringen
...
calendar-alarm-snooze-for =
    .label = Uitstellen voor
calendar-alarm-snooze-all-for =
    .label = Alle uitstellen voor
# Variables:
...
calendar-newevent-button =
    .label = Nieuwe gebeurtenis
    .tooltiptext = Een nieuwe gebeurtenis maken
calendar-newtask-button =
    .label = Nieuwe taak
    .tooltiptext = Een nieuwe taak maken
calendar-unifinder-show-completed-todos =
    .label = Voltooide taken tonen
calendar-display-todos-checkbox =
    .label = Taken in overzicht
    .accesskey = c
...
calendar-publish-publish-dialog-button =
    .buttonlabelaccept = Publiceren
calendar-publish-close-button = Sluiten
calendar-select-dialog-title = Agenda selecteren
...
calendar-extract-event-button =
    .label = Toevoegen als gebeurtenis
    .tooltiptext = Agendagegevens uit het bericht halen en deze aan uw agenda toevoegen als een gebeurtenis
...
calendar-auth-enter-user-password-for-calendar = ‘{ $calendarName }’ ({ $location }) vraagt om uw gebruikersnaam en wachtwoord.
# Variables:
#   $username (String) - The account username.
#   $location (String) - The calendar server location.
calendar-auth-enter-password-for = Voer wachtwoord in voor { $username } op { $location }
# Variables:
#   $location (String) - The calendar server location.
calendar-auth-enter-user-password-for = { $location } vraagt om uw gebruikersnaam en wachtwoord.
