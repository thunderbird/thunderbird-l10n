...
quick-filter-bar-tag-mode-none =
    .label = Alleen ongelabeld
    .title = Alleen  berichten zonder labels
...
folder-pane-header-toggle-full-path =
    .label = Volledig pad tonen
folder-pane-header-hide-local-folders =
    .label = Lokale mappen verbergen
folder-pane-mode-header-all = Alle mappen
folder-pane-mode-header-unread = Ongelezen mappen
folder-pane-mode-header-favorite = Favoriete mappen
folder-pane-mode-header-recent = Recente mappen
folder-pane-mode-header-smart = Samengevoegde mappen
...
threadpane-column-header-a11y-select =
    .aria-label = Berichten selecteren
...
folder-pane-context-reset-sort =
    .label = Mappenvolgorde herinitialiseren
    .accesskey = h
# Variables:
