...
oauth-reauthorize-title = Toegang opnieuw autoriseren
...
oauth-reauthorize-description = U dient voor { $hostname } nogmaals de toegang te bevestigen om met uw account te blijven synchroniseren. Gebruikersnaam: { $username }
