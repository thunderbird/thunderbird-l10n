...
account-hub-email-set-up-account-button = Account instellen
account-hub-email-confirm-button = Bevestigen
account-hub-email-find-settings-button = Instellingen zoeken
account-hub-email-connect-button = Verbinden
account-hub-result-incoming-legend = Inkomend
account-hub-result-outgoing-legend = Uitgaand
...
account-hub-servers-username-label = Gebruikersnaam:
account-hub-result-server-label = Server:
account-hub-result-port-label = Poort:
account-hub-result-security-label = Beveiliging:
account-hub-result-authentication-type-label = Authenticatie:
account-hub-result-authentication-none = Geen
    .title = Geen
account-hub-result-authentication-password = Normaal wachtwoord
    .title = Normaal wachtwoord
account-hub-result-authentication-encrypted-password = Versleuteld wachtwoord
    .title = Versleuteld wachtwoord
account-hub-result-authentication-gssapi = Kerberos
    .title = Kerberos
account-hub-result-authentication-ntlm = NTLM
    .title = NTLM
account-hub-result-authentication-external = Extern
    .title = Extern
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = Geen
account-hub-result-auth-password = Normaal wachtwoord
account-hub-result-auth-encrypted-password = Versleuteld wachtwoord
account-hub-result-auth-gssapi = Kerberos
account-hub-result-auth-ntlm = NTLM
account-hub-result-auth-external = Extern
...
account-hub-exchange-service-url-label = Voer de service-URL in
...
account-hub-privacy-policy = Privacybeleid
account-hub-welcome = Welkom bij
account-hub-welcome-brand = { -brand-short-name }
account-hub-welcome-text = Welkom bij { -brand-short-name }
...
account-hub-password-label = Wachtwoord
    .accesskey = W
    .title = Optioneel, wordt alleen gebruikt om de gebruikersnaam te valideren
account-hub-remember-password = Wachtwoord onthouden
    .accesskey = h
account-hub-exchange-label = Uw aanmelding
    .accesskey = a
account-hub-installing-addon = Add-on downloaden en installeren…
account-hub-success-addon = Add-on met succes geïnstalleerd
account-hub-success-half-manual = De volgende instellingen zijn gevonden door de opgegeven server te zoeken:
account-hub-result-security-no-encryption = Geen versleuteling
    .title = Geen versleuteling
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = Geen versleuteling
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = Authenticatie mislukt. Controleer de gebruikersnaam en het wachtwoord
...
account-hub-exchange-config-unverifiable = Configuratie kan niet worden geverifieerd. Als uw gebruikersnaam en wachtwoord juist zijn, heeft de serverbeheerder waarschijnlijk de geselecteerde configuratie voor uw account uitgeschakeld. Probeer een ander protocol te selecteren.
account-hub-advanced-setup-button = Uitgebreide configuratie
    .accesskey = U
# Variables:
#  $domain (String): The name of the server where the configuration was found, e.g. rackspace.com.
account-hub-exchange-dialog-question = { -brand-short-name } heeft uw accountinstellingen op { $domain } gevonden. Wilt u doorgaan en uw aanmeldgegevens versturen?
account-hub-creation-error-title = Fout bij aanmaken van account
account-hub-error-server-exists = Inkomende server bestaat al.
account-hub-confirm-advanced-title = Uitgebreide configuratie bevestigen
account-hub-confirm-advanced-description = Dit dialoogvenster zal worden gesloten en er wordt een account met de huidige instellingen aangemaakt, ook als de configuratie onjuist is. Wilt u doorgaan?
account-hub-addon-install-title = Installeren
account-hub-encryption-button = End-to-end-versleuteling
account-hub-address-books-button = Adresboeken
account-hub-calendars-button = Agenda’s
account-hub-thundermail-button = Aanmelden met Thundermail
...
account-hub-same-username-checkbox = Dezelfde gebruikersnaam als inkomende server
# Variables:
...
account-hub-manual-config-security-changed = Kan { $oldValue } niet vinden, maar { $newValue } is beschikbaar.
# Variables:
...
account-hub-manual-config-port-changed = Kan poort { $oldValue } niet bereiken, maar poort { $newValue } is beschikbaar.
# Variables:
# $oldValue (String): The value requested before the configuration was tested.
# $newValue (String): The value found after the configuration was tested.
account-hub-manual-config-value-changed = Kan { $oldValue } niet gebruiken, maar { $newValue } is beschikbaar.
...
account-hub-username-help-text = Meestal uw volledige e-mailadres
...
account-hub-email-exchange-settings = Exchange-instellingen
account-hub-email-connect-settings = Uw e-mailinstellingen verbinden
account-hub-email-protocol-select-header = Kies een e-mailaccounttype
account-hub-email-protocol-select-additional-info = Er is extra informatie nodig om deze account in te stellen.
account-hub-email-protocol-select-notification = Er is extra informatie nodig om deze account in te stellen
...
account-hub-result-graph-api-description = De Microsoft Graph-API gebruiken om uw mappen en e-mailberichten te synchroniseren met Microsoft 365
account-hub-result-graph-shortname = Exchange (Graph)
account-hub-result-graph-description = Microsoft Graph-API gebruiken om uw mappen en e-mailberichten te synchroniseren
...
account-hub-config-success-title = Accountinstellingen automatisch gevonden.
account-hub-config-success-description-db = Configuratie gevonden in de Mozilla-ISPDB.
account-hub-config-success-description-exchange = Configuratie gevonden voor een Microsoft Exchange-server.
...
address-book-add-remote-icon2 =
    .alt = Een extern adresboek toevoegen
address-book-add-remote-icon =
    .alt = Een nieuw extern adresboek toevoegen
address-book-add-remote = Extern adresboek toevoegen
address-book-add-remote-carddav-description = Verbinding maken met een CardDAV-adresboek
...
address-book-add-ldap-icon2 =
    .alt = Een LDAP-adresboek toevoegen
address-book-add-ldap-button = LDAP-adresboek toevoegen
...
account-hub-address-book-sync-books-data =
    { $addressBooks ->
        [one] 1 adresboek beschikbaar
       *[other] { $addressBooks } adresboeken beschikbaar
    }
...
account-hub-exchange-type-account-type = Accounttype
account-hub-card-graph-title = Microsoft Graph
account-hub-card-graph-description = Microsoft Graph is een moderne verbindingsmethode voor Microsoft 365.
account-hub-card-ews-title = Exchange Web Services
account-hub-card-ews-tag = Verouderd
account-hub-card-ews-description = Exchange Web Services (EWS) maakt verbinding met Microsoft Exchange om uw e-mail te synchroniseren.
# This is shown after the type description, so "it" is referring to the type (either Microsoft Graph or Exchange Web Services).
account-hub-card-recommended-description = Deze methode wordt aanbevolen omdat deze overeenkomt met uw service-URL.
account-hub-exchange-type-username = Gebruikersnaam
account-hub-exchange-type-username-hint = Doorgaans uw e-mailadres of Active Directory UPN.
account-hub-exchange-type-authentication = Authenticatiemethode
# Checkbox that can be unchecked to use a custom OAuth config.
account-hub-exchange-type-default-oauth = Standaard Microsoft 365 Copilot-authenticatie-instellingen gebruiken
account-hub-exchange-type-oauth-tenant = Tenant-ID
account-hub-exchange-type-oauth-app = App-id
account-hub-exchange-type-advanced-config = Uitgebreide configuratie
account-hub-exchange-type-title = Kies een accounttype
