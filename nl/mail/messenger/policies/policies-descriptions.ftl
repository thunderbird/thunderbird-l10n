...
policy-DisableChat = De chatfunctie uitschakelen.
policy-DisableCommunity = Gemeenschapsfuncties niet in de gebruikersinterface tonen (zoals Doneren, Meehelpen, Ideeën delen, enz.)
...
policy-DisableFileLink = De Filelink-functie uitschakelen.
...
policy-DisableMessageForwardingFilters = Voorkomen dat berichtenfilters automatisch berichten doorsturen.
...
policy-DisableUpdateSettings = Voorkomen dat de gebruiker instellingen voor toepassingsupdates wijzigt.
...
policy-InAppNotification = Notificatietypen in- of uitschakelen.
...
policy-Permissions2 = Toestemmingen voor camera, microfoon, locatie, meldingen en automatisch afspelen configureren.
