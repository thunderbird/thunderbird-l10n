...
toolbar-spam =
    .title = Geselecteerde berichten als spam markeren
toolbar-not-spam-label = Geen spam
toolbar-not-spam =
    .title = Geselecteerde berichten als geen spam markeren
...
toolbar-add-address-book-label = Adresboek toevoegen
