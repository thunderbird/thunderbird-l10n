...
menu-move-copy-no-recent =
    .label = (Geen recente bestemmingen)
menu-move-copy-no-favorites =
    .label = (Geen favorieten)
...
allow-remote-content-resource =
    .label = Externe inhoud van { $origin } toestaan
# Variables:
...
tags-label-1 = Belangrijk
tags-label-2 = Werk
tags-label-3 = Persoonlijk
tags-label-4 = Nog te doen
tags-label-5 = Later
tags-add-new =
    .label = Nieuw label…
    .accesskey = N
