...
default-app-intro = { -brand-short-name } als de standaardapp gebruiken voor:
...
checkbox-net-thunderbird-url-label =
    .label = Aangepaste Thunderbird-koppelingen (net.thunderbird://)
    .tooltiptext = { unset-default-tooltip }
...
check-default-email-app-label =
    .label = Altijd controleren of { -brand-short-name } bij openen de standaard e-mailapp is
    .accesskey = A
check-on-startup-label =
    .label = Deze controle altijd uitvoeren bij het starten van { -brand-short-name }
    .accesskey = D
system-settings-dialog-title = Systeeminstellingen
