...
general-email-notifications-header = E-mailnotificaties
...
general-files-and-attachment-description = Selecteer welke bestanden moeten worden opgeslagen en waar ze op uw computer moeten worden opgeslagen.
general-tags-header = Labels
general-reading-and-viewing-header = Lezen en bekijken
general-reading-and-display-header = Lezen & Weergave
general-updates-header = Updates
general-network-and-storage-header = Netwerk en opslag
general-search-performance-label = Zoeken en prestaties
compose-writing-emails-header = E-mailberichten opstellen
...
compose-message-formatting-title = Berichtopmaak
compose-address-autocomplete-header = Automatische adresaanvulling
...
choose-display-language-description = Kies de taal die wordt gebruikt voor menu’s, berichten en notificaties.
...
manual-storage-limit-label =
    .label = Handmatig opslaglimieten voor tijdelijke bestanden instellen
    .accesskey = H
clear-temp-files-button =
    .label = Tijdelijke bestanden wissen
    .accesskey = w
clear-temp-files-shutdown-label =
    .label = Tijdelijke bestanden wissen als { -brand-short-name } wordt gesloten
    .accesskey = s
...
show-start-page-label =
    .label = De startpagina tonen bij openen van { -brand-short-name }
    .accesskey = b
start-page-label =
...
close-to-tray-label =
    .label = Naar de systeembalk verplaatsen, wanneer { -brand-short-name } wordt gesloten
    .accesskey = s
start-in-tray-label =
    .label = { -brand-short-name } in de systeembalk starten
    .accesskey = b
new-message-arrival-legend = Als een nieuw bericht binnenkomt:
...
mail-play-button =
    .label = Afspelen
    .accesskey = f
change-dock-icon-description = App-badges en -meldingen
change-dock-icon =
    { PLATFORM() ->
...
new-email-alert-label =
    .label = Een waarschuwing voor nieuwe e-mailberichten tonen
    .accesskey = t
customize-alerts-label =
    .label = Waarschuwingen aanpassen…
    .accesskey = p
...
use-custom-sound-label =
    .label = Aangepast geluid voor waarschuwingen gebruiken
    .accesskey = b
mail-select-audio-button =
    .label = Audio selecteren…
    .accesskey = A
enable-global-search-label =
    .label = Zoeken in alle e-mailaccounts inschakelen
    .accesskey = e
gloda-results-plain-list-label =
    .label = Zoekresultaten als een lijst tonen
    .accesskey = l
...
gloda-show-results-as-list-label =
    .label = Algemene zoekresultaten standaard als lijst tonen
    .accesskey = z
datetime-formatting-legend = Datum- en tijdopmaak
display-language-legend = Weergavetaal
allow-graphics-accel =
    .label = Grafische versnelling voor soepeler scrollen en prestaties gebruiken
    .accesskey = G
storage-format-label =
    .value = Opslagindeling voor nieuwe accounts:
    .accesskey = O
...
enable-autoscroll-label =
    .label = Automatisch scrollen inschakelen
    .accesskey = c
autoscroll-label =
...
hide-titlebar-label =
    .label = Titelbalk verbergen
    .accesskey = v
hide-titlebar-description = Verwijdert de bovenste balk met de vensternaam om schermruimte te besparen
hide-tabbar-single-tab-label =
    .label = De tabbladenbalk verbergen als slechts één tabblad is geopend
    .accesskey = t
auto-hide-tabbar-second-tab-description = Verbergt automatisch tabbladen totdat u een tweede tabblad opent.
system-settings-legend = Systeeminstellingen
check-email-app-label =
    .label = Altijd controleren of { -brand-short-name } de standaard e-mailapp is bij het openen
    .accesskey = A
edit-defaults-apps-button =
    .label = Standaardinstellingen bewerken…
    .accesskey = i
...
update-settings-title = Instellingen bijwerken
install-updates-automatically-label =
    .label = Updates automatisch installeren (aanbevolen)
    .accesskey = U
install-updates-automatically-description = Houdt { -brand-short-name } veilig met de nieuwste beveiligingsfixes.
check-updates-ask-label =
    .label = Controleren op updates, maar vragen voor installatie
    .accesskey = C
...
connection-config-description = Bepalen hoe { -brand-short-name } verbinding maakt met het internet.
connection-options-button =
    .label = Verbindingsopties…
    .accesskey = V
offline-mode-legend = Offlinemodus
offline-settings-label = Offline-instellingen
...
offline-settings-button =
    .label = Offline…
    .accesskey = O
temporary-storage-legend = Tijdelijke opslag
offline-compact-remove-deleted =
    .label = Gegevens uit mappen verwijderen als ze al zijn verwijderd om opslagruimte vrij te maken
    .accesskey = G
offline-compact-ask-cleanup =
    .label = Vragen voor het opruimen van mappen
    .accesskey = v
...
use-cache-before =
    .value = Tot
    .accesskey = T
use-temp-storage-after = MB ruimte voor tijdelijke bestanden
...
underline-text-links-label =
    .label = Tekstkoppelingen in berichten onderstrepen
    .accesskey = p
...
convert-emoticons-label =
    ...
    .accesskey = E
display-text-formatting-label = Opmaak van geciteerde tekst
...
search-content-types =
    .placeholder = Typen inhoud zoeken
...
always-ask-label =
    ...
    .accesskey = v
use-tags-text = Gebruik labels om berichten te categoriseren en te prioriteren.
...
mark-read-when-opened =
    .label = Direct bij openen
    .accesskey = o
show-attachments-inline-label =
    .label = Bijlagen in de berichttekst tonen
    .accesskey = l
mark-read-no-delay =
...
display-name-only-label =
    .label = Alleen schermnaam tonen voor contacten opgeslagen in het adresboek
    .accesskey = s
...
show-conversation-view-label =
    .label = Conversatieweergave tonen
    .accesskey = C
conversation-view-preview-description = Dit is een vroege voorbeeldfunctie. Het groepeert gerelateerde berichten, maar het werkt mogelijk niet altijd zoals verwacht.
...
dark-mode-message-appearance = Berichtuiterlijk
dark-mode-checkbox-label =
    .label = Donkere modus gebruiken voor berichttekst
    .accesskey = D
dark-mode-message-text-description = Past een donkere achtergrond toe op alle inkomende berichten, zelfs als de afzender ze in lichte kleuren heeft opgemaakt.
...
dark-message-mode-toggle-label =
    ...
    .accesskey = h
dark-mode-toggle-description = Laat u een e-mailbericht tijdens het lezen snel terugzetten naar de lichte modus, zonder uw belangrijkste instellingen te wijzigen.
general-folder-settings-header = Mapinstellingen
recent-folders-legend = Recente mappen
recent-folders-description = Bepaalt hoe onlangs gebruikte mappen verschijnen bij het verplaatsen van berichten.
dark-message-mode-toggle-description = Schakelaar in de berichtkop tonen om snel de donkere berichtmodus uit te schakelen
general-folder-options-header = Opties voor mappenbeheer
recent-destinations-legend = Recente bestemmingen
recent-destinations-description = Opties voor het tonen en ordenen van mappen waarnaar onlangs berichten zijn verplaatst.
recent-sort-order-label = Sorteervolgorde:
    .accesskey = S
recent-sort-order-mru =
    .label = Meest recent
recent-sort-order-alphabetic =
    .label = Alfabetisch
max-recent-label = Maximumaantal recente mappen:
    .accesskey = M
...
account-hub-manual-config-checkbox-label =
    .label = De nieuwe handmatige configuratiestroom in Account Hub gebruiken
    .accesskey = c
...
new-calendar-checkbox-description = Experimenteel nieuw agendadialoogvenster voor het bekijken van gebeurtenissen
...
as-attachment-label =
    .label = Als bijlage
add-file-type-label =
    .label = Bestandstype aan bijgevoegde berichten toevoegen
    .accesskey = y
extension-label =
    .label = Extensie aan bestandsnaam toevoegen
    .accesskey = n
forward-messages-label =
    .value = Berichten doorsturen als:
    .accesskey = d
forward-inline-label =
    .label = In het bericht (inline)
...
autosave-draft-label =
    .label = Concept automatisch opslaan om de
    .accesskey = a
...
ignore-sender-styles-label =
    .label = Lettertypen en kleuren van de afzender negeren
    .accesskey = g
...
paragraph-spacing-label =
    .label = Op Enter drukken begint een nieuwe alinea met extra afstand
    .accesskey = d
...
compose-format-automatic-option =
    .label = Automatisch (aanbevolen)
compose-format-automatic-description = Opgemaakte tekst verzenden als u stijlen toevoegt (zoals vet of koppelingen), of platte tekst als u dat niet doet.
compose-format-both-option =
    .label = Zowel RTF-tekst (HTML) als platte tekst
compose-format-both-description = Altijd beide versies versturen, zodat de e-mailapp van de ontvanger kan kiezen welke wordt weergegeven.
compose-format-html-option =
    .label = Alleen opgemaakte tekst (HTML)
compose-format-html-description = Behoudt aangepaste lettertypen, kleuren en afbeeldingen, maar sommige oudere e-mailapps geven deze mogelijk niet goed weer.
compose-format-plain-option =
    .label = Alleen platte tekst
compose-format-plain-description = Verwijdert alle opmaak, kleuren en afbeeldingen. Het beste voor eenvoudige tekstberichten die overal werken.
autocomplete-matches-description = Wanneer u de naam of het e-mailadres van een ontvanger typt, zoeken naar overeenkomsten in:
company-network-directory-label =
    .label = Bedrijfs- of netwerkadresboek
    .accesskey = B
...
manage-directories-label =
    .label = Directories beheren…
    .accesskey = D
collect-outgoing-label =
    .label = E-mailadressen van uitgaande berichten automatisch toevoegen aan:
    .accesskey = E
collect-outgoing-description = Waar nieuwe contacten worden opgeslagen wanneer ze handmatig worden aangemaakt of toegevoegd vanuit e-mailberichten.
save-added-contacts-label =
    .value = Handmatig toegevoegde contacten opslaan in:
    .accesskey = H
save-added-contacts-description = Waar nieuwe contacten uit e-mailberichten worden opgeslagen.
show-directory-startup-label =
    .value = Map in het adresboekvenster tonen bij het openen van { -brand-short-name }
    .accesskey = M
...
email-picker-label =
    ...
    .accesskey = E
email-picker-description = De locatie van nieuwe opgeslagen contacten vanuit verzonden berichten.
default-add-address-book-label =
    .value = Standaardadresboek voor handmatig toegevoegde contacten:
    .accesskey = S
default-add-address-book-description = De locatie van nieuwe opgeslagen contacten vanuit ontvangen berichten.
...
attachment-label =
    ...
    .accesskey = C
edit-keywords-label =
    .label = Trefwoorden bewerken…
    .accesskey = T
offer-share-large-files-label =
    .label = Aanbieden om bestanden via een koppeling te delen als ze groter zijn dan:
...
search-preferences-input2 =
    ...
    .style = width: 15.4em
managed-by-organization-notice = { -brand-short-name } wordt beheerd door een organisatie.
...
accent-color-legend = Accentkleur
accent-color-selection-label =
    .value = Selecteer een kleur voor de primaire knop en accentueringen
accent-color-label =
    .value = Definieer de kleur die wordt gebruikt voor primaire knoppen en gemarkeerde elementen:
accent-color-os =
    .label = Besturingssysteem volgen
accent-color-thunderbird =
    .label = Thunderbird-blauw
accent-color-purple =
    .label = Paars
accent-color-orange =
    .label = Oranje
...
accent-color-teal =
    .label = Blauwgroen
accent-color-disabled-description = Accentkleuren worden niet ondersteund in de modus Hoog contrast.
default-message-list-legend = Berichtenlijst
appearance-view-style-select =
    .value = Selecteer weergavestijl:
...
appearance-radio-card-view =
    .label = Kaartweergave
card-view-options-legend = Opties voor kaartweergave
...
default-message-list-new-folders-description = Selecteer de standaard sorteer- en conversatieopties voor nieuw gemaakte mappen
...
default-sort-by-label = Berichten sorteren op:
...
default-sort-newest-bottom =
    .label = Nieuwste berichten onderaan
default-sort-new-messages-top =
    .label = Nieuwste berichten bovenaan
apply-view-settings-label = Deze weergave-instellingen toepassen op:
apply-view-settings-to-all-folders-button =
    .label = Alle mappen en submappen
    .accesskey = A
select-apply-sort-folders-button =
    .label = Mappen selecteren
    .accesskey = M
