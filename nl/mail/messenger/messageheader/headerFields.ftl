...
message-header-list-id = Lijst-ID
# List management header - RFC 2369.
...
message-header-archived-at = Gearchiveerd-Op
...
message-header-list-id-field = Lijst-ID<span data-l10n-name="field-separator">:</span>
...
message-header-archived-at-field = Gearchiveerd-Op<span data-l10n-name="field-separator">:</span>
...
dark-message-mode-toggle-disabled =
    .title = Donkere berichtmodus inschakelen

## Spam filter

message-bar-spam = { -brand-short-name } denkt dat dit bericht spam is.
