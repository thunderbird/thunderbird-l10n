...
calendar-context-attendance-occ-needs-action =
    .label = Encara necessita una acció
    .accesskey = E
...
calendar-context-delete-server =
    .label = Suprimeix el calendari…
    .accesskey = S
calendar-context-remove-server =
    .label = Elimina el calendari…
    .accesskey = E
calendar-context-unsubscribe-server =
    .label = Cancel·la la subscripció al calendari…
    .accesskey = C
calendar-context-publish =
    .label = Publica el calendari…
    .accesskey = b
calendar-context-export =
    .label = Exporta el calendari…
    .accesskey = E
calendar-context-properties =
    .label = Propietats
    .accesskey = P
calendar-context-showall =
    .label = Mostra tots els calendaris
    .accesskey = t
...
calendar-task-mark-completed =
    .label = Marca com a acabada
    .accesskey = d
    .tooltiptext = Marca les tasques seleccionades com a acabades
calendar-task-change-priority =
    .label = Prioritat
    .accesskey = r
    .tooltiptext = Canvia la prioritat
...
calendar-tasks-view-calendarlist =
    .label = Llista de calendaris
    .accesskey = L
calendar-tasks-view-filtertasks =
    .label = Filtra les tasques
    .accesskey = F
...
calendar-properties-show-reminders =
    .label = Mostra els recordatoris
calendar-properties-offline-support =
    .label = Funcionament fora de línia
calendar-properties-enable-calendar =
    .label = Activa aquest calendari
calendar-properties-provider-missing = No s'ha pogut trobar el proveïdor d'aquest calendari. Això sol passar quan s'han inhabilitat o s'han desinstal·lat complements.
calendar-properties-unsubscribe =
    .label = Cancel·la la subscripció
    .accesskey = C
    .buttonlabelextra1 = Cancel·la la subscripció
    .buttonaccesskeyextra1 = C
calendar-alarm-dialog-title = Recordatoris del calendari
calendar-alarm-details =
    .value = Detalls…
calendar-alarm-dismiss =
    .label = Atura l'alarma
calendar-alarm-dismiss-all =
    .label = Atura totes les alarmes
calendar-alarm-snooze-for =
    .label = Ajorna fins d'aquí
calendar-alarm-snooze-all-for =
    .label = Ajorna-ho tot fins d'aquí
...
calendar-newevent-button =
    .label = Cita nova
    .tooltiptext = Crea una cita nova
calendar-newtask-button =
    .label = Tasca nova
    .tooltiptext = Crea una tasca nova
calendar-unifinder-show-completed-todos =
    .label = Mostra les tasques acabades
calendar-display-todos-checkbox =
    .label = Tasques de la vista
    .accesskey = q
...
calendar-publish-publish-dialog-button =
    .buttonlabelaccept = Publica
calendar-publish-publish-button = Publica
calendar-publish-close-button = Tanca
calendar-select-dialog-title = Selecció d'un calendari
...
calendar-extract-event-button =
    .label = Afegeix com a cita
    .tooltiptext = Extreu la informació temporal del missatge i l'afegeix al calendari com a cita
