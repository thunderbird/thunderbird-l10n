...
quick-filter-bar-tag-mode-none =
    .label = Només sense etiquetar
    .title = Només missatges sense etiquetes
...
folder-pane-mode-header-all = Totes les carpetes
folder-pane-mode-header-unread = Carpetes per llegir
...
threadpane-column-header-a11y-select =
    .aria-label = Selecció de missatges
