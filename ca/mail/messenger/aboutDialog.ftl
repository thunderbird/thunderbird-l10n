...
community-exp =
    ...
    { -vendor-short-name }</a>
     és una <a data-l10n-name="community-exp-credits-link">
    comunitat global</a>
     que treballa conjuntament per mantenir el web obert, públic i accessible per a tothom.
community-2 =
    El { -brand-short-name } està dissenyat per <a data-l10n-name="community-mozilla-link">
    { -vendor-short-name }</a>
    , una <a data-l10n-name="community-credits-link">
    comunitat global</a>
     que treballa conjuntament per mantenir el web obert, públic i accessible per a tothom.
about-helpus =
    Voleu ajudar? <a data-l10n-name="helpus-donate-link">
    Feu una donació</a> or <a data-l10n-name="helpus-get-involved-link">
    col·laboreu-hi!</a>
