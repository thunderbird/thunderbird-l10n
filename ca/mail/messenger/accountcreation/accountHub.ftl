...
account-hub-result-outgoing-legend = Sortida
account-hub-all-servers-legend = Tots els servidors
...
account-hub-servers-username-label = Nom d'usuari:
account-hub-result-server-label = Servidor:
account-hub-result-port-label = Port:
account-hub-result-security-label = Seguretat:
account-hub-result-authentication-type-label = Autenticació:
account-hub-result-authentication-none = Cap
    .title = Cap
account-hub-result-authentication-password = Contrasenya normal
    .title = Contrasenya normal
account-hub-result-authentication-encrypted-password = Contrasenya xifrada
    .title = Contrasenya xifrada
...
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = Cap
account-hub-result-auth-password = Contrasenya normal
account-hub-result-auth-encrypted-password = Contrasenya xifrada
...
account-hub-server-label = URL/Nom d’amfitrió
account-hub-max-results-label = Nombre màxim de resultats
...
account-hub-result-security-no-encryption = Sense xifratge
    .title = Sense xifratge
...
account-hub-email-sync-accounts = Sincronitzeu els calendaris i les llibretes d’adreces
