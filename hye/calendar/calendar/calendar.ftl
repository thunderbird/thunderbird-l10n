...
calendar-search-options-searchfor =
    .value = Պարունակի
calendar-properties-dialog-title = Խմբագրել Աւրացոյցը
calendar-server-dialog-title-edit =
    .title = Խմբագրել Աւրացոյցը
calendar-server-dialog-name-label =
    .value = Աւրացոյցի Անունը՝
calendar-publish-dialog-window-title = Հրապարակել Աւրացոյցը
...
calendar-error-description =
    .value = Նկարագրութիւն
calendar-error-prompt-title = Սխալ յայտնուեց
