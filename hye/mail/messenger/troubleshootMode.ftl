...
troubleshoot-mode-disable-addons =
    .label = Անջատուած են բոլոր յաւելումները
    .accesskey = Ա
troubleshoot-mode-reset-toolbars =
    .label = Վերականգնել գործիքագաւտիները եւ կառավարումները
    .accesskey = Վ
troubleshoot-mode-change-and-restart =
    .label = Կատարել փոփոխութիւններ եւ վերակործարկել
    .accesskey = Կ
troubleshoot-mode-continue =
    .label = Շարունակել խափաշտկող ռեժիմում
    .accesskey = Շ
