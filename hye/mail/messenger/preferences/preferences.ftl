...
tray-icon-unread-label =
    ...
    .accesskey = ս
tray-icon-unread-description = Առաջարկուում է փոքր գործիքագաւտու տողի կոճակներ աւգտագործելիս
...
warn-on-send-accel-key =
    ...
    .accesskey = Հ
add-link-previews =
    .label = Ավելացնել յղումների նախադիտումներ URL-ներ տեղադրելու ժամանակ
    .accesskey = ղ
spellcheck-label =
