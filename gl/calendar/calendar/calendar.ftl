...
calendar-none =
    .label = Ningunha
imip-bar-unsupported-text = Esta mensaxe contén un evento que esta versión do { -brand-short-name } non pode procesar.
# Error strings
# @name UID_NOT_FOUND
# @loc none
...
calendar-error-description =
    .value = Descrición:
calendar-error-prompt-title = Produciuse un erro
