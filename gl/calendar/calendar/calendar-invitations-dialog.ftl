...
# Invitations dialog
calendar-invitations-title = Convites
calendar-invitations-status-updating = Estase actualizando a lista de convites.
calendar-invitations-status-none = Non se atoparon convites sen confirmar.
