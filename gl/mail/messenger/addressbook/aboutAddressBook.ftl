...
books-pane-import-button = Importar
    .title = Importar axendas de enderezos
...
about-addressbook-search-all2 =
    .label = Busca en todas as axendas de enderezos
...
about-addressbook-column-header-a11y-emailaddresses2 =
    .aria-label = Enderezos de correo electrónico
...
about-addressbook-column-header-a11y-addrbook2 =
    .aria-label = Axenda de enderezos
...
ab-search-dialog-matches-found =
    .value =
        { $count ->
            [one] { $count } coincidencia atopada
           *[other] { $count } coincidencias atopadas
        }
ab-search-dialog-no-matches-found =
    .value = Non se atoparon coincidencias
...
ab-search-dialog-delete-button =
    .label = Eliminar
    .accesskey = n
ab-search-dialog-title = Busca avanzada na axenda de enderezos
