...
address-display-full =
    .label = Nome completo e enderezo de correo electrónico
    .accesskey = F
address-display-email =
    .label = Só o correo electrónico
    .accesskey = E
...
condensed-addresses-label =
    ...
    .accesskey = s
table-layout-legend = Vista de táboa
table-layout-horizontal-scroll-label =
    .label = Permitir desprazamento horizontal
    .accesskey = h
conversation-view-legend = Vista de conversa
conversation-view-checkbox-label =
    .label = Activar a vista de conversa
    .accesskey = c
...
exceptions-button =
    .label = Excepcións…
    .accesskey = E
remote-content-privacy-info = Obteña máis información sobre os problemas de privacidade do contido remoto
remote-content-info =
...
global-privacy-control-description =
    .label = Dille aos sitios web que non vendan nin compartan os meus datos
    .accesskey = n
...
junk-read-auto-label =
    .label = Cando { -brand-short-name } determina que son lixo
    .accesskey = T
junk-log-label =
