...
account-hub-result-socket-type-label = Seguridade da conexión
account-hub-on-port-label = Porto
...
address-book-carddav-known-incompatible = Sábese que { $url } é incompatible con { -brand-short-name }.
address-book-carddav-connection-error = Produciuse un fallo ao conectar.
address-book-ldap-duplicate-error = O nome do directorio LDAP xa existe. Introduce un nome de directorio diferente.
...
account-hub-password-label = Contrasinal
    .accesskey = a
    .title = Opcional, só será usado para validar o nome de usuario
account-hub-remember-password = Lembrar o contrasinal
    .accesskey = m
account-hub-exchange-label = Seus datos de acceso
    .accesskey = d
account-hub-installing-addon = Descargando e instalando o complemento…
account-hub-success-addon = O complemento instalouse correctamente
account-hub-success-half-manual = Atopáronse as seguintes configuracións probando o servidor indicado:
account-hub-result-security-no-encryption = Sen cifraxe
    .title = Sen cifraxe
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = Sen cifraxe
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = Fallou a autenticación. Comprobe o nome de usuario e o contrasinal
...
account-hub-exchange-config-unverifiable = Non se puido verificar a configuración. Se o seu nome de usuario e contrasinal son correctos, é probábel que o administrador do servidor desactivase a configuración seleccionada para a súa conta. Probe a seleccionar outro protocolo.
account-hub-advanced-setup-button = Configuración avanzada
    .accesskey = a
# Variables:
#  $domain (String): The name of the server where the configuration was found, e.g. rackspace.com.
account-hub-exchange-dialog-question = O { -brand-short-name } atopou a información de configuración da súa conta en { $domain }. Desexa continuar e enviar as súas credenciais?
account-hub-creation-error-title = Produciuse un erro ao crear a conta
account-hub-error-server-exists = O servidor entrante xa existe.
account-hub-confirm-advanced-title = Confirmar a configuración avanzada
account-hub-confirm-advanced-description = Este diálogo pecharase e crearase unha conta coa configuración actual, mesmo que a configuración sexa incorrecta. Desexa continuar?
account-hub-addon-install-title = Instalar
account-hub-encryption-button = Cifraxe de extremo a extremo
account-hub-address-books-button = Axendas de enderezos
