...
folder-pane-mode-header-all = Todos os cartafoles
folder-pane-mode-header-unread = Cartafoles non lidos
...
threadpane-column-header-a11y-select =
    .aria-label = Seleccionar mensaxes
