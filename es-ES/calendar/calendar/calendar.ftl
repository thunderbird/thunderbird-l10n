...
too-new-dbschema-error-text = Los datos de su calendario no son compatibles con esta versión de { -brand-short-name }. Los datos del calendario de su perfil se han actualizado con una versión más reciente de { -brand-short-name }. Se ha creado una copia de seguridad del archivo de datos, denominada “{ $fileName }”. Se continuará con el nuevo archivo de datos.
