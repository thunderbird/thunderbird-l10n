...
webext-perms-description-experiment-access = Este complemento tendrá acceso completo y sin restricciones a { -brand-short-name } y a su equipo.
...
webext-perms-description-messagesModifyPermanent = Modificar permanentemente el origen de sus mensajes (incluyendo encabezados, cuerpo y adjuntos)
...
webext-perms-description-messages-send = Envía mensajes de correo electrónico de forma masiva mediante programación en su nombre, sin ninguna respuesta visual. Utilice el Gestor de actividades para consultar el historial de envíos del complemento.
webext-perms-description-messages-save = Guarda mensajes de correo electrónico como borradores o plantillas de forma automática, sin necesidad de su intervención{ "\u000A" }
