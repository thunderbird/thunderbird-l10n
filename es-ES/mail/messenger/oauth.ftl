...
oauth-reauthorize-title = Volver a autorizar el acceso
...
oauth-reauthorize-description = { $hostname } necesita que confirme de nuevo el acceso para seguir sincronizándose con su cuenta. Nombre de usuario: { $username }
