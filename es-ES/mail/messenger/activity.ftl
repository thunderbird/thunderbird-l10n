...
extension-send-activity-live = La extensión “{ $extensionName }” está enviando mensajes sin supervisión.
...
extension-send-activity-event =
    { $count ->
        [one] La extensión “{ $extensionName }” ha enviado un mensaje sin supervisión.
       *[other] La extensión “{ $extensionName }” ha enviado varios mensajes sin supervisión.
    }
...
extension-sent-activity-event-status =
    { $count ->
        [one] { $count } mensaje (tiempo transcurrido: { $time })
       *[other] { $count } mensajes (tiempo transcurrido: { $time })
    }
