...
privacy-spam-header = Mensaje no deseado
...
recent-destinations-description = Opciones para listar y ordenar las carpetas a las que se han movido mensajes recientemente.
recent-sort-order-label = Orden de clasificación:
    .accesskey = c
...
account-hub-manual-config-checkbox-label =
    .label = Usar el nuevo flujo de configuración manual en el Centro de cuentas
    .accesskey = c
account-hub-manual-config-checkbox-description = Flujo de configuración manual para el nuevo Centro de cuentas
new-calendar-legend = Nuevo cuadro de diálogo de evento del calendario
new-calendar-checkbox-label =
    .label = Ver eventos del calendario en el nuevo cuadro de diálogo
new-calendar-checkbox-description = Nuevo cuadro de diálogo de calendario experimental para visualizar eventos
...
spam-description = Establezca la configuración predeterminada para el correo no deseado. La configuración específica de cada cuenta puede realizarse en Configuración de las cuentas.
spam-marked-label =
    .label = Cuando los mensajes se marcan como no deseados:
    .accesskey = C
spam-move-label =
...
spam-read-manual-label =
    .label = Cuando se marcan manualmente como no deseados
    .accesskey = C
spam-read-auto-label =
    .label = Cuando { -brand-short-name } determina que no son deseados
    .accesskey = t
spam-log-label =
    .label = Activar el registro del filtro adaptativo de correo no deseado
    .accesskey = A
spam-log-button =
    .label = Mostrar el registro
    .accesskey = M
reset-spam-button =
    .label = Reiniciar los datos de entrenamiento
    .accesskey = R
...
email-e2ee-enable-accounts-info = Configure las cuentas de correo electrónico y las identidades para el cifrado de extremo a extremo en la <a data-l10n-name="account-settings-url">Configuración de la cuenta</a>.
...
preferences-doh-description = El sistema de nombres de dominio (DNS) sobre HTTPS envía las peticiones de un nombre de dominio a través de una conexión cifrada, lo que proporciona un DNS seguro y hace más difícil que otros vean a qué sitio web está tratando de acceder.
# Variables:
...
preferences-doh-default-detailed-desc-2 = Usar la resolución DNS predeterminada si hay un problema con el proveedor de DNS seguro
...
preferences-doh-default-detailed-desc-5 = Desactivar cuando una red indique a { -brand-short-name } que no debería usar DNS seguro
...
preferences-doh-enabled-detailed-desc-2 = Usar la resolución de DNS predeterminada sólo si hay un problema con el DNS seguro
preferences-doh-setting-strict =
    .label = Máxima protección
    .accesskey = M
preferences-doh-strict-desc = { -brand-short-name } siempre usará un DNS seguro. Se mostrará una advertencia de riesgo de seguridad antes de que use el DNS del sistema.
...
email-e2ee-key-servers-intro =
    Un servidor de claves recibe y proporciona claves públicas existentes a los usuarios. 
    Le permite publicar su clave pública, así como encontrar y actualizar las claves de otros usuarios.
email-e2ee-key-servers-use-following = Usar los siguientes servidores de claves:
email-e2ee-key-servers-add = Añadir…
email-e2ee-key-servers-reset = Restablecer lista de servidores
email-e2ee-key-servers-add-title = Añadir servidor de claves
email-e2ee-key-servers-add-text = Introduzca la URL del servidor de claves a añadir.
email-e2ee-key-servers-add-failed-title = Error al añadir el servidor de claves
email-e2ee-key-servers-add-failed-text = No se ha podido conectar a un servidor de claves en la URL proporcionada.
...
accent-color-legend = Color de contraste
accent-color-label =
    .value = Definir el color usado para los botones primarios y elementos resaltados:
accent-color-os =
    .label = Usar las preferencias del sistema operativo
...
accent-color-teal =
    .label = Verde azulado
accent-color-disabled-description = Los colores de contraste no son compatibles con el modo de alto contraste.
