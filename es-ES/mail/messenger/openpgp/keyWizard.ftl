...
openpgp-import-own-key-title = Importar su clave pública
#   $keyId (String) - The Key ID.
openpgp-import-own-key-description = { -brand-short-name } no encontró la clave pública con ID { $keyId }. Impórtela para continuar.
#   $keyId (String) - The Key ID.
