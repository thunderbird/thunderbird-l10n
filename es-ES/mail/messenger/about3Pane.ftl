...
quick-filter-bar-tag-mode-none =
    .label = Sólo sin etiquetas
    .title = Solamente los mensajes sin etiquetas
...
folder-pane-header-toggle-full-path =
    .label = Mostrar la ruta completa
folder-pane-header-hide-local-folders =
    .label = Ocultar carpetas locales
folder-pane-mode-header-all = Todas las carpetas
folder-pane-mode-header-unread = Carpetas no leídas
folder-pane-mode-header-favorite = Carpetas favoritas
folder-pane-mode-header-recent = Carpetas recientes
folder-pane-mode-header-smart = Carpetas unificadas
