...
toolbar-spam-label = Mensaje no deseado
toolbar-spam =
    .title = Marcar los mensajes seleccionados como no deseados
toolbar-not-spam-label = Legítimo
toolbar-not-spam =
    .title = Marcar los mensajes seleccionados como correo legítimo
...
toolbar-add-address-book-label = Añadir libreta de direcciones
