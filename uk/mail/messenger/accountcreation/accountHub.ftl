...
account-hub-email-label = Адреса електронної пошти
    .accesskey = е
...
account-hub-remember-password = Запам’ятати пароль
    .accesskey = м
account-hub-exchange-label = Ваше ім'я
    .accesskey = а
account-hub-installing-addon = Завантаження і встановлення додатка…
account-hub-success-addon = Додаток успішно встановлено
account-hub-success-half-manual = Такі налаштування було знайдено під час випробування цього сервера:
account-hub-result-security-no-encryption = Без шифрування
    .title = Без шифрування
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = Без шифрування
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = Помилка автентифікації. Перевірте ім’я користувача та пароль
...
account-hub-exchange-config-unverifiable = Не вдалося перевірити конфігурацію. Якщо ваше ім’я користувача та пароль правильні, ймовірно, що адміністратор сервера вимкнув вибрану конфігурацію для вашого облікового запису. Спробуйте вибрати інший протокол.
account-hub-advanced-setup-button = Розширені налаштування
    .accesskey = Р
# Variables:
#  $domain (String): The name of the server where the configuration was found, e.g. rackspace.com.
account-hub-exchange-dialog-question = { -brand-short-name } знайшов налаштування для вашого облікового запису на { $domain }. Хочете продовжити та ввести свої облікові дані?
account-hub-creation-error-title = Помилка створення облікового запису
account-hub-error-server-exists = Сервер вхідної пошти вже існує.
account-hub-confirm-advanced-title = Підтвердити персональні конфігурації
account-hub-confirm-advanced-description = Це діалогове вікно буде закрито, а також буде створено обліковий запис із поточними налаштуваннями, навіть якщо конфігурація неправильна. Хочете продовжити?
account-hub-addon-install-title = Встановити
account-hub-encryption-button = Наскрізне шифрування
account-hub-address-books-button = Адресні книги
account-hub-calendars-button = Календарі
