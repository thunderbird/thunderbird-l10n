...
message-header-list-id = Розсилка-Ідентифікатор
# List management header - RFC 2369.
...
message-header-archived-at = Архівовано
...
message-header-list-id-field = Розсилка-Ідентифікатор<span data-l10n-name="field-separator">:</span>
...
message-header-archived-at-field = Архівовано<span data-l10n-name="field-separator">:</span>
