...
e2e-signing-description = Цифровий підпис дає змогу одержувачам перевірити, що повідомлення надіслали ви, а його вміст не змінено. Зашифровані повідомлення типово завжди підписуються.
e2e-sign-message =
