...
rights-intro-point-2 =
    Вам не передаються жодні права на торговельну марку чи ліцензії на торговельні марки
    Mozilla Foundation або будь-якої сторони, включно та без обмежень на 
    назву і логотип Thunderbird. Додаткову інформацію щодо торговельних марок можна
...
rights-intro-point-5 =
    ...
    <a data-l10n-name="mozilla-service-terms-link">Умовах надання послуг</a>.
