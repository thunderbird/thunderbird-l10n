...
account-hub-servers-username-label = Kullanıcı adı:
account-hub-result-server-label = Sunucu:
account-hub-result-port-label = Port:
account-hub-result-security-label = Güvenlik:
account-hub-result-authentication-type-label = Kimlik doğrulama:
account-hub-result-authentication-none = Yok
    .title = Yok
account-hub-result-authentication-password = Normal parola
    .title = Normal parola
account-hub-result-authentication-encrypted-password = Şifrelenmiş parola
    .title = Şifrelenmiş parola
account-hub-result-authentication-gssapi = Kerberos
    .title = Kerberos
account-hub-result-authentication-ntlm = NTLM
    .title = NTLM
account-hub-result-authentication-external = Harici
    .title = Harici
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = Yok
account-hub-result-auth-password = Normal parola
account-hub-result-auth-encrypted-password = Şifrelenmiş parola
account-hub-result-auth-gssapi = Kerberos
account-hub-result-auth-ntlm = NTLM
account-hub-result-auth-external = Harici
...
account-hub-auth-no-authentication-option =
    .label = Kimlik doğrulama yok
account-hub-auth-label = Kimlik doğrulama yöntemi
...
account-hub-welcome = Hoş geldiniz
...
account-hub-password-label = Parola
    .title = İsteğe bağlı, yalnızca kullanıcı adını doğrulamak için kullanılır
    .accesskey = P
account-hub-remember-password = Parolayı hatırla
    .accesskey = h
account-hub-exchange-label = Kullanıcı adınız
    .accesskey = K
account-hub-installing-addon = Eklenti indirilip yükleniyor…
account-hub-success-addon = Eklenti başarıyla yüklendi
account-hub-success-half-manual = Belirtilen sunucu incelenerek aşağıdaki ayarlar bulundu:
account-hub-result-security-no-encryption = Şifreleme yok
    .title = Şifreleme yok
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = Şifreleme yok
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = Kimlik doğrulama başarısız oldu. Lütfen kullanıcı adını ve parolayı kontrol edin
...
account-hub-exchange-config-unverifiable = Yapılandırma doğrulanamadı. Kullanıcı adınız ve parolanız doğruysa sunucu yöneticisi hesabınız için seçili yapılandırmayı devre dışı bırakmış olabilir. Başka bir protokol seçmeyi deneyin.
account-hub-advanced-setup-button = Gelişmiş yapılandırma
    .accesskey = G
# Variables:
#  $domain (String): The name of the server where the configuration was found, e.g. rackspace.com.
account-hub-exchange-dialog-question = { -brand-short-name }, { $domain } üzerinde hesap kurulum bilgilerinizi buldu. Devam etmek ve hesap bilgilerinizi göndermek ister misiniz?
account-hub-creation-error-title = Hesap Oluşturma Hatası
account-hub-error-server-exists = Gelen sunucusu zaten var.
account-hub-confirm-advanced-title = Gelişmiş Yapılandırmayı Onayla
account-hub-confirm-advanced-description = Bu iletişim kutusu kapatılacak ve yapılandırma hatalı olsa bile mevcut ayarlarla bir hesap oluşturulacaktır. Devam etmek istiyor musunuz?
account-hub-addon-install-title = Yükle
...
account-hub-thundermail-button = Thundermail ile giriş yapın
...
account-hub-port-help-text = Boş bırakılırsa { -brand-short-name } portu keşfetmeye çalışır.
...
account-hub-email-connect-settings = E-posta ayarlarınızı tamamlayın
...
account-hub-result-graph-api-description = Klasörlerimi ve e-postalarımı Microsoft 365 ile eşitlemek için Microsoft Graph API’yi kullan
...
account-hub-config-success-title = Hesap ayarları otomatik olarak bulundu.
account-hub-config-success-description-db = Mozilla İSS veritabanında yapılandırma bulundu.
account-hub-config-success-description-exchange = Bir Microsoft Exchange sunucusuna ait yapılandırma bulundu.
account-hub-config-success-description-guess = Sık kullanılan sunucu adları denenerek yapılandırma bulundu.
account-hub-config-success-description-disk = { -brand-short-name } kurulumunda yapılandırma bulundu.
...
address-book-add-remote-icon2 =
    .alt = Uzak adres defteri ekle
address-book-add-remote-icon =
    .alt = Yeni uzak adres defteri ekle
address-book-add-remote = Uzak adres defteri ekle
address-book-add-remote-carddav-description = CardDAV adres defterine bağlan
...
address-book-add-ldap-icon2 =
    .alt = LDAP adres defteri ekle
address-book-add-ldap-button = LDAP adres defteri ekle
...
account-hub-exchange-type-account-type = Hesap türü
account-hub-card-graph-title = Microsoft Graph
account-hub-card-graph-description = Microsoft Graph, Microsoft 365 için modern bir bağlantı yöntemidir.
...
account-hub-exchange-type-oauth-tenant = Kiracı kimliği
account-hub-exchange-type-oauth-app = Uygulama kimliği
