...
quick-filter-bar-tag-mode-none =
    .label = Yalnızca etiketsizler
    .title = Yalnızca etiketsiz iletiler
...
folder-pane-header-toggle-full-path =
    .label = Tam yolu göster
folder-pane-header-hide-local-folders =
    .label = Yerel klasörleri gizle
folder-pane-mode-header-all = Tüm klasörler
folder-pane-mode-header-unread = Okunmamış klasörler
