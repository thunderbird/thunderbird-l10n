...
oauth-reauthorize-title = Erişimi yeniden yetkilendir
...
oauth-reauthorize-description = Hesabınızı eşitlemeye devam etmek için { $hostname } erişiminizi yeniden onaylamanızı gerektiriyor. Kullanıcı adı: { $username }
