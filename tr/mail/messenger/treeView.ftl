...
tree-list-view-column-picker-restore-default-columns =
    .label = Varsayılan sütunları geri yükle
tree-list-view-row-thread-button =
    .title = Bu bir ileti zinciridir
tree-list-view-row-expand-thread-button =
    .aria-label = Diziyi genişlet
tree-list-view-row-collapse-thread-button =
    .aria-label = Diziyi daralt
tree-list-view-row-ignored-thread = Dizi görmezden gelindi
tree-list-view-row-ignored-thread-button =
    .title = Bu ileti dizisi görmezden gelindi
tree-list-view-row-ignored-subthread = Alt dizi görmezden gelindi
tree-list-view-row-ignored-subthread-button =
    .title = Bu alt dizi görmezden gelindi
