...
general-email-notifications-header = E-posta bildirimleri
...
general-network-and-storage-header = Ağ ve depolama
general-search-performance-label = Arama ve performans
compose-writing-emails-header = E-posta yazma
...
compose-message-formatting-title = İleti biçimlendirme
compose-address-autocomplete-header = Otomatik adres tamamlama
...
choose-display-language-description = Menüler, düğmeler ve bildirimler için kullanılacak dili seçin.
...
manual-storage-limit-label =
    .label = Geçici dosyalar için depolama sınırlarını elle ayarla
    .accesskey = G
...
start-in-tray-label =
    ...
    .accesskey = s
new-message-arrival-legend = Yeni bir ileti geldiğinde:
...
gloda-show-results-as-list-label =
    .label = Global arama sonuçlarını varsayılan olarak liste halinde göster
    .accesskey = G
datetime-formatting-legend = Tarih ve Saat Biçimi
display-language-legend = Görüntüleme dili
storage-format-label =
    .value = Yeni hesaplar için depolama biçimi:
    .accesskey = Y
mbox-store-single-label =
    .label = Her klasör için tek dosya (mbox)
...
enable-autoscroll-label =
    .label = Otomatik kaydırmayı etkinleştir
    .accesskey = O
autoscroll-label =
...
hide-titlebar-label =
    .label = Başlık çubuğunu gizle
    .accesskey = u
hide-titlebar-description = Ekranda yer açmak için pencere adını gösteren üst çubuğu kaldırır
hide-tabbar-single-tab-label =
    .label = Yalnızca tek bir sekme açıkken sekme çubuğunu gizle
    .accesskey = Y
auto-hide-tabbar-second-tab-description = İkinci bir sekme açılana kadar sekmeleri otomatik olarak gizler.
system-settings-legend = Sistem ayarları
edit-defaults-apps-button =
    .label = Varsayılanları düzenle…
    .accesskey = V
...
update-settings-title = Güncelleme ayarları
install-updates-automatically-label =
    .label = Güncellemeleri otomatik olarak yükle (Önerilir)
    .accesskey = G
install-updates-automatically-description = En son güvenlik düzeltmelerini uygulayarak { -brand-short-name } uygulamasını güvende tutar.
check-updates-ask-label =
    .label = Güncellemeleri denetle ama yüklemeden önce sor
    .accesskey = n
...
connection-config-description = { -brand-short-name } uygulamasının internete nasıl bağlanacağını yönetin.
connection-options-button =
    .label = Bağlantı seçenekleri…
    .accesskey = B
offline-mode-legend = Çevrimdışı kip
offline-settings-label = Çevrimdışı ayarları
...
offline-settings-button =
    .label = Çevrimdışı…
    .accesskey = d
temporary-storage-legend = Geçici depolama
offline-compact-ask-cleanup =
    .label = Klasörleri temizlemeden önce sor
    .accesskey = t
...
underline-text-links-label =
    .label = İletilerdeki bağlantıların altını çiz
    .accesskey = İ
...
customize-fonts-button =
    .label = Yazı tiplerini özelleştir…
    .accesskey = Y
font-options-button =
    .label = Gelişmiş…
    .accesskey = e
...
show-conversation-view-label =
    .label = Yazışma görünümünü göster
    .accesskey = z
...
dark-mode-message-appearance = İleti görünümü
dark-mode-checkbox-label =
    .label = İleti metni için koyu modu kullan
    .accesskey = k
...
dark-message-mode-toggle-label =
    ...
    .accesskey = o
general-folder-settings-header = Klasör ayarları
recent-folders-legend = Son kullanılan klasörler
...
general-folder-options-header = Klasör Yönetimi Seçenekleri
recent-destinations-legend = Son hedefler
recent-destinations-description = İletilerin son taşındığı klasörleri listeleme ve sıralama seçenekleri.
recent-sort-order-label = Sıralama:
    .accesskey = S
recent-sort-order-mru =
    .label = En son
recent-sort-order-alphabetic =
    .label = Alfabetik
max-recent-label = Gösterilecek en fazla son klasör sayısı:
    .accesskey = G
...
account-hub-manual-config-checkbox-label =
    .label = Hesap merkezinde yeni manuel yapılandırma akışını kullan
    .accesskey = m
account-hub-manual-config-checkbox-description = Yeni hesap merkezinde manuel yapılandırma akışı
new-calendar-legend = Yeni takvim etkinliği iletişim kutusu
new-calendar-checkbox-label =
    .label = Takvim etkinliklerini yeni pencerede görüntüle
new-calendar-checkbox-description = Etkinlikleri görüntülemek için deneysel yeni takvim iletişim kutusu
...
forward-inline-label =
    .label = İletinin içinde (satır içi)
...
email-picker-label =
    ...
    .accesskey = t
email-picker-description = Gönderilmiş iletilerden kaydedilen yeni kişilerin konumu.
default-add-address-book-label =
    .value = Elle eklenen kişiler için varsayılan adres defteri:
    .accesskey = E
default-add-address-book-description = Gelen iletilerden kaydedilen yeni kişilerin konumu.
...
attachment-label =
    ...
    .accesskey = d
edit-keywords-label =
    .label = Anahtar kelimeleri düzenle…
    .accesskey = A
...
search-preferences-input2 =
    ...
    .style = width: 15.4em
managed-by-organization-notice = { -brand-short-name } bir kuruluş tarafından yönetiliyor.
...
accent-color-selection-label =
    .value = Ana düğme ve vurgularda kullanılacak rengi seçin
accent-color-label =
...
accent-color-teal =
    .label = Turkuaz
accent-color-disabled-description = Yüksek karşıtlık modunda vurgu renkleri desteklenmez.
default-message-list-legend = İleti Listesi
appearance-view-style-select =
    .value = Görünüm stilini seçin:
...
appearance-radio-card-view =
    .label = Kart görünümü
card-view-options-legend = Kart görünümü seçenekleri
...
default-message-list-new-folders-description = Yeni klasörler için varsayılan sıralama ve dizi seçeneklerini seçin
...
default-sort-newest-bottom =
    .label = En yeni iletiler altta
default-sort-new-messages-top =
    .label = En yeni iletiler üstte
apply-view-settings-label = Bu görünüm ayarlarını şuna uygula:
apply-view-settings-to-all-folders-button =
    .label = Tüm klasörler ve alt klasörler
    .accesskey = T
