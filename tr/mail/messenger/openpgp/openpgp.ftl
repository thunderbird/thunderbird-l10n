...
openpgp-key-details-attr-ignored = Uyarı: Bu anahtarın bazı özellikleri güvenli olmadığı için görmezden gelinebileceğinden anahtar beklendiği gibi çalışmayabilir.
