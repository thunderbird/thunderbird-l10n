...
source-thunderbird-description = Bir { app-name-thunderbird } profilinden ayarları, süzgeçleri, iletileri ve diğer verileri içe aktar.
source-seamonkey = { app-name-seamonkey } kurulumundan içe aktar
source-seamonkey-description = Bir { app-name-seamonkey } profilinden ayarları, süzgeçleri, iletileri ve diğer verileri içe aktar.
...
file-addressbook = Adres defterlerini içe aktar
