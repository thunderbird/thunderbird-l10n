...
toolbar-spam =
    .title = Seçili iletileri spam olarak işaretle
toolbar-not-spam-label = Spam değil
toolbar-not-spam =
    .title = Seçili iletileri spam değil olarak işaretle
...
toolbar-add-address-book-label = Adres defteri ekle
