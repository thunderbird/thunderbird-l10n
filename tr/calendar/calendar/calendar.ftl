...
calendar-task-filter-notstarted =
    .label = Başlamamış görevler
    .accesskey = a
calendar-task-filter-overdue =
    .label = Süresi geçmiş görevler
    .accesskey = r
...
calendar-task-filter-current =
    .label = Mevcut görevler
    .accesskey = M
calendar-task-details-title = başlık
calendar-task-details-organizer = kimden
calendar-task-details-priority = öncelik
calendar-task-details-priority-low = Düşük
calendar-task-details-priority-normal = Normal
calendar-task-details-priority-high = Yüksek
calendar-task-details-status = durum
calendar-task-details-category = kategori
calendar-task-details-repeat = tekrarla
calendar-task-details-attachments = ekler
calendar-task-details-start = başlangıç tarihi
...
calendar-progress-level-25 =
    .label = %25 tamamlanmış
    .accesskey = 2
calendar-progress-level-50 =
    .label = %50 tamamlanmış
    .accesskey = 5
calendar-progress-level-75 =
    .label = %75 tamamlanmış
    .accesskey = 7
calendar-progress-level-100 =
    .label = %100 tamamlanmış
    .accesskey = 1
...
calendar-newevent-button =
    .label = Yeni etkinlik
    .tooltiptext = Yeni etkinlik oluştur
calendar-newtask-button =
    .label = Yeni görev
    .tooltiptext = Yeni görev oluştur
calendar-unifinder-show-completed-todos =
    .label = Bitmiş görevleri göster
calendar-display-todos-checkbox =
    .label = Görünümdeki görevler
    .accesskey = n
...
calendar-publish-publish-dialog-button =
    .buttonlabelaccept = Yayımla
calendar-publish-publish-button = Yayımla
calendar-publish-close-button = Kapat
calendar-select-dialog-title = Takvim seç
...
calendar-extract-event-button =
    .label = Etkinlik olarak ekle
    .tooltiptext = Takvim bilgisini iletiden ayıklar ve takviminize etkinlik olarak ekler
