...
calendar-creation-panel-local-settings =
    .buttonlabelaccept = Takvim oluştur
    .buttonaccesskeyaccept = r
    .buttonlabelextra2 = Geri
...
calendar-creation-panel-network-settings =
    .buttonlabelaccept = Takvimleri bul
    .buttonaccesskeyaccept = b
    .buttonlabelextra2 = Geri
    .buttonaccesskeyextra2 = G
calendar-creation-panel-select-calendars =
    .buttonlabelaccept = Abone ol
...
calendar-creation-location-placeholder =
    .placeholder = Takvim sunucusunun URL’si veya ana bilgisayar adı
    .default-placeholder = Takvim sunucusunun URL’si veya ana bilgisayar adı
