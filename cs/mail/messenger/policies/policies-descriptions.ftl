...
policy-DisableQRExport = Zakáže generování QR kódu pro export nastavení účtu a přihlašovacích údajů.
...
policy-InAppNotification = Povolení nebo zakázání typů oznámení.
