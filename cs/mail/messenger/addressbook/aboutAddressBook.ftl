...
about-addressbook-photo-dialog-title =
    .aria-label = Spravovat fotografii tohoto kontaktu.
...
ab-search-dialog-delete-button =
    .label = Smazat
    .accesskey = S
ab-search-dialog-title = Rozšířené hledání v kontaktech
