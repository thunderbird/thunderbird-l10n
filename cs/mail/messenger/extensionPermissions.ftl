...
webext-perms-description-messages-send = Programově odesílat hromadné e-mailové zprávy vaším jménem, aniž by se zobrazovala jakákoli vizuální zpětná vazba. Pomocí Správce aktivit si můžete prohlédnout historii odeslaných zpráv tohoto doplňku.
webext-perms-description-messages-save = Ukládat e-mailové zprávy jako koncepty nebo šablony programově, bez vašeho zásahu
