...
toolbar-spam-label = Nevyžádaná
toolbar-spam =
    .title = Označí vybrané zprávy jako nevyžádané
toolbar-not-spam-label = Není nevyžádaná
toolbar-not-spam =
    .title = Označí vybrané zprávy jako že nejsou nevyžádané
...
toolbar-add-address-book-label = Přidat složku kontaktů
