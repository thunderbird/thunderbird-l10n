...
account-hub-title = Centrum účtů
...
account-hub-servers-username-label = Uživatelské jméno:
account-hub-result-server-label = Server:
account-hub-result-port-label = Port:
account-hub-result-security-label = Bezpečnost:
account-hub-result-authentication-type-label = Autentizace:
account-hub-result-authentication-none = Žádné
    .title = Žádné
account-hub-result-authentication-password = Normální heslo
    .title = Normální heslo
...
account-hub-result-authentication-ntlm = NTLM
    .title = NTLM
account-hub-result-authentication-external = Externí
    .title = Externí
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = Žádné
account-hub-result-auth-password = Normální heslo
...
account-hub-result-auth-external = Externí
...
account-hub-exchange-service-url-label = Zadejte URL adresu služby
...
account-hub-privacy-policy = Zásady ochrany osobních údajů
account-hub-welcome = Vítá vás
account-hub-welcome-brand = { -brand-short-name }
account-hub-welcome-text = Vítá vás { -brand-short-name }
...
account-hub-result-security-no-encryption = Bez šifrování
    .title = Bez šifrování
...
account-hub-thundermail-button = Přihlásit se pomocí Thundermailu
...
account-hub-result-graph-api-description = Pomocí Microsoft Graph API můžete synchronizovat své složky a e-maily s Microsoft 365
...
account-hub-config-success-title = Nastavení účtu bylo automaticky nalezeno.
...
address-book-add-remote-icon2 =
    .alt = Přidat vzdálenou složku kontaktů
address-book-add-remote-icon =
    .alt = Přidat novou vzdálenou složku kontaktů
address-book-add-remote = Přidat vzdálenou složku kontaktů
address-book-add-remote-carddav-description = Připojit složku kontaktů CardDAV
...
address-book-add-ldap-icon2 =
    .alt = Přidat složku kontaktů LDAP
address-book-add-ldap-button = Přidat složku kontaktů LDAP
...
account-hub-card-graph-description = Microsoft Graph je moderní metoda připojení pro Microsoft 365.
account-hub-card-ews-title = Webové služby Exchange
account-hub-card-ews-tag = Legacy
account-hub-card-ews-description = Exchange Web Services (EWS) se připojí k Microsoft Exchange za účelem synchronizace vaší pošty.
# This is shown after the type description, so "it" is referring to the type (either Microsoft Graph or Exchange Web Services).
account-hub-card-recommended-description = Je doporučeno, protože odpovídá URL vaší služby.
account-hub-exchange-type-username = Uživatelské jméno
account-hub-exchange-type-username-hint = Obvykle se jedná o vaši e-mailovou adresu nebo UPN v Active Directory.
account-hub-exchange-type-authentication = Způsob autentizace
# Checkbox that can be unchecked to use a custom OAuth config.
account-hub-exchange-type-default-oauth = Použít výchozí nastavení ověřování pro Microsoft 365 Copilot
account-hub-exchange-type-oauth-tenant = Tenant ID
account-hub-exchange-type-oauth-app = ID aplikace
account-hub-exchange-type-advanced-config = Rozšířené nastavení
