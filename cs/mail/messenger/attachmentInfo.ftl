...
attachment-save-dialog-title = Uložit přílohu
attachment-save-all-dialog-title = Uložit všechny přílohy
attachment-detach-dialog-title = Odpojit přílohu
attachment-detach-all-dialog-title = Odpojit všechny přílohy
attachment-save-failed = Nelze uložit přílohu. Zkontrolujte prosím název souboru a zkuste to znovu.
# Variables:
