...
pane-qr-export-title = Export do mobilu
category-qr-export =
    .tooltiptext = Exportovat do mobilu
general-language-and-fonts-header = Jazyk a písma
general-email-notifications-header = E-mailová oznámení
...
general-files-and-attachment-description = Zvolte, které soubory a kam se mají v počítači uložit.
general-tags-header = Štítky
general-reading-and-viewing-header = Čtení a prohlížení
general-reading-and-display-header = Čtení a zobrazení
general-updates-header = Aktualizace
general-network-and-storage-header = Síť a úložiště
general-search-performance-label = Vyhledávání a výkon
compose-writing-emails-header = Psaní e-mailů
...
compose-message-formatting-title = Formátování zpráv
compose-address-autocomplete-header = Automatické doplňování adres
...
choose-display-language-description = Zvolte jazyk, ve kterém se budou zobrazovat nabídky, tlačítka a oznámení.
manage-languages-button =
    .label = Spravovat jazyky…
    .accesskey = S
...
mail-play-button =
    .label = Přehrát
    .accesskey = h
change-dock-icon-description = Oznámení aplikace
...
enable-global-search-label =
    .label = Povolit vyhledávání ve všech e-mailových účtech
    .accesskey = v
gloda-results-plain-list-label =
    .label = Zobrazit výsledky vyhledávání v jednoduchém seznamu
    .accesskey = Z
...
enable-gloda-search-label =
    .label = Povolit globální vyhledávání a indexaci
    .accesskey = g
gloda-show-results-as-list-label =
    .label = Zobrazovat ve výchozím nastavení globální výsledky vyhledávání jako seznam
    .accesskey = Z
datetime-formatting-legend = Formátování data a času
display-language-legend = Jazyk rozhraní
allow-graphics-accel =
    .label = Použít grafickou akceleraci pro plynulejší posouvání a vyšší výkon
    .accesskey = P
storage-format-label =
    .value = Formát úložiště pro nové účty:
    .accesskey = F
mbox-store-single-label =
    .label = Jeden soubor pro každou složku (mbox)
...
enable-autoscroll-label =
    .label = Povolit automatické posouvání
    .accesskey = P
autoscroll-label =
...
hide-titlebar-label =
    .label = Skrýt záhlaví okna
    .accesskey = S
hide-titlebar-description = Skryje horní lištu s názvem okna a ušetří tak místo na obrazovce
hide-tabbar-single-tab-label =
    .label = Skrýt lištu panelů, pokud je otevřen pouze jeden panel
    .accesskey = S
auto-hide-tabbar-second-tab-description = Panely se automaticky skryjí, dokud neotevřete druhý.
system-settings-legend = Systémová nastavení
check-email-app-label =
    .label = Při otevření vždy zkontrolovat, zda je aplikace { -brand-short-name } výchozí e-mailovou aplikací
    .accesskey = P
edit-defaults-apps-button =
    .label = Upravit výchozí…
    .accesskey = U
...
update-settings-title = Nastavení aktualizací
install-updates-automatically-label =
    .label = Instalovat aktualizace automaticky (doporučeno)
    .accesskey = I
install-updates-automatically-description =
    { -brand-short-name.case-status ->
        [with-cases] Udržuje { -brand-short-name(case: "acc") } v bezpečí pomocí nejnovějších bezpečnostních oprav.
       *[no-cases] Udržuje aplikaci { -brand-short-name } v bezpečí pomocí nejnovějších bezpečnostních oprav.
    }
check-updates-ask-label =
    .label = Kontrolovat aktualizace, ale před instalací se dotázat
    .accesskey = K
allow-description =
    { -brand-short-name.case-status ->
...
connection-config-description = Určete, jak se má { -brand-short-name } připojovat k internetu.
connection-options-button =
    .label = Nastavení připojení…
    .accesskey = N
offline-mode-legend = Režim offline
offline-settings-label = Nastavení režimu offline
...
offline-settings-button =
    .label = Režim offline…
    .accesskey = o
temporary-storage-legend = Dočasné úložiště
offline-compact-remove-deleted =
    .label = Odstranit data složek, které už byly smazány, a uvolnit tak místo v úložišti
    .accesskey = O
offline-compact-ask-cleanup =
    .label = Před vyčištěním složek se dotázat
    .accesskey = v
...
use-cache-before =
    ...
    .accesskey = P
use-temp-storage-after = MB prostoru pro dočasné soubory
...
underline-text-links-label =
    .label = Podtrhávat textové odkazy ve zprávách
    .accesskey = P
...
convert-emoticons-label =
    ...
    .accesskey = Z
display-text-formatting-label = Formátování citovaného textu
...
search-content-types =
    .placeholder = Hledat podle typu obsahu
...
always-ask-label =
    ...
    .accesskey = k
use-tags-text = Pomocí štítků můžete zprávy třídit do kategorií a určovat jejich prioritu.
...
mark-read-when-opened =
    .label = Ihned po otevření
    .accesskey = I
show-attachments-inline-label =
    .label = Zobrazovat přílohy v těle zprávy
    .accesskey = Z
mark-read-no-delay =
...
display-name-only-label =
    .label = U kontaktů uložených v adresáři zobrazovat pouze zobrazované jméno
    .accesskey = U
...
show-conversation-view-label =
    .label = Používat zobrazení Konverzace
    .accesskey = o
conversation-view-preview-description = Tato funkce je zatím v rané fázi testování. Seskupuje související zprávy, ale nemusí vždy fungovat podle očekávání.
...
dark-mode-message-appearance = Vzhled zpráv
dark-mode-checkbox-label =
    .label = Používat tmavý režim pro textové zprávy
    .accesskey = t
dark-mode-message-text-description = Nastavit tmavé pozadí u všech příchozích zpráv, i když je odesílatel naformátoval ve světlých barvách.
...
dark-message-mode-toggle-label =
    ...
    .accesskey = Z
dark-mode-toggle-description = Umožňuje při čtení rychle přepnout e-mail zpět do světlého režimu, aniž by se změnilo vaše hlavní nastavení.
general-folder-settings-header = Nastavení složky
recent-folders-legend = Nedávné složky
recent-folders-description = Určuje, jak se při přesunutí zpráv zobrazí naposledy použité složky.
...
recent-destinations-description = Zobrazení a řazení složek, do kterých byly nedávno přesunuty zprávy.
recent-sort-order-label = Pořadí řazení:
    .accesskey = P
recent-sort-order-mru =
    .label = Nejnovější
recent-sort-order-alphabetic =
    .label = Abecedně
max-recent-label = Maximální počet nedávných složek:
    .accesskey = M
...
account-hub-manual-config-checkbox-label =
    .label = Použít nový postup ruční konfigurace v Centru účtů
    .accesskey = k
account-hub-manual-config-checkbox-description = Postup ruční konfigurace v novém Centru účtů
new-calendar-legend = Nový dialog události kalendáře
new-calendar-checkbox-label =
    .label = Zobrazí události kalendáře v novém dialogu
...
as-attachment-label =
    .label = Jako přílohu
add-file-type-label =
    .label = Přidat typ souboru k přiloženým zprávám
    .accesskey = t
extension-label =
...
autosave-draft-label =
    .label = Automaticky ukládat koncept každých
    .accesskey = k
...
ignore-sender-styles-label =
    .label = Ignorovat písma a barvy odesílatele
    .accesskey = I
...
paragraph-spacing-label =
    .label = Stisknutím klávesy Enter vytvářet nový odstavec s větším rozestupem
    .accesskey = S
...
compose-format-automatic-option =
    .label = Automatický (doporučeno)
compose-format-automatic-description = Pokud přidáte formátování (například tučné písmo nebo odkazy), odešle se formátovaný text, jinak prostý text.
compose-format-both-option =
    .label = Formátovaný text (HTML) i prostý text
compose-format-both-description = Vždy odešle obě verze, aby si e-mailová aplikace příjemce mohla vybrat, kterou zobrazí.
...
autocomplete-matches-description = Při zadávání jména nebo e-mailu příjemce vyhledávat shody v:
company-network-directory-label =
    .label = Firemní nebo síťový adresář
    .accesskey = F
directory-server-label =
    .label = Server adresářové služby
    .accesskey = S
...
manage-directories-label =
    .label = Spravovat adresáře…
    .accesskey = a
collect-outgoing-label =
    .label = Automaticky ukládat adresy příjemců odchozích e-mailů do:
    .accesskey = A
collect-outgoing-description = Místo pro ukládání nových kontaktů vytvořených ručně nebo přidaných z e-mailů.
save-added-contacts-label =
    .value = Ručně přidané kontakty ukládat do:
    .accesskey = R
save-added-contacts-description = Místo pro ukládání nových kontaktů z e-mailů.
show-directory-startup-label =
    .value = Při otevření aplikace { -brand-short-name } zobrazit adresář v okně kontaktů
    .accesskey = P
...
default-add-address-book-label =
    .value = Výchozí složka pro ručně přidané kontakty:
    .accesskey = V
default-add-address-book-description = Umístění nových kontaktů uložených z přijatých zpráv.
...
attachment-label =
    ...
    .accesskey = n
edit-keywords-label =
    .label = Upravit klíčová slova…
    .accesskey = U
offer-share-large-files-label =
    .label = Nabízet sdílení souborů pomocí odkazu při překročení:
...
exceptions-button =
    .label = Výjimky…
    .accesskey = m
remote-content-privacy-info = Zjistit více o problémech se soukromím u vzdáleného obsahu
remote-content-info =
...
email-e2ee-key-servers-legend = Servery klíčů OpenPGP
email-e2ee-key-servers-intro =
    Server klíčů přijímá a poskytuje existující veřejné klíče uživatelům.
    To vám umožní publikovat váš veřejný klíč a najít a obnovit klíče ostatních.
email-e2ee-key-servers-use-following = Použít následující servery klíčů:
email-e2ee-key-servers-add = Přidat…
email-e2ee-key-servers-reset = Obnovit seznam serverů
email-e2ee-key-servers-add-title = Přidat server klíčů
email-e2ee-key-servers-add-text = Zadejte adresu serveru klíčů, který chcete přidat.
email-e2ee-key-servers-add-failed-title = Přidání serveru klíčů se nezdařilo
...
search-preferences-input2 =
    ...
    .style = width: 15.4em
managed-by-organization-notice = { -brand-short-name } je spravován organizací.
managed-notice =
    { -brand-short-name.case-status ->
...
qr-export-security-warning = V zájmu své bezpečnosti se ujistěte, že máte soukromí, přičemž skenujte pouze QR kódy pocházející z důvěryhodných zdrojů.
...
accent-color-selection-label =
    .value = Zvolte barvu hlavního tlačítka a zvýraznění
accent-color-label =
...
card-view-options-legend = Možnosti zobrazení karty
...
default-message-list-new-folders-description = Nastavte výchozí řazení a seskupování do vláken pro nové složky
...
default-sort-by-label = Seřadit zprávy podle:
...
default-sort-newest-bottom =
    .label = Nejnovější zprávy dole
default-sort-new-messages-top =
    .label = Nejnovější zprávy nahoře
apply-view-settings-label = Tato nastavení zobrazení použít pro:
apply-view-settings-to-all-folders-button =
    .label = Všechny složky a podsložky
    .accesskey = V
select-apply-sort-folders-button =
    .label = Vyberte složky
    .accesskey = V
