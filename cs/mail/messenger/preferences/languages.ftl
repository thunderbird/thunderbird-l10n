...
messenger-languages-description = { -brand-short-name } zobrazí své uživatelské rozhraní v prvním uvedeném jazyce. Ostatní jazyky použije jen pokud bude potřeba, a to v uvedeném pořadí.
