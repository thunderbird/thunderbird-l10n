...
privacy-scam-detection-title = Svindeloppdagelse
...
close-to-tray-label =
    .label = Når { -brand-short-name } er lukket, flytt den til systemstatusfeltet
    .accesskey = N
start-in-tray-label =
...
gloda-show-results-as-list-label =
    .label = Vis globale søkeresultater som en liste som standard
    .accesskey = V
...
general-folder-options-header = Alternativer for mappebehandling
recent-destinations-legend = Siste destinasjoner
recent-destinations-description = Alternativer for å liste opp og sortere mapper der meldinger nylig ble flyttet.
recent-sort-order-label = Sorteringsrekkefølge:
    .accesskey = S
recent-sort-order-mru =
    .label = Nyeste
recent-sort-order-alphabetic =
    .label = Alfabetisk
max-recent-label = Maksimalt antall nylige mapper:
    .accesskey = M
...
new-calendar-legend = Ny kalenderhendelse-dialogvindu
new-calendar-checkbox-label =
    .label = Vis kalenderhendelser i det nye dialogvinduet
new-calendar-checkbox-description = Eksperimentell ny kalenderdialogvindu for visning av hendelser
...
email-picker-label =
    ...
    .accesskey = A
email-picker-description = Plasseringen der nye kontakter fra sendte meldinger lagres.
default-add-address-book-label =
    .value = Standard adressebok for manuelt tillagte kontakter:
    .accesskey = S
default-add-address-book-description = Plasseringen der nye kontakter fra mottatte meldinger lagres.
...
email-e2ee-enable-accounts-info = Sett opp e-postkontoer og identiteter for ende-til-ende-kryptering i <a data-l10n-name="account-settings-url">Kontoinnstillinger</a>.
...
email-e2ee-key-servers-legend = OpenPGP-nøkkelservere
email-e2ee-key-servers-intro =
    En nøkkelserver mottar og leverer eksisterende offentlige nøkler til brukere.
    Den lar deg publisere din offentlige nøkkel samt finne og oppdatere andres nøkler.
email-e2ee-key-servers-use-following = Bruk følgende nøkkelservere:
...
email-e2ee-key-servers-add-text = Skriv inn URL-en til nøkkelserveren som skal legges til.
email-e2ee-key-servers-add-failed-title = Kunne ikke legge til nøkkelserver
email-e2ee-key-servers-add-failed-text = Kunne ikke koble til en nøkkelserver på den oppgitte URL-en.
...
accent-color-label =
    .value = Definer fargen som brukes for primærknapper og uthevede elementer:
accent-color-os =
...
accent-color-teal =
    .label = Blågrønn
accent-color-disabled-description = Aksentfarger støttes ikke i høykontrastmodus.
