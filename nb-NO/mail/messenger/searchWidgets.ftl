...
search-attrib-screen-name = Skjermnavn
search-attrib-email = E-post
search-attrib-additional-email = E-post (annen)
search-attrib-any-number = Et nummer
search-attrib-work-phone = Arbeidstelefon
search-attrib-home-phone = Hjemmetelefon
search-attrib-fax = Faks
search-attrib-pager = Personsøker
search-attrib-mobile = Mobiltelefon
search-attrib-city = Poststed
