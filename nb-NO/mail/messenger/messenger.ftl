...
menu-file-get-next-n-news-msgs =
    { $count ->
        [one] Hent neste { $count } nyhetsgruppemelding
       *[other] Hent neste { $count } nyhetsgruppemeldinger
    }
# Variables:
...
menu-move-copy-no-recent =
    .label = (Ingen nylige destinasjoner)
...
ignored-theads-feedback =
    { $count ->
        [one] Svar på tråden «{ $subject }» vil ikke bli vist.
       *[other] Svar på de { $count } valgte trådene vil ikke bli vist.
    }
# Variables:
#    $count - the number of threads that were selected
#    $subject - the message thread title (subject)
ignored-subtheads-feedback =
    { $count ->
        [one] Svar på undertråden «{ $subject }» vil ikke bli vist.
       *[other] Svar på de { $count } valgte undertrådene vil ikke bli vist.
    }
...
allow-remote-content-resource =
    .label = Tillat eksternt innhold fra { $origin }
# Variables:
#    $count - the number of origins to allow
remote-content-option-allow-all =
    .label =
        { $count ->
            [one] Tillat eksternt innhold fra { $count } kilde oppgitt ovenfor
           *[other] Tillat eksternt innhold fra alle { $count } kildene listet ovenfor
        }
...
tags-label-4 = Å gjøre
tags-label-5 = Senere
tags-add-new =
    .label = Ny etikett …
    .accesskey = N
tags-manage =
    .label = Behandle etiketter …
    .accesskey = B
tags-remove-all =
    .label = Slett tilordnede etiketter
    .accesskey = 0
# Variables:
...
oauth2-loopback-success = Du kan lukke dette vinduet.
oauth2-loopback-failure = OAuth-omdirigering mislyktes.
