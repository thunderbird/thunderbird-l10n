...
account-hub-result-auth-password = Vanlig passord
...
account-hub-password-label = Passord
    ...
    .accesskey = P
account-hub-remember-password = Husk passord
    .accesskey = k
account-hub-exchange-label = Din innloggning
    .accesskey = l
account-hub-installing-addon = Laster ned og installerer utvidelse …
account-hub-success-addon = Utvidelsen ble installert
account-hub-success-half-manual = Følgende innstillinger ble funnet ved undersøking av serveren:
account-hub-result-security-no-encryption = Ingen kryptering
    .title = Ingen kryptering
...
account-hub-credentials-wrong = Autentiseringen mislyktes. Kontroller brukernavn og passord
...
account-hub-exchange-config-unverifiable = Konfigurasjonen kunne ikke bekreftes. Hvis brukernavnet og passordet ditt er riktig, er det sannsynlig at serveradministratoren har deaktivert den valgte konfigurasjonen for kontoen din. Prøv å velge en annen protokoll.
account-hub-advanced-setup-button = Avansert konfigurasjon
    .accesskey = A
# Variables:
#  $domain (String): The name of the server where the configuration was found, e.g. rackspace.com.
account-hub-exchange-dialog-question = { -brand-short-name } fant kontooppsettinformasjonen din på { $domain }. Vil du fortsette og sende inn informasjonen din?
account-hub-creation-error-title = Kunne ikke opprette konto
account-hub-error-server-exists = Den innkommende serveren eksisterer allerede.
account-hub-confirm-advanced-title = Bekreft avansert oppsett
account-hub-confirm-advanced-description = Denne dialogboksen blir lukket og en konto med de gjeldende innstillingene vil bli opprettet, selv om innstillingene er feil. Vil du fortsette?
...
account-hub-port-help-text = Hvis feltet står tomt, vil { -brand-short-name } forsøke å finne porten automatisk.
...
account-hub-result-graph-api-description = Bruk Microsoft Graph API for å synkronisere mapper og e-poster med Microsoft 365
...
account-hub-result-ews-expanded-text = Exchange-webtjenester
...
account-hub-config-success-title = Kontoinnstillinger funnet automatisk.
account-hub-config-success-description-db = Innstillinger funnet i Mozilla ISPDB.
account-hub-config-success-description-exchange = Innstillinger funnet for en Microsoft Exchange-server.
account-hub-config-success-description-guess = Innstillinger funnet ved å prøve vanlige servernavn.
account-hub-config-success-description-disk = Innstillinger funnet i { -brand-short-name }-installasjonen.
...
account-hub-select-security-warning = <span data-l10n-name="error-text">Advarsel: Usikker e-postserver oppdaget.</span> Denne serveren mangler kryptering, noe som eksponerer passordet og dataene dine. Kontakt administratoren din for å sikre tilkoblingen, eller fortsett på egen risiko. <a data-l10n-name="error-link">Se ofte stilte spørsmål for mer informasjon.</a>
...
address-book-add-remote-icon2 =
    .alt = Legg til en ekstern adressebok
address-book-add-remote-icon =
    .alt = Legg til en ny ekstern adressebok
address-book-add-remote = Legg til ekstern adressebok
address-book-add-remote-carddav-description = Koble til en CardDAV-adressebok
...
address-book-add-ldap-icon2 =
    .alt = Legg til en LDAP-adressebok
...
account-hub-exchange-type-title = Velg en kontotype
