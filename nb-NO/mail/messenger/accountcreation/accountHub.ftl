...
account-hub-username-warning-icon = Brukernavn er påkrevd
account-hub-address-book-username-error-text = Skriv inn et brukernavn
account-hub-server-label = URL/servernavn
...
address-book-carddav-known-incompatible = { $url } er kjent for å være ikke kompatibel med { -brand-short-name }.
