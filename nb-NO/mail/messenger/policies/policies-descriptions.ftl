...
policy-AppUpdateURL = Angi tilpasset programoppdateringsadresse.
...
policy-DisableChat = Slå av chat-funksjonen.
policy-DisableDataCollectionSettings = Hindre brukeren i å endre innstillinger for datainnsamling.
...
policy-DisableMessageForwardingFilters = Hindre meldingsfiltre i å videresende meldinger automatisk.
...
policy-DisableExperimentalFeatures = Deaktiver eksperimentelle funksjoner i Thunderbird.
...
policy-DisableUpdateSettings = Hindre brukeren i å endre innstillinger for programoppdateringer.
