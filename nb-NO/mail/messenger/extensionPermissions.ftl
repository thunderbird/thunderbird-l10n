...
webext-perms-description-messages-send = Send e-postmeldinger i stort antall på dine vegne uten visuell tilbakemelding. Bruk aktivitetsbehandleren til å se gjennom tilleggets sendehistorikk.
webext-perms-description-messages-save = Lagre e-postmeldinger som utkast eller maler programmatisk, uten at du trenger å gjøre noe.
