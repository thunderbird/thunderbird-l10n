...
search-attrib-any-name = Any Name
search-attrib-display-name = Display Name
search-attrib-nickname = Nickname
search-attrib-screen-name = Screen Name
search-attrib-email = Email
search-attrib-additional-email = Additional Email
search-attrib-any-number = Any Number
search-attrib-work-phone = Work Phone
search-attrib-home-phone = Home Phone
search-attrib-fax = Fax
search-attrib-pager = Pager
search-attrib-mobile = Mobile
search-attrib-city = City
search-attrib-street = Street
...
search-op-contains = ਰੱਖਦਾ
search-op-doesnt-contain = ਨਹੀਂ ਰੱਖਦਾ ਹੈ
search-op-is = ਹੈ
search-op-isnt = ਨਹੀਂ ਹੈ
search-op-is-empty = ਖਾਲੀ ਹੈ
search-op-is-before = ਪਹਿਲਾਂ
search-op-is-after = ਬਾਅਦ
search-op-is-higher-than = ਤੋਂ ਵੱਧ
search-op-is-lower-than = ਤੋਂ ਘੱਟ
search-op-begins-with = ਇਸ ਨਾਲ ਸ਼ੁਰੂ
search-op-ends-with = ਇਸ ਨਾਲ ਸਮਾਪਤ
search-op-sounds-like = ਆਵਾਜ਼ ਹੋਵੇ
search-op-ldap-dwim = LdapDwim
search-op-is-greater-than = ਤੋਂ ਵੱਧ
search-op-is-less-than = ਤੋਂ ਘੱਟ
search-op-name-completion = NameCompletion
search-op-is-in-ab = ਮੇਰੀ ਐਡਰੈੱਸਬੁੱਕ ਵਿੱਚ ਹੈ
search-op-isnt-in-ab = ਮੇਰੀ ਐਡਰੈੱਸ ਬੁੱਕ ਵਿੱਚ ਨਹੀਂ ਹੈ
search-op-isnt-empty = ਖਾਲੀ ਨਹੀਂ ਹੈ
...
search-match-all =
    .label = ਹੇਠ ਦਿੱਤਿਆਂ ਵਿੱਚੋਂ ਸਭ ਮੇਲਾਓ
    .accesskey = a
search-match-any =
    .label = ਹੇਠ ਦਿੱਤਿਆਂ ਵਿੱਚੋਂ ਕੋਈ ਵੀ ਮੇਲਾਓ
    .accesskey = o
