...
calendar-item-summary-status-tentative = ਆਰਜ਼ੀ
calendar-item-summary-status-confirmed = ਤਸਦੀਕ ਕੀਤਾ
calendar-item-summary-event-status-cancelled = ਰੱਦ ਕੀਤਾ
calendar-item-summary-todo-status-cancelled = ਰੱਦ ਕੀਤਾ
