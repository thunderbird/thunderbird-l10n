...
account-hub-result-auth-encrypted-password = ססמה מוצפנת
    .title = ססמה מוצפנת
account-hub-result-auth-external = חיצוני
    .title = חיצוני
...
account-hub-server-label = כתובת/שם מארח:
account-hub-server-warning-icon = כתובת שגויה
account-hub-server-error-text = נא למלא כתובת תקנית
account-hub-address-book-name-label = שם
account-hub-address-book-name-error-text = נא למלא שם
account-hub-advanced-configuration-button = הגדרות מתקדמות
account-hub-email-setup-ews = הגדרות שרת
account-hub-exchange-service-url-label = נא להכניס את כתובת האתר של השירות
account-hub-email-credentials-confirmation = הגדרות חשבון
account-hub-close-button =
    .title = סגירה
account-hub-privacy-policy = מדיניות פרטיות
...
account-hub-name-label = שם מלא
    .accesskey = ש
account-hub-adding-account-title = הוספת חשבון
account-hub-email-account-added-title = החשבון נוסף בהצלחה
...
account-hub-name-error-text = נא למלא שם
account-hub-account-authentication-error = שגיאת אימות.
address-book-sync-existing = סנכרון מחשבון קיים
address-book-add-remote-icon2 =
    .alt = הוספת ספר כתובות מרוחק
address-book-add-remote-icon =
    .alt = הוספת ספר כתובות מרוחק חדש
