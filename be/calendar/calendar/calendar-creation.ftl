...
calendar-creation-panel-network-settings =
    .buttonlabelaccept = Знайсці календары
    .buttonaccesskeyaccept = З
    .buttonlabelextra2 = Назад
    .buttonaccesskeyextra2 = Н
calendar-creation-panel-select-calendars =
    .buttonlabelaccept = Падпісацца
...
calendar-creation-location-placeholder =
    .placeholder = URL або імя хоста сервера календара
    .default-placeholder = URL або імя хоста сервера календара
calendar-creation-network-nocredentials =
    .label = Для гэтага адраса не патрабуюцца ўліковыя даныя
