...
prompt-remove-attachments-title = Выдаліць прымацаванні
# LOCALIZATION NOTE (prompt-remove-attachments-text):
#  $count will be replaced with number of attachments
prompt-remove-attachments-text =
    { $count ->
        [one] Вы ўпэўнены, што жадаеце выдаліць { $count } прымацаванне?
        [few] Вы ўпэўнены, што жадаеце выдаліць { $count } прымацаванні?
       *[many] Вы ўпэўнены, што жадаеце выдаліць { $count } прымацаванняў?
    }
...
several-calendar-weeks = Тыдні: { $startIndex }-{ $endIndex }
...
calendar-context-new-server =
    .label = Новы каляндар…
    .accesskey = Н
calendar-task-filter-title = Паказаць
...
calendar-task-filter-today =
    .label = Сёння
    .accesskey = С
calendar-task-details-priority = прыярытэт
calendar-task-details-priority-low = Нізкі
calendar-task-details-priority-normal = Звычайны
calendar-task-details-priority-high = Высокі
calendar-task-details-status = статус
calendar-task-details-category = катэгорыя
calendar-task-details-attachments = прымацаванні
calendar-task-details-start = дата пачатку
calendar-task-text-filter-field =
    .emptytextbase = Фільтр задач #1
...
calendar-properties-refresh =
    .value = Абнаўляць каляндар:
calendar-properties-refresh-manual =
    .label = Уручную
calendar-properties-read-only =
    .label = Толькі для чытання
calendar-properties-show-reminders =
    .label = Паказваць напамінкі
calendar-properties-offline-support =
    .label = Працаваць па-за сеткай
calendar-properties-enable-calendar =
    .label = Уключыць гэты каляндар
calendar-properties-provider-missing = Не атрымалася знайсці дастаўніка паслуг для гэтага календара. Часцей за ўсё гэта адбываецца пасля адключэння або выдалення дадаткаў.
calendar-properties-unsubscribe =
    .label = Адпісацца
    .accesskey = А
    .buttonlabelextra1 = Адпісацца
    .buttonaccesskeyextra1 = А
calendar-alarm-dialog-title = Напамінкі календара
...
calendar-newevent-button =
    .label = Новая падзея
    .tooltiptext = Стварыць новую падзею
calendar-newtask-button =
    .label = Новая задача
    .tooltiptext = Стварыць новую задачу
calendar-unifinder-show-completed-todos =
    .label = Паказаць выкананыя задачы
...
calendar-publish-publish-dialog-button =
    .buttonlabelaccept = Апублікаваць
calendar-publish-publish-button = Апублікаваць
calendar-publish-close-button = Закрыць
calendar-select-dialog-title = Выберыце каляндар
...
calendar-extract-event-button =
    .label = Дадаць як падзею
    .tooltiptext = Выцягнуць каляндарную інфармацыю з паведамлення і дадаць яе ў ваш каляндар як падзею
