...
calendar-event-listing-close =
    .tooltiptext = Закрыць пошук і спіс падзей

## Listing columns

calendar-event-listing-column-calendar-name =
    .label = Назва календара
    .tooltiptext = { "" }
...
calendar-event-listing-column-creation-date =
    .label = Створана
    .tooltiptext = Сартаваць паводле даты стварэння
calendar-event-listing-column-last-modified-time =
    .label = Зменена
    .tooltiptext = Сартаваць паводле даты апошняй змены
