...
account-setup-success-secondary-description = Вы можаце палепшыць вопыт узаемадзеяння з праграмай шляхам падлучэння звязаных служб і з дапамогай пашыранай канфігурацыі ў наладах уліковага запісу.
