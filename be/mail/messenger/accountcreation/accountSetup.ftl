...
account-setup-success-secondary-description = Вы можаце палепшыць досвед узаемадзеяння з праграмай шляхам падлучэння звязаных служб і з дапамогай пашыранай канфігурацыі ў наладах уліковага запісу.
...
account-setup-hostname-label = Імя хоста:
...
exchange-dialog-question = { -brand-short-name } знайноў інфармацыю па наладжванню вашага ўліковага запісу на { $domain }. Ці жадаеце працягнуць і адправіць вашы ўліковыя даныя?
exchange-dialog-confirm-button = Увайсці
exchange-dialog-cancel-button = Скасаваць

## Dismiss account creation dialog

exit-dialog-title = Ніводзін уліковы запіс электроннай пошты не сканфігураваны
exit-dialog-description = Вы ўпэўнены, што жадаеце скасаваць працэс наладжвання? { -brand-short-name } можа выкарыстоўвацца далей і без ўліковага запісу электроннай пошты, але мноства функцый не будуць даступныя.
...
exit-dialog-cancel-button = Працягнуць наладжванне
    .accesskey = П
exit-dialog-confirm-button = Выйсці з наладжвання
    .accesskey = В
...
account-setup-found-address-books-description =
    { $count ->
        [one] { -brand-short-name } знайшоў адну адрасную кнігу, звязаную з вашым уліковым запісам электроннай пошты.
        [few] { -brand-short-name } знайшоў { $count } адрасныя кнігі, звязаныя з вашым уліковым запісам электроннай пошты.
       *[many] { -brand-short-name } знайшоў { $count } адрасных кніг, звязаных з вашым уліковым запісам электроннай пошты.
    }
# Variables:
# $count (Number) - The number of calendars found during autoconfig.
account-setup-found-calendars-description =
    { $count ->
        [one] { -brand-short-name } знайшоў адзін каляндар, звязаны з вашым уліковым запісам электроннай пошты.
