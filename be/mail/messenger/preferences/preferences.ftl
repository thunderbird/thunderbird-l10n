...
account-hub-checkbox-label =
    .label = Ствараць ўліковыя запісы ў новым цэнтры ўліковых запісаў
    .accesskey = С
...
default-order-label = Парадак сартавання:
default-sort-ascending =
    .label = Па ўзрастанні
default-sort-ascending-description = Новыя паведамленні знізу
...
apply-current-view-to-folder-children =
    .label = Папку і яе падпапкі…
apply-changes-prompt-title = Ужыць змены?
apply-changes-prompt-message = Вы ўпэўнены, што жадаеце ўжыць бягучыя налады сартавання і адлюстравання абмеркаванняў для ўсіх папак?
