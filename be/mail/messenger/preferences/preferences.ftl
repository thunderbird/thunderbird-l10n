...
qr-export-description = Сгенеруйце QR-код і хутка перанясіце налады вашага ўліковага запісу з камп'ютара на мабільную прыладу. Выберыце, якія ўліковыя запісы ўключыць у экспарт, вырашыце, ці жадаеце перанесці ваш пароль, потым адскануйце код на вашай мабільнай прыладзе. Хутка, бяспечна і проста.
qr-export-get-app = У вас яшчэ няма { -brand-product-name } на мабільнай прыладзе? <a data-l10n-name="app-link">Спампуйце ў Google Play</a>
