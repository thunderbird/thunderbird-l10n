...
account-hub-manual-config-checkbox-label =
    .label = Wužiwajće nowy manuelny konfiguraciski běh w kontowym centrumje
    .accesskey = k
account-hub-manual-config-checkbox-description = Nowy manuelny konfiguraciski běh kontoweho centruma
