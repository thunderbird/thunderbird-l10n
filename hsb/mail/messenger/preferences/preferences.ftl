...
general-email-notifications-header = E-mejlowe zdźělenki
...
general-files-and-attachment-description = Postajće, kotre dataje maja so składować a hdźež so maja na wašim ličaku składować.
general-tags-header = Znački
general-reading-and-viewing-header = Čitanje a wobhladanje
general-reading-and-display-header = Čitanje a zwobraznjenje
general-updates-header = Aktualizacije
general-network-and-storage-header = Syć a składowak
general-search-performance-label = Pytanje a wukon
compose-writing-emails-header = Mejlki spisać
...
compose-address-autocomplete-header = Awtowudospołnjenje adresow
...
choose-display-language-description = Wubjerće rěč za menije, tłóčatka a zdźělenki.
...
manual-storage-limit-label =
    .label = Składowanske limity za temporerne dataje manuelnje nastajić
    .accesskey = S
clear-temp-files-button =
    .label = Temporerne dataje zhašeć
    .accesskey = T
clear-temp-files-shutdown-label =
    .label = Temporerne dataje zhašeć, hdyž so { -brand-short-name } začinja
    .accesskey = z
...
show-start-page-label =
    .label = Startowu stronu pokazać, hdyž so { -brand-short-name } wočinja
    .accesskey = t
start-page-label =
...
start-in-tray-label =
    ...
    .accesskey = s
new-message-arrival-legend = Hdyž nowa powěsć dochadźa:
...
use-custom-sound-label =
    .label = Swójski zynk za zdźělenki wužiwać
    .accesskey = S
mail-select-audio-button =
    .label = Awdijo wubrać…
    .accesskey = A
enable-global-search-label =
    .label = Pytanje za wšě e-mejlowe konta zmóžnić
    .accesskey = m
gloda-results-plain-list-label =
    .label = Pytanske wuslědki w jednorej lisćinje pokazać
    .accesskey = P
...
gloda-show-results-as-list-label =
    .label = Globalne pytanske wuslědki po standardźe jako lisćinu pokazać
    .accesskey = G
datetime-formatting-legend = Formatowanje datuma a časa
display-language-legend = Zwobraznjenska rěč
allow-graphics-accel =
    .label = Grafikowe pospěšenje za łahodniše kulenje a lěpši wukon wužiwać
    .accesskey = G
storage-format-label =
    .value = Składowanski format za nowe konta:
    .accesskey = k
mbox-store-single-label =
    .label = Jednotliwa dataja na rjadowak (mbox)
...
enable-autoscroll-label =
    .label = Awtomatiske přesuwanje zmóžnić
    .accesskey = A
autoscroll-label =
...
hide-titlebar-label =
    .label = Titulnu lajstu schować
    .accesskey = c
hide-titlebar-description = Wotstronja titulnu lajstu, kotraž mjeno wokna pokazuje, zo byšće rum na wobrazowce zalutował
hide-tabbar-single-tab-label =
    .label = Schowajće lajstu rajtarkow, hdyž jenož jedyn rajtark je wočinjeny
    .accesskey = S
auto-hide-tabbar-second-tab-description = Chowa rajtarki awtomatisce, doniž druhi rajtark njewočinjeće.
system-settings-legend = Systemowe nastajenja
check-email-app-label =
    .label = Při startowanju přeco kontrolować, hač { -brand-short-name } je standardny e-mejlowe nałoženje
    .accesskey = k
edit-defaults-apps-button =
    .label = Standard wobdźěłać…
    .accesskey = d
...
install-updates-automatically-label =
    ...
    .accesskey = A
install-updates-automatically-description = Dźerži { -brand-short-name } wěsty z najnowšimi wěstotnymi porjedźenjemi.
check-updates-ask-label =
    .label = Aktualizacije pytać, ale so prašeć, prjedy hač so instaluja
    .accesskey = A
...
connection-config-description = Kontrolujće, kak { -brand-short-name } z internetom zwjazuje.
...
offline-settings-button =
    .label = Offline…
    .accesskey = O
temporary-storage-legend = Temporerne składowanje
offline-compact-remove-deleted =
    .label = Daty z rjadowakow wotstronić, hdyž su hižo zhašane, zo by so składowanski rum wuswobodźił
    .accesskey = t
offline-compact-ask-cleanup =
    .label = Prašeć so, prjedy hač so rjadowaki zrumowali
    .accesskey = d
...
use-cache-before =
    .value = Hač k
    .accesskey = H
use-temp-storage-after = MB składowanskeho ruma za temporerne dataje
...
underline-text-links-label =
    .label = Tekstowe wotkazy w powěsćach podšmórnyć
    .accesskey = k
...
convert-emoticons-label =
    ...
    .accesskey = E
display-text-formatting-label = Formatěrowanje citowaneho teksta
...
search-content-types =
    .placeholder = Wobsahowe typy přepytać
...
always-ask-label =
    ...
    .accesskey = h
use-tags-text = Wužiwajće znački, zo byšće powěsće kategorizował a priorizował
...
display-name-only-label =
    .label = Pokazane mjeno jenož za kontakty pokazać, kotrež su so w adresniku składowali
    .accesskey = P
...
show-conversation-view-label =
    .label = Rozmołwny napohlad pokazać
    .accesskey = m
conversation-view-preview-description = Tuta funkcije je hišće w zažnej fazy. Zeskupja podobne powěsće, ale móhła nic přeco kaž wočakowana fungować.
...
dark-mode-checkbox-label =
    ...
    .accesskey = m
dark-mode-message-text-description = Nałožuje ćmowy pozadk na wšě dochadźace powěsće, samo hdyž wotpósłar je je w swětłych barbach formatěrował.
...
dark-message-mode-toggle-label =
    ...
    .accesskey = P
dark-mode-toggle-description = Zmóžnja wam, mejlku při čitanju spěšnje zaso w swětłym modusu pokazać, bjeztoho zo byšće trjebał swoje hłowne nastajenja změnić.
general-folder-settings-header = Rjadowakowe nastajenja
recent-folders-legend = Najnowše rjadowaki
recent-folders-description = Postaja, kak so njedawno wužiwane rjadowaki pokazuja, hdyž powěsće přesuwaće.
...
recent-sort-order-alphabetic =
    .label = Alfabetisce
max-recent-label = Maksimalna ličba najnowšich rjadowakow:
    .accesskey = M
...
account-hub-manual-config-checkbox-label =
    .label = Wužiwajće nowu manuelnu konfiguraciju w kontowym centrumje
    .accesskey = k
account-hub-manual-config-checkbox-description = Nowa manuelna konfiguracija kontoweho centruma
new-calendar-legend = Dialog za nowy protykowy podawk
new-calendar-checkbox-label =
    .label = Protykowe podawki w nowym dialogu pokazać
new-calendar-checkbox-description = Eksperimentelny nowy protykowy dialog za pokazowanje podawkow
...
as-attachment-label =
    .label = Jako přiwěšk
add-file-type-label =
    .label = Připowěsnjenym powěsćam datajowy typ přidać
    .accesskey = o
extension-label =
...
autosave-draft-label =
    .label = Naćisk awtomatisce składować kóžde
    .accesskey = N
...
ignore-sender-styles-label =
    .label = Pisma a barby wotpósłarja ignorować
    .accesskey = m
...
paragraph-spacing-label =
    .label = Hdyž Enter tłóčiće, so nowy wotstawk z přidatnym wotstupom započnje
    .accesskey = E
...
compose-format-automatic-option =
    .label = Awtomatiski (doporučeny)
compose-format-automatic-description = Formatěrowany tekst słać, jeli stile (na přikład tučny abo wotkazy) přidawaće, abo luty tekst, jeli nic.
compose-format-both-option =
    .label = Rich Text (HTML) a luty tekst
compose-format-both-description = Přeco wobě wersiji słać, zo by e-mejlowe nałoženje přijimarja wubrać móhło, kotre so ma pokazać.
compose-format-html-option =
    .label = Jenož Rich text (HTML)
compose-format-html-description = Wobchowuje swójske pisma, barby a wobrazy, někotre starše e-mejlowe nałoženja so snano korektnje njepokazuja.
...
collect-outgoing-label =
    .label = E-mejlowe adresy při słanju awtomatisce składować do:
    .accesskey = E
collect-outgoing-description = Tam, hdźež so nowe kontakty składuja, hdyž su so manuelnje wutworili abo z mejlkow přidali.
save-added-contacts-label =
    .value = Manuelnje přidate kontakty składować do:
    .accesskey = M
save-added-contacts-description = Tam, hdźež so nowe kontakty z mejlkow składuja.
show-directory-startup-label =
    .value = Zapis we woknje adresnika pokazać, hdyž so { -brand-short-name } wočinja
    .accesskey = Z
...
email-picker-label =
    ...
    .accesskey = t
email-picker-description = Městno nowych kontaktow, kotrež su so z pósłanych powěsćow składowali.
default-add-address-book-label =
    .value = Standardny adresnik za manuelnje přidate kontakty:
    .accesskey = S
default-add-address-book-description = Městno nowych kontaktow, kotrež su so z přijatych powěsćow składowali.
...
attachment-label =
    ...
    .accesskey = f
edit-keywords-label =
    .label = Klučowe słowa wobdźěłać
    .accesskey = K
offer-share-large-files-label =
    .label = Z wotkazom dźělenje datajow poskićić, hdyž su wjetše hač:
...
accent-color-selection-label =
    .value = Wubjerće barbu za primarne tłóčatko a wuzběhnjenja
accent-color-label =
...
appearance-view-style-select =
    .value = Zwobraznjenski stil wubrać
...
card-view-options-legend = Nastajenja kartoweho napohlada
...
default-message-list-new-folders-description = Wubjerće standardne nastajenja za sortěrowanje a strukturu nitkow za nowe rjadowaki
...
default-sort-by-label = Powěsće sortěrować po:
...
default-sort-newest-bottom =
    .label = Najnowše powěsće deleka
default-sort-new-messages-top =
    .label = Najnowše powěsće horjeka
apply-view-settings-label = Tute nastajenja napohlada nałožić na:
apply-view-settings-to-all-folders-button =
    .label = Wšě rjadowaki a podrjadowaki
    .accesskey = r
select-apply-sort-folders-button =
    .label = Rjadowaki wubrać
    .accesskey = R
