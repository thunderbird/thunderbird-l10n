...
default-app-intro = { -brand-short-name } jako standardne nałoženje wužiwać za:
...
checkbox-net-thunderbird-url-label =
    .label = Swójske wotkazy Thunderbird (net.thunderbird://)
    .tooltiptext = { unset-default-tooltip }
...
check-default-email-app-label =
    .label = Při startowanju přeco kontrolować, hač { -brand-short-name } je standardny e-mejlowy program, hdyž so wočinja
    .accesskey = s
