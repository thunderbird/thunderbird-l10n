...
num-unread =
    { $count ->
        [one] , { $count } nječitana
        [two] , { $count } nječitanej
        [few] , { $count } nječitane
       *[other] , { $count } nječitanych
    }
...
num-ignored =
    { $count ->
        [one] , { $count } ignorowana
        [two] , { $count } ignorowanej
        [few] , { $count } ignorowane
       *[other] , { $count } ignorowanych
    }
...
max-count-exceeded = (Kedźbu: { $total } powěsćow je wubranych, prěnje { $shown } so pokazuja)
...
max-thread-count-exceeded = (Kedźbu: Wubrane powěsće: { $total }, prěnje, kotrež so pokazuja: { $shown })
