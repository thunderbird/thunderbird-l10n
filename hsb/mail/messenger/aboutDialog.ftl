...
about-dialog-meadow-logo =
    .alt = Značka kodoweho mjena Meadow za { -brand-short-name }
    .title = { -brand-short-name } – Kodowe mjeno Meadow
...
about-donation = Chceće pomhać? <a data-l10n-name="helpus-donate-link">Darić</a> abo <a data-l10n-name="helpus-get-involved-link">čińće sobu!</a>
