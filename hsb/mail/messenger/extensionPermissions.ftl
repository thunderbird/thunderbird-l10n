...
webext-perms-description-messages-send = Sćelće e-mejlowe powěsće programatisce z masami w swojim mjenje, bjez wizualneje reakcije. Wužiwajće zrjadowak aktiwity, zo byšće wusyłansku historiju přidatka přepruwował.
webext-perms-description-messages-save = Składujće e-mejlowe powěsće jako naćiski abo předłohi programatisce, bjez wašeje interakcije
