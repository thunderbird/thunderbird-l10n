...
toolbar-spam =
    .title = Wubrane powěsće jako spam markěrować
toolbar-not-spam-label = Njeje spam
toolbar-not-spam =
    .title = Wubrane powěsće jako njeje spam markěrować
...
toolbar-add-address-book-label = Adresnik přidać
