...
account-hub-email-set-up-account-button = Konto konfigurować
account-hub-email-confirm-button = Wobkrućić
account-hub-email-find-settings-button = Nastajenja pytać
account-hub-email-connect-button = Zwjazać
account-hub-result-incoming-legend = Dochadźace
account-hub-result-outgoing-legend = Wuchadźace
account-hub-all-servers-legend = Wšě serwery
...
account-hub-servers-username-label = Wužiwarske mjeno:
...
account-hub-result-authentication-none = Žadyn
    .title = Žadyn
account-hub-result-authentication-password = Normalne hesło
    .title = Normalne hesło
account-hub-result-authentication-encrypted-password = Zaklučowane hesło
    .title = Zaklučowane hesło
...
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = Žadyn
account-hub-result-auth-password = Normalne hesło
account-hub-result-auth-encrypted-password = Zaklučowane hesło
...
account-hub-exchange-service-url-label = Zapodajće URL słužby
...
account-hub-result-security-no-encryption = Žane zaklučowanje
    .title = Žane zaklučowanje
...
account-hub-oauth-unsupported-description = { -brand-short-name } njemóže OAuth2 za tute hostmjeno awtomatisce konfigurować. Wubjerće rozšěrjenu konfiguraciju, zo byšće konto załožił a dokónčće potom konfiguraciju z kontowych nastajenjow. <a data-l10n-name="oauth-support-link">Dóstańće pomoc za konfiguraciju OAuth2.</a>
account-hub-username-help-text = Husto waša dospołna e-mejlowa adresa
...
account-hub-email-connect-settings = Zwjazajće swoje e-mejlowe nastajenja
account-hub-email-protocol-select-header = Wubjerće typ e-mejloweho konta
account-hub-email-protocol-select-additional-info = Su přidatne informacije trěbne, zo byšće tute konto konfigurował.
account-hub-email-protocol-select-notification = Su přidatne informacije trěbne, zo byšće tute konto konfigurował
...
account-hub-result-graph-api-description = Wužiwajće Microsoft Graph API, zo byšće swoje rjadowaki a mejlki z Microsoft 365 synchronizował
...
account-hub-config-success-title = Kontowe nastajenja su so awtomatisce namakali.
account-hub-config-success-description-db = Konfiguracija je so w Mozilla ISPDB namakała.
account-hub-config-success-description-exchange = Konfiguracija je so za serwer Microsoft Exchange namakał.
account-hub-config-success-description-guess = Konfiguracija přez probowanje zwučenych serwerowych mjenow namakana.
account-hub-config-success-description-disk = Konfiguracija w instalaciji { -brand-short-name } namakana.
...
address-book-add-remote-icon2 =
    .alt = Zdaleny adresnik přidać
address-book-add-remote-icon =
    .alt = Nowy zdaleny adresnik přidać
address-book-add-remote = Zdaleny adresnik přidać
address-book-add-remote-carddav-description = Z CardDAV-adresnikom zwjazać
...
address-book-add-ldap-icon2 =
    .alt = Adresnik LDAP přidać
address-book-add-ldap-button = Adresnik LDAP přidać
...
account-hub-exchange-type-title = Wubjerće kontowy typ
