...
calendar-task-filter-next7days =
    .label = Přichodnych sydom dnjow
    .accesskey = P
calendar-task-filter-notstarted =
    .label = Njezapočene nadawki
    .accesskey = a
calendar-task-filter-overdue =
    .label = Nadawki, kotrež dyrbjeli hižo sčinjene być
    .accesskey = h
calendar-task-filter-completed =
    .label = Dokónčene nadawki
    .accesskey = k
calendar-task-filter-open =
    .label = Njedospołne nadawki
    .accesskey = s
...
calendar-task-filter-current =
    ...
    .accesskey = a
calendar-task-details-title = titul
calendar-task-details-organizer = wot
...
calendar-task-details-priority-high = Wysoki
calendar-task-details-status = status
calendar-task-details-category = kategorija
calendar-task-details-repeat = wospjetowanje
calendar-task-details-attachments = přiwěški
calendar-task-details-start = spočatny datum
calendar-task-details-due = termin
calendar-task-mark-completed =
    .label = Jako sčinjeny markěrować
    .tooltiptext = Wubrane nadawki jako sčinjene markěrować
    .accesskey = s
calendar-task-change-priority =
    .label = Priorita
    .tooltiptext = Prioritu změnić
    .accesskey = r
calendar-task-input-filter-field =
    .aria-label = Nadawki filtrować
    .emptytextbase = Nadawki filtrować #1
    .keylabelmac = <⇧⌘K>
...
calendar-tasks-view-minimonth =
    .label = Měsačny přehlad
    .accesskey = M
calendar-tasks-view-calendarlist =
    .label = Lisćina protykow
    .accesskey = L
calendar-tasks-view-filtertasks =
    .label = Nadawki filtrować
    .accesskey = f
...
calendar-properties-refresh =
    .value = Protyku aktualizować:
calendar-properties-refresh-manual =
    .label = Manuelnje
calendar-properties-read-only =
    .label = Jenož čitajomny
calendar-properties-show-reminders =
    .label = Dopomnjeća pokazać
calendar-properties-offline-support =
    .label = Podpěra offline
calendar-properties-enable-calendar =
    .label = Tutu protyku zmóžnić
calendar-properties-provider-missing = Poskićowar za tutu protyku njeda so namakać. To so husto stawa, jeli sće wěste přidatki znjemóžnił abo wotinstalował.
calendar-properties-unsubscribe =
    .buttonlabelextra1 = Wotskazać
    .buttonaccesskeyextra1 = t
    .label = Wotskazać
    .accesskey = t
calendar-alarm-dialog-title = Protykowe dopomnjeća
...
calendar-alarm-snooze-for =
    .label = Hišće raz dopomnić za
calendar-alarm-snooze-all-for =
    .label = Na wšě hišće raz dopomnić za
# Variables:
...
calendar-alarm-snooze-cancel =
    .aria-label = Wospjetowane dopominanje přetorhnyć
calendar-calendar =
    .label = Protyka
    .accesskey = P
calendar-newevent-button =
    .label = Nowy podawk
    .tooltiptext = Nowy podawk wutworić
calendar-newtask-button =
    .label = Nowy nadawk
    .tooltiptext = Nowy nadawk wutworić
calendar-unifinder-show-completed-todos =
    .label = Dokónčene nadawki pokazać
calendar-display-todos-checkbox =
    .label = Nadawki w přehledźe
    .accesskey = k
...
calendar-orientation =
    .label = Napohlad wjerćeć
    .accesskey = o
calendar-todaypane-button =
    .label = Dźensniši plan
    .tooltiptext = Dźensniši dźeń pokazać
calendar-search-options-searchfor =
    .value = wobsahuje
calendar-properties-dialog-title = Protyku wobdźěłać
calendar-server-dialog-name-label =
    .value = Mjeno protyki:
calendar-publish-dialog-window-title = Protyku wozjewić
calendar-publish-url-label = URL za wozjewjenje
calendar-publish-publish-dialog-button =
    .buttonlabelaccept = Wozjewić
calendar-publish-close-button = Začinić
calendar-select-dialog-title = Protyku wubrać
...
calendar-error-description =
    .value = Wopisanje:
calendar-error-prompt-title = Zmylk je wustupił
calendar-extract-event-button =
    .label = Jako podawk přidać
    .tooltiptext = Protykowe informacije z powěsće ekstrahować a je wašej protyce jako podawk přidać
...
calendar-auth-enter-user-password-for-calendar = “{ $calendarName }” ({ $location }) sej waše wužiwarske mjeno a hesło žada.
# Variables:
