...
category-sync =
    .tooltiptext = 同期
pane-qr-export-title = モバイル向けの書き出し
category-qr-export =
    .tooltiptext = モバイル向けの書き出し
...
gloda-show-results-as-list-label =
    .label = デフォルトでグローバル検索の結果をリスト表示する
    .accesskey = L
...
browsing-gtk-use-non-overlay-scrollbars =
    ...
    .accesskey = c
window-layout-legend = ウインドウレイアウト
hide-titlebar-label =
    .label = タイトルバーを隠す
    .accesskey = H
hide-titlebar-description = ウインドウ名を表示する上部のタイトルバーを隠して画面領域を節約します
...
check-email-app-label =
    .label = 起動時に { -brand-short-name } がデフォルトメールアプリとして設定されているか確認する
    .accesskey = A
edit-defaults-apps-button =
    .label = デフォルトアプリを変更...
    .accesskey = u
draw-in-titlebar-label =
    .label = システムウインドウのタイトルバーを隠す
    .accesskey = H
...
dark-mode-checkbox-label =
    ...
    .accesskey = d
dark-mode-message-text-description = 送信者が明るいカラーを背景に指定している場合も、すべての受信メッセージに暗い背景を適用します。
...
account-hub-checkbox-label =
    ...
    .accesskey = C
account-hub-checkbox-description = 新規メールアカウントの実験的な作成フローです。
...
new-calendar-legend = カレンダーの新規予定ダイアログ
...
account-hub-ab-checkbox-label =
    ...
    .accesskey = A
account-hub-ab-checkbox-description = 新規アドレス帳の実験的な作成フローです。
...
compose-format-html-description = メッセージにカスタムフォント、カラー、画像を保持しますが、古いメールアプリでは正しく表示できない可能性があります。
compose-format-plain-option =
    .label = プレーンテキスト形式のみ
compose-format-plain-description = すべてのスタイル書式とカラー、画像を除去します。どこでも利用できるシンプルなテキストメールに最適です。
...
collect-outgoing-label =
    ...
    .accesskey = A
collect-outgoing-description = 手動またはメールから追加した新規連絡先を保存するアドレス帳です。
save-added-contacts-label =
    .value = 手動で追加した連絡先を保存する場所:
    .accesskey = m
save-added-contacts-description = メールからの新規連絡先を保存するアドレス帳です。
show-directory-startup-label =
    .value = { -brand-short-name } の起動時に表示するアドレス帳ウインドウ内のディレクトリー
    .accesskey = S
...
email-picker-label =
    ...
    .accesskey = A
email-picker-description = 送信したメールからの新規連絡先の保存場所
default-add-address-book-label =
    .value = 手動で追加した連絡先のデフォルトアドレス帳:
    .accesskey = D
default-add-address-book-description = 受信したメールからの新規連絡先の保存場所
...
find-cloud-providers =
    .value = 他のプロバイダーを検索...
cloud-account-description = 新規 Filelink ストレージサービスを追加してください。
...
spam-description = デフォルト迷惑メールフィルターの動作を設定します。アカウントごとの迷惑メールフィルターの設定は “アカウント設定” で行います。
spam-marked-label =
...
accent-color-selection-label =
    .value = 重要なボタンと強調表示に使用するカラーを選択する
accent-color-label =
...
default-message-list-new-folders-description = 新規フォルダーのデフォルトの並べ替えとスレッド表示を選択してください
default-message-list-description = 新規作成したフォルダーに設定されるデフォルトの並べ替えとスレッド表示のオプションです。
default-flag-label =
    .value = デフォルトのスレッド表示:
...
default-sort-label = デフォルトの並べ替えの種類:
default-sort-date =
    .label = 日付
