...
toolbar-next =
    .title = 次のメッセージに移動します
toolbar-spam-label = 迷惑メール
toolbar-spam =
    .title = 選択したメッセージに迷惑マークを付けます
toolbar-not-spam-label = 非迷惑メール
toolbar-not-spam =
    .title = 選択したメッセージの迷惑マークを外します
...
toolbar-undelete-label = 削除を取り消す
toolbar-undelete =
    .title = 選択した削除メッセージを取り消します
...
toolbar-go-to-today =
    .title = 今日の日付へ移動します
toolbar-print-event-label = プリント
toolbar-print-event =
    .title = 予定または ToDo をプリントします
toolbar-new-event-label = 予定
toolbar-new-event =
    .title = 新規予定を作成します
toolbar-new-task-label = ToDo
toolbar-new-task =
    .title = 新規 ToDo を作成します
...
toolbar-throbber =
    .title = アクティブインジケーター
toolbar-create-contact-label = 新規連絡先
toolbar-create-contact =
    .title =  新規連絡先を作成します
toolbar-create-address-book-label = 新規アドレス帳
toolbar-create-address-book =
    .title = 新規アドレス帳を作成します
toolbar-create-list-label = 新規アドレスリスト
toolbar-create-list =
    .title = 新規アドレスリストを作成します
toolbar-import-contacts-label = 読み込む
toolbar-import-contacts =
    .title = ファイルから連絡先を読み込みます
