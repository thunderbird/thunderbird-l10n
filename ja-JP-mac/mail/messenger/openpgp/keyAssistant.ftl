...
# Variables:
# $recipient (String) - The email address of the recipient needing resolution.
openpgp-key-assistant-resolve-discover-info = オンラインで { $recipient } の追加の鍵や更新された鍵を見つけるか、ファイルから読み込んでください。
...
openpgp-key-assistant-import-keys-button = 公開鍵をファイルから読み込む...
