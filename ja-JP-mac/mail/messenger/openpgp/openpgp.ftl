...
e2e-csr-select-strength = 新しい S/MIME 証明書の暗号の強度を指定するか、デフォルト設定を選んでください (数値が低いほど高速で、高いほど安全です)。
...
openpgp-passphrase-new = 新規パスフレーズ
openpgp-passphrase-new-repeat = 新規パスフレーズの確認
...
import-from-clip = クリップボードから鍵を読み込みますか？
...
key-man-button-export-sec-key = 秘密鍵を含めて書き出す(&S)
key-man-button-export-pub-key = 公開鍵のみを書き出す(&P)
...
export-to-file = ファイルとして公開鍵を書き出す
export-keypair-to-file = ファイルとして秘密鍵と公開鍵を書き出す
export-secret-key = 書き出す OpenPGP 鍵ファイルに秘密鍵を含めますか？
...
openpgp-export-public-success = <b>公開鍵の書き出しに成功しました！</b>
openpgp-export-public-fail = <b>選択した公開鍵の書き出しに失敗しました！</b>
openpgp-export-secret-success = <b>秘密鍵の書き出しに成功しました！</b>
openpgp-export-secret-fail = <b>選択した秘密鍵の書き出しに失敗しました！</b>
...
confirm-permissive-import = 読み込みに失敗しました。読み込みを試みた鍵は、破損しているか未知の属性が使われています。正常な部分のみの読み込みを試みますか？ この場合、読み込みが完了しない、あるいは利用できない鍵となる可能性があります。

## Strings used in keyRing.sys.mjs

# Variables:
# $fingerprints (String) - A comma-separated list of fingerprints, either one or multiple, for example "ABCDEF7890ABCDEF7890ABCDEF7890ABCDEF7890, 0123456789012345678901234567890123456789"
imported-secret-with-unsupported-features = 読み込まれた一部の秘密鍵には未サポートの機能が使われています。これらを個人鍵として使用した場合、通信相手がメールや公開鍵を互換性のない形式で送信する可能性があります。これは次のフィンガープリントを持つ読み込まれた秘密鍵に影響します: {$fingerprints}
...
keys-to-export = 書き出す OpenPGP 鍵を選択
...
attachment-pgp-key-import = 添付ファイル ‘{ $name }’ は OpenPGP 鍵ファイルです。このファイルに含まれる鍵を読み込みますか？
# Variables:
# $name (String) - File name of the attachment.
