...
about-addressbook-toolbar-add-ldap-address-book =
    .label = LDAP アドレス帳を追加
books-pane-create-contact-button = 新規連絡先
    .title = 新規連絡先を作成します
books-pane-create-book-button =
    .title = 新規アドレス帳を作成します
books-pane-create-list-button =
    .title = 新規アドレスリストを作成します
books-pane-import-button = 読み込み
    .title = アドレス帳を読み込みます
...
# (^m^) ファイル名の候補なので英語のままにする
about-addressbook-export-selected-filename = Contacts
...
about-addressbook-placeholder-new-contact = 新規連絡先
...
about-addressbook-details-edit-photo =
    .title = 連絡先の顔写真を編集します
about-addressbook-new-contact-header = 新規連絡先
...
about-addressbook-new-list-action-button = 新規アドレスリスト
...
about-addressbook-photo-drop-target = 顔写真をここにドロップまたはペーストするか、クリックしてファイルを選択してください
