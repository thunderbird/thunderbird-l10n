...
webext-perms-description-messages-send = 視覚的フィードバックなしで、プログラムによりメッセージを一括送信。アドオンの送信履歴は “イベントログの管理” から確認してください。
webext-perms-description-messages-save = ユーザーとの対話なしで、プログラムによりメッセージを下書きまたはテンプレートとして保存
