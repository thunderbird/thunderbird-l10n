...
buttons-multiple-parent-copy =
    .label = 選択したすべての項目をコピー
buttons-multiple-parent-cut =
    .label = 選択したすべての項目をカット
