...
status-priority-img-low-priority =
    .alt = 低
import-prompt = これらの項目をどのカレンダーに読み込みますか？
export-prompt = どのカレンダーから書き出しますか？
paste-prompt = 現在書き込み可能などのカレンダーにペーストしますか？
publish-prompt = どのカレンダーを公開しますか？
# LOCALIZATION NOTE (paste-event-also): The users pasting operation includes among
# others also a meeting invitation - this is used as a affix in
# paste-notify-about
paste-event-also = ペーストデータにミーティングが含まれています
# LOCALIZATION NOTE (paste-events-also): The users pasting operation includes among
# others also several meeting invitations  - this is used as a affix in
# paste-notify-about
paste-events-also = ペーストデータに複数のミーティングが含まれています
# LOCALIZATION NOTE (paste-task-also): The users pasting operation includes among
# others also an assigned task - this is used as a affix in paste-notify-about
paste-task-also = ペーストデータに割り当てられた ToDo が含まれています
# LOCALIZATION NOTE (paste-tasks-also): The users pasting operation include among
# others also several assigned tasks - this is used as a affix in
# paste-notify-about
paste-tasks-also = ペーストデータに割り当てられた複数の ToDo が含まれています
# LOCALIZATION NOTE (paste-items-also): The users pasting operation includes among
# others also assigned task(s) and meeting invitation(s) - this is used as a affix
# in paste-notify-about
paste-items-also = ペーストデータにミーティングと割り当てられた ToDo が含まれています
# LOCALIZATION NOTE (paste-event-only): The users is pasting a meeting -
# this is used as a affix in paste-notify-about
paste-event-only = ミーティングをペーストします
# LOCALIZATION NOTE (paste-events-only): The users is pasting several meetings -
# this is used as a affix in paste-notify-about
paste-events-only = ミーティングをペーストします
# LOCALIZATION NOTE (paste-event-only): The users is pasting an assigned task -
# this is used as a affix in paste-notify-about
paste-task-only = 割り当てられた ToDo をペーストします
# LOCALIZATION NOTE (paste-events-only): The users is pasting several assigned
# tasks - this is used as a affix in paste-notify-about
paste-tasks-only = 割り当てられた ToDo をペーストします
# LOCALIZATION NOTE (paste-events-only): The users is pasting assigned task(s) and
# meeting(s) - this is used as a affix in paste-notify-about
paste-items-only = ミーティングと割り当てられた ToDo をペーストします
...
paste-and-notify-label = ペーストして今すぐ送信
# LOCALIZATION NOTE (paste-dont-notify-label): button label used in calendar prompt
# of the pasted item has attendees
paste-dont-notify-label = 送信せずにペースト
# LOCALIZATION NOTE (import-items-failed):
#    $count will be replaced with number of failed items
#    $error will be replaced with last error code / error string
import-items-failed = { $count } 個の項目の読み込みに失敗しました。最後のエラー: { $error }
# LOCALIZATION NOTE (no-items-in-calendar-file2):
#    $filePath will be replaced with file path
no-items-in-calendar-file2 = { $filePath } からの読み込みができません。このファイルには読み込み可能な項目がありません。
...
calendar-new = 新規
calendar-open = 開く
filepicker-title-import = 読み込み
filepicker-title-export = 書き出し
...
read-only-mode = カレンダー { $name } の読み込み中にエラーが発生しました。このカレンダーへ書き込みを行うとデータを破損する可能性があるため、読み込み専用に切り替えました。右クリックの “情報を見る” メニューからこの設定を変更できます。
...
minor-error =
    ...
    このエラーは影響が少ないと考えられるので、アプリケーションはこのままカレンダーを読み込みます。
...
calendar-task-filter-current =
    .label = 現在の ToDo
    .accesskey = u
calendar-task-details-title = 件名
calendar-task-details-organizer = 差出人
calendar-task-details-priority = 重要度
calendar-task-details-priority-low = 低
calendar-task-details-priority-normal = 標準
calendar-task-details-priority-high = 高
calendar-task-details-status = 状態
calendar-task-details-category = カテゴリー
calendar-task-details-repeat = 周期
calendar-task-details-attachments = 添付
calendar-task-details-start = 着手日時
calendar-task-details-due = 締切日時
calendar-task-mark-completed =
    .label = 完了にする
    .accesskey = o
    .tooltiptext = 選択した ToDo を完了にします
calendar-task-change-priority =
    .label = 重要度
    .accesskey = r
    .tooltiptext = 重要度を変更します
calendar-task-text-filter-field =
    .emptytextbase = ToDo の絞り込み #1
    .keylabelnonmac = <Ctrl+Shift+K>
    .keylabelmac = <⇧⌘K>
calendar-copylink =
    .label = リンク先の URL をコピー
    .accesskey = C
...
calendar-properties-enable-calendar =
    .label = このカレンダーを有効にする
calendar-properties-provider-missing = このカレンダーのプロバイダーが見つかりませんでした。対象のアドオンが無効にされているかアンインストールされています。
...
calendar-newevent-button =
    .label = 新規予定
    .tooltiptext = 新規予定を作成します
calendar-newtask-button =
    .label = 新規 ToDo
    .tooltiptext = 新規 ToDo を作成します
...
calendar-publish-publish-dialog-button =
    .buttonlabelaccept = 公開
calendar-publish-publish-button = 公開
calendar-publish-close-button = 閉じる
calendar-select-dialog-title = カレンダーの選択
...
calendar-extract-event-button =
    .label = 予定に追加
    .tooltiptext = メッセージからカレンダー情報を抽出し、カレンダーの予定に追加します
