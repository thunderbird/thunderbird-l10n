...
toolbar-view-picker =
    .title = Customise view of current folder
...
toolbar-synchronize-label = Synchronise
toolbar-synchronize =
    .title = Reload calendars and synchronise changes
...
toolbar-go-back-label = Backwards
toolbar-go-back =
    .title = Go back one message
toolbar-go-forward-label = Forwards
toolbar-go-forward =
    .title = Go forwards one message
