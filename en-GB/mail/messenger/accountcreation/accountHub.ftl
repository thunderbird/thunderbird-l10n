...
account-hub-email-sync-accounts = Synchronise your calendars and address books
account-hub-test-configuration = Test
account-hub-add-new-email = Add another email
account-hub-result-imap-description = Keep your folders and emails synchronised on your server
account-hub-result-pop-description = Keep your folders and emails on your computer
account-hub-result-ews-shortname = Exchange
account-hub-result-ews-description = Use Microsoft Exchange Web Services to synchronise your folders and emails
account-hub-result-graph-api-shortname = Microsoft Graph API
account-hub-result-graph-api-description = Use the Microsoft Graph API to synchronise your folders and emails with Microsoft 365
account-hub-result-graph-shortname = Exchange (Graph)
account-hub-result-graph-description = Use Microsoft Graph API to synchronise your folders and emails
account-hub-result-exchange-description = Synchronise folders & emails with Exchange or Office 365
...
account-hub-email-added-success-links-title = Explore options for security and personalisation:
...
address-book-sync-existing-icon =
    .alt = Synchronise an address book from an existing account
address-book-sync-existing = Synchronise from an existing account
...
account-hub-account-address-book-count = { $synced } of { $total }
    .title = { $synced } synchronised address books, { $available } available
...
account-hub-sync-address-books = Synchronise existing address books
...
account-hub-card-ews-description = Exchange Web Services (EWS) connects to Microsoft Exchange to synchronise your mail.
