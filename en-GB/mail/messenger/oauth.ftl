...
oauth-reauthorize-title = Reauthorise access
...
oauth-reauthorize-description = { $hostname } needs you to confirm access again to keep synchronising with your account. Username: { $username }
