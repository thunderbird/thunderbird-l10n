...
sync-signout-dialog-body = Synchronised data will remain in your account.
sync-signout-dialog-button = Sign out

## These strings are shown in a confirmation dialog when the user chooses to stop syncing.

sync-disconnect-dialog-title = Disconnect?
sync-disconnect-dialog-body = { -brand-product-name } will stop synchronising but won’t delete any of your data on this device.
