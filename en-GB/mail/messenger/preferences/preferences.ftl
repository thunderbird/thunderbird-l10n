...
always-ask-label =
    ...
    .accesskey = A
use-tags-text = Use tags to categorise and prioritise messages.
...
dark-mode-checkbox-label =
    ...
    .accesskey = d
dark-mode-message-text-description = Applies a dark background to all incoming messages, even if the sender formatted them in light colours.
...
new-calendar-legend = New Calendar Event Dialogue
new-calendar-checkbox-label =
    .label = View calendar events in the new dialogue
new-calendar-checkbox-description = Experimental new calendar dialogue for viewing events
...
ignore-sender-styles-label =
    .label = Ignore sender fonts and colours
    .accesskey = d
...
compose-format-html-description = Keeps custom fonts, colours and images, but some older email apps may not display it properly.
compose-format-plain-option =
    .label = Plain text only
compose-format-plain-description = Removes all formatting, colours and images. Best for simple text emails that work everywhere.
...
search-preferences-input2 =
    ...
    .style = width: 15.4em
managed-by-organization-notice = { -brand-short-name } is managed by an organisation.
managed-notice = { -brand-short-name } is being managed by your organisation.
...
accent-color-selection-label =
    .value = Select colour for primary button and highlights
accent-color-label =
