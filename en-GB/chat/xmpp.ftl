...
connection-initializing-stream = Initialising stream
connection-initializing-encryption = Initialising encryption
...
connection-error-not-authorized = Not authorised (Did you enter the wrong password?)
...
conversation-error-join-failed-not-authorized = Registration required: You are not authorised to join this room.
...
conversation-error-change-topic-failed-not-authorized = You are not authorised to set the topic of this room.
