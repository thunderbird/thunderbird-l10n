...
toolbar-delete =
    .title = Odstrániť vybrané správy alebo priečinok
...
toolbar-tag-message-label = Popis
toolbar-tag-message =
    .title = Priradí k správe popis
...
toolbar-go-to-today-label = Prejsť na panel Dnes
toolbar-go-to-today =
