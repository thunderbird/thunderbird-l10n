...
toolbar-spam-label = Nevyžiadaná správa
toolbar-spam =
    .title = Označí vybrané správy ako nevyžiadané
toolbar-not-spam-label = Nie je to nevyžiadaná správa
toolbar-not-spam =
    .title = Označí vybrané správy ako nie nevyžiadané
...
toolbar-add-address-book-label = Pridať adresár
