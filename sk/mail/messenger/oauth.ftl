...
oauth-reauthorize-title = Znovu autorizovať prístup
...
oauth-reauthorize-description = { $hostname } vyžaduje opätovné potvrdenie prístupu, aby sa mohla synchronizácia s vaším účtom pokračovať. Používateľské meno: { $username }
