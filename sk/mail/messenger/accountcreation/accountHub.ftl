...
account-hub-servers-username-label = Používateľské meno:
account-hub-result-server-label = Server:
account-hub-result-port-label = Port:
account-hub-result-security-label = Bezpečnosť:
account-hub-result-authentication-type-label = Overenie:
account-hub-result-authentication-none = Žiadne
    .title = Žiadne
account-hub-result-authentication-password = Normálne heslo
    .title = Normálne heslo
account-hub-result-authentication-encrypted-password = Zašifrované heslo
    .title = Zašifrované heslo
account-hub-result-authentication-gssapi = Kerberos
    .title = Kerberos
account-hub-result-authentication-ntlm = NTLM
    .title = NTLM
account-hub-result-authentication-external = Externé
    .title = Externé
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = Žiadne
account-hub-result-auth-password = Normálne heslo
account-hub-result-auth-encrypted-password = Zašifrované heslo
account-hub-result-auth-gssapi = Kerberos
account-hub-result-auth-ntlm = NTLM
account-hub-result-auth-external = Externé
...
account-hub-exchange-service-url-label = Zadajte URL adresu služby
...
account-hub-password-label = Heslo
    ...
    .accesskey = H
account-hub-remember-password = Zapamätať si heslo
    .accesskey = Z
account-hub-exchange-label = Vaše prihlasovacie údaje
    .accesskey = V
account-hub-installing-addon = Sťahuje a inštaluje sa doplnok…
account-hub-success-addon = Doplnok bol úspešne nainštalovaný
account-hub-success-half-manual = Nasledujúce nastavenia sa našli sondovaním na danom serveri:
account-hub-result-security-no-encryption = Bez zabezpečenia
    .title = Bez zabezpečenia
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = Bez zabezpečenia
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = Overenie zlyhalo. Skontrolujte používateľské meno a heslo
...
account-hub-exchange-config-unverifiable = Konfiguráciu sa nepodarilo overiť. Ak sú vaše používateľské meno a heslo správne, je pravdepodobné, že správca servera zakázal vybratú konfiguráciu vášho účtu. Skúste zvoliť iný protokol.
account-hub-advanced-setup-button = Pokročilé nastavenie
    .accesskey = P
# Variables:
#  $domain (String): The name of the server where the configuration was found, e.g. rackspace.com.
account-hub-exchange-dialog-question = { -brand-short-name } našiel informácie o nastavení vášho účtu na serveri { $domain }. Chcete pokračovať a odoslať svoje prihlasovacie údaje?
account-hub-creation-error-title = Chyba pri vytváraní účtu
account-hub-error-server-exists = Server pre prichádzajúcu poštu už existuje.
account-hub-confirm-advanced-title = Potvrdenie pokročilého nastavenia
account-hub-confirm-advanced-description = Toto dialógové okno bude zatvorené a účet s týmito nastaveniami bude vytvorený a to aj v prípade, že konfigurácia nie je správna. Chcete pokračovať?
account-hub-addon-install-title = Nainštalovať
...
account-hub-username-help-text = Často vaša celá e‑mailová adresa
account-hub-port-help-text = Ak toto pole ponecháte prázdne, { -brand-short-name } sa pokúsi zistiť port.
...
account-hub-result-graph-api-description = Synchronizácia priečinkov a e‑mailov so službou Microsoft 365 pomocou rozhrania Microsoft Graph API
account-hub-result-graph-shortname = Exchange (Graph)
account-hub-result-graph-description = Synchronizácia priečinkov a e‑mailov pomocou rozhrania Microsoft Graph API
...
account-hub-result-ews-expanded-text = Webové služby Exchange
...
account-hub-config-success-title = Nastavenia účtu sa našli automaticky.
account-hub-config-success-description-db = Konfigurácia bola nájdená v databáze Mozilla ISPDB.
account-hub-config-success-description-exchange = Konfigurácia bola nájdená na serveri Microsoft Exchange.
account-hub-config-success-description-guess = Konfigurácia nájdená vyskúšaním bežných názvov serverov.
account-hub-config-success-description-disk = Konfigurácia bola nájdená v inštalácii { -brand-short-name(case: "gen") }.
...
account-hub-select-security-warning = <span data-l10n-name="error-text">Upozornenie: zistil sa nezabezpečený poštový server.</span> Tento server nemá šifrovanie, čo prezrádza vaše heslo a údaje. Ak chcete zabezpečiť pripojenie, kontaktujte svojho správcu alebo pokračujte na vlastné riziko. Ďalšie informácie nájdete v <a data-l10n-name="error-link">najčastejšie kladených otázkach</a>.
...
address-book-add-remote-icon2 =
    .alt = Pridať vzdialený adresár
address-book-add-remote-icon =
    .alt = Pridať nový vzdialený adresár
address-book-add-remote = Pridať vzdialený adresár
address-book-add-remote-carddav-description = Pripojiť sa k adresáru typu CardDAV
...
address-book-add-ldap-icon2 =
    .alt = Pridať adresár LDAP
address-book-add-ldap-button = Pridať adresár LDAP
...
account-hub-exchange-type-account-type = Typ účtu
...
account-hub-exchange-type-username = Používateľské meno
account-hub-exchange-type-username-hint = Zvyčajne vaša e‑mailová adresa alebo hlavné meno používateľa v službe Active Directory.
account-hub-exchange-type-authentication = Metóda overenia
# Checkbox that can be unchecked to use a custom OAuth config.
account-hub-exchange-type-default-oauth = Použiť predvolené nastavenia overovania v službe Microsoft 365 Copilot
account-hub-exchange-type-oauth-tenant = Tenant ID
account-hub-exchange-type-oauth-app = Identifikátor aplikácie
account-hub-exchange-type-title = Vyberte typ účtu
