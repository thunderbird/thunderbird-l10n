...
policy-DisableCommunity = Skryje v používateľskom rozhraní komunitné funkcie (napríklad Prispieť, Zapojiť sa, Zdieľať nápady atď.)
...
policy-DisableFileLink = Deaktivuje funkciu Filelink.
...
policy-DisableMessageForwardingFilters = Zakáže automatické preposielanie správ pomocou filtrov.
...
policy-DisableExperimentalFeatures = Zakáže experimentálne funkcie v Thunderbirde.
...
policy-DisableUpdateSettings = Zabráni používateľovi meniť nastavenia aktualizácií aplikácie.
