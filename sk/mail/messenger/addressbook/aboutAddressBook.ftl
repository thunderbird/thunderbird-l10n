...
about-addressbook-search2 =
    .label = Hľadať v adresári { $name }
    .placeholder = Hľadať v adresári { $name }…
about-addressbook-search-all2 =
    .label = Hľadať vo všetkých adresároch
...
about-addressbook-export-selected-filename = Kontakty
...
about-addressbook-photo-dialog-title =
    .aria-label = Spravovať fotografiu tohto kontaktu.
...
ab-search-dialog-delete-button =
    .label = Odstrániť
    .accesskey = d
ab-search-dialog-title = Pokročilé hľadanie v adresári
