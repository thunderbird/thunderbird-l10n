...
webext-perms-description-experiment = Mať plný a neobmedzený prístup k { -brand-short-name(case: "dat") } a vášmu počítaču
...
webext-perms-description-messages-send = Programovo odosielať hromadne e‑mailové správy vo vašom mene bez akejkoľvek interakcie. Na kontrolu histórie odoslaní cez doplnok použite Správcu aktivít.
webext-perms-description-messages-save = Ukladať e‑mailové správy ako koncepty alebo šablóny programovo, bez vašej interakcie
