...
folder-pane-mode-header-all = Všetky priečinky
folder-pane-mode-header-unread = Neprečítané priečinky
folder-pane-mode-header-favorite = Obľúbené priečinky
folder-pane-mode-header-recent = Nedávno použité priečinky
folder-pane-mode-header-smart = Zoskupené priečinky
...
threadpane-cell-read-status =
    .aria-label = Stav prečítania
threadpane-new-cell-label = Nové
