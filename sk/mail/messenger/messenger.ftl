...
show-recent-folders-label =
    .label = Nedávno použité priečinky
    .accesskey = N
...
remote-content-option-allow-all =
    .label =
        { $count ->
            [one] Povoliť vzdialený obsah z { $count } zdroja uvedeného vyššie
...
tags-label-1 = Dôležité
tags-label-2 = Zamestnanie
tags-label-3 = Osobné
tags-label-4 = Vybaviť
tags-label-5 = Neskôr
tags-add-new =
    .label = Nový štítok…
    .accesskey = N
tags-manage =
    .label = Spravovať štítky…
    .accesskey = S
tags-remove-all =
