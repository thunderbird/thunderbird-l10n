...
address-book-add-label = Adresár
    .aria-label = Pridať adresár
...
import-paragraph2 = { -brand-short-name } vám umožní importovať e‑mailové správy, položky adresára, odoberané informačné kanály, nastavenia a/alebo filtre z iných poštových klientov a z bežných formátov adresárov.
