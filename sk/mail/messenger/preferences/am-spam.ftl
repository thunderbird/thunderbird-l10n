...
move-spam-message-menuitem =
    .label = Správy rozpoznané ako nevyžiadané automaticky presúvať do:
    .accesskey = S
set-spam-folder-menuitem =
    .label = Priečinok “Nevyžiadaná pošta” v účte:
    .accesskey = N
move-message-other =
    .label = inde:
    .accesskey = i
automatic-spam-purge-checkbox =
    .label = Automaticky odstraňovať správy označené ako nevyžiadané po
    .accesskey = u
automatic-spam-purge-label =
    .value = dňoch
allowlist-header-label =
    .value = Neoznačovať automaticky správy ako nevyžiadané, ak sa odosielateľ nachádza v:
    .accesskey = e
isp-headers-checkbox =
    .label = Dôverovať hlavičkám nevyžiadanej pošty nastaveným nástrojom:
    .accesskey = D
isp-warning-description = Ak je táto voľba zapnutá, { -brand-short-name } bude automaticky považovať správy označené touto externou kontrolou ako nevyžiadané.
spam-classification-legend = Rozpoznávanie nevyžiadanej pošty
spam-actions-legend = Presúvanie a odstraňovanie správ
global-spam-preferences-button =
    .label = Globálne nastavenia nevyžiadanej pošty…
    .accesskey = G
