...
general-email-notifications-header = E‑mailové oznámenia
...
general-files-and-attachment-description = Vyberte, ktoré súbory a kam sa majú ukladať vo vašom počítači.
general-tags-header = Štítky
general-reading-and-viewing-header = Čítanie a prezeranie
general-reading-and-display-header = Čítanie a zobrazenie
general-updates-header = Aktualizácie
general-network-and-storage-header = Sieť a úložisko
general-search-performance-label = Vyhľadávanie a výkon
compose-writing-emails-header = Písanie e‑mailov
...
compose-message-formatting-title = Formátovanie správ
compose-address-autocomplete-header = Automatické dopĺňanie adries
...
choose-display-language-description = Vyberte jazyk, ktorý sa bude používať pre ponuky, tlačidlá a oznámenia.
...
manual-storage-limit-label =
    .label = Manuálne nastaviť limity úložiska pre dočasné súbory
    .accesskey = M
clear-temp-files-button =
    .label = Vymazať dočasné súbory
    .accesskey = V
clear-temp-files-shutdown-label =
    .label = Vymazávať dočasné súbory pri ukončení { -brand-short-name(case: "gen") }
    .accesskey = m
...
show-start-page-label =
    .label = Po spustení { -brand-short-name(case: "gen") } zobraziť úvodnú stránku
    .accesskey = z
start-page-label =
...
start-in-tray-label =
    ...
    .accesskey = b
new-message-arrival-legend = Po prijatí novej správy:
...
use-custom-sound-label =
    .label = Používať vlastný zvuk pre upozornenia
    .accesskey = v
mail-select-audio-button =
    .label = Vybrať zvukový súbor…
    .accesskey = V
enable-global-search-label =
    .label = Povoliť vyhľadávanie vo všetkých e‑mailových účtoch
    .accesskey = o
gloda-results-plain-list-label =
    .label = Zobrazovať výsledky vyhľadávania ako obyčajný zoznam
    .accesskey = Z
...
gloda-show-results-as-list-label =
    .label = Predvolene zobrazovať globálne výsledky vyhľadávania ako zoznam
    .accesskey = d
datetime-formatting-legend = Formát dátumu a času
display-language-legend = Jazyk rozhrania
allow-graphics-accel =
    .label = Používať grafické urýchľovanie na plynulejšie posúvanie a vyšší výkon
    .accesskey = f
storage-format-label =
    .value = Formát úložiska pre nové účty:
    .accesskey = F
...
enable-autoscroll-label =
    .label = Povoliť automatické posúvanie
    .accesskey = a
autoscroll-label =
...
hide-titlebar-label =
    .label = Skryť panel s titulkom okna
    .accesskey = S
hide-titlebar-description = Skryje horný panel s názvom okna a uvoľní miesto na obrazovke
hide-tabbar-single-tab-label =
    .label = Skryť panel kariet, ak je otvorená len jedna karta
    .accesskey = k
auto-hide-tabbar-second-tab-description = Karty sa automaticky zobrazia až po otvorení druhej karty.
system-settings-legend = Systémové nastavenia
check-email-app-label =
    .label = Pri každom spustení skontrolovať, či je { -brand-short-name } predvolenou e‑mailovou aplikáciou
    .accesskey = r
edit-defaults-apps-button =
    .label = Upraviť predvolené nastavenia…
    .accesskey = U
...
update-settings-title = Nastavenia aktualizácií
install-updates-automatically-label =
    .label = Automaticky inštalovať aktualizácie (odporúčané)
    .accesskey = A
install-updates-automatically-description = Udržiava { -brand-short-name(case: "acc") } v bezpečí pomocou najnovších bezpečnostných opráv.
check-updates-ask-label =
    .label = Vyhľadať aktualizácie, no pred inštaláciou požiadať o potvrdenie
    .accesskey = V
...
connection-config-description = Nastavte spôsob, akým sa { -brand-short-name } pripája k internetu.
connection-options-button =
    .label = Nastavenia pripojenia…
    .accesskey = N
offline-mode-legend = Režim offline
offline-settings-label = Nastavenie režimu offline
...
offline-settings-button =
    .label = Nastavenia…
    .accesskey = a
temporary-storage-legend = Dočasné úložisko
offline-compact-remove-deleted =
    .label = Odstrániť údaje priečinkov, ktoré už boli vymazané, a uvoľniť tak miesto v úložisku
    .accesskey = O
offline-compact-ask-cleanup =
    .label = Pred vyčistením priečinkov sa opýtať
    .accesskey = r
...
use-cache-before =
    .value = Vyhradiť do
    .accesskey = h
use-temp-storage-after = MB priestoru pre dočasné súbory
use-cache-after = MB priestoru pre vyrovnávaciu pamäť
...
underline-text-links-label =
    .label = Podčiarkovať textové odkazy v správach
    .accesskey = x
...
convert-emoticons-label =
    ...
    .accesskey = m
display-text-formatting-label = Formátovanie citovaného textu
...
search-content-types =
    .placeholder = Vyhľadať typy obsahu
...
always-ask-label =
    ...
    .accesskey = k
use-tags-text = Pomocou značiek môžete správy kategorizovať a určovať ich prioritu.
...
mark-read-when-opened =
    .label = Hneď po otvorení
    .accesskey = H
show-attachments-inline-label =
    .label = Zobrazovať prílohy v tele správy
    .accesskey = Z
mark-read-no-delay =
...
display-name-only-label =
    .label = Pre kontakty uložené v adresári zobrazovať iba meno
    .accesskey = k
...
show-conversation-view-label =
    .label = Používať zobrazenie Konverzácie
    .accesskey = K
conversation-view-preview-description = Táto funkcia je zatiaľ v skúšobnej verzii. Zoskupuje súvisiace správy, no nemusí vždy fungovať podľa očakávaní.
...
dark-mode-message-appearance = Vzhľad správ
dark-mode-checkbox-label =
    .label = Používať tmavý režim pre textové správy
    .accesskey = u
dark-mode-message-text-description = Nastaví tmavé pozadie pre všetky prijaté správy, aj keď ich odosielateľ naformátoval vo svetlých farbách.
...
dark-message-mode-toggle-label =
    ...
    .accesskey = t
dark-mode-toggle-description = Pri čítaní môžete e‑mail rýchlo prepnúť späť do svetlého režimu bez toho, aby ste zmenili hlavné nastavenia.
general-folder-settings-header = Nastavenia priečinkov
recent-folders-legend = Naposledy použité priečinky
recent-folders-description = Určuje spôsob zobrazenia nedávno použitých priečinkov pri presúvaní správ.
dark-message-mode-toggle-description = Zobrazí prepínač v hlavičke správy na rýchle vypnutie tmavého režimu pre správy
general-folder-options-header = Možnosti správy priečinkov
recent-destinations-legend = Nedávne umiestnenia
recent-destinations-description = Možnosti zobrazenia a zoradenia priečinkov, kam boli správy nedávno presunuté.
recent-sort-order-label = Poradie zoradenia:
    .accesskey = P
recent-sort-order-mru =
    .label = Nedávno použité
recent-sort-order-alphabetic =
    .label = Abecedne
max-recent-label = Maximálny počet nedávnych priečinkov:
    .accesskey = M
...
account-hub-manual-config-checkbox-label =
    .label = Použiť nový postup manuálnej konfigurácie v Centre účtov
    .accesskey = C
account-hub-manual-config-checkbox-description = Postup manuálnej konfigurácie v novom Centre účtov
new-calendar-legend = Dialógové okno novej udalosti v kalendári
new-calendar-checkbox-label =
    .label = Zobrazovať udalosti kalendára v novom dialógovom okne
new-calendar-checkbox-description = Experimentálne nové dialógové okno kalendára na zobrazenie udalostí
...
compose-format-automatic-option =
    .label = Automatický (odporúčané)
compose-format-automatic-description = Ak použijete formátovanie (napríklad tučné písmo alebo odkazy), odošle sa formátovaný text, inak obyčajný text.
compose-format-both-option =
    .label = Formátovaný text (HTML) aj obyčajný text
compose-format-both-description = Vždy odošle obe verzie, aby si e‑mailová aplikácia príjemcu mohla vybrať, ktorú zobrazí.
compose-format-html-option =
    .label = Iba formátovaný text (HTML)
compose-format-html-description = Zachová vlastné písma, farby aj obrázky, no v niektorých starších e‑mailových aplikáciách sa nemusí zobraziť správne.
compose-format-plain-option =
    .label = Iba obyčajný text
compose-format-plain-description = Odstráni všetko formátovanie, farby aj obrázky. Ideálne pre jednoduché textové e‑maily, ktoré sa správne zobrazia všade.
autocomplete-matches-description = Pri zadávaní mena alebo e‑mailovej adresy príjemcu vyhľadávať zhody v:
company-network-directory-label =
    .label = Firemný alebo sieťový adresár
    .accesskey = F
directory-server-label =
    .label = Server adresárovej služby
    .accesskey = S
...
manage-directories-label =
    .label = Spravovať adresáre…
    .accesskey = a
collect-outgoing-label =
    .label = Automaticky ukladať adresy príjemcov odoslaných e‑mailov do:
    .accesskey = A
collect-outgoing-description = Miesto ukladania nových kontaktov vytvorených ručne alebo pridaných z e‑mailov.
save-added-contacts-label =
    .value = Manuálne pridané kontakty ukladať do:
    .accesskey = M
save-added-contacts-description = Miesto ukladania nových kontaktov z e‑mailov.
show-directory-startup-label =
    .value = Pri spustení { -brand-short-name(case: "gen") } zobraziť v okne adresára tento adresár
    .accesskey = u
...
email-picker-label =
    ...
    .accesskey = o
email-picker-description = Umiestnenie nových kontaktov uložených z odoslaných správ.
default-add-address-book-label =
    .value = Predvolený adresár pre manuálne pridané kontakty:
    .accesskey = m
default-add-address-book-description = Umiestnenie nových kontaktov uložených z prijatých správ.
default-directory-label =
    .value = Predvolený priečinok pri spustení v okne adresára:
    .accesskey = r
default-last-label =
    .none = Naposledy použitý adresár
attachment-label =
    .label = Kontrolovať, či v správe nechýba príloha
    .accesskey = c
edit-keywords-label =
    .label = Upraviť kľúčové slová…
    .accesskey = U
offer-share-large-files-label =
    .label = Ponúknuť zdieľanie súborov cez odkaz, ak sú väčšie než:
...
search-preferences-input2 =
    ...
    .style = width: 15.4em
managed-by-organization-notice = { -brand-short-name } je spravovaný organizáciou.
...
accent-color-legend = Vylepšené motívy vzhľadu
accent-color-selection-label =
    .value = Vyberte farbu hlavných tlačidiel a zvýraznených prvkov
accent-color-label =
...
accent-color-teal =
    .label = Tyrkysová
accent-color-disabled-description = Vylepšené motívy vzhľadu nie sú v režime vysokého kontrastu podporované.
default-message-list-legend = Zoznam správ
appearance-view-style-select =
    .value = Vyberte štýl zobrazenia:
...
card-view-options-legend = Nastavenia zobrazenia kariet
...
default-message-list-new-folders-description = Vyberte predvolené možnosti zoradenia a vlákien pre nové priečinky
...
default-sort-by-label = Zoradiť správy podľa:
...
default-sort-newest-bottom =
    .label = Najnovšie správy v dolnej časti
default-sort-new-messages-top =
    .label = Najnovšie správy hore
apply-view-settings-label = Použiť tieto nastavenia zobrazenia pre:
apply-view-settings-to-all-folders-button =
    .label = Všetky priečinky a podpriečinky
    .accesskey = e
select-apply-sort-folders-button =
    .label = Vybrať priečinky
    .accesskey = V
