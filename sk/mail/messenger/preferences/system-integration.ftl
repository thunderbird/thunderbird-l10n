...
default-app-intro = Nastaviť { -brand-short-name(case: "acc") } ako predvolenú aplikáciu pre:
...
checkbox-net-thunderbird-url-label =
    .label = Vlastné odkazy Thunderbirdu (net.thunderbird://)
    .tooltiptext = { unset-default-tooltip }
...
check-on-startup-label =
    ...
    .accesskey = a
system-settings-dialog-title = Systémové nastavenia
