...
calendar-invitations-status-updating = Mise à jour de la liste des invitations.
calendar-invitations-status-none = Aucune invitation non confirmée n’a été trouvée.
