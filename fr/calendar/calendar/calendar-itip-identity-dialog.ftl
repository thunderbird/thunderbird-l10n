...
calendar-itip-identity-dialog-box-title = Invité non invité
calendar-itip-identity-warning-body = L’adresse électronique associée à l’agenda vers lequel vous importez cette invitation ne figure pas dans la liste des invités.
