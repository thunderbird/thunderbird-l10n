...
prompt-remove-attachments-text =
    { $count ->
        [one] Voulez-vous vraiment supprimer la pièce jointe ?
       *[other] Voulez-vous vraiment supprimer { $count } pièces jointes ?
    }
...
calendar-multiday-hour-slot = { $date } à { $time }
...
calendar-context-attendance-occ-needs-action =
    .label = Nécessite encore une action
    .accesskey = S
...
calendar-context-delete-server =
    .label = Supprimer l’agenda…
    .accesskey = S
calendar-context-remove-server =
    .label = Retirer l’agenda…
    .accesskey = R
calendar-context-unsubscribe-server =
    .label = Se désabonner de l’agenda…
    .accesskey = d
calendar-context-publish =
    .label = Publier l’agenda…
    .accesskey = b
...
calendar-context-showall =
    .label = Afficher tous les agendas
    .accesskey = A
...
calendar-context-convert-to-task =
    .label = Tâche…
    .accesskey = T
calendar-task-filter-title2 = Filtrer les tâches
...
calendar-task-filter-current =
    .label = Les tâches en cours
    .accesskey = u
calendar-task-details-title = titre
calendar-task-details-organizer = émetteur
calendar-task-details-priority = priorité
calendar-task-details-priority-low = Basse
calendar-task-details-priority-normal = Normale
calendar-task-details-priority-high = Haute
calendar-task-details-status = statut
calendar-task-details-category = catégorie
calendar-task-details-repeat = répétition :
...
calendar-task-mark-completed =
    ...
    .tooltiptext = Marquer les tâches sélectionnées comme terminées
    .accesskey = M
calendar-task-change-priority =
    .label = Priorité
    .tooltiptext = Changer la priorité
    .accesskey = r
...
calendar-properties-refresh =
    .value = Actualiser l’agenda :
calendar-properties-refresh-manual =
    .label = Manuellement
calendar-properties-read-only =
    .label = En lecture seule
calendar-properties-show-reminders =
    .label = Afficher les alarmes
calendar-properties-offline-support =
    .label = Prise en charge du mode hors connexion
calendar-properties-enable-calendar =
    .label = Activer cet agenda
calendar-properties-provider-missing = Le fournisseur de cet agenda n’a pas été trouvé. Ceci arrive souvent lors de la désactivation ou de la désinstallation de certains modules complémentaires.
calendar-properties-unsubscribe =
    .buttonlabelextra1 = Se désabonner
    .buttonaccesskeyextra1 = S
    .label = Se désabonner
    .accesskey = S
calendar-alarm-dialog-title = Alarme d’agenda
...
calendar-alarm-snooze-for =
    .label = Report d’alarme pendant
calendar-alarm-snooze-all-for =
    .label = Report de toutes les alarmes pendant
# Variables:
...
calendar-newtask-button =
    .label = Nouvelle tâche
    .tooltiptext = Créer une nouvelle tâche
calendar-unifinder-show-completed-todos =
    .label = Afficher les tâches accomplies
...
calendar-todaypane-button =
    .label = Panneau « Aujourd’hui »
    .tooltiptext = Afficher le panneau Aujourd’hui
calendar-search-options-searchfor =
    .value = contenant
calendar-properties-dialog-title = Modifier l’agenda
calendar-server-dialog-name-label =
    .value = Nom de l’agenda :
calendar-publish-dialog-window-title = Publier l’agenda
calendar-publish-url-label = URL de publication
calendar-publish-publish-dialog-button =
    .buttonlabelaccept = Publier
...
calendar-extract-event-button =
    .label = Ajouter comme évènement
    .tooltiptext = Extraire les informations temporelles du message et les ajouter à votre agenda en tant qu’évènement
...
calendar-auth-enter-user-password-for-calendar = « { $calendarName } » ({ $location }) demande votre nom d’utilisateur et votre mot de passe.
# Variables:
