...
email-picker-label =
    ...
    .accesskey = A
email-picker-description = L’emplacement des nouveaux contacts enregistrés parmi les messages envoyés.
default-add-address-book-label =
    .value = Carnet d’adresses par défaut pour les contacts ajoutés manuellement :
    .accesskey = C
default-add-address-book-description = Emplacement où sont enregistrés les nouveaux contacts ajoutés à partir des messages reçus.
