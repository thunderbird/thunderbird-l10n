...
general-email-notifications-header = Notifications d’e-mails
...
general-files-and-attachment-description = Sélectionnez les fichiers à enregistrer et leur emplacement sur votre ordinateur.
general-tags-header = Étiquettes
general-reading-and-viewing-header = Lecture et affichage
...
compose-message-formatting-title = Formatage des messages
compose-address-autocomplete-header = Saisie semi-automatique de l’adresse
...
collection-improve-header = Données collectées pour améliorer { -brand-short-name }
collection-community-description = { -brand-short-name } est construit par une communauté mondiale. Le partage de données de performance anonymes nous aide à corriger les bugs plus rapidement et à rendre l’application plus rapide pour tout le monde.
collection-privacy-policy = Consultez notre politique de confidentialité
collection-data-sharing-off = <strong>Le partage des données est désactivé.</strong> Les données d’utilisation passée seront définitivement supprimées des serveurs de { -vendor-short-name } dans les 30 jours.
...
collection-share-performance =
    .label = Partagez des données de performance anonymes avec { -vendor-short-name }
    .accesskey = P
collection-share-performance-description = (Inclut des informations techniques de base comme votre système d’exploitation, l’utilisation mémoire, et l’activité des fonctionnalités. { -brand-short-name } ne collecte jamais le contenu des courriels, les contacts ou les messages personnels.)
...
collection-share-crash-data =
    .label = Envoyer les rapports de plantage anonymes à { -vendor-short-name }
    .accesskey = E
...
privacy-security-certificates-title = Certificats de sécurité
...
choose-display-language-description = Choisissez la langue utilisée pour les menus, les boutons et les notifications.
...
manual-storage-limit-label =
    .label = Définir manuellement les limites de stockage des fichiers temporaires
    .accesskey = D
clear-temp-files-button =
    .label = Effacer les fichiers temporaires
    .accesskey = E
clear-temp-files-shutdown-label =
    .label = Vider les fichiers temporaires lors de la fermeture de { -brand-short-name }
    .accesskey = V
...
show-start-page-label =
    .label = Afficher la page de démarrage lorsque { -brand-short-name } s’ouvre
    .accesskey = A
start-page-label =
...
close-to-tray-label =
    .label = Lorsque { -brand-short-name } est fermé, le déplacer dans la barre de notification
    .accesskey = L
start-in-tray-label =
    .label = Démarrer { -brand-short-name } dans la barre de notification
    .accesskey = D
new-message-arrival-legend = Lorsqu’un nouveau message arrive :
...
mail-play-button =
    .label = Jouer le son
    .accesskey = o
change-dock-icon-description = Badges d'application et notifications
...
new-email-alert-label =
    .label = Afficher une alerte à la réception de nouveaux e-mails
    .accesskey = A
customize-alerts-label =
    .label = Personnaliser les alertes…
    .accesskey = P
...
use-custom-sound-label =
    .label = Utiliser un son personnalisé pour les alertes
    .accesskey = U
mail-select-audio-button =
    .label = Sélectionner un fichier audio…
    .accesskey = S
enable-global-search-label =
    .label = Activer la recherche pour tous les comptes de messagerie
    .accesskey = A
gloda-results-plain-list-label =
    .label = Afficher les résultats de recherche sous forme de liste simple
    .accesskey = A
...
gloda-show-results-as-list-label =
    .label = Afficher les résultats de recherche globale sous forme de liste par défaut
    .accesskey = A
datetime-formatting-legend = Format de date et heure
display-language-legend = Langue d’affichage
allow-graphics-accel =
    .label = Activer l’accélération graphique pour améliorer la fluidité du défilement et les performances
    .accesskey = A
storage-format-label =
    .value = Format de stockage pour les nouveaux comptes :
    .accesskey = F
mbox-store-single-label =
    .label = Un seul fichier par dossier (mbox)
...
hide-titlebar-label =
    ...
    .accesskey = M
hide-titlebar-description = Supprime la barre supérieure affichant le nom de la fenêtre pour économiser de l’espace à l’écran
hide-tabbar-single-tab-label =
    .label = Masquer la barre des onglets s’il n’y en a qu’un d’ouvert
    .accesskey = M
auto-hide-tabbar-second-tab-description = Masque automatiquement les onglets jusqu’à ce que vous en ouvriez un deuxième.
system-settings-legend = Paramètres système
...
edit-defaults-apps-button =
    .label = Modifier les paramètres par défaut…
    .accesskey = M
...
update-settings-title = Paramètres de mise à jour
install-updates-automatically-label =
    .label = Installer les mises à jour automatiquement (recommandé)
    .accesskey = I
install-updates-automatically-description = Protégez { -brand-short-name } grâce aux derniers correctifs de sécurité.
check-updates-ask-label =
    .label = Vérifier l’existence de mises à jour, mais demander avant l’installation
    .accesskey = V
...
connection-config-description = Contrôlez la façon dont { -brand-short-name } se connecte à Internet.
connection-options-button =
    .label = Options de connexion…
    .accesskey = O
offline-mode-legend = Mode hors connexion
offline-settings-label = Paramètres hors connexion
...
offline-settings-button =
    ...
    .accesskey = H
temporary-storage-legend = Stockage temporaire
offline-compact-remove-deleted =
    .label = Supprimez des données des dossiers alors qu’ils ont déjà été supprimés pour libérer de l’espace disque
    .accesskey = S
offline-compact-ask-cleanup =
    .label = Demander avant de nettoyer des dossiers
    .accesskey = D
...
use-cache-before =
    ...
    .accesskey = U
use-temp-storage-after = Mo d’espace disque pour les fichiers temporaires
...
underline-text-links-label =
    .label = Souligner les liens texte dans les messages
    .accesskey = S
...
customize-fonts-button =
    .label = Personnaliser les polices…
    .accesskey = P
font-options-button =
    .label = Avancé…
    .accesskey = A
...
convert-emoticons-label =
    ...
    .accesskey = f
display-text-formatting-label = Mise en forme du texte avec guillemets
...
search-content-types =
    .placeholder = Rechercher des types de contenu
...
always-ask-label =
    ...
    .accesskey = o
use-tags-text = Utilisez des étiquettes pour classer en catégories et donner un ordre de priorité aux messages.
...
mark-read-when-opened =
    .label = Immédiatement après ouverture
    .accesskey = I
show-attachments-inline-label =
    .label = Afficher les pièces jointes dans le corps du message
    .accesskey = A
mark-read-no-delay =
...
mark-read-after-viewing =
    .label = Après avoir regardé pendant
    .accesskey = A
...
display-name-only-label =
    .label = Afficher uniquement le nom à afficher pour les contacts enregistrés dans le carnet d’adresses
    .accesskey = A
...
show-conversation-view-label =
    ...
    .accesskey = A
conversation-view-preview-description = Il s’agit d’une fonctionnalité en avant-première. Elle regroupe les messages liés, mais il se peut que le fonctionnement ne soit pas toujours le résultat attendu.
...
dark-mode-message-appearance = Apparence du message
dark-mode-checkbox-label =
    .label = Utiliser le mode sombre pour le texte des messages
    .accesskey = U
dark-mode-message-text-description = Applique un arrière-plan sombre à tous les messages entrants, même si l’expéditeur les a mis en forme avec des couleurs claires.
...
dark-message-mode-toggle-label =
    ...
    .accesskey = A
dark-mode-toggle-description = Permet de faire revenir rapidement un e-mail en mode clair pendant la lecture, sans modifier vos paramètres principaux.
general-folder-settings-header = Paramètres du dossier
recent-folders-legend = Dossiers récents
recent-folders-description = Contrôle l’affichage des dossiers récemment utilisés lors du déplacement de messages.
...
general-folder-options-header = Options de gestion des dossiers
recent-destinations-legend = Destinations récentes
recent-destinations-description = Options de liste et de tri des dossiers vers lesquels des messages ont été récemment déplacés.
recent-sort-order-label = Ordre de tri :
    .accesskey = O
recent-sort-order-mru =
    .label = Les plus récents
recent-sort-order-alphabetic =
    .label = Ordre alphabétique
max-recent-label = Nombre maximum de dossiers récents :
    .accesskey = N
...
account-hub-manual-config-checkbox-label =
    .label = Utiliser le nouveau flux de configuration manuelle dans le Centre de compte
    .accesskey = U
account-hub-manual-config-checkbox-description = Flux de configuration manuelle du nouveau Centre de compte
new-calendar-legend = Boîte de dialogue Nouvel évènement d’agenda
new-calendar-checkbox-label =
    .label = Voir les évènements de l’agenda dans la nouvelle boîte de dialogue
new-calendar-checkbox-description = Nouvelle boîte de dialogue expérimentale de l’agenda pour l’affichage d’évènements
...
add-file-type-label =
    .label = Ajouter un type de fichier aux pièces jointes
    .accesskey = A
extension-label =
    .label = ajouter une extension au nom de fichier
    .accesskey = a
forward-messages-label =
    .value = Transférer les messages en tant que :
    .accesskey = T
forward-inline-label =
    .label = À l’intérieur du message (inline)
...
autosave-draft-label =
    .label = Enregistrer automatiquement un brouillon chaque
    .accesskey = E
...
spellcheck-while-typing-label =
    .label = Vérifiez l’orthographe pendant la saisie
    .accesskey = V
...
ignore-sender-styles-label =
    .label = Ignorer les polices et les couleurs de l’expéditeur
    .accesskey = I
...
paragraph-spacing-label =
    .label = Un appui sur Entrée commence un nouveau paragraphe avec un espacement supplémentaire
    .accesskey = U
...
compose-format-automatic-description = Envoyez du texte mis en forme si vous ajoutez des styles (comme des gras ou des liens) ou du texte simple dans le cas contraire.
compose-format-both-option =
    .label = Du texte enrichi (HTML) et du texte simple
compose-format-both-description = Envoie toujours les deux versions pour que l’application de messagerie du destinataire puisse choisir celle à afficher.
compose-format-html-option =
    .label = Texte enrichi (HTML) uniquement
compose-format-html-description = Conserve les polices, couleurs et images personnalisées, mais certaines anciennes applications de messagerie peuvent ne pas les afficher correctement.
compose-format-plain-option =
    .label = Texte simple uniquement
compose-format-plain-description = Supprime la mise en forme, les couleurs et les images. Meilleur pour de simples e-mails de texte qui fonctionnent partout.
autocomplete-matches-description = Lorsque vous saisissez le nom ou l’adresse électronique d’un destinataire, recherchez les correspondances dans :
company-network-directory-label =
    .label = Annuaire d’entreprise ou de réseau
    .accesskey = A
directory-server-label =
    .label = Serveur d’annuaire
    .accesskey = S
...
manage-directories-label =
    .label = Gérer les annuaires…
    .accesskey = G
collect-outgoing-label =
    .label = Enregistrer automatiquement les adresses électroniques sortantes dans :
    .accesskey = E
collect-outgoing-description = Où sont enregistrés les nouveaux contacts lorsqu’ils sont créés manuellement ou ajoutés à partir d’e-mails.
save-added-contacts-label =
    .value = Enregistrer les contacts ajoutés manuellement dans :
    .accesskey = E
save-added-contacts-description = Emplacement d’enregistrement des nouveaux contacts à partir des e-mails.
show-directory-startup-label =
    .value = Afficher le répertoire dans la fenêtre du carnet d’adresses lors de l’ouverture de { -brand-short-name }
    .accesskey = A
...
email-picker-label =
    ...
    .accesskey = A
email-picker-description = L’emplacement où sont enregistrés les nouveaux contacts ajoutés à partir des messages envoyés.
default-add-address-book-label =
    .value = Carnet d’adresses par défaut pour les contacts ajoutés manuellement :
    .accesskey = C
default-add-address-book-description = L’emplacement où sont enregistrés les nouveaux contacts ajoutés à partir des messages reçus.
...
offer-share-large-files-label =
    .label = Proposer de partager les fichiers par lien lorsqu’ils dépassent :
...
exceptions-button =
    .label = Exceptions…
    .accesskey = p
remote-content-privacy-link = Impact du contenu distant sur la vie privée
remote-content-privacy-info = En savoir plus sur les problématiques de vie privée liées au contenu distant
remote-content-info =
...
third-party-visited-only =
    .label = À partir des sites visités uniquement
third-party-visited =
...
passwords-registered-description = { -brand-short-name } peut enregistrer les mots de passe des comptes enregistrés.
view-saved-passwords-button =
    .label = Afficher les mots de passe enregistrés…
    .accesskey = A
primary-password-session-description = Un mot de passe principal protège tous les mots de passe et est saisi une fois par session.
use-primary-password-label =
    .label = Utiliser le mot de passe principal
    .accesskey = U
do-not-track-label =
...
spam-accounts-description = Ces paramètres s’appliquent à tous les comptes. Les options de compte individuel peuvent être modifiées dans les paramètres du compte.
...
spam-move-folder-label =
    .label = Déplacer dans le dossier Spam
    .accesskey = D
spam-delete-immediately-label =
    .label = Supprimer immédiatement
    .accesskey = S
spam-move-label =
...
spam-marked-manually-label =
    .label = Si marqué manuellement
    .accesskey = S
spam-detected-auto-label =
    .label = Quand détecté automatiquement par { -brand-short-name }
    .accesskey = Q
spam-log-keep-label =
    .label = Tenez un journal de la détection automatique des spams
    .accesskey = T
...
reset-spam-button =
    ...
    .accesskey = R
scam-detection-description = { -brand-short-name } vérifie la présence de liens d’hameçonnage et des signes courants d’escroquerie.
scam-detection-label =
    .label = Avertir lors de la lecture d’un e-mail qui semble être frauduleux
    .accesskey = A
...
certificate-choose-auto =
    .label = Choisir un certificat automatiquement
    .accesskey = C
...
email-e2ee-automatism-intro = { -brand-short-name } peut activer le chiffrement s’il existe des clés ou des certificats valides et acceptés pour tous les destinataires.
email-e2ee-turn-on =
...
email-e2ee-automatism-note = Remarque : vous pouvez également activer ou désactiver manuellement le chiffrement lorsque vous rédigez un message. Répondre à un message chiffré active toujours le chiffrement.
...
preferences-doh-setting-off =
    .label = Désactivé
    .accesskey = D
preferences-doh-off-standard-desc = Utilise un fournisseur ou un réseau Internet standard pour rechercher des adresses web
...
qr-export-pane-header-mobile = Exporter vers { -brand-product-name } mobile
...
accent-color-os =
    .label = Suivre le système d’exploitation
accent-color-thunderbird =
    .label = Bleu Thunderbird
accent-color-purple =
    .label = Violet
accent-color-orange =
    .label = Orange
...
appearance-radio-card-view =
    .label = Mode fiche
card-view-options-legend = Options d’affichage des cartes
...
default-message-list-new-folders-description = Sélectionner les options de tri et d’unités de thread par défaut pour les nouveaux dossiers
...
default-sort-by-label = Trier les messages par :
...
default-sort-newest-bottom =
    .label = Messages les plus récents en bas
default-sort-new-messages-top =
    .label = Les messages les plus récents en haut
apply-view-settings-label = Appliquer ces paramètres d’affichage à :
apply-view-settings-to-all-folders-button =
    .label = Tous les dossiers et sous-dossiers
    .accesskey = T
