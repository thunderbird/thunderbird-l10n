...
dark-message-mode-legend = Style de lecteur de message
dark-message-mode-checkbox-label =
    .label = Activer le mode sombre
    .accesskey = A
dark-message-mode-checkbox-description = Fonctionnalité expérimentale pour que le corps du message suive des thèmes sombres
dark-message-mode-toggle-label =
    .label = Afficher/Masquer le mode sombre
    .accesskey = A
dark-message-mode-toggle-description = Afficher une bascule dans l’en-tête du message pour désactiver rapidement le mode de message sombre
