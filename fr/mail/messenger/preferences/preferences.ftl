...
general-email-notifications-header = Notifications par courriel
...
compose-message-formatting-title = Formatage du message
...
new-email-alert-label =
    .label = Afficher une alerte pour les nouveaux messages
    .accesskey = A
...
mail-select-audio-button =
    .label = Sélectionner une piste audio…
    .accesskey = S
...
allow-graphics-accel =
    .label = Utiliser l’accélération graphique pour un défilement et des performances plus fluides
    .accesskey = U
...
update-settings-title = Mettre à jour les paramètres
