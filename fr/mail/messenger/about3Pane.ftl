...
quick-filter-bar-tag-mode-none =
    .label = Sans étiquette uniquement
    .title = Seuls les messages sans étiquette
...
folder-pane-header-toggle-full-path =
    .label = Afficher le chemin complet
folder-pane-header-hide-local-folders =
    .label = Masquer les dossiers locaux
folder-pane-mode-header-all = Tous les dossiers
folder-pane-mode-header-unread = Dossiers non lus
...
threadpane-cell-read-status =
    .aria-label = Statut de lecture
threadpane-new-cell-label = Nouveau
