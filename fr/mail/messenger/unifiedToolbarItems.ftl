...
toolbar-spam-label = Indésirable
toolbar-spam =
    .title = Marquer les messages sélectionnés comme indésirables
toolbar-not-spam-label = Acceptable
toolbar-not-spam =
    .title = Marquer les messages sélectionnés comme acceptables
...
toolbar-add-address-book-label = Ajouter un carnet d’adresses
