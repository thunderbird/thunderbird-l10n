...
books-pane-add-book-button =
    .title = Ajouter un carnet d’adresses
...
address-book-list =
    .aria-label = Liste des carnets d’adresses
...
about-addressbook-photo-dialog-title =
    .aria-label = Gérer la photo de ce contact.
...
ab-search-dialog-delete-button =
    .label = Supprimer
    .accesskey = S
ab-search-dialog-title = Recherche avancée dans le carnet d’adresses
