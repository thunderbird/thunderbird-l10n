...
account-hub-server-tip = Thunderbird va essayer de détecter automatiquement votre nom d’hôte
account-hub-server-warning-icon = Adresse invalide
account-hub-server-error-text = Veuillez saisir une URL valide
