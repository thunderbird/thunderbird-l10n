...
account-hub-servers-username-label = Nom d’utilisateur :
account-hub-result-server-label = Serveur :
account-hub-result-port-label = Port :
account-hub-result-security-label = Sécurité :
account-hub-result-authentication-type-label = Authentification :
account-hub-result-authentication-none = Aucun
    .title = Aucun
account-hub-result-authentication-password = Mot de passe normal
    .title = Mot de passe normal
account-hub-result-authentication-encrypted-password = Mot de passe chiffré
    .title = Mot de passe chiffré
account-hub-result-authentication-gssapi = Kerberos
    .title = Kerberos
account-hub-result-authentication-ntlm = NTLM
    .title = NTLM
account-hub-result-authentication-external = Externe
    .title = Externe
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = Aucun
account-hub-result-auth-password = Mot de passe normal
account-hub-result-auth-encrypted-password = Mot de passe chiffré
account-hub-result-auth-gssapi = Kerberos
account-hub-result-auth-ntlm = NTLM
account-hub-result-auth-external = Externe
...
account-hub-exchange-service-url-label = Saisissez l’URL du service
...
account-hub-exchange-label = Votre identifiant
    .accesskey = V
account-hub-installing-addon = Téléchargement et installation du module…
account-hub-success-addon = Installation du module complémentaire terminée
account-hub-success-half-manual = Les paramètres suivants ont été trouvés en sondant le serveur donné :
account-hub-result-security-no-encryption = Pas de chiffrement
    .title = Pas de chiffrement
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = Pas de chiffrement
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = Échec de l’authentification. Veuillez vérifier le nom d’utilisateur et le mot de passe
...
account-hub-confirm-advanced-description = Cette boîte de dialogue sera fermée et un compte avec les paramètres actuels sera créé, même si la configuration est incorrecte. Voulez-vous poursuivre ?
account-hub-addon-install-title = Installer
account-hub-encryption-button = Chiffrement de bout en bout
account-hub-address-books-button = Carnets d’adresses
account-hub-calendars-button = Agendas
account-hub-thundermail-button = Se connecter avec Thundermail
...
account-hub-same-username-checkbox = Même nom d’utilisateur que le serveur entrant
# Variables:
...
account-hub-manual-config-port-changed = Impossible de joindre le port { $oldValue }, mais le port { $newValue } est disponible.
# Variables:
# $oldValue (String): The value requested before the configuration was tested.
# $newValue (String): The value found after the configuration was tested.
account-hub-manual-config-value-changed = Impossible d’utiliser { $oldValue }, mais { $newValue } est disponible.
...
account-hub-username-help-text = Généralement, votre adresse e-mail complète
...
account-hub-email-exchange-settings = Paramètres d’Exchange
account-hub-email-connect-settings = Connectez vos paramètres de messagerie
account-hub-email-protocol-select-header = Choisissez un type de compte de messagerie
account-hub-email-protocol-select-additional-info = Des informations supplémentaires sont nécessaires pour configurer ce compte.
account-hub-email-protocol-select-notification = Des informations supplémentaires sont nécessaires pour configurer ce compte
...
account-hub-result-graph-api-description = Utilisez l’API Microsoft Graph pour synchroniser vos dossiers et e-mails avec Microsoft 365
account-hub-result-graph-shortname = Exchange (Graph)
account-hub-result-graph-description = Utiliser l’API Microsoft Graph pour synchroniser vos dossiers et e-mails
...
account-hub-config-success-title = Paramètres du compte détectés automatiquement.
account-hub-config-success-description-db = Configuration trouvée dans la base de données des FAI de Mozilla.
account-hub-config-success-description-exchange = Configuration trouvée pour un serveur Microsoft Exchange.
account-hub-config-success-description-guess = Configuration trouvée en essayant les noms de serveur courants.
account-hub-config-success-description-disk = Configuration trouvée dans l’installation de { -brand-short-name }.
...
account-hub-select-security-warning = <span data-l10n-name="error-text">Attention : serveur de courrier non sécurisé détecté.</span> Ce serveur n’est pas chiffré ; votre mot de passe et vos données sont exposés. Contactez votre administrateur pour sécuriser la connexion ou poursuivez à vos risques et périls. <a data-l10n-name="error-link">Voir la FAQ pour plus d’informations.</a>
...
address-book-add-remote-icon2 =
    .alt = Ajouter un carnet d’adresses distant
address-book-add-remote-icon =
    .alt = Ajouter un nouveau carnet d’adresses distant
address-book-add-remote = Ajouter un carnet d’adresses distant
address-book-add-remote-carddav-description = Se connecter à un carnet d’adresses CardDAV
...
address-book-add-ldap-icon2 =
    .alt = Ajouter un carnet d’adresses LDAP
address-book-add-ldap-button = Ajouter un carnet d’adresses LDAP
...
account-hub-exchange-type-account-type = Type de compte
...
account-hub-card-ews-description = Exchange Web Services (EWS) se connecte à Microsoft Exchange pour synchroniser vos messages.
# This is shown after the type description, so "it" is referring to the type (either Microsoft Graph or Exchange Web Services).
account-hub-card-recommended-description = Type de compte recommandé, car il correspond à l’URL de votre service.
account-hub-exchange-type-username = Nom d’utilisateur
account-hub-exchange-type-username-hint = Généralement votre adresse e-mail ou l’UPN d’Active Directory.
...
account-hub-exchange-type-oauth-tenant = Identifiant client
