...
account-hub-result-incoming-legend = Entrant
    .title = Entrant
account-hub-result-outgoing-legend = Sortant
    .title = Sortant
...
account-hub-result-auth-none = Aucune
...
account-hub-result-ews-expanded-text = Services web Exchange
account-hub-result-graph-expanded-text = API de graphiques
