...
account-hub-result-graph-shortname = Exchange (graphique)
account-hub-result-graph-description = Utilisez l’API Microsoft Graph pour synchroniser vos dossiers et e-mails
