...
account-hub-config-success-description-read-more = Vous pouvez <a data-l10n-name="automated-setup-link">apprendre comment fonctionne la configuration automatisée des e-mails.</a>
