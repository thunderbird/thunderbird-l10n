...
account-hub-protocol-pop3 = Télécharger sur l’appareil
...
account-hub-email-protocol-select-header = Choisir un type de compte de messagerie
...
account-hub-exchange-type-username-hint = Généralement votre adresse e-mail ou UPN ActiveDirectory.
