...
webext-perms-description-messages-send = Envoyez automatiquement des e-mails en masse en votre nom, sans affichage visuel. Consultez l’historique des envois du module complémentaire dans le gestionnaire d’activité.
webext-perms-description-messages-save = Enregistrer des e-mails en tant que brouillons ou modèles automatiquement, sans votre intervention
