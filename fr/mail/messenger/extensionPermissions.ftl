...
webext-perms-description-messages-send = Envoyez des e-mails en nombre à votre place par programme, sans retour visuel. Utilisez le gestionnaire d’activité pour consulter l’historique d’envoi du module.
webext-perms-description-messages-save = Enregistrez les messages électroniques en tant que brouillons ou modèles par programmation, sans votre intervention
...
webext-perms-description-messengerSettings = Lire les paramètres de { -brand-short-name }
