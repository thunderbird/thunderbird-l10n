...
toolbar-spam-label = Mesazh i padëshiruar
toolbar-spam =
    .title = Mesazheve të përzgjedhur vëru shenjë si të padëshiruar
toolbar-not-spam-label = Jo mesazh i padëshiruar
toolbar-not-spam =
    .title = Mesazheve të përzgjedhur vëru shenjë si jo të padëshiruar
