...
about-addressbook-search-all2 =
    .label = Kërko në krejt librat e adresave
    .placeholder = Kërkoni në krejt librat e adresave…
...
about-addressbook-export-selected-filename = Kontakte
