...
general-folder-options-header = Mundësi Administrimi Dosjesh
recent-destinations-legend = Vendmbërritje Së Fundi
recent-destinations-description = Mundësi për paraqitje dhe renditje dosjes ku qenë shpënë mesazhet tani afër.
recent-sort-order-label = Rend renditjeje:
    .accesskey = R
recent-sort-order-mru =
    .label = Më të freskëtit
recent-sort-order-alphabetic =
    .label = Alfabetik
max-recent-label = Numër maksimum dosjesh së fundi:
    .accesskey = k
...
new-calendar-legend = Dialog Akti të Ri Kalendari
new-calendar-checkbox-label =
    .label = Shihni aktet e kalendarit te dialogu i ri
