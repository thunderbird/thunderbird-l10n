...
quick-filter-bar-tag-mode-none =
    .label = Vetëm të paetiketuar
    .title = Vetëm mesazhe pa etiketa
...
folder-pane-mode-header-all = Tërë Dosjet
folder-pane-mode-header-unread = Dosje për Të palexuarit
...
threadpane-column-header-a11y-spam =
    .aria-label = Mesazh i padëshiruar
...
threadpane-column-header-a11y-id =
    .aria-label = Radhë sipas Marrjes
...
threadpane-column-header-a11y-select =
    .aria-label = Përzgjidhni Mesazhe
