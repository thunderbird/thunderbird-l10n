...
account-hub-email-label = Adresë email
    .accesskey = A
account-hub-email-input =
    .placeholder = filanfisteku@example.com
account-hub-email-warning-icon =
    .title = Adresë email e pavlefshme
account-hub-password-label = Fjalëkalim
    .accesskey = F
    .title = Opsionale, do të përdoret vetëm për të vlerësuar emrin e përdoruesit
account-hub-remember-password = Mbaje mend fjalëkalimin
    .accesskey = M
account-hub-exchange-label = Kredencialet tuaja të hyrjes
    .accesskey = K
account-hub-installing-addon = Po shkarkohet dhe instalohet shtesa…
account-hub-success-addon = Shtesa u instalua me sukses
account-hub-success-half-manual = Rregullimet vijues i gjetën duke provuar shërbyesin e dhënë:
account-hub-result-security-no-encryption = Pa Fshehtëzim
    .title = Pa Fshehtëzim
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = Pa Fshehtëzim
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = Mirëfilltësimi dështoi. Ju lutemi,, kontrolloni emrin e përdoruesi dhe fjalëkalimin
...
account-hub-exchange-config-unverifiable = Formësimi s’u verifikua dot. Nëse emri juaj i përdoruesit dhe fjalëkalimi janë të saktë, gjasat janë që përgjegjësi i shërbyesit të ketë çaktivizuar për llogarinë tuaj formësimin e përzgjedhur. Provoni përzgjedhjen e një protokolli tjetër.
account-hub-advanced-setup-button = Formësim i mëtejshëm
    .accesskey = e
# Variables:
#  $domain (String): The name of the server where the configuration was found, e.g. rackspace.com.
account-hub-exchange-dialog-question = { -brand-short-name }-i gjeti hollësi ujdisjeje të llogarisë tuaj në { $domain }. Doni të vazhdohet dhe të parashtrohen kredencialet tuaja?
account-hub-creation-error-title = Gabim në Krijim Llogarie
account-hub-error-server-exists = Shërbyesi marrës ekziston tashmë.
account-hub-confirm-advanced-title = Ripohoni Formësim të Mëtejshëm
account-hub-confirm-advanced-description = Ky dialog do të mbyllet dhe do të krijohet një llogari me rregullimet e tanishme, edhe nëse formësimi është i pasaktë. Doni të vazhdohet?
account-hub-addon-install-title = Instaloje
account-hub-encryption-button = Fshehtëzim skaj-më-skaj
account-hub-address-books-button = Libra Adresash
account-hub-calendars-button = Kalendarë
