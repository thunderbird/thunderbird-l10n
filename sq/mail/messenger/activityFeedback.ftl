...
looking-for-messages-account = Po shihet për mesazhe të rinj për { $accountName }…
# Feedback message shown in the status bar while we look for new messages in a
# specific folder.
# Variables:
# $folderName (String) - The folder's name.
looking-for-messages-folder = Po shihet për mesazhe të rinj te { $folderName }…
...
deleting-message =
    { $number ->
        [one] Po fshihet një mesazh nga { $folderName }…
       *[other] Po fshihen { $number } mesazhe nga { $folderName }…
    }
# Feedback message shown in the status bar while we're deleting messages in a
# specific folder (and waiting for the remote operation to complete).
# Variables:
# $number (Number) - Number of messages being deleted.
# $folderName (String) - The folder's name.
deleting-messages = Po fshihet { $number } mesazh(e) nga { $folderName }…
