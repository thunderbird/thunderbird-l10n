...
calendar-none =
    .label = 无
imip-bar-unsupported-text = 此消息包含此版本 { -brand-short-name } 无法处理的事件。
# Error strings
# @name UID_NOT_FOUND
# @loc none
...
calendar-context-convert-to-task =
    .label = 任务…
    .accesskey = T
calendar-task-filter-title2 = 筛选任务
...
calendar-task-filter-current =
    .label = 当前任务
    .accesskey = u
calendar-task-details-title = 标题
calendar-task-details-organizer = 从
calendar-task-details-priority = 优先级
calendar-task-details-priority-low = 低
calendar-task-details-priority-normal = 普通
calendar-task-details-priority-high = 高
calendar-task-details-status = 状态
calendar-task-details-category = 分类
calendar-task-details-repeat = 重复
calendar-task-details-attachments = 附件
calendar-task-details-start = 开始日期
calendar-task-details-due = 截止日期
calendar-task-mark-completed =
    .label = 标记为已完成
    .accesskey = o
    .tooltiptext = 标记选中的任务为已完成
...
calendar-properties-enable-calendar =
    .label = 启用此日历
calendar-properties-provider-missing = 未找到该日历的提供者。通常是由于您禁用或者卸载了某些附加组件。
...
calendar-search-options-searchfor =
    .value = 包含
calendar-properties-dialog-title = 编辑日历
calendar-server-dialog-name-label =
    .value = 日历名称：
calendar-publish-dialog-window-title = 发布日历
calendar-publish-url-label = 发布 URL
calendar-publish-publish-dialog-button =
    .buttonlabelaccept = 发布
calendar-publish-close-button = 关闭
calendar-select-dialog-title = 选择日历
...
calendar-error-description =
    .value = 描述：
calendar-error-prompt-title = 发生错误
calendar-extract-event-button =
    .label = 作为事件添加
    .tooltiptext = 从消息中提取日历信息并作为事件添加到你的日历中
