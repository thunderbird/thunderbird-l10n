...
folder-pane-header-hide-local-folders =
    .label = 隐藏本地文件夹
folder-pane-mode-header-all = 全部文件夹
folder-pane-mode-header-unread = 未读文件夹
folder-pane-mode-header-favorite = 收藏夹
folder-pane-mode-header-recent = 最近文件夹
folder-pane-mode-header-smart = 综合文件夹
folder-pane-mode-header-tags = 标签
