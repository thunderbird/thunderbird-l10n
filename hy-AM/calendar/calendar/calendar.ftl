...
calendar-task-filter-next7days =
    .label = Հաջորդ յոթ օրերը
    .accesskey = N
calendar-task-filter-notstarted =
    .label = Չսկսված առաջադրանքներ
    .accesskey = a
calendar-task-filter-overdue =
    .label = Հետաձգված առաջադրանքներ
    .accesskey = O
calendar-task-filter-completed =
    .label = Կատարված առաջադրանքներ
    .accesskey = C
calendar-task-filter-open =
    .label = Անավարտ առաջադրանքներ
    .accesskey = m
...
calendar-task-details-organizer = որտեղից
calendar-task-details-priority = առաջնահետթություն
...
calendar-task-details-status = վիճակագրություն
calendar-task-details-category = շարակարգ
calendar-task-details-repeat = կրկնել
calendar-task-details-attachments = կցումներ
calendar-task-details-start = Սկսման ամսաթիվ
calendar-task-details-due = ավարտի ամսաթիվ
calendar-task-mark-completed =
    .label = Նշումը կատարվել է
    .accesskey = o
    .tooltiptext = Նշել ընտրված առաջադրանքները որպես ավարտված
calendar-task-change-priority =
    .label = Առաջնահերթություն
    .accesskey = r
    .tooltiptext = Փոխել առաջնահերթությունը
calendar-task-text-filter-field =
    .emptytextbase = Զտել առաջադրանքները #1
    .keylabelnonmac = <Ctrl+Shift+K>
    .keylabelmac = <⇧⌘K>
calendar-copylink =
    .label = Պատճենել հղման տեղը
    .accesskey = C
...
calendar-progress-level-100 =
    .label = 100% Կատարված է
    .accesskey = 1
calendar-priority-none =
    .label = Հատկորոշված չէ
    .accesskey = s
...
calendar-properties-refresh =
    .value = Թարմեցնել օրացույցը՝
calendar-properties-refresh-manual =
    .label = Ձեռքով
calendar-properties-read-only =
    .label = Միայն ընթերցել
calendar-properties-show-reminders =
    .label = Ցուցադրել հիշեցումները
calendar-properties-offline-support =
    .label = Անցանց աջակցություն
calendar-properties-enable-calendar =
    .label = Միացնել այս օրացույցը
calendar-properties-provider-missing = Այս օրացույցի համար մատակարատ չի գտնվել։ Սա պատահում է, եթե Դուք անջատել կամ ապատեղակայել Եք որոշ հավելվածներ։
calendar-properties-unsubscribe =
    .label = Ապաբաժանորդագրվել
    .accesskey = U
    .buttonlabelextra1 = Ապաբաժանորդագրվել
    .buttonaccesskeyextra1 = U
calendar-alarm-dialog-title = Օրացույցի հիշեցումներ
calendar-alarm-details =
    .value = Մանրամասներ…
calendar-alarm-dismiss =
    .label = Բաց թողնել
calendar-alarm-dismiss-all =
    .label = Բաց թողնել ամբողջը
...
calendar-newevent-button =
    .label = Նոր իրադարձություն
    .tooltiptext = Նոր իրադարձություն
calendar-newtask-button =
    .label = Նոր առաջադրանք
    .tooltiptext = Նոր առաջադրանք
calendar-unifinder-show-completed-todos =
    .label = Ցուցադրել կատարված առաջադրանքները
calendar-display-todos-checkbox =
    .label = Առաջադրանքներ դիտումում
    .accesskey = k
...
calendar-extract-event-button =
    .label = Ավելացնել որպես իրադարձություն
