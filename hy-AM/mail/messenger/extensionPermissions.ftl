...
webext-perms-description-experiment-access = Այս հավելումը կունենա { -brand-short-name }-ին և ձեր համակարգչին լիարժեք, անսահմանափակ մուտքի իրավունք։
webext-perms-description-experiment = Ունի լիարժեք, անսահմանափակ մուտք դեպի { -brand-short-name } և ձեր համակարգիչ
