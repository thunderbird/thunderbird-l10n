...
address-book-add-label = Հասցեագիրք
    .aria-label = Ավելացնել հասցեների գիրք
...
import-paragraph2 = { -brand-short-name }-ը թույլ է տալիս ներմուծել փոստային հաղորդագրություններ, հասցեագրքի գրառումներ, լրահոսի բաժանորդագրություններ, կարգավորումներ և/կամ զտիչներ այլ փոստային ծրագրերից և հասցեագրքի տարածված ձևաչափերից։
