...
num-unread =
    { $count ->
        [one] , { $count } չընթերցված
       *[other] , { $count } չընթերցված
    }
...
max-count-exceeded = (Հուշում. { $total } նամակներ են ընտրված, ցուցադրվում են առաջին { $shown }-ը)
...
max-thread-count-exceeded = (Նշում. { $total } շաղթաներ են ընտրված, ցուցադրված են առաջին { $shown }-ը)
