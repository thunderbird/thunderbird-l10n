...
calendars-title = Օրացույցի կարգավորումներ
calendars-table-heading-property = Անուն
calendars-table-heading-value = Արժեք
calendars-table-name = Անուն
calendars-table-type = Տեսակ
calendars-table-disabled = Անջատված
calendars-table-username = Օգտվողի անուն
