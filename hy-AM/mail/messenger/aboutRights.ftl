...
rights-webservices2 =
    { -brand-full-name }-ը օգտագործում է վեբ-հիմքով տեղեկատվական ծառայություններ («Ծառայություններ»)՝ { -brand-short-name }-ի այս երկուական տարբերակով ձեզ համար տրամադրվող որոշ գործառույթներ տրամադրելու համար՝ ստորև նկարագրված պայմաններով։ Եթե դուք չեք
    ցանկանում օգտագործել Ծառայություններից մեկը կամ մի քանիսը, կամ ստորև նշված պայմանները
    անընդունելի են, կարող եք անջատել գործառույթը կամ Ծառայություն(ներ)ը։ Որոշակի գործառույթի կամ ծառայության անջատման վերաբերյալ հրահանգները կարող եք գտնել
    <a data-l10n-name="mozilla-disable-service-link">այստեղ</a>։ Այլ գործառույթներ
    և ծառայություններ կարող են անջատվել ծրագրի կարգավորումներում։
