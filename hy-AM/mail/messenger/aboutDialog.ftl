...
community-exp =
    ...
    { -vendor-short-name }-ը</a>
     ստեղծել է <a data-l10n-name="community-exp-credits-link">
    գլոբալ համայնք, </a>
     որն աշխատում է մեկ նպատակով՝ ապահովել համացանցի հասանելիությունը բոլորի համար:
community-2 =
    { -brand-short-name }-ը ստեղծել է <a data-l10n-name="community-mozilla-link">
    { -vendor-short-name }-ն</a>
