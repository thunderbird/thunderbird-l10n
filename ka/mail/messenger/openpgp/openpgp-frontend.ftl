...
openpgp-has-nested-encrypted-parts = წერილი შეიცავს დამატებით დაშიფრულ ნაწილებს.
openpgp-show-encrypted-parts = გაშიფვრა და ჩვენება
openpgp-has-nested-signed-parts = ამ წერილის ზოგიერთი ნაწილი შესაძლოა ციფრულად ხელმოწერილი იყოს.
openpgp-show-signed-parts = გახსნა და ჩვენება
