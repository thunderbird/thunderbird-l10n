...
openpgp-sig-invalid-date-mismatch = ეს წერილი შეიცავს ციფრულ ხელმოწერას, მაგრამ ხელმოწერილი არაა ელფოსტის გაგზავნისას. ეს შეიძლება თქვენი შეცდენის მცდელობა იყოს გარემოებების ცვლილებით: მაგ. თავის დროზე დაწერისას შესაძლოა, სხვა დანიშნულება ჰქონოდა ან სხვისთვის ყოფილიყო განკუთვნილი.
...
openpgp-other-enc-additional-key-ids = გარდა ამისა, წერილი დაშიფრული იყო მათთვის, ვინც ფლობს მოცემულ გასაღებებს:
openpgp-other-enc-all-key-ids = წერილი დაშიფრული იყო მათთვის, ვინც ფლობს მოცემულ გასაღებებს:
