...
openpgp-passphrase-new-repeat = ახალი ფრაზის დადასტურება
openpgp-passphrase-set = შემშვები ფრაზის დაყენება
openpgp-passphrase-change = შემშვები ფრაზის შეცვლა
...
openpgp-selection-status-expiring-soon = მიმდინარე გამართვაში გამოიყენება გასაღები <b>{ $key }</b>, რომელსაც ვადა ეწურება { $when }. გასაღები მოქმედი რომ დარჩეს, გთხოვთ ახლავე გაზარდოთ გასაღების ვადის ხანგრძლივობა.
#   $key (String) - the currently selected OpenPGP key
...
openpgp-suggest-publishing-key = საჯარო გასაღების გამოქვეყნება გასაღებების სერვერზე ყველას მისცემს მისი მონახვის საშუალებას.
...
text-file = ტექსტური ფაილები (*.txt)
