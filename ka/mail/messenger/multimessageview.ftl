...
num-ignored =
    { $count ->
        [one] , { $count } უგულებელყოფილი
       *[other] , { $count } უგულებელყოფილი
    }
...
max-count-exceeded = (შენიშვნა: შერჩეულია { $total } შეტყობინება, ნაჩვენებია პირველი { $shown })
...
max-thread-count-exceeded = (შენიშვნა: შერჩეულია { $total } მიმოწერა, ნაჩვენებია პირველი { $shown })
