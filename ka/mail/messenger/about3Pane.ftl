...
quick-filter-bar-tag-mode-none =
    .label = ჭდეების არმქონე მხოლოდ
    .title = მხოლოდ ჭდეების არმქონე წერილები
...
folder-pane-header-toggle-full-path =
    .label = მდებარეობა სრულად
folder-pane-header-hide-local-folders =
    .label = დაიმალოს ადგილობრივი საქაღალდეები
folder-pane-mode-header-all = ყველა საქაღალდე
folder-pane-mode-header-unread = წასაკითხი საქაღალდეები
folder-pane-mode-header-favorite = რჩეული საქაღალდეები
folder-pane-mode-header-recent = უახლესი საქაღალდეები
folder-pane-mode-header-smart = ერთიანი საქაღალდეები
folder-pane-mode-header-tags = ჭდეები
