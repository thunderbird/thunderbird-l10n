...
account-settings-color-label = ფერი:
    .accesskey = ფ
account-settings-reset-color-button =
    .title = ფერის ახლიდან დაყენება
delete-account-button =
    .label = წაშლა
default-account-button =
    .label = ნაგულისხმევად მითითება
outgoing-server-name = გამავალი სერვერი:
    .accesskey = გ
...
oauth2-authorization-endpoint-label =
    .value = მომხმარებლის შესაყვანი დამოწმებისთვის:
    .accesskey = წ
oauth2-token-endpoint-label =
    .value = საშვის მიმღები:
    .accesskey = ვ
oauth2-scopes-label =
    .value = არეები:
    .accesskey = რ
...
oauth2-client-secret-label =
    .value = კლიენტის საიდუმლო:
    .accesskey = კ
oauth2-issuer-identifier-label =
    .value = გამომცემის საცნობი:
    .accesskey = ნ
oauth2-use-pkce =
...
ews-override-oauth-details =
    .label = შენაცვლდეს Office365-გამართვა:
    .accesskey = ც
