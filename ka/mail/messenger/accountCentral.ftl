...
newsgroups-label = სასაუბრო ჯგუფები
    .aria-label = დაუკავშირდით სასაუბრო ჯგუფებს
newsgroups-description = { -brand-short-name } ასევე გაძლევთ საშუალებას დაუკავშირდეთ სასურველ სასაუბრო ჯგუფებს.
