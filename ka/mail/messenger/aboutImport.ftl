...
source-thunderbird-description = გადმოტანა პარამეტრების, ფილტრების, წერილებისა და სხვა მონაცემებისა { app-name-thunderbird }-პროფილიდან.
source-seamonkey = გადმოტანა მონაცემებისა, რომელთაც შეიცავს { app-name-seamonkey }
source-seamonkey-description = გადმოტანა პარამეტრების, ფილტრების, წერილებისა და სხვა მონაცემებისა { app-name-seamonkey }-პროფილიდან.
source-outlook = გადმოტანა მონაცემებისა, რომელთაც შეიცავს { app-name-outlook }
source-outlook-description = გადმოტანა ანგარიშების, მისამართების წიგნაკებისა და წერილებისა, რომელთაც შეიცავს { app-name-outlook }.
source-apple-mail = გადმოტანა მონაცემებისა, რომელთაც შეიცავს { app-name-apple-mail }
source-apple-mail-description = გადმოტანა წერილებისა, რომელთაც შეიცავს { app-name-apple-mail }
source-file2 = ფაილიდან შემოტანა
source-file-description = ფაილის არჩევა, რომ გადმოიტანოთ მისამართების წიგნაკები, კალენდრები ან პროფილი მარქაფიდან (ZIP-ფაილი).

## Import from file selections

file-profile2 = დამარქაფებული პროფილის გადმოტანა
file-profile-description = აირჩიეთ წინა Thunderbird-ით დამარქაფებული პროფილი (.zip)
...
from-app-thunderbird = გადმოტანა { app-name-thunderbird }-პროფილიდან
from-app-seamonkey = გადმოტანა { app-name-seamonkey }-პროფილიდან
from-app-outlook = გადმოტანა მონაცემებისა, რომელთაც შეიცავს { app-name-outlook }
from-app-apple-mail = გადმოტანა მონაცემებისა, რომელთაც შეიცავს { app-name-apple-mail }
profiles-pane-title-thunderbird = გადმოტანა პარამეტრებისა და მონაცემებისა { app-name-thunderbird }-პროფილიდან
profiles-pane-title-seamonkey = გადმოტანა პარამეტრებისა და მონაცემებისა { app-name-seamonkey }-პროფილიდან
profiles-pane-title-outlook = გადმოტანა სხვადასხვა მონაცემებისა, რომელთაც შეიცავს { app-name-outlook }
profiles-pane-title-apple-mail = გადმოტანა წერილებისა, რომელთაც შეიცავს { app-name-apple-mail }.
profile-source = შემოტანა პროფილიდან
# $profileName (string) - name of the profile
profile-source-named = შემოტანა პროფილიდან <strong>„{ $profileName }“</strong>
profile-file-picker-directory = პროფილის საქაღალდის არჩევა
profile-file-picker-archive = აირჩიეთ <strong>ZIP</strong>-ფაილი
profile-file-picker-archive-description = ZIP-ფაილი უნდა იყოს არაუმეტეს 2ᲒᲑ
profile-file-picker-archive-title = აირჩიეთ ZIP-ფაილი (არაუმეტეს 2ᲒᲑ)
items-pane-title2 = შემოსატანი მონაცემების შერჩევა
items-pane-directory = საქაღალდე:
items-pane-profile-name = პროფილის სახელი:
...
import-from-addr-book-file-description = აირჩიეთ ფაილის სახეობა, რომელიც შეიცავს თქვენი წიგნაკის მონაცემებს.
...
addr-book-import-into-new-directory2 = შექმენით ახალი საქაღალდე სახელწოდებით <strong>„{ $addressBookName }“</strong>
# $addressBookName (string) - name of the address book to import into
addr-book-summary-title = შემოიტანეთ შერჩეული მონაცემები საქაღალდეში „{ $addressBookName }“
# $addressBookName (string) - name of the address book that will be created.
addr-book-summary-description = შეიქმნება ახალი მისამართების წიგნაკი სახელწოდებით „{ $addressBookName }“.
...
calendar-import-into-new-calendar2 = შექმენით ახალი კალენდარი სახელწოდებით <strong>„{ $targetCalendar }“</strong>
# $itemCount (number) - count of selected items (tasks, events) that will be imported
# $targetCalendar (string) - name of the calendar the items will be imported into
calendar-summary-title =
    { $itemCount ->
        [one] გადმოიტანეთ ერთი ჩანაწერი კალენდარში „{ $targetCalendar }“
       *[other] გადმოიტანეთ { $itemCount } ჩანაწერი კალენდარში „{ $targetCalendar }“
    }
# $targetCalendar (string) - name of the calendar that will be created
calendar-summary-description = შეიქმნება ახალი კალენდარი სახელწოდებით „{ $targetCalendar }“.
...
progress-pane-finished-desc2 = დასრულდა.
...
error-message-extract-zip-file-failed2 = ვერ მოხერხდა ZIP-ფაილის გაშლა. გთხოვთ, ხელით ამოიღოთ შიგთავსი და შესაბამისი საქაღალდიდან შემოიტანოთ.
...
error-message-no-profile = პროფილი ვერ მოიძებნა.
...
export-profile-description = თუ თქვენი პროფილის მოცულობა მეტია, ვიდრე 2ᲒᲑ, გირჩევთ თავადვე დაამარქაფოთ.
...
footer-support-forum = მხარდაჭერის ფორუმი

## Step navigation on top of the wizard pages

step-list =
    .aria-label = შემოტანის ნაბიჯები
step-confirm = თანხმობა
# Variables:
