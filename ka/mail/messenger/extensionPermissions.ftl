...
webext-perms-description-messagesModifyPermanent = თქვენი წერილების წყაროს მუდმივად შეცვლა (თავსართების, შიგთავსისა და დანართების ჩათვლით)
...
webext-perms-description-messagesRead2 = თქვენი ელფოსტის წერილების წაკითხვა
webext-perms-description-messagesUpdate = თქვენი ელფოსტის წერილების მახასიათებლებისა და ჭდეების შეცვლა
webext-perms-description-messages-send = პროგრამულად აგზავნის ელფოსტის წერილებს ერთიანად თქვენი სახელით, ხილული სახით დადასტურების გარეშე. დაიხმარეთ მოქმედებების სამართავი ამ დამატების მიერ გაგზავნილი წერილების ისტორიის გასაცნობად.
webext-perms-description-messages-save = პროგრამულად ინახავს ელფოსტის წერილებს გასაგზავნად ან ნიმუშებად თქვენი ჩარევის გარეშე
webext-perms-description-messagesTags = წერილის ჭდეების შექმნა, შესწორება და წაშლა
webext-perms-description-messagesTagsList = წერილის ჭდეების აღრიცხვა
...
webext-perms-description-messengerSettings = { -brand-short-name } პარამეტრების წაკითხვა
