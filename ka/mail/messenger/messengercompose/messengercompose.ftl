...
compose-message-cancelling = უქმდება…
compose-message-attachment-name = დართული წერილი
...
blocked-content-message =
    { $count ->
        [one] { -brand-short-name } ზღუდავს ფაილის ჩატვირთვას ამ წერილში. შეზღუდვის მოხსნის შემთხვევაში, ფაილი დაემატება გაგზავნილ წერილებში.
       *[other] { -brand-short-name } ზღუდავს გარკვეული ფაილების ჩატვირთვას ამ წერილში. შეზღუდვის მოხსნის შემთხვევაში, ფაილი დაემატება გაგზავნილ წერილებში.
    }
# Variables:
...
compose-button-send =
    .label = გაგზავნა
    .tooltiptext = წერილის დაუყოვნებლივ გაგზავნა
compose-button-send-later =
    .label = გაგზავნა მოგვიანებით
    .tooltiptext = წერილის მოგვიანებით გაგზავნა
