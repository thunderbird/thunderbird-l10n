...
in-app-notification-instructions =
    { PLATFORM() ->
        [macos] დააჭირეთ ⌥+Shift+{ -in-app-notification-accesskey } შეტყობინებაზე გადასასვლელად
       *[other] დააჭირეთ Alt+Shift+{ -in-app-notification-accesskey } შეტყობინებაზე გადასასვლელად
    }
