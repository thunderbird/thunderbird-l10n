...
account-hub-servers-username-label = მომხმარებელი:
account-hub-result-server-label = სერვერი:
account-hub-result-port-label = პორტი:
account-hub-result-security-label = უსაფრთხოება:
account-hub-result-authentication-type-label = შესვლის დამოწმება:
account-hub-result-authentication-none = არცერთი
    .title = არცერთი
account-hub-result-authentication-password = ჩვეულებრივი პაროლი
    .title = ჩვეულებრივი პაროლი
account-hub-result-authentication-encrypted-password = დაშიფრული პაროლი
    .title = დაშიფრული პაროლი
account-hub-result-authentication-gssapi = Kerberos
    .title = Kerberos
account-hub-result-authentication-ntlm = NTLM
    .title = NTLM
account-hub-result-authentication-external = გარე
    .title = გარე
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = არცერთი
    .title = არცერთი
account-hub-result-auth-password = ჩვეულებრივი პაროლი
    .title = ჩვეულებრივი პაროლი
account-hub-result-auth-encrypted-password = დაშიფრული პაროლი
    .title = დაშიფრული პაროლი
account-hub-result-auth-gssapi = Kerberos
    .title = Kerberos
account-hub-result-auth-ntlm = NTLM
    .title = NTLM
account-hub-result-auth-external = გარე
    .title = გარე
...
account-hub-exchange-service-url-label = შეიყვანეთ მომსახურების URL-ბმული
...
account-hub-password-label = პაროლი
    .accesskey = პ
    .title = არასავალდებული, მხოლოდ სახელის დასამოწმებლად
account-hub-remember-password = პაროლის დამახსოვრება
    .accesskey = მ
account-hub-exchange-label = თქვენი ანგარიში
    .accesskey = გ
account-hub-installing-addon = დამატების ჩამოტვირთვა და ჩადგმა…
account-hub-success-addon = წარმატებით ჩაიდგა დამატება
account-hub-success-half-manual = შემდეგი პარამეტრებია ნაპოვნი, მოცემული სერვერის გამოკვლევით:
account-hub-result-security-no-encryption = დაშიფვრის გარეშე
    .title = დაშიფვრის გარეშე
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = დაშიფვრის გარეშე
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = შესვლა ვერ მოხერხდა. გთხოვთ, გადაამოწმოთ სახელი და პაროლი
...
account-hub-exchange-config-unverifiable = გამართვის პარამეტრების დამოწმება ვერ მოხერხდა. თუ თქვენი სახელი და პაროლი სწორია, შესაძლოა სერვერის ხელმძღვანელობამ გათიშა აღნიშნული პარამეტრები თქვენი ანგარიშისთვის. სცადეთ სხვა ოქმის მითითება.
account-hub-advanced-setup-button = გაფართოებული გამართვა
    .accesskey = ო
# Variables:
#  $domain (String): The name of the server where the configuration was found, e.g. rackspace.com.
account-hub-exchange-dialog-question = { -brand-short-name } პოულობს თქვენი ანგარიშის მონაცემებს { $domain }-ზე. გსურთ, განაგრძოთ და წარადგინოთ ანგარიშის მონაცემები?
account-hub-creation-error-title = შეცდომა ანგარიშის შექმნისას
account-hub-error-server-exists = შემომავალი სერვერი უკვე არსებობს.
account-hub-confirm-advanced-title = დამატებით გამართვის დადასტურება
account-hub-confirm-advanced-description = ეს ფანჯარა დაიხურება და ანგარიში შეიქმნება მიმდინარე პარამეტრებით, იმ შემთხვევაშიც, თუ არასწორადაა გამართული. გსურთ, განაგრძოთ?
account-hub-addon-install-title = ჩადგმა
...
account-hub-result-graph-api-description = გამოიყენეთ Microsoft-Graph-API თქვენი საქაღალდეებისა და წერილების დასინქრონებისთვის Microsoft-365-თან
account-hub-result-graph-shortname = Exchange (Graph)
account-hub-result-graph-description = გამოიყენეთ Microsoft Graph API თქვენი საქაღალდეებისა და წერილების დასინქრონებისთვის
...
account-hub-result-ews-expanded-text = Exchange-ვებმომსახურება
...
account-hub-config-success-title = ანგარიშის პარამეტრები მოიძებნა ავტომატურად.
account-hub-config-success-description-db = ნაპოვნი გამართვის წყაროა Mozilla-ISPDB.
account-hub-config-success-description-exchange = ნაპოვნია გამართვის მონაცემები Microsoft-Exchange-სერვერისთვის.
account-hub-config-success-description-guess = ნაპოვნია გამართვის მონაცემები ცნობილი სერვერების დასახელებების მოსინჯვით.
account-hub-config-success-description-disk = ნაპოვნი გამართვის წყაროა დაყენებული { -brand-short-name }.
...
account-hub-select-security-warning = <span data-l10n-name="error-text">გაფრთხილება: აღმოჩენილია ფოსტის დაუცველი სერვერი.</span>  ამ სერვერს არ ახლავს დაშიფვრა, შესაბამისად, გამჟღავნდება თქვენი პაროლი და მონაცემები. მიმართეთ ზედამხედველს კავშირის დასაცავად ან განაგრძეთ საფრთხის გაცნობიერებით. <a data-l10n-name="error-link">ვრცლად იხილეთ ᲮᲓᲙ.</a>
...
address-book-add-remote-icon2 =
    .alt = დაშორებული წიგნაკის დამატება
address-book-add-remote-icon =
    .alt = ახალი დაშორებული წიგნაკის დამატება
address-book-add-remote = დაამატეთ დაშორებული წიგნაკი
address-book-add-remote-carddav-description = დაკავშირება CardDAV-წიგნაკთან
...
address-book-add-ldap-icon2 =
    .alt = LDAP-წიგნაკის დამატება
address-book-add-ldap-button = LDAP-წიგნაკის დამატება
...
account-hub-exchange-type-account-type = ანგარიშის სახეობა
account-hub-card-graph-title = Microsoft Graph
account-hub-card-graph-description = Microsoft Graph თანამედროვე საშუალებაა, რომ დაკავშირდეს Microsoft 365
account-hub-card-ews-title = Exchange-ვებმომსახურებები
account-hub-card-ews-tag = სამართლებრივი
account-hub-card-ews-description = Exchange-Web-Services (EWS) უკავშირდება Microsoft-Exchange-ს თქვენი ფოსტის დასინქრონებისთვის.
