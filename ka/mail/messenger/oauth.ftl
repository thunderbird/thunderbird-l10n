...
oauth-reauthorize-title = წვდომის ხელახლა დამოწმება
...
oauth-reauthorize-description = { $hostname } ითხოვს წვდომის ხელახლა დადასტურებას თქვენს ანგარიშთან დასინქრონების გასაგრძელებლად. მომხმარებლის სახელი: { $username }
