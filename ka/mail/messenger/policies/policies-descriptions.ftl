...
policy-DisableCommunity = არ გამოჩნდეს ერთობის შესაძლებლობები გარსში (მაგალითად, შემოწირულობის გაღება, მონაწილეობის გზები, მოსაზრებების გაზიარება და ა. შ.)
...
policy-DisableFileLink = Filelink-შესაძლებლობის გათიშვა.
...
policy-DisableMessageForwardingFilters = ფილტრებით წერილების თავისთავად გადამისამართების შეზღუდვა.
...
policy-DisableExperimentalFeatures = საცდელი შესაძლებლობების გამორთვა Thunderbird-ში.
policy-DisableQRExport = QR-კოდის შედგენის გათიშვა ანგარიშის პარამეტრებისა და მონაცემების გასატანად.
...
policy-DisableUpdateSettings = მომხმარებლისთვის განახლების პარამეტრების ცვლილების შეზღუდვა.
...
policy-InAppNotification = შეტყობინებების სახეობების ჩართვა ან გამორთვა.
