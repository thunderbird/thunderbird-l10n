...
default-app-intro = გახდეს { -brand-short-name } ნაგულისხმევი:
...
checkbox-net-thunderbird-url-label =
    .label = მორგებული Thunderbird-ბმულები (net.thunderbird://)
    .tooltiptext = { unset-default-tooltip }
...
check-on-startup-label =
    ...
    .accesskey = ყ
system-settings-dialog-title = სისტემის პარამეტრები
