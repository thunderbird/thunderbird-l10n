...
general-email-notifications-header = ელფოსტის შეტყობინებები
...
general-files-and-attachment-description = აირჩიეთ, რომელი ფაილებია შენახული და სად ინახება თქვენს კომპიუტერში.
general-tags-header = ჭდეები
general-reading-and-viewing-header = კითხვა და ნახვა
general-reading-and-display-header = კითხვა და ჩვენება
general-updates-header = განახლებები
general-network-and-storage-header = ქსელი და საცავი
general-search-performance-label = ძიება და წარმადობა
compose-writing-emails-header = წერილების წერა
...
compose-message-formatting-title = წერილის გაფორმება
compose-address-autocomplete-header = მისამართების თვითდასრულება
...
choose-display-language-description = აირჩიეთ ენა, რომელიც გამოიყენება მენიუს, ღილაკებისა და შეტყობინებებისთვის.
...
manual-storage-limit-label =
    .label = დროებით ფაილებზე მეხსიერების ზღვრის ხელით დაყენება
    .accesskey = ზ
clear-temp-files-button =
    .label = დროებითი ფაილების გასუფთავება
    .accesskey = ფ
clear-temp-files-shutdown-label =
    .label = დროებით ფაილების გასუფთავება, როცა { -brand-short-name } დაიხურება
    .accesskey = დ
...
show-start-page-label =
    .label = საწყისი გვერდის ჩვენება, როცა { -brand-short-name } გაიხსნება
    .accesskey = წ
start-page-label =
...
start-in-tray-label =
    ...
    .accesskey = ტ
new-message-arrival-legend = ახალი წერილის შემოსვლისას:
...
new-email-alert-label =
    .label = ცნობება ელფოსტის ახალი წერილისას
    .accesskey = ც
customize-alerts-label =
    .label = ცნობების მორგება…
    .accesskey = ც
...
use-custom-sound-label =
    .label = გამოიყენეთ მორგებული ხმები ცნობებისთვის
    .accesskey = გ
mail-select-audio-button =
    .label = ხმის არჩევა…
    .accesskey = ა
enable-global-search-label =
    .label = ძიების ჩართვა ელფოსტის ყველა ანგარიშზე
    .accesskey = ძ
gloda-results-plain-list-label =
    .label = ძიების შედეგების ჩვენება უბრალო სიის სახით
    .accesskey = ძ
...
display-language-legend = ჩვენების ენა
allow-graphics-accel =
    .label = გრაფიკული აჩქარების გამოყენება გლუვი გადაადგილებისა და წარმადობისთვის
    .accesskey = ლ
storage-format-label =
    .value = საცავის სახეობა ახალი ანგარიშებისთვის:
    .accesskey = რ
mbox-store-single-label =
    .label = ცალკეული ფაილი თითო საქაღალდეზე (mbox)
...
enable-autoscroll-label =
    .label = თვითგადაადგილების ჩართვა
    .accesskey = ბ
autoscroll-label =
...
hide-titlebar-label =
    .label = სათაურის ზოლის დამალვა
    .accesskey = დ
hide-titlebar-description = აცილებს ზედა ზოლს, ფანჯრის სახელის შემცველს, ეკრანზე სივრცის დასაზოგად
hide-tabbar-single-tab-label =
    .label = ჩანართის ზოლის დამალვა, როცა მხოლოდ ერთი ჩანართია
    .accesskey = ჩ
auto-hide-tabbar-second-tab-description = თავისთავად მალავს ჩანართებს, სანამ მეორე ჩანართს გახსნით.
system-settings-legend = სისტემის პარამეტრები
check-email-app-label =
    .label = ყოველთვის შემოწმდეს გახსნისას, არის თუ არა { -brand-short-name } ელფოსტის ნაგულისხმევი პროგრამა
    .accesskey = ყ
edit-defaults-apps-button =
    .label = ნაგულისხმევის ჩასწორება…
    .accesskey = ნ
...
update-settings-title = განახლების პარამეტრები
install-updates-automatically-label =
    .label = თავად დააყენოს განახლებები (სასურველია)
    .accesskey = ვ
install-updates-automatically-description = დაცული რჩება { -brand-short-name } უსაფრთხოების უახლესი შესწორებებით.
...
connection-config-description = მიუთითეთ, როგორ დაუკავშირდეს { -brand-short-name } ქსელს.
connection-options-button =
    .label = კავშირის პარამეტრები…
    .accesskey = კ
offline-mode-legend = კავშირგარეშე რეჟიმი
offline-settings-label = კავშირგარეშე პარამეტრები
...
offline-settings-button =
    .label = კავშირგარეშე…
    .accesskey = გ
temporary-storage-legend = დროებითი საცავი
offline-compact-remove-deleted =
    .label = მოცილდეს მონაცემები საქაღალდეებიდან, რომლებიც უკვე წაშლილია მეხსიერების გასათავისუფლებლად
    .accesskey = ც
offline-compact-ask-cleanup =
    .label = შეკითხვა საქაღალდეების გასუფთავებამდე
    .accesskey = შ
...
use-cache-before =
    ...
    .accesskey = ყ
use-temp-storage-after = მბაიტი მეხსიერებიდან დროებითი ფაილებისთვის
...
underline-text-links-label =
    .label = ტექსტური ბმულების ხაზგასმა წერილებში
    .accesskey = ხ
...
search-content-types =
    .placeholder = მასალის სახეობების ძიება
...
always-ask-label =
    ...
    .accesskey = A
use-tags-text = ჭდეების გამოყენება წერილების დაჯგუფებისა და უპირატესობის მისანიჭებლად.
...
show-attachments-inline-label =
    .label = დანართების ჩვენება წერილის შიგთავსში
    .accesskey = დ
mark-read-no-delay =
...
display-name-only-label =
    .label = მხოლოდ გამოსაჩენი სახელის ჩვენება მისამართების წიგნაკში შენახული ხალხისთვის
    .accesskey = მ
...
show-conversation-view-label =
    .label = საუბრის ხედის ჩვენება
    .accesskey = უ
conversation-view-preview-description = ეს ადრეული სახეა ამ შესაძლებლობისა. იგი აჯგუფებს დაკავშირებულ წერილებს ერთად, მაგრამ შესაძლოა, ყოველთვის სათანადოდ ვერ იმუშაოს.
...
dark-mode-message-appearance = წერილის იერსახე
dark-mode-checkbox-label =
    .label = მუქი რეჟიმის გამოყენება წერილის ტექსტისთვის
    .accesskey = მ
dark-mode-message-text-description = მუქ ფონს მოარგებს ყველა შემოსულ წერილს, იმ შემთხვევაშიც კი, თუ გამომგზავნს ღია ფერებით აქვს გაფორმებული.
...
dark-message-mode-toggle-label =
    ...
    .accesskey = გ
dark-mode-toggle-description = საშუალებას გაძლევთ, სწრაფად დააბრუნოთ ელფოსტა ნათელ რეჟიმზე კითხვისას მთავარი პარამეტრების შეუცვლელად.
general-folder-settings-header = საქაღალდის პარამეტრები
recent-folders-legend = უახლესი საქაღალდეები
recent-folders-description = განსაზღვრავს, როგორ გამოჩნდეს ბოლოს გამოყენებული საქაღალდეები წერილების გადაადგილებისას.
...
general-folder-options-header = საქაღალდის მართვის პარამეტრები
recent-destinations-legend = ბოლოს გამოყენებული ადგილები
recent-destinations-description = პარამეტრები იმ საქაღალდეთა სიისა და დახარისხებისთვის, სადაც ბოლოს იყო გადატანილი წერილები.
recent-sort-order-label = დალაგება:
    .accesskey = ლ
recent-sort-order-mru =
    .label = უახლესი
recent-sort-order-alphabetic =
    .label = ანბანური
max-recent-label = ბოლოს გამოყენებული საქაღალდეების რაოდენობა არაუმეტეს:
    .accesskey = ტ
...
account-hub-manual-config-checkbox-label =
    .label = გამოიყენეთ ხელით გამართვის ახალი საშუალება ანგარიშების ერთიანი არისთვის
    .accesskey = ყ
account-hub-manual-config-checkbox-description = ანგარიშების ერთიანი არის ხელით გამართვის საშუალება
new-calendar-legend = კალენდრის ახალი ღონისძიების არე
new-calendar-checkbox-label =
    .label = კალენდრის ღონისძიებების ნახვა ახალ არე
new-calendar-checkbox-description = კალენდრის ახალი საცდელი არე ღონისძიებების სანახავად
...
as-attachment-label =
    .label = დანართად
add-file-type-label =
    .label = დართული წერილებისთვის ფაილის სახეობის დამატება
    .accesskey = დ
extension-label =
...
ignore-sender-styles-label =
    .label = გამგზავნის შრიფტებისა და ფერების უგულებელყოფა
    .accesskey = უ
...
paragraph-spacing-label =
    .label = დაჭერისას Enter ახალ ხაზზე გადაიტანს დამატებითი დაშორებით
    .accesskey = ჭ
...
compose-format-automatic-option =
    .label = ავტომატური (სასურველია)
compose-format-automatic-description = გაგზავნის გაფორმებულ ტექსტს, თუ შეუცვლით იერსახეს (თუნდაც გამუქებით ან ბმულებით), თუ არადა, დატოვებს უბრალო ტექსტს.
compose-format-both-option =
    .label = ორივე, როგორც გაფართოებული (HTML), ასევე უბრალო ტექსტი
compose-format-both-description = ყოველთვის გაიგზავნება ორივე სახით, ასე რომ მიმღების ელფოსტის პროგრამას შეეძლება აირჩიოს, რომელი გამოჩნდეს.
compose-format-html-option =
    .label = მხოლოდ გაფართოებული (HTML) ტექსტი
compose-format-html-description = დატოვებს შრიფტებს, ფერებსა და სურათებს, მაგრამ ელფოსტის ზოგიერთ ძველ პროგრამაში სათანადოდ ვერ გამოჩნდება.
compose-format-plain-option =
    .label = მხოლოდ უბრალო ტექსტი
compose-format-plain-description = მოაცილებს ყველანაირ გაფორმებას, ფერსა და სურათს. საუკეთესოა მარტივი ტექსტური წერილებისთვის, რომლებიც ყველგან იმუშავებს.
autocomplete-matches-description = მიმღების სახელის ან ელფოსტის აკრეფისას მოიძებნება თანხვედრა:
company-network-directory-label =
    .label = კომპანიის ან ქსელის საქაღალდე
    .accesskey = კ
directory-server-label =
    .label = საქაღალდის სერვერი
    .accesskey = ს
...
collect-outgoing-label =
    .label = გამავალი ელფოსტის მისამართების თვითშენახვა:
    .accesskey = გ
collect-outgoing-description = სად შეინახოს ახალი ხალხი ხელით შექმნისას ან ელფოსტის წერილებიდან დამატებისას.
save-added-contacts-label =
    .value = ხელით დამატებული ხალხის შესანახად:
    .accesskey = ხ
save-added-contacts-description = სად შეინახოს ახალი ხალხი ელფოსტის წერილებიდან.
show-directory-startup-label =
    .value = საქაღალდის ჩვენება მისამართების წიგნაკის ფანჯარაში, როცა გაიხსნება { -brand-short-name }
    .accesskey = ს
...
email-picker-label =
    ...
    .accesskey = დ
email-picker-description = გაგზავნილი წერილებიდან შენახულ პირთა მდებარეობა.
default-add-address-book-label =
    .value = ნაგულისხმევი მისამართების წიგნაკი ხელით დამატებულ პირთათვის:
    .accesskey = ნ
default-add-address-book-description = მიღებული წერილებიდან შენახულ პირთა მდებარეობა.
...
attachment-label =
    ...
    .accesskey = ო
edit-keywords-label =
    .label = საკვანძო სიტყვების ჩასწორება…
    .accesskey = კ
offer-share-large-files-label =
    .label = ფაილების ბმულით გაზიარების შემოთავაზება, როცა ზომაა არანაკლებ:
...
search-preferences-input2 =
    ...
    .style = width: 15.4em
managed-by-organization-notice = { -brand-short-name } იმართება დაწესებულების მიერ.
...
accent-color-legend = შეფერილობა
accent-color-selection-label =
    .value = ფერის არჩევა მთავარი ღილაკისა და გამორჩევისთვის
accent-color-label =
    .value = განსაზღვრეთ ფერი ძირითადი ღილაკებისა და მონიშნული ნაწილებისთვის:
accent-color-os =
    .label = საოპერაციო სისტემის მიხედვით
accent-color-thunderbird =
    .label = Thunderbird-ლურჯი
accent-color-purple =
    .label = მეწამული
accent-color-orange =
    .label = ნარინჯისფერი
...
accent-color-ink =
    .label = მელნისფერი
accent-color-teal =
    .label = მოლურჯო-მწვანე
accent-color-disabled-description = შეფერილობის არჩევა მხარდაუჭერელია მაღალი კონტრასტის რეჟიმში.
default-message-list-legend = წერილების სია
appearance-view-style-select =
    .value = ხედის სახეობის შერჩევა:
...
appearance-radio-card-view =
    .label = საბარათო ხედი
card-view-options-legend = საბარათო ხედის გამართვა
...
default-message-list-new-folders-description = ნაგულისხმევი პარამეტრების შერჩევა ახალი წერილების დალაგებისა და მიმოწერად დახარისხებისთვის
...
default-sort-by-label = წერილების დალაგება:
...
default-sort-newest-bottom =
    .label = უახლესი წერილები ქვემოთ
default-sort-new-messages-top =
    .label = უახლესი წერილები ზემოთ
apply-view-settings-label = ხედის პარამეტრებს გამოიყენებს:
apply-view-settings-to-all-folders-button =
    .label = ყველა საქაღალდე და ქვესაქაღალდე
    .accesskey = ყ
select-apply-sort-folders-button =
    .label = საქაღალდეების არჩევა
    .accesskey = ს
