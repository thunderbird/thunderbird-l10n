...
rights-intro-point-1 =
    { -brand-short-name } მოგეწოდებათ პირობებით, რომელსაც განსაზღვრავს
    <a data-l10n-name="mozilla-public-license-link">Mozilla Public License</a>.
    რაც გულისხმობს, რომ შეგიძლიათ { -brand-short-name } გამოიყენოთ, გაამრავლოთ და გაავრცელოთ. ასევე მისაღებია პირველწყარო კოდის გადაკეთებაც,
    რომ უკეთ მოარგოთ { -brand-short-name } საკუთარ საჭიროებებს. ამასთანავე, Mozilla Public
    License უფლებას გაძლევთ, გაავრცელოთ თქვენი სახეცვლილი ვერსიები.
