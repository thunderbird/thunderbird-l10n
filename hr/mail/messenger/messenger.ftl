...
context-menu-mark-not-junk =
    .aria-label = Označi da nije neželjena pošta
    .tooltiptext = Označi da nije neželjena pošta
...
menuitem-label-spam-score-origin =
    .label = Podrijetlo rezultata neželjene pošte
