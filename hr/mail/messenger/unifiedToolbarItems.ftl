...
toolbar-spam-label = Neželjena pošta
toolbar-spam =
    .title = Označi odabrane poruke kao neželjena pošta
toolbar-not-spam-label = Nije neželjena pošta
toolbar-not-spam =
    .title = Označi odabrane poruke kao da nisu neželjena pošta
...
toolbar-add-address-book-label = Dodaj adresar
