...
download-headers-info-text = Za ovu interesnu grupu postoji { $count } novih zaglavlja poruka za preuzeti.
...
enter-news-credentials-title = Potrebno korisničko ime i lozinka za poslužitelj interesnih grupa
# Variables:
