...
looking-for-messages-account = Traženje novih poruka za { $accountName }…
# Feedback message shown in the status bar while we look for new messages in a
# specific folder.
# Variables:
# $folderName (String) - The folder's name.
looking-for-messages-folder = Traženje novih poruka u { $folderName }…
...
deleting-message =
    { $number ->
        [one] Brisanje { $number } poruke iz { $folderName }…
        [few] Brisanje { $number } poruke iz { $folderName }…
       *[other] Brisanje { $number } poruka iz { $folderName }…
    }
