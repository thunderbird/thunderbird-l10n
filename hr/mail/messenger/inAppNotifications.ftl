...
in-app-notification-instructions =
    { PLATFORM() ->
        [macos] Pritisnite ⌥+Shift+{ -in-app-notification-accesskey } za skok na obavijest
       *[other] Pritisnite Alt+Shift+{ -in-app-notification-accesskey } za skok na obavijest
    }
