...
quick-filter-bar-tag-mode-none =
    .label = Само немаркирани
    .title = Само съобщения без етикети
...
folder-pane-header-toggle-full-path =
    .label = Показване на пълния път
folder-pane-header-hide-local-folders =
    .label = Скриване на локални папки
folder-pane-mode-header-all = Всички папки
folder-pane-mode-header-unread = Непрочетени папки
...
folder-pane-context-compact =
    .label =
        { $count ->
            [1] Уплътняване на папкa
            [one] Уплътняване на папкa
