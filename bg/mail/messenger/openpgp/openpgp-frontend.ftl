...
openpgp-cannot-decrypt-because-mdc =
    Това е криптирано съобщение, което използва стар и уязвим механизъм.
...
openpgp-partially-encrypted =
    ...
    Ако щракнете върху бутона за дешифриране, ще се покаже съдържанието на криптираните части.
