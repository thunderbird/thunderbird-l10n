...
e2e-intro-description = За да изпращате шифровани или цифрово подписани съобщения, трябва да конфигурирате технология за криптиране, OpenPGP или S/MIME.
...
e2e-sign-message =
    .label = Подписване на некриптирани съобщения
    .accesskey = П
e2e-disable-enc =
