...
account-hub-email-label = Електронен адрес:
    .accesskey = Е
account-hub-email-input =
    .placeholder = ivan.ivanov@example.com
account-hub-email-warning-icon =
    .title = Недействителен адрес на ел. поща
account-hub-password-label = Парола
    .accesskey = П
    .title = Парола
account-hub-remember-password = Запазване на паролата
    .accesskey = З
account-hub-exchange-label = Потребителско име
    .accesskey = П
account-hub-installing-addon = Добавката се изтегля и инсталира...
account-hub-success-addon = Добавката е инсталирана успешно.
account-hub-success-half-manual = Следните настройки бяха открити при запитване на този сървър:
account-hub-result-security-no-encryption = Без шифроване
    .title = Без шифроване
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = Без шифроване
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = Грешка при удостоверяване. Моля, проверете потребителското име и паролата.
...
account-hub-exchange-config-unverifiable = Конфигурацията не можа да бъде потвърдена. Ако вашето потребителско име и парола са правилни, вероятно администраторът на сървъра е деактивирал избраната конфигурация за вашия профил. Опитайте да изберете друг протокол.
account-hub-advanced-setup-button = Разширени настройки
    .accesskey = Р
# Variables:
#  $domain (String): The name of the server where the configuration was found, e.g. rackspace.com.
account-hub-exchange-dialog-question = { -brand-short-name } намери информация за настройка на вашия профил на { $domain }. Искате ли да продължите и да изпратите идентификационните си данни?
account-hub-creation-error-title = Грешка при създаване на профил
account-hub-error-server-exists = Входящият съръвр вече съществува.
account-hub-confirm-advanced-title = Потвърдете разширените настройки
account-hub-confirm-advanced-description = Този диалогов прозорец ще бъде затворен и ще бъде създаден профил с текущите настройки, дори ако конфигурацията е неправилна. Искате ли да продължите?
account-hub-addon-install-title = Инсталиране
account-hub-encryption-button = Шифроване от край до край
account-hub-address-books-button = Адресници
...
account-hub-select-security-warning = <span data-l10n-name="error-text">Внимание: Засечен е незащитен имейл сървър.</span> Този сървър не е шифрован, което излага на показ паролата и данните ви. Свържете се с администратора си, за да защити връзката или продължете на свой собствен риск. <a data-l10n-name="error-link">Вижте често задавани въпроси за повече детайли.</a>
