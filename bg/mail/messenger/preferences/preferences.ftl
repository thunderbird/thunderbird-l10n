...
qr-export-description = Бързо прехвърлете настройките на профила си от настолен компютър към мобилен телефон, като генерирате QR. Изберете кои пробили да включите, решете дали искате да прехвърлите паролата си и сканирайте кода с мобилното си устройство. Бързо, сигурно и лесно.
...
qr-export-create = Създайте QR, за да изнесете профилите си
