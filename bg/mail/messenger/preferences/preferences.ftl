...
privacy-spam-header = Нежелана поща
...
draw-in-titlebar-label =
    .label = Скриване на лента със заглавието на прозореца
    .accesskey = з
...
address-display-full =
    .label = Цялото име и електронен адрес
    .accesskey = Ц
address-display-email =
    .label = Само електронен адрес
    .accesskey = е
...
exceptions-button =
    .label = Изключения…
    .accesskey = з
remote-content-privacy-info = Научете повече за проблемите с личните данни и отдалеченото съдържание
remote-content-info =
...
spam-description = Установете началните настройки за нежеланите писма. Специфичните за всеки профил настройки могат да бъдат направени в Настройки на профила.
spam-marked-label =
    .label = Когато писмата са маркирани като нежелани:
    .accesskey = н
spam-move-label =
    .label = Преместете ги в папката „Нежелана поща“.
    .accesskey = Н
spam-delete-label =
    .label = Изтрийте ги
    .accesskey = И
...
preferences-doh-default-detailed-desc-1 = Използва защитен DNS в региони, където е наличен
...
preferences-doh-enabled-detailed-desc-1 = Използване на избран от вас доставчик
...
preferences-doh-strict-detailed-desc-1 = Използване само на избраният от вас доставчик
...
preferences-doh-checkbox-warn =
    ...
    .accesskey = п
preferences-doh-select-resolver = Избор на доставчик:
# Variables:
