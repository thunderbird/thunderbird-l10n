...
chat-encryption-log =
    .label = Включете криптирани от край до край съобщения в регистрационните файлове на разговорите
chat-encryption-label = Нативно шифроване от край до край
# Variables:
# $protocol (String) - Name of the chat protocol. Example: Matrix
chat-encryption-description = { $protocol } осигурява криптиране от край до край за съобщения в чат. Това не позволява на трети страни да подслушват разговорa. Може да е необходима допълнителна настройка по-долу, за да работи шифроването.
