...
community-exp =
    ...
    { -vendor-short-name }</a>
     е <a data-l10n-name="community-exp-credits-link">
    глобална, сплотена общност</a>
    , работеща за една отворена и общодостъпна Мрежа.
community-2 =
    { -brand-short-name } е разработен от <a data-l10n-name="community-mozilla-link">
    { -vendor-short-name }</a>
    , <a data-l10n-name="community-credits-link">
    глобална, сплотена общност</a>
    , работеща за една отворена и общодостъпна Мрежа.
about-helpus =
    Искате да помогнете? <a data-l10n-name="helpus-donate-link">
    Направете дарение</a> or <a data-l10n-name="helpus-get-involved-link">
    се включете и вие!</a>
