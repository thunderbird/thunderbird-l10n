...
looking-for-messages-account = Търсене на нови съобщения за { $accountName }…
# Feedback message shown in the status bar while we look for new messages in a
# specific folder.
# Variables:
# $folderName (String) - The folder's name.
looking-for-messages-folder = Търсене на нови съобщения в { $folderName }…
...
deleting-message =
    { $number ->
        [one] Изтриване на едно съобщение от { $folderName }…
       *[other] Изтриване на { $number } съобщения от { $folderName }…
    }
# Feedback message shown in the status bar while we're deleting messages in a
# specific folder (and waiting for the remote operation to complete).
# Variables:
# $number (Number) - Number of messages being deleted.
# $folderName (String) - The folder's name.
deleting-messages = Изтриване на { $number } съобщения от { $folderName }…
