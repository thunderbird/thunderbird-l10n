...
filelink-description = { -brand-short-name } ви позволява да настроите удобен облачен акаунт за файлова връзка за лесно изпращане на големи прикачени файлове.
...
import-title = Вмасяне от друга програма
