...
calendar-task-input-filter-field =
    .aria-label = Φιλτράρισμα εργασιών
...
calendar-search-options-searchfor =
    .value = { " " }που περιέχουν
calendar-properties-dialog-title = Επεξεργασία ημερολογίου
calendar-server-dialog-name-label =
    .value = Όνομα ημερολογίου:
calendar-publish-dialog-window-title = Δημοσίευση ημερολογίου
calendar-publish-url-label = URL δημοσίευσης
calendar-publish-publish-dialog-button =
    .buttonlabelaccept = Δημοσίευση
...
calendar-error-description =
    .value = Περιγραφή:
calendar-error-prompt-title = Προέκυψε σφάλμα
