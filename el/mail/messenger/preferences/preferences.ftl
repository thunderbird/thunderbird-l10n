...
general-email-notifications-header = Ειδοποιήσεις email
...
general-network-and-storage-header = Δίκτυο και αποθήκευση
general-search-performance-label = Αναζήτηση και επιδόσεις
compose-writing-emails-header = Σύνταξη email
...
compose-message-formatting-title = Μορφοποίηση μηνυμάτων
compose-address-autocomplete-header = Αυτόματη συμπλήρωση διευθύνσεων
...
collection-improve-header = Δεδομένα που συλλέγονται για τη βελτίωση του { -brand-short-name }
collection-privacy-policy = Διαβάστε την πολιτική απορρήτου μας
...
privacy-security-certificates-title = Πιστοποιητικά ασφαλείας
...
choose-display-language-description = Επιλέξτε τη γλώσσα στην οποία θα εμφανίζονται τα μενού, τα κουμπιά και οι ειδοποιήσεις.
...
manual-storage-limit-label =
    .label = Χειροκίνητος ορισμός ορίων αποθήκευσης για προσωρινά αρχεία
    .accesskey = μ
clear-temp-files-button =
    .label = Απαλοιφή προσωρινών αρχείων
    .accesskey = φ
clear-temp-files-shutdown-label =
    .label = Απαλοιφή προσωρινών αρχείων κατά το κλείσιμο του { -brand-short-name }
    .accesskey = σ
...
show-start-page-label =
    .label = Εμφάνιση της αρχικής σελίδας κατά την εκκίνηση του { -brand-short-name }
    .accesskey = δ
start-page-label =
...
new-email-alert-label =
    .label = Εμφάνιση ειδοποίησης για νέα email
    .accesskey = σ
customize-alerts-label =
    .label = Προσαρμογή ειδοποιήσεων…
    .accesskey = Π
...
use-custom-sound-label =
    .label = Χρήση προσαρμοσμένου ήχου για ειδοποιήσεις
    .accesskey = Χ
mail-select-audio-button =
    .label = Επιλογή ήχου…
    .accesskey = χ
enable-global-search-label =
    .label = Ενεργοποίηση της αναζήτησης σε όλους τους λογαριασμούς email
    .accesskey = ε
gloda-results-plain-list-label =
    .label = Εμφάνιση των αποτελεσμάτων αναζήτησης ως απλής λίστας
    .accesskey = λ
...
gloda-show-results-as-list-label =
    .label = Εμφάνιση καθολικών αποτελεσμάτων αναζήτησης σε μορφή λίστας από προεπιλογή
    .accesskey = λ
datetime-formatting-legend = Μορφή ημερομηνίας και ώρας
display-language-legend = Γλώσσα εμφάνισης
allow-graphics-accel =
    .label = Χρήση επιτάχυνσης γραφικών για ομαλότερη κύλιση και επιδόσεις
    .accesskey = η
storage-format-label =
    .value = Μορφή αποθήκευσης για νέους λογαριασμούς:
    .accesskey = Μ
mbox-store-single-label =
    .label = Ένα αρχείο ανά φάκελο (mbox)
...
enable-autoscroll-label =
    .label = Ενεργοποίηση αυτόματης κύλισης
    .accesskey = γ
autoscroll-label =
...
hide-titlebar-label =
    .label = Απόκρυψη γραμμής τίτλου
    .accesskey = η
hide-titlebar-description = Αφαιρεί την επάνω γραμμή που εμφανίζει το όνομα του παραθύρου για εξοικονόμηση χώρου στην οθόνη
hide-tabbar-single-tab-label =
    .label = Απόκρυψη της γραμμής καρτελών όταν μόνο μία καρτέλα είναι ανοικτή
    .accesskey = τ
auto-hide-tabbar-second-tab-description = Αποκρύπτει αυτόματα τις καρτέλες μέχρι να ανοίξετε μια δεύτερη.
system-settings-legend = Ρυθμίσεις συστήματος
...
update-settings-title = Ρυθμίσεις ενημερώσεων
install-updates-automatically-label =
    .label = Αυτόματη εγκατάσταση ενημερώσεων (συνιστάται)
    .accesskey = Α
install-updates-automatically-description = Διατηρεί το { -brand-short-name } ασφαλές με τις πιο πρόσφατες διορθώσεις ασφαλείας.
check-updates-ask-label =
    .label = Έλεγχος για ενημερώσεις, αλλά ερώτηση πριν από την εγκατάσταση
    .accesskey = γ
...
connection-config-description = Ρυθμίστε τον τρόπο σύνδεσης του { -brand-short-name } στο διαδίκτυο.
connection-options-button =
    .label = Επιλογές σύνδεσης…
    .accesskey = σ
offline-mode-legend = Λειτουργία εκτός σύνδεσης
offline-settings-label = Ρυθμίσεις εκτός σύνδεσης
...
offline-settings-button =
    ...
    .accesskey = Ε
temporary-storage-legend = Προσωρινή αποθήκευση
offline-compact-remove-deleted =
    .label = Αφαίρεση δεδομένων από φακέλους που έχουν ήδη διαγραφεί, για εξοικονόμηση χώρου
    .accesskey = α
offline-compact-ask-cleanup =
    .label = Ερώτηση πριν από την εκκαθάριση φακέλων
    .accesskey = θ
...
use-cache-before =
    .value = Χρήση έως
    .accesskey = Χ
use-temp-storage-after = MB χώρου για προσωρινά αρχεία
use-cache-after = MB χώρου για την προσωρινή μνήμη

##

smart-cache-label =
    .label = Παράκαμψη αυτόματης διαχείρισης προσωρινής μνήμης
    .accesskey = ψ
clear-cache-button =
    .label = Απαλοιφή τώρα
    .accesskey = π
...
customize-fonts-button =
    .label = Προσαρμογή γραμματοσειρών…
    .accesskey = μ
font-options-button =
    .label = Σύνθετα…
    .accesskey = Σ
...
display-name-only-label =
    .label = Εμφάνιση μόνο του εμφανιζόμενου ονόματος για επαφές που είναι αποθηκευμένες στο ευρετήριο
    .accesskey = Ε
...
show-conversation-view-label =
    .label = Χρήση προβολής συνομιλίας
    .accesskey = σ
conversation-view-preview-description = Η συγκεκριμένη λειτουργία βρίσκεται σε πρώιμο στάδιο. Ομαδοποιεί τα σχετικά μηνύματα, αλλά ενδέχεται να μην λειτουργεί πάντα όπως πρέπει.
...
dark-mode-message-appearance = Εμφάνιση μηνυμάτων
dark-mode-checkbox-label =
    .label = Χρήση σκουρόχρωμης λειτουργίας για το κείμενο των μηνυμάτων
    .accesskey = χ
dark-mode-message-text-description = Εφαρμόζει σκούρο φόντο σε όλα τα εισερχόμενα μηνύματα, ακόμα κι αν ο αποστολέας χρησιμοποίησε ανοιχτόχρωμη μορφοποίηση.
...
dark-message-mode-toggle-label =
    ...
    .accesskey = φ
dark-mode-toggle-description = Επιτρέπει τη γρήγορη εναλλαγή ενός email σε ανοιχτόχρωμη λειτουργία κατά την ανάγνωση, χωρίς να αλλάξετε τις κύριες ρυθμίσεις σας.
general-folder-settings-header = Ρυθμίσεις φακέλων
recent-folders-legend = Πρόσφατοι φάκελοι
recent-folders-description = Ελέγχει τον τρόπο εμφάνισης των πρόσφατα χρησιμοποιημένων φακέλων κατά τη μετακίνηση μηνυμάτων.
...
general-folder-options-header = Επιλογές διαχείρισης φακέλων
recent-destinations-legend = Πρόσφατοι προορισμοί
recent-destinations-description = Επιλογές παράθεσης και ταξινόμησης φακέλων στους οποίους μετακινήθηκαν πρόσφατα μηνύματα.
recent-sort-order-label = Σειρά ταξινόμησης:
    .accesskey = Σ
recent-sort-order-mru =
    .label = Πιο πρόσφατα
recent-sort-order-alphabetic =
    .label = Αλφαβητική
max-recent-label = Μέγιστος αριθμός πρόσφατων φακέλων:
    .accesskey = Μ
...
account-hub-manual-config-checkbox-label =
    .label = Χρήση της νέας διαδικασίας χειροκίνητης ρύθμισης στο Κέντρο λογαριασμών
    .accesskey = ρ
account-hub-manual-config-checkbox-description = Νέα διαδικασία χειροκίνητης ρύθμισης κέντρου λογαριασμών
new-calendar-legend = Νέος διάλογος ημερολογίου για εκδηλώσεις
new-calendar-checkbox-label =
    .label = Προβολή εκδηλώσεων ημερολογίου στη νέα μορφή διαλόγου
...
as-attachment-label =
    .label = Ως συνημμένο
add-file-type-label =
    .label = Προσθήκη τύπου αρχείου στα συνημμένα μηνύματα
    .accesskey = ε
extension-label =
    .label = Προσθήκη επέκτασης στο όνομα αρχείου
    .accesskey = χ
forward-messages-label =
    .value = Προώθηση μηνυμάτων ως:
    .accesskey = Π
forward-inline-label =
    .label = Εντός του μηνύματος (ενσωμάτωση)
...
autosave-draft-label =
    .label = Αυτόματη αποθήκευση προσχεδίου κάθε
    .accesskey = Α
...
ignore-sender-styles-label =
    .label = Παράβλεψη γραμματοσειρών και χρωμάτων αποστολέα
    .accesskey = β
...
paragraph-spacing-label =
    .label = Πατώντας το Enter, δημιουργείται μια νέα παράγραφος με μεγαλύτερο διάστιχο
    .accesskey = Π
...
compose-format-automatic-option =
    .label = Αυτόματα (συνιστάται)
compose-format-automatic-description = Αποστολή μορφοποιημένου κειμένου όταν προσθέτετε μορφοποίηση (όπως έντονη γραφή ή συνδέσμους) ή απλού κειμένου όταν δεν το κάνετε.
compose-format-both-option =
    .label = Εμπλουτισμένο κείμενο (HTML) και απλό κείμενο
compose-format-both-description = Αποστέλλει πάντα και τις δύο εκδόσεις, ώστε η εφαρμογή email του παραλήπτη να επιλέγει ποια θα προβάλει.
compose-format-html-option =
    .label = Μόνο εμπλουτισμένο κείμενο (HTML)
compose-format-html-description = Διατηρεί τις προσαρμοσμένες γραμματοσειρές, τα χρώματα και τις εικόνες, αλλά ορισμένες παλαιότερες εφαρμογές email ενδέχεται να μην τα εμφανίζουν σωστά.
compose-format-plain-option =
    .label = Μόνο απλό κείμενο
compose-format-plain-description = Αφαιρεί κάθε μορφοποίηση, χρώματα και εικόνες. Ιδανική επιλογή για απλά email κειμένου που εμφανίζονται σωστά παντού.
autocomplete-matches-description = Κατά την πληκτρολόγηση του ονόματος ή της διεύθυνσης email ενός παραλήπτη, αναζήτηση αντιστοιχιών σε:
company-network-directory-label =
    .label = Κατάλογος εταιρείας ή δικτύου
    .accesskey = Κ
...
autocomplete-description = Κατά τη διευθυνσιοδότηση μηνυμάτων, αναζήτηση για αντίστοιχες καταχωρίσεις σε:
ab-label =
...
manage-directories-label =
    .label = Διαχείριση καταλόγων…
    .accesskey = ε
collect-outgoing-label =
    .label = Αυτόματη αποθήκευση των διευθύνσεων email των παραληπτών σε:
    .accesskey = Α
collect-outgoing-description = Η τοποθεσία αποθήκευσης των νέων επαφών που δημιουργούνται χειροκίνητα ή προστίθενται από email.
save-added-contacts-label =
    .value = Αποθήκευση επαφών που προστέθηκαν χειροκίνητα σε:
    .accesskey = φ
save-added-contacts-description = Η τοποθεσία αποθήκευσης των νέων επαφών από email.
show-directory-startup-label =
    .value = Εμφάνιση καταλόγου στο παράθυρο του ευρετηρίου κατά την εκκίνηση του { -brand-short-name }
    .accesskey = σ
...
email-picker-label =
    ...
    .accesskey = τ
email-picker-description = Η τοποθεσία των νέων επαφών που αποθηκεύονται από τα απεσταλμένα μηνύματα.
default-add-address-book-label =
    .value = Προεπιλεγμένο ευρετήριο για χειροκίνητη προσθήκη επαφών:
    .accesskey = Π
default-add-address-book-description = Η τοποθεσία των νέων επαφών που αποθηκεύονται από τα ληφθέντα μηνύματα.
...
attachment-label =
    ...
    .accesskey = γ
edit-keywords-label =
    .label = Επεξεργασία λέξεων-κλειδιών…
    .accesskey = κ
offer-share-large-files-label =
    .label = Πρόταση για κοινοποίηση των αρχείων μέσω συνδέσμου όταν αυτά ξεπερνούν:
...
spam-move-folder-label =
    .label = Μετακίνηση στον φάκελο «Ανεπιθύμητα»
    .accesskey = ο
spam-delete-immediately-label =
    .label = Άμεση διαγραφή
    .accesskey = δ
spam-move-label =
...
spam-delete-label =
    .label = Διαγραφή
    .accesskey = Δ
spam-read-description = Επισήμανση μηνυμάτων ως αναγνωσμένων
...
search-preferences-input2 =
    ...
    .style = width: 15.4em
managed-by-organization-notice = Το { -brand-short-name } ρυθμίζεται από έναν οργανισμό.
managed-notice = Το { -brand-short-name } ρυθμίζεται από τον οργανισμό σας.
...
accent-color-legend = Χρώμα έμφασης
accent-color-selection-label =
    .value = Επιλέξτε χρώμα για τα κύρια κουμπιά και τις επισημάνσεις
accent-color-label =
    .value = Καθορίστε το χρώμα για τα κύρια κουμπιά και τα επισημασμένα στοιχεία:
accent-color-os =
    .label = Χρώμα λειτουργικού συστήματος
accent-color-thunderbird =
    .label = Μπλε του Thunderbird
accent-color-purple =
    .label = Μοβ
accent-color-orange =
    .label = Πορτοκαλί
...
accent-color-teal =
    .label = Teal
accent-color-disabled-description = Τα χρώματα έμφασης δεν υποστηρίζονται στη λειτουργία υψηλής αντίθεσης.
default-message-list-legend = Λίστα μηνυμάτων
appearance-view-style-select =
    .value = Επιλέξτε τρόπο προβολής:
...
card-view-options-legend = Επιλογές προβολής καρτών
...
default-message-list-new-folders-description = Καθορίστε τις προεπιλογές ταξινόμησης και προβολής σε νήμα για τους νέους φακέλους
...
default-sort-by-label = Ταξινόμηση μηνυμάτων κατά:
...
default-sort-newest-bottom =
    .label = Νεότερα μηνύματα στο κάτω μέρος
default-sort-new-messages-top =
    .label = Νεότερα μηνύματα στο πάνω μέρος
apply-view-settings-label = Εφαρμογή ρυθμίσεων προβολής σε:
apply-view-settings-to-all-folders-button =
    .label = Όλους τους φακέλους και τους υποφακέλους
    .accesskey = α
select-apply-sort-folders-button =
    .label = Επιλογή φακέλων
    .accesskey = Ε
