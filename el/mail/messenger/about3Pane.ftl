...
folder-pane-header-toggle-full-path =
    .label = Εμφάνιση πλήρους διαδρομής
folder-pane-header-hide-local-folders =
    .label = Απόκρυψη τοπικών φακέλων
folder-pane-mode-header-all = Όλοι οι φάκελοι
folder-pane-mode-header-unread = Μη αναγνωσμένοι φάκελοι
folder-pane-mode-header-favorite = Αγαπημένοι φάκελοι
folder-pane-mode-header-recent = Πρόσφατοι φάκελοι
folder-pane-mode-header-smart = Ενοποιημένοι φάκελοι
folder-pane-mode-header-tags = Ετικέτες
