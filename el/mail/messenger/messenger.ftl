...
no-reply-message = Η διεύθυνση απάντησης ({ $email }) δεν φαίνεται να είναι εποπτευόμενη διεύθυνση. Τα μηνύματα προς αυτήν την διεύθυνση πιθανότατα δεν θα διαβαστούν από κανέναν.
