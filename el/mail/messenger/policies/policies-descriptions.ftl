...
policy-DisableMessageForwardingFilters = Αποτροπή της αυτόματης προώθησης μηνυμάτων από τα φίλτρα.
...
policy-DisableExperimentalFeatures = Απενεργοποίηση των πειραματικών λειτουργιών στο Thunderbird.
policy-DisableQRExport = Απενεργοποίηση της δημιουργίας κωδικού QR για εξαγωγή ρυθμίσεων και διαπιστευτηρίων λογαριασμών.
...
policy-DisableUpdateSettings = Αποτροπή της αλλαγής των ρυθμίσεων ενημέρωσης της εφαρμογής από τον χρήστη.
...
policy-InAppNotification = Ενεργοποίηση ή απενεργοποίηση τύπων ειδοποιήσεων.
...
policy-LegacySameSiteCookieBehaviorEnabled = Ενεργοποίηση προεπιλεγμένης ρύθμισης της παλαιάς συμπεριφοράς «SameSite» για cookie.
...
policy-PromptForDownloadLocation = Ερώτηση για την τοποθεσία αποθήκευσης των αρχείων κατά τη λήψη.
