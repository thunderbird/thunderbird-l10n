...
toolbar-spam-label = Ανεπιθύμητο
toolbar-spam =
    .title = Επισήμανση επιλεγμένων μηνυμάτων ως ανεπιθύμητων
toolbar-not-spam-label = Επιθυμητό
toolbar-not-spam =
    .title = Επισήμανση επιλεγμένων μηνυμάτων ως επιθυμητών
...
toolbar-compact-label = Συμπίεση
toolbar-compact =
...
toolbar-add-address-book-label = Προσθήκη ευρετηρίου
