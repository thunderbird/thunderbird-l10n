...
webext-perms-description-messages-send = Αυτοματοποιημένη, μαζική αποστολή μηνυμάτων email εκ μέρους σας, χωρίς καμία οπτική ανατροφοδότηση. Χρησιμοποιήστε τη Διαχείριση δραστηριοτήτων για να ελέγξετε το ιστορικό αποστολών του προσθέτου.
webext-perms-description-messages-save = Αυτοματοποιημένη αποθήκευση μηνυμάτων email ως πρόχειρων ή προτύπων, χωρίς τη δική σας αλληλεπίδραση
