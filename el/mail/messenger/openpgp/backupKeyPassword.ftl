...
set-password-reminder = <b>Σημαντικό!</b> Αν ξεχάσετε τον κωδικό πρόσβασης του αντιγράφου ασφαλείας του ιδιωτικού σας κλειδιού, δε θα μπορείτε να επαναφέρετε το αντίγραφο ασφαλείας στο μέλλον. Σημειώστε τον και αποθηκεύστε τον σε ασφαλές μέρος.
