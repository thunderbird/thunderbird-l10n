...
key-wizard-warning = <b>Αν διαθέτετε ήδη ένα προσωπικό κλειδί</b> για αυτήν τη διεύθυνση email, θα πρέπει να το εισαγάγετε. Διαφορετικά, δεν θα έχετε πρόσβαση στα αρχεία των κρυπτογραφημένων email σας, ούτε θα μπορείτε να διαβάζετε εισερχόμενα κρυπτογραφημένα email από άτομα που χρησιμοποιούν το υπάρχον κλειδί σας.
...
openpgp-keygen-import-complete =
    .label = Κλείσιμο
    .accesskey = Κ
openpgp-keygen-missing-username = Δεν έχει οριστεί όνομα για τον τρέχοντα λογαριασμό. Εισαγάγετε μια τιμή στο πεδίο «Το όνομά σας» στις ρυθμίσεις του λογαριασμού.
openpgp-keygen-long-expiry = Δεν μπορείτε να δημιουργήσετε ένα κλειδί που λήγει σε περισσότερα από 100 έτη.
...
openpgp-external-key-warning = <b>Μπορείτε να ρυθμίσετε μόνο ένα εξωτερικό κλειδί GnuPG.</b> Η προηγούμενή σας καταχώριση θα αντικατασταθεί.
