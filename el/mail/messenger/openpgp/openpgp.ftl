...
openpgp-key-man-please-wait-tooltip =
    .label = Περιμένετε όσο φορτώνονται τα κλειδιά…
...
wkd-message-body-req =
    ...
    Κάντε επιβεβαίωση για να ολοκληρώσετε τη δημοσίευση του δημόσιου κλειδιού σας.
...
key-man-loading-keys = Φόρτωση κλειδιών, περιμένετε…
...
keygen-missing-user-name = Δεν έχει καθοριστεί όνομα για τον επιλεγμένο λογαριασμό/ταυτότητα. Εισαγάγετε μια τιμή στο πεδίο «Το όνομά σας» στις ρυθμίσεις του λογαριασμού.
...
msg-compose-internal-error = Προέκυψε εσωτερικό σφάλμα.
