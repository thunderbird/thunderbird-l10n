...
tree-list-view-row-expand-thread-button =
    .aria-label = Ανάπτυξη νήματος
tree-list-view-row-collapse-thread-button =
    .aria-label = Σύμπτυξη νήματος
...
tree-list-view-row-read-status =
    .alt = Ένδειξη κατάστασης αναγνωσμένου
    .title = Αναγνωσμένο μήνυμα
tree-list-view-row-not-read-status =
    .alt = Ένδειξη κατάστασης μη αναγνωσμένου
    .title = Μη αναγνωσμένο μήνυμα
