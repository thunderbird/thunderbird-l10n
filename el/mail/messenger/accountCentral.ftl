...
address-book-add-label = Ευρετήριο διευθύνσεων
    .aria-label = Προσθήκη ευρετηρίου διευθύνσεων
...
import-paragraph2 = Το { -brand-short-name } σάς επιτρέπει να εισαγάγετε μηνύματα email, καταχωρίσεις ευρετηρίων, συνδρομές ροών, προτιμήσεις ή/και φίλτρα από άλλα προγράμματα email και συνηθισμένες μορφές ευρετηρίων.
...
about-paragraph-consider-donation = <b>Το Thunderbird χρηματοδοτείται από χρήστες σαν εσάς! Αν σας αρέσει το Thunderbird, σκεφτείτε να κάνετε μια δωρεά.</b> Ο καλύτερος τρόπος για να εξασφαλίσετε ότι το Thunderbird θα παραμείνει διαθέσιμο, είναι να <a data-l10n-name="donation-link">κάνετε μια δωρεά</a>.
