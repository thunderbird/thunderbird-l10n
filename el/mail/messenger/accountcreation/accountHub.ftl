...
account-hub-servers-username-label = Όνομα χρήστη:
account-hub-result-server-label = Διακομιστής:
account-hub-result-port-label = Θύρα:
account-hub-result-security-label = Ασφάλεια:
account-hub-result-authentication-type-label = Ταυτοποίηση:
account-hub-result-authentication-none = Καμία
    .title = Καμία
account-hub-result-authentication-password = Κανονικός κωδικός πρόσβασης
    .title = Κανονικός κωδικός πρόσβασης
account-hub-result-authentication-encrypted-password = Κρυπτογραφημένος κωδικός πρόσβασης
    .title = Κρυπτογραφημένος κωδικός πρόσβασης
account-hub-result-authentication-gssapi = Kerberos
    .title = Kerberos
account-hub-result-authentication-ntlm = NTLM
    .title = NTLM
account-hub-result-authentication-external = Εξωτερική
    .title = Εξωτερική
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = Καμία
account-hub-result-auth-password = Κανονικός κωδικός πρόσβασης
account-hub-result-auth-encrypted-password = Κρυπτογραφημένος κωδικός πρόσβασης
account-hub-result-auth-gssapi = Kerberos
account-hub-result-auth-ntlm = NTLM
account-hub-result-auth-external = Εξωτερική
...
account-hub-exchange-service-url-label = Εισαγάγετε το URL της υπηρεσίας
...
account-hub-privacy-policy = Πολιτική απορρήτου
account-hub-welcome = Καλώς ορίσατε στο
account-hub-welcome-brand = { -brand-short-name }
account-hub-welcome-text = Καλώς ορίσατε στο { -brand-short-name }
account-hub-name-warning-icon =
    .title = Eισαγάγετε το όνομά σας
account-hub-email-label = Διεύθυνση email
    .accesskey = Δ
...
account-hub-result-security-no-encryption = Χωρίς κρυπτογράφηση
    .title = Χωρίς κρυπτογράφηση
...
account-hub-credentials-wrong = Η ταυτοποίηση απέτυχε. Ελέγξτε το όνομα χρήστη και τον κωδικό πρόσβασης
...
account-hub-address-books-button = Ευρετήρια
account-hub-calendars-button = Ημερολόγια
...
account-hub-result-graph-api-description = Χρησιμοποιήστε το Microsoft Graph API για συγχρονισμό των φακέλων και των email σας με το Microsoft 365
account-hub-result-graph-shortname = Exchange (Graph)
account-hub-result-graph-description = Χρησιμοποιήστε το Microsoft Graph API για συγχρονισμό των φακέλων και των email σας
...
account-hub-config-success-title = Βρέθηκαν αυτόματα ρυθμίσεις λογαριασμού.
account-hub-config-success-description-db = Βρέθηκε διαμόρφωση στο Mozilla ISPDB.
account-hub-config-success-description-exchange = Βρέθηκε διαμόρφωση για διακομιστή Microsoft Exchange.
account-hub-config-success-description-guess = Βρέθηκε διαμόρφωση μέσω δοκιμής κοινών ονομάτων διακομιστή.
account-hub-config-success-description-disk = Βρέθηκε διαμόρφωση στην εγκατάσταση του { -brand-short-name }.
...
account-hub-select-security-warning = <span data-l10n-name="error-text">Προειδοποίηση: Εντοπίστηκε επισφαλής διακομιστής αλληλογραφίας.</span> Αυτός ο διακομιστής δεν διαθέτει κρυπτογράφηση, με αποτέλεσμα να εκθέτει τους κωδικούς πρόσβασης και τα δεδομένα σας. Επικοινωνήστε με τον διαχειριστή για να ασφαλίσει τη σύνδεση ή συνεχίστε με δική σας ευθύνη. <a data-l10n-name="error-link">Δείτε τις συχνές ερωτήσεις για περισσότερες πληροφορίες.</a>
...
address-book-add-remote-icon2 =
    .alt = Προσθήκη απομακρυσμένου ευρετηρίου
address-book-add-remote-icon =
    .alt = Προσθήκη νέου απομακρυσμένου ευρετηρίου
address-book-add-remote = Προσθήκη απομακρυσμένου ευρετηρίου
address-book-add-remote-carddav-description = Σύνδεση σε ευρετήριο CardDAV
...
address-book-add-ldap-icon2 =
    .alt = Προσθήκη ευρετηρίου LDAP
address-book-add-ldap-button = Προσθήκη ευρετηρίου LDAP
...
account-hub-exchange-type-account-type = Τύπος λογαριασμού
