...
prompt-remove-attachments-title = Usuń załączniki
# LOCALIZATION NOTE (prompt-remove-attachments-text):
#  $count will be replaced with number of attachments
prompt-remove-attachments-text =
    { $count ->
        [one] Czy na pewno usunąć załącznik?
        [few] Czy na pewno usunąć { $count } załączniki?
       *[many] Czy na pewno usunąć { $count } załączników?
    }
...
calendar-context-delete-server =
    .label = Usuń kalendarz…
    .accesskey = U
calendar-context-remove-server =
    .label = Usuń kalendarz…
    .accesskey = U
calendar-context-unsubscribe-server =
    .label = Zrezygnuj z subskrypcji kalendarza…
    .accesskey = Z
calendar-context-publish =
    .label = Publikuj kalendarz…
    .accesskey = P
calendar-context-export =
    .label = Eksportuj kalendarz…
    .accesskey = E
calendar-context-properties =
    .label = Właściwości
    .accesskey = W
calendar-context-showall =
    .label = Pokaż wszystkie kalendarze
    .accesskey = w
...
calendar-context-convert-to-task =
    .label = Zadanie…
    .accesskey = Z
calendar-task-filter-title2 = Filtruj zadania
calendar-task-filter-title = Wyświetl
...
calendar-task-filter-next7days =
    .label = Następne siedem dni
    .accesskey = s
calendar-task-filter-notstarted =
    .label = Nierozpoczęte zadania
    .accesskey = N
...
calendar-task-filter-current =
    .label = Bieżące zadania
    .accesskey = B
calendar-task-details-title = Nazwa:
calendar-task-details-organizer = Od:
calendar-task-details-priority = Priorytet:
calendar-task-details-priority-low = Niski
calendar-task-details-priority-normal = Zwykły
calendar-task-details-priority-high = Wysoki
calendar-task-details-status = Stan:
calendar-task-details-category = Kategoria:
calendar-task-details-repeat = Powtarzaj:
calendar-task-details-attachments = Załączniki:
calendar-task-details-start = Początek:
calendar-task-details-due = Koniec:
calendar-task-mark-completed =
    .label = Oznacz jako ukończone
    .accesskey = n
    .tooltiptext = Oznacz wybrane zadania jako ukończone
calendar-task-change-priority =
    .label = Priorytet
    .accesskey = r
    .tooltiptext = Zmień priorytet
calendar-task-text-filter-field =
    .emptytextbase = Filtruj zadania #1
...
calendar-progress-level-25 =
    .label = Ukończono w 25%
    .accesskey = 2
calendar-progress-level-50 =
    .label = Ukończono w 50%
    .accesskey = 5
calendar-progress-level-75 =
    .label = Ukończono w 75%
    .accesskey = 7
calendar-progress-level-100 =
    .label = Ukończono w 100%
    .accesskey = 1
...
calendar-tasks-view-minimonth =
    .label = Kalendarz podręczny
    .accesskey = K
calendar-tasks-view-calendarlist =
    .label = Lista kalendarzy
    .accesskey = L
calendar-tasks-view-filtertasks =
    .label = Filtruj zadania
    .accesskey = F
...
calendar-properties-refresh =
    .value = Odświeżaj kalendarz:
calendar-properties-refresh-manual =
    .label = ręcznie
calendar-properties-read-only =
    .label = Tylko do odczytu
calendar-properties-show-reminders =
    .label = Wyświetlaj przypomnienia
calendar-properties-offline-support =
    .label = Dostępność offline
calendar-properties-enable-calendar =
    .label = Włącz ten kalendarz
calendar-properties-provider-missing = Nie znaleziono dostawcy dla tego kalendarza. Zdarza się to często, gdy zostały wyłączone lub odinstalowane pewne rozszerzenia.
...
calendar-alarm-snooze-cancel =
    .aria-label = Anuluj przypomnienie
calendar-calendar =
    .label = Kalendarz
    .accesskey = K
calendar-newevent-button =
    .label = Nowe wydarzenie
    .tooltiptext = Utwórz nowe wydarzenie
calendar-newtask-button =
    .label = Nowe zadanie
    .tooltiptext = Utwórz nowe zadanie
calendar-unifinder-show-completed-todos =
    .label = Pokaż ukończone zadania
calendar-display-todos-checkbox =
    .label = Zadania w widoku
    .accesskey = n
calendar-completed-tasks-checkbox =
    .label = Wyświetlaj ukończone zadania
    .accesskey = u
...
calendar-publish-publish-dialog-button =
    .buttonlabelaccept = Opublikuj
calendar-publish-publish-button = Opublikuj
calendar-publish-close-button = Zamknij
calendar-select-dialog-title = Wybierz kalendarz
...
calendar-extract-event-button =
    .label = Dodaj jako wydarzenie
    .tooltiptext = Wyodrębnij informacje o wydarzeniu z wiadomości i dodaj je do kalendarza
