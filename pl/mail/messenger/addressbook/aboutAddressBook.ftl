...
address-book-list =
    .aria-label = Lista książek adresowych
...
about-addressbook-photo-dialog-title =
    .aria-label = Zarządzaj zdjęciem tego kontaktu.
...
ab-search-dialog-matches-found =
    .value =
        { $count ->
            [one] Znaleziono { $count } adres
            [few] Znaleziono { $count } adresy
           *[many] Znaleziono { $count } adresów
        }
