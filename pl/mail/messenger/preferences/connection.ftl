...
http-port-label =
    ...
    .accesskey = P
proxy-https-sharing =
    .label = Użyj tego serwera proxy dla bezpiecznych adresów internetowych (HTTPS)
    .accesskey = x
proxy-http-sharing =
...
proxy-auto-script-url =
    .label = Adres URL skryptu automatycznej konfiguracji:
    .accesskey = A
proxy-type-auto =
...
no-proxy-addresses-label =
    .value = Nie używaj serwera proxy dla tych adresów:
    .accesskey = d
no-proxy-label =
