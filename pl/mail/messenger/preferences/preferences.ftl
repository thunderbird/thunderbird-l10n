...
update-application-background-enabled =
    .label = Kiedy program { -brand-short-name } nie jest włączony
    .accesskey = K
...
dark-message-mode-checkbox-label =
    ...
    .accesskey = c
dark-message-mode-checkbox-description = Eksperymentalna funkcja dostosowująca treść wiadomości do ciemnych motywów
dark-message-mode-toggle-label =
    .label = Pokaż przełącznik trybu ciemnego wiadomości
    .accesskey = P
dark-message-mode-toggle-description = Pokaż przełącznik w nagłówku wiadomości, aby szybko wyłączyć tryb ciemny wiadomości
