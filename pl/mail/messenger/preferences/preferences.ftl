...
mail-play-button =
    .label = Odtwórz
    .accesskey = r
change-dock-icon-description = Plakietki programu i powiadomienia
...
use-custom-sound-label =
    .label = Użyj niestandardowego dźwięku dla alertów
    .accesskey = d
...
edit-defaults-apps-button =
    .label = Edytuj ustawienia domyślne…
    .accesskey = u
...
spellcheck-while-typing-label =
    .label = Sprawdzaj pisownię podczas pisania
    .accesskey = S
...
autocomplete-matches-description = Podczas wpisywania imienia i nazwiska lub adresu e-mail odbiorcy wyszukuj pasujące wyniki w:
company-network-directory-label =
    .label = Katalog firm lub sieci
    .accesskey = K
directory-server-label =
    .label = Serwer usług katalogowych
    .accesskey = S
