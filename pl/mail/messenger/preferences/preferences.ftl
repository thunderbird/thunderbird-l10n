...
general-email-notifications-header = Powiadomienia e-mailowe
...
general-files-and-attachment-description = Wybierz pliki, które chcesz zapisywać, oraz miejsce ich zapisu na komputerze.
general-tags-header = Etykiety
general-reading-and-viewing-header = Czytanie i wyświetlanie
general-reading-and-display-header = Czytanie i wyświetlanie
general-updates-header = Aktualizacje
general-network-and-storage-header = Sieć i miejsce na dysku
general-search-performance-label = Wyszukiwanie i wydajność
compose-writing-emails-header = Pisanie wiadomości e-mail
...
compose-message-formatting-title = Formatowanie wiadomości
compose-address-autocomplete-header = Autouzupełnianie adresu
...
collection-community-description = { -brand-short-name } powstaje dzięki globalnej społeczności. Udostępniając anonimowe dane o  wydajności, pomagasz nam szybciej usuwać błędy i przyspieszać działanie programu dla wszystkich.
...
collection-share-performance =
    .label = Udostępniaj programowi { -vendor-short-name } anonimowe dane o wydajności
    .accesskey = r
collection-share-performance-description = (Obejmuje podstawowe informacje techniczne, takie jak system operacyjny, użycie pamięci i aktywność funkcji. { -brand-short-name } nigdy nie gromadzi treści wiadomości e-mail, kontaktów ani wiadomości osobistych.)
...
collection-share-crash-data =
    .label = Wysyłaj anonimowe raporty o awariach do { -vendor-short-name }
    .accesskey = c
...
privacy-security-certificates-title = Certyfikaty bezpieczeństwa
...
choose-display-language-description = Wybierz język menu, przycisków i powiadomień.
...
manual-storage-limit-label =
    .label = Ręcznie ustaw limity przechowywania plików tymczasowych
    .accesskey = R
clear-temp-files-button =
    .label = Wyczyść pliki tymczasowe
    .accesskey = W
clear-temp-files-shutdown-label =
    .label = Wyczyść pliki tymczasowe po zamknięciu programu { -brand-short-name }
    .accesskey = s
...
show-start-page-label =
    .label = Pokaż stronę startową po otwarciu programu { -brand-short-name }
    .accesskey = o
start-page-label =
...
start-in-tray-label =
    ...
    .accesskey = U
new-message-arrival-legend = Po otrzymaniu nowej wiadomości:
...
mail-play-button =
    .label = Odtwórz
    .accesskey = r
change-dock-icon-description = Plakietki aplikacji i powiadomienia
change-dock-icon = Zmień preferencje ikony aplikacji
app-icon-options =
    .label = Opcje ikony aplikacji…
    .accesskey = i
new-email-alert-label =
    .label = pokaż alert o nowych wiadomościach e-mail
    .accesskey = P
customize-alerts-label =
    .label = Dostosuj alerty…
    .accesskey = D
...
use-custom-sound-label =
    .label = użyj niestandardowego dźwięku alertów
    .accesskey = d
mail-select-audio-button =
    .label = Wybierz dźwięk…
    .accesskey = b
enable-global-search-label =
    .label = Włącz wyszukiwanie we wszystkich kontach e-mail
    .accesskey = l
gloda-results-plain-list-label =
    .label = Pokaż wyniki wyszukiwania jako zwykłą listę
    .accesskey = s
...
gloda-show-results-as-list-label =
    .label = Domyślnie wyświetlaj wyniki wyszukiwania jako listę
    .accesskey = l
datetime-formatting-legend = Format daty i czasu
display-language-legend = Język wyświetlania
allow-graphics-accel =
    .label = Użyj przyspieszenia grafiki, aby zapewnić płynniejsze przewijanie i większą wydajność
    .accesskey = f
storage-format-label =
    .value = Format przechowywania nowych kont:
    .accesskey = F
mbox-store-single-label =
    .label = pojedynczy plik na folder (mbox)
...
enable-autoscroll-label =
    .label = Włącz automatyczne przewijanie
    .accesskey = c
autoscroll-label =
...
hide-titlebar-label =
    .label = Ukrywaj pasek tytułu
    .accesskey = t
hide-titlebar-description = Usuwa górny pasek pokazujący nazwę okna, aby zaoszczędzić miejsce na ekranie
hide-tabbar-single-tab-label =
    .label = Ukrywaj pasek kart, jeżeli otwarta jest tylko jedna karta
    .accesskey = k
auto-hide-tabbar-second-tab-description = Automatycznie ukrywa karty do momentu otwarcia drugiej karty.
system-settings-legend = Ustawienia systemowe
check-email-app-label =
    .label = Zawsze sprawdzaj, czy program { -brand-short-name } jest domyślnym programem pocztowym po jego otwarciu
    .accesskey = a
edit-defaults-apps-button =
    .label = Edytuj domyślne…
    .accesskey = u
...
update-settings-title = Ustawienia aktualizacji
install-updates-automatically-label =
    .label = Automatyczne instalowanie aktualizacji (zalecane)
    .accesskey = A
install-updates-automatically-description = Zapewnia bezpieczeństwo programowi { -brand-short-name } dzięki najnowszym poprawkom bezpieczeństwa.
check-updates-ask-label =
    .label = Sprawdź dostępność aktualizacji, ale zapytaj przed instalacją
    .accesskey = r
...
connection-config-description = Kontroluj, w jaki sposób program { -brand-short-name } ma się łączyć z Internetem.
connection-options-button =
    .label = Opcje połączenia…
    .accesskey = O
offline-mode-legend = Tryb offline
offline-settings-label = Ustawienia trybu offline
...
offline-settings-button =
    .label = Tryb offline…
    .accesskey = T
temporary-storage-legend = Pamięć tymczasowa
offline-compact-remove-deleted =
    .label = Usuń dane z folderów, jeśli zostały już usunięte, aby zwolnić miejsce na dane
    .accesskey = a
offline-compact-ask-cleanup =
    .label = Zapytaj przed czyszczeniem folderów
    .accesskey = m
...
use-cache-before =
    ...
    .accesskey = m
use-temp-storage-after = MB miejsca na pliki tymczasowe
...
underline-text-links-label =
    .label = Podkreśl odnośniki tekstowe w wiadomościach
    .accesskey = P
...
convert-emoticons-label =
    ...
    .accesskey = W
display-text-formatting-label = Formatowanie tekstu cytowanego
...
search-content-types =
    .placeholder = Wyszukaj typy treści
...
mark-read-when-opened =
    .label = natychmiast po otwarciu
    .accesskey = o
show-attachments-inline-label =
    .label = Pokaż załączniki w treści wiadomości
    .accesskey = t
mark-read-no-delay =
...
display-name-only-label =
    .label = Pokaż tylko nazwę wyświetlaną kontaktów zapisanych w książce adresowej
    .accesskey = s
...
show-conversation-view-label =
    .label = Pokaż widok rozmowy
    .accesskey = P
conversation-view-preview-description = To funkcja wczesnej wersji zapoznawczej. Grupuje ona powiązane wiadomości, ale może nie zawsze działać zgodnie z oczekiwaniami.
...
dark-mode-message-appearance = Wygląd wiadomości
dark-mode-checkbox-label =
    .label = Użyj trybu ciemnego dla tekstu wiadomości
    .accesskey = d
dark-mode-message-text-description = Zastosowuje ciemne tło do wszystkich wiadomości przychodzących, nawet jeśli nadawca sformatował je w jasnych kolorach.
...
dark-message-mode-toggle-label =
    ...
    .accesskey = P
dark-mode-toggle-description = Umożliwia szybkie przełączenie wiadomości e-mail z powrotem do trybu uproszczonego podczas czytania, bez konieczności zmiany głównych ustawień.
general-folder-settings-header = Ustawienia folderów
recent-folders-legend = Ostatnie foldery
recent-folders-description = Określa sposób wyświetlania ostatnio używanych folderów podczas przenoszenia wiadomości.
...
general-folder-options-header = Opcje zarządzania folderami
recent-destinations-legend = Ostatnie miejsca docelowe
recent-destinations-description = Opcje umożliwiające wyświetlenie i sortowanie folderów, do których ostatnio przeniesiono wiadomości.
recent-sort-order-label = Kolejność sortowania:
    .accesskey = K
recent-sort-order-mru =
    .label = Najnowsze
recent-sort-order-alphabetic =
    .label = Alfabetyczne
max-recent-label = Maksymalna liczba ostatnich folderów:
    .accesskey = M
...
account-hub-manual-config-checkbox-label =
    .label = Używaj nowej metody ręcznej konfiguracji w centrum kont
    .accesskey = k
account-hub-manual-config-checkbox-description = Nowa metoda ręcznej konfiguracji w centrum kont
new-calendar-legend = Nowe okno wydarzeń kalendarza
new-calendar-checkbox-label =
    .label = Wyświetl wydarzenia kalendarza w nowym oknie
new-calendar-checkbox-description = Eksperymentalne okno kalendarza do wyświetlania wydarzeń
...
add-file-type-label =
    .label = Dodaj typ pliku do załączonych wiadomości
    .accesskey = a
extension-label =
    .label = dodawaj rozszerzenia do nazw plików załączników
    .accesskey = d
forward-messages-label =
    .value = Przekaż wiadomości jako:
    .accesskey = k
forward-inline-label =
    .label = w treści wiadomości (bezpośrednio)
...
autosave-draft-label =
    .label = Automatycznie zapisuj wersję roboczą co
    .accesskey = A
...
ignore-sender-styles-label =
    .label = Ignoruj czcionki i kolory nadawcy
    .accesskey = I
...
paragraph-spacing-label =
    .label = Naciśnięcie klawisza Enter tworzy nowy akapit z większym odstępem
    .accesskey = N
...
compose-format-automatic-option =
    .label = Automatyczny (zalecany)
compose-format-automatic-description = Wysyłaj tekst sformatowany, gdy używasz stylów (np. pogrubienia lub odnośników), a w przeciwnym razie — zwykły tekst.
compose-format-both-option =
    .label = Zarówno tekst sformatowany (HTML), jak i zwykły tekst
compose-format-both-description = Zawsze wysyłaj obie wersje, aby program pocztowy odbiorcy mogła wybrać, którą wyświetlić.
compose-format-html-option =
    .label = Tylko tekst sformatowany (HTML)
compose-format-html-description = Zachowuje niestandardowe czcionki, kolory i obrazy, ale niektóre starsze programy pocztowe mogą nie wyświetlać ich poprawnie.
compose-format-plain-option =
    .label = Tylko zwykły tekst
compose-format-plain-description = Usuwa całe formatowanie, kolory i obrazy. Najlepiej sprawdza się w przypadku prostych wiadomości tekstowych, które działają wszędzie.
autocomplete-matches-description = Podczas wpisywania imienia i nazwiska lub adresu e-mail odbiorcy wyszukuj pasujące wyniki:
company-network-directory-label =
    .label = w katalogu firm lub sieci
    .accesskey = K
...
manage-directories-label =
    .label = Zarządzaj katalogami…
    .accesskey = t
collect-outgoing-label =
    .label = Automatycznie zapisuj wychodzące adresy e-mail w:
    .accesskey = A
collect-outgoing-description = Miejsce, w którym zapisywane są nowe kontakty utworzone ręcznie lub dodane z wiadomości e-mail.
save-added-contacts-label =
    .value = Zapisz ręcznie dodane kontakty w:
    .accesskey = k
save-added-contacts-description = Gdzie zapisywane są nowe kontakty z wiadomości e-mail.
show-directory-startup-label =
    .value = Pokaż katalog w oknie książki adresowej podczas otwierania programu { -brand-short-name }
    .accesskey = P
...
email-picker-label =
    ...
    .accesskey = Z
email-picker-description = Położenie nowych kontaktów zapisanych z wysłanych wiadomości.
default-add-address-book-label =
    .value = Domyślna książka adresowa dla kontaktów dodanych ręcznie:
    .accesskey = D
default-add-address-book-description = Położenie nowych kontaktów zapisanych z odebranych wiadomości.
...
attachment-label =
    ...
    .accesskey = S
edit-keywords-label =
    .label = Edytuj słowa kluczowe…
    .accesskey = k
offer-share-large-files-label =
    .label = Zaproponuj udostępnienie plików za pomocą odnośnika, jeśli ich rozmiar przekracza:
...
exceptions-button =
    .label = Wyjątki…
    .accesskey = W
remote-content-privacy-link = Wpływ zdalnej treści na prywatność
remote-content-privacy-info = Informacje o wpływie zdalnych treści na prywatność
remote-content-info =
...
third-party-visited-only =
    .label = Tylko z odwiedzonych witryn
third-party-visited =
...
global-privacy-control-label =
    .label = Żądanie od witryn, by nie sprzedawały ani nie udostępniały danych osobowych
    .accesskey = n
...
passwords-registered-description = { -brand-short-name } może zapisywać hasła do zarejestrowanych kont.
view-saved-passwords-button =
    .label = Wyświetl zapisane hasła…
    .accesskey = z
primary-password-session-description = Hasło główne chroni wszystkie hasła i jest wpisywane raz na sesję.
use-primary-password-label =
    .label = Użyj hasła głównego
    .accesskey = U
do-not-track-label =
...
spam-accounts-description = Te ustawienia obowiązują na wszystkich kontach. Opcje każdego konta można zmienić w ustawieniach konta.
...
spam-marked-manually-label =
    .label = Po oznaczeniu ręcznym
    .accesskey = m
spam-detected-auto-label =
    .label = Po automatycznym wykryciu przez { -brand-short-name }
    .accesskey = t
spam-log-keep-label =
    .label = Zachowuj dziennik automatycznego wykrywania niechcianej poczty
    .accesskey = e
...
reset-spam-button =
    ...
    .accesskey = r
scam-detection-description = { -brand-short-name } sprawdza wiadomości pod kątem odnośników wyłudzających dane i typowych oznak oszustw e-mailowych.
scam-detection-label =
    .label = Ostrzegamy przed czytaniem wiadomości e-mail, które wyglądają na próbę oszustwa
    .accesskey = s
antivirus-check-description = Umożliwia oprogramowaniu antywirusowemu indywidualne sprawdzanie wiadomości przychodzących przed ich zapisaniem na komputerze.
antivirus-isolate-label =
    .label = Zezwalaj oprogramowaniu antywirusowemu na izolowanie zainfekowanych wiadomości przychodzących
    .accesskey = a
certificate-verify-description = Gdy serwer żąda certyfikatu potwierdzającego Twoją tożsamość:
...
search-preferences-input2 =
    ...
    .style = width: 15.4em
managed-by-organization-notice = { -brand-short-name } jest zarządzany przez organizację.
...
accent-color-selection-label =
    .value = Wybierz kolor dla głównych przycisków i wyróżnień
accent-color-label =
...
appearance-view-style-select =
    .value = Wybierz styl widoku:
appearance-view-style =
    .value = Styl widoku:
appearance-radio-table =
    .label = Widok tabeli
appearance-radio-card-view =
    .label = Widok wizytówki
card-view-options-legend = Opcje widoku wizytówki
...
default-message-list-new-folders-description = Wybierz domyślne opcje sortowania i wątkowania nowych folderów
...
default-flag-grouped =
    .label = Pogrupowane
default-sort-by-label = Sortuj wiadomości według:
...
default-sort-newest-bottom =
    .label = Najnowsze wiadomości na dole
default-sort-new-messages-top =
    .label = Najnowsze wiadomości na górze
apply-view-settings-label = Zastosuj te ustawienia widoku do:
apply-view-settings-to-all-folders-button =
    .label = Wszystkie foldery i podfoldery
    .accesskey = W
select-apply-sort-folders-button =
    .label = Wybierz foldery
    .accesskey = f
