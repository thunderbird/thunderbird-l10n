...
collection-share-performance =
    .label = Udostępniaj anonimowe dane o wydajności serwisowi { -vendor-short-name }
    .accesskey = r
...
collection-share-crash-data =
    .label = Wysyłaj anonimowe raporty o awariach do serwisu { -vendor-short-name }
    .accesskey = c
...
global-privacy-control-label =
    .label = Żądanie od witryn, aby nie sprzedawały ani nie udostępniały danych osobowych
    .accesskey = n
...
spam-detected-auto-label =
    .label = Po automatycznym wykryciu przez program { -brand-short-name }
    .accesskey = t
spam-log-keep-label =
...
scam-detection-label =
    .label = Ostrzegaj podczas czytania wiadomości e-mail wyglądającej na próbę oszustwa
    .accesskey = s
