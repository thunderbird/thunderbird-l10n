...
email-picker-label =
    ...
    .accesskey = Z
email-picker-description = Lokalizacja nowych kontaktów zapisanych z wysłanych wiadomości.
default-add-address-book-label =
    .value = Domyślna książka adresowa dla kontaktów dodanych ręcznie:
    .accesskey = D
default-add-address-book-description = Lokalizacja nowych kontaktów zapisanych z odebranych wiadomości.
