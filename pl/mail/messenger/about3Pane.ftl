...
folder-pane-header-toggle-full-path =
    .label = Wyświetlaj pełną ścieżkę
folder-pane-header-hide-local-folders =
    .label = Ukryj lokalne foldery
folder-pane-mode-header-all = Wszystkie
folder-pane-mode-header-unread = Nieprzeczytane
folder-pane-mode-header-favorite = Ulubione
folder-pane-mode-header-recent = Ostatnie
folder-pane-mode-header-smart = Pogrupowane
folder-pane-mode-header-tags = Etykiety
...
threadpane-cell-read-status =
    .aria-label = Stan przeczytania
threadpane-new-cell-label = Nowa
