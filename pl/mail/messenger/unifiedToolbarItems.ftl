...
toolbar-spam-label = Niechciana
toolbar-spam =
    .title = Oznacz zaznaczoną wiadomość jako niechcianą
toolbar-not-spam-label = Pożądana
toolbar-not-spam =
    .title = Oznacz zaznaczoną wiadomość jako pożądaną
...
toolbar-add-address-book-label = Dodaj książkę adresową
