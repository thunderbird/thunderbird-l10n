...
account-hub-protocol-pop3 = Pobierz na urządzenie
...
account-hub-result-graph-api-description = Użyj Microsoft Graph API do synchronizowania folderów i wiadomości e-mail z usługą Microsoft 365
