...
account-hub-servers-username-label = Nazwa użytkownika:
account-hub-result-server-label = Serwer:
account-hub-result-port-label = Port:
account-hub-result-security-label = Bezpieczeństwo:
account-hub-result-authentication-type-label = Uwierzytelnianie:
account-hub-result-authentication-none = Brak
    .title = Brak
account-hub-result-authentication-password = Zwykłe hasło
    .title = Zwykłe hasło
account-hub-result-authentication-encrypted-password = Szyfrowane hasło
    .title = Szyfrowane hasło
account-hub-result-authentication-gssapi = Kerberos
    .title = Kerberos
account-hub-result-authentication-ntlm = NTLM
    .title = NTLM
account-hub-result-authentication-external = Zewnętrzne
    .title = Zewnętrzne
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = Brak
account-hub-result-auth-password = Zwykłe hasło
account-hub-result-auth-encrypted-password = Szyfrowane hasło
account-hub-result-auth-gssapi = Kerberos
account-hub-result-auth-ntlm = NTLM
account-hub-result-auth-external = Zewnętrzne
...
account-hub-exchange-service-url-label = Wpisz adres URL usługi
...
account-hub-welcome = Witamy w programie
account-hub-welcome-brand = { -brand-short-name }
account-hub-welcome-text = Witamy w programie { -brand-short-name }
...
account-hub-password-label = Hasło
    .title = Opcjonalnie, zostanie użyte wyłącznie do sprawdzenia nazwy użytkownika
    .accesskey = H
account-hub-remember-password = Zachowaj hasło
    .accesskey = Z
account-hub-exchange-label = Nazwa użytkownika
    .accesskey = N
account-hub-installing-addon = Pobieranie i instalowanie dodatku…
account-hub-success-addon = Pomyślnie zainstalowano dodatek
account-hub-success-half-manual = Ustawienia znalezione w wyniku testowania wskazanego serwera:
account-hub-result-security-no-encryption = Bez szyfrowania
    .title = Bez szyfrowania
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = Bez szyfrowania
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = Uwierzytelnienie się nie powiodło. Sprawdź poprawność nazwy użytkownika i hasła.
...
account-hub-exchange-config-unverifiable = Konfiguracja nie mogła zostać zweryfikowana. Jeśli nazwa użytkownika i hasło są poprawne, to prawdopodobnie administrator serwera wyłączył wybraną konfigurację dla tego konta. Spróbuj wybrać inny protokół.
account-hub-advanced-setup-button = Utwórz konto i edytuj jego ustawienia
    .accesskey = e
# Variables:
#  $domain (String): The name of the server where the configuration was found, e.g. rackspace.com.
account-hub-exchange-dialog-question = { -brand-short-name } znalazł informacje o konfiguracji tego konta w serwisie { $domain }. Czy chcesz kontynuować i wysłać swoje dane logowania?
account-hub-creation-error-title = Błąd przy tworzeniu konta
account-hub-error-server-exists = Serwer poczty przychodzącej już istnieje.
account-hub-confirm-advanced-title = Potwierdź konfigurację zaawansowaną
account-hub-confirm-advanced-description = To okno zostanie zamknięte, a konto z obecnymi ustawieniami zostanie utworzone, nawet jeśli konfiguracja jest niepoprawna. Czy chcesz kontynuować?
account-hub-addon-install-title = Zainstaluj
...
account-hub-username-help-text = Często Twój pełny adres e-mail
account-hub-port-help-text = Jeśli to pole pozostanie puste, { -brand-short-name } spróbuje wykryć port.
...
account-hub-result-graph-api-description = Użyj interfejsu API Microsoft Graph do synchronizowania folderów i wiadomości e-mail z usługą Microsoft 365
...
account-hub-config-success-title = Ustawienia konta zostały znalezione automatycznie.
account-hub-config-success-description-db = Konfiguracja znaleziona w bazie danych Mozilli.
account-hub-config-success-description-exchange = Konfiguracja znaleziona dla serwera Microsoft Exchange.
account-hub-config-success-description-guess = Konfiguracja znaleziona poprzez odpytywanie typowych adresów serwerów.
account-hub-config-success-description-disk = Konfiguracja znaleziona w plikach instalacyjnych programu { -brand-short-name }.
...
account-hub-select-security-warning = <span data-l10n-name="error-text">Ostrzeżenie: wykryto niezabezpieczony serwer pocztowy.</span> Ten serwer nie obsługuje szyfrowania, co naraża hasło i dane użytkownika. Skontaktuj się z administratorem, aby zabezpieczyć połączenie, lub kontynuuj na własne ryzyko. <a data-l10n-name="error-link">Więcej informacji znajdziesz w dokumencie FAQ.</a>
...
address-book-add-remote-icon2 =
    .alt = Dodaj zdalną książkę adresową
address-book-add-remote-icon =
    .alt = Dodaj nową zdalną książkę adresową
address-book-add-remote = Dodaj zdalną książkę adresową
address-book-add-remote-carddav-description = Połącz z książką adresową CardDAV
...
address-book-add-ldap-icon2 =
    .alt = Dodaj książkę adresową LDAP
address-book-add-ldap-button = Dodaj książkę adresową LDAP
...
account-hub-exchange-type-account-type = Typ konta
...
account-hub-exchange-type-username = Nazwa użytkownika
account-hub-exchange-type-username-hint = Zazwyczaj jest to adres e-mail lub nazwa UPN w usłudze Active Directory.
account-hub-exchange-type-authentication = Metoda uwierzytelniania
# Checkbox that can be unchecked to use a custom OAuth config.
account-hub-exchange-type-default-oauth = Użyj domyślnych ustawień uwierzytelniania usługi Microsoft 365 Copilot
account-hub-exchange-type-oauth-tenant = Identyfikator dzierżawy
account-hub-exchange-type-oauth-app = Identyfikator aplikacji
account-hub-exchange-type-title = Wybierz typ konta
