...
looking-for-messages-account = Wyszukiwanie nowych wiadomości dla konta { $accountName }…
# Feedback message shown in the status bar while we look for new messages in a
# specific folder.
# Variables:
# $folderName (String) - The folder's name.
looking-for-messages-folder = Wyszukiwanie nowych wiadomości w folderze { $folderName }…
...
deleting-message =
    { $number ->
        [one] Usuwanie jednej wiadomości z folderu { $folderName }…
        [few] Usuwanie { $number } wiadomości z folderu { $folderName }…
       *[many] Usuwanie { $number } wiadomości z folderu { $folderName }…
    }
# Feedback message shown in the status bar while we're deleting messages in a
# specific folder (and waiting for the remote operation to complete).
# Variables:
# $number (Number) - Number of messages being deleted.
# $folderName (String) - The folder's name.
deleting-messages = Usuwanie { $number } wiadomości z folderu { $folderName }…
