...
oauth-reauthorize-title = Ponownie zezwól na dostęp
...
oauth-reauthorize-description = { $hostname } wymaga ponownego potwierdzenia dostępu, aby móc synchronizować się z kontem. Nazwa użytkownika: { $username }
