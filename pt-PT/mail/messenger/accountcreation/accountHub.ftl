...
account-hub-welcome = Bem-vindo(a) ao
account-hub-welcome-brand = { -brand-short-name }
account-hub-welcome-text = Bem-vindo(a) ao { -brand-short-name }
account-hub-name-warning-icon =
    .title = Por favor, insira o seu nome
account-hub-email-label = Endereço de correio eletrónico
    .accesskey = E
...
account-hub-password-label = Palavra-passe
    .title = Opcional, só será utilizada para validar o nome de utilizador
    .accesskey = P
account-hub-remember-password = Memorizar palavra-passe
    .accesskey = m
...
account-hub-result-security-no-encryption = Sem encriptação
    .title = Sem encriptação
...
account-hub-credentials-wrong = A autenticação falhou. Por favor, verifique o nome de utilizador e palavra-passe
account-hub-result-username-label = Nome de utilizador
    .title = Nome de utilizador
account-hub-name-label = Nome completo
    .accesskey = N
account-hub-adding-account-title = A Adicionar Conta
...
account-hub-config-success-title = As definições da conta foram encontradas automaticamente.
account-hub-config-success-description-db = Configuração encontrada na ISPDB da Mozilla.
