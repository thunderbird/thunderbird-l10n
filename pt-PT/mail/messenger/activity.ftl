...
extension-send-activity-live = A extensão “{ $extensionName }” está a enviar mensagens não monitorizadas.
...
extension-send-activity-event =
    { $count ->
        [one] A extensão “{ $extensionName }” enviou uma mensagem não monitorizada
       *[other] A extensão “{ $extensionName }” enviou múltiplas mensagens não monitorizadas
    }
...
extension-sent-activity-event-status =
    { $count ->
        [one] { $count } mensagem (tempo decorrido: { $time })
       *[other] { $count } mensagens (tempo decorrido: { $time })
    }
