...
max-count-exceeded = (Nota: { $total } mensagens selecionadas, as primeiras { $shown } são mostradas)
...
max-thread-count-exceeded = (Nota: { $total } conversas selecionadas, são mostradas as primeiras { $shown })
