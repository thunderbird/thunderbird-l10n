...
webext-perms-description-experiment-access = Este complemento terá acesso completo e sem restrições ao { -brand-short-name } e ao seu computador.
...
webext-perms-description-messages-send = Envie de forma programada mensagens de e-mail em lote em seu nome, sem qualquer retorno visual. Utilize o Gestor de Atividade para rever o histórico de envios do extra.
webext-perms-description-messages-save = Guarde mensagens de e-mail como rascunhos ou modelos de forma programada, sem a sua interação
...
webext-perms-description-messengerSettings = Ler as definições do { -brand-short-name }
