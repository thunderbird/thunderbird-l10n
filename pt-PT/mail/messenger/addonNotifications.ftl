...
addon-confirm-install-unsigned-message =
    { $addonCount ->
        [one] Cuidado: este site gostaria de instalar um complemento não verificado no { -brand-short-name }. Continue por sua conta e risco .
       *[other] Cuidado: este site gostaria de instalar { $addonCount } complementos não verificados no { -brand-short-name }. Continue por sua conta e risco.
    }
# Variables:
#   $addonCount (Number): the number of add-ons being installed (at least 2)
addon-confirm-install-some-unsigned-message = Cuidado: este site gostaria de instalar { $addonCount } complementos no { -brand-short-name }, alguns dos quais não verificados. Continue por sua conta e risco.
