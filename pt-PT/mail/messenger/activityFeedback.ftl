...
looking-for-messages-account = A procurar por novas mensagens para { $accountName }…
# Feedback message shown in the status bar while we look for new messages in a
# specific folder.
# Variables:
# $folderName (String) - The folder's name.
looking-for-messages-folder = A procurar por novas mensagens em { $folderName }…
...
deleting-message =
    { $number ->
        [one] A eliminar uma mensagem de { $folderName }…
       *[other] A eliminar { $number } mensagens de { $folderName }…
    }
