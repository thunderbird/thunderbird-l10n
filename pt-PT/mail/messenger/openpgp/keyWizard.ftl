...
openpgp-keygen-secret-protection = Proteção com Chave Secreta
radio-keygen-no-protection =
    .label = Desprotegido
radio-keygen-protect-primary-pass =
    .label = Proteger com a Palavra-passe Primária
radio-keygen-passphrase-protection =
    .label = Proteger com uma frase de acesso:
openpgp-passphrase-repeat = Confirmar a frase de acesso:
...
openpgp-import-keep-passphrases =
    .label = Manter a proteção de frase de acesso para chaves secretas importadas
openpgp-passphrase-prompt-title = Frase de acesso necessária
...
openpgp-import-own-key-title = Importar a sua chave pública
#   $keyId (String) - The Key ID.
openpgp-import-own-key-description = O { -brand-short-name } não conseguiu encontrar a chave pública com o Id. { $keyId }. Por favor, importe a mesma para continuar.
#   $keyId (String) - The Key ID.
openpgp-import-keyid-failed = Não foi possível importar a chave pública { $keyId } desse ficheiro.
