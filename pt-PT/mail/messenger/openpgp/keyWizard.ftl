...
radio-keygen-passphrase-protection =
    .label = Proteger com uma frase-chave:
openpgp-passphrase-repeat = Confirmar a frase-chave:
...
openpgp-import-keep-passphrases =
    .label = Manter a proteção da frase-chave para chaves secretas importadas
