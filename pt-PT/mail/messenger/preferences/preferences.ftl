...
general-email-notifications-header = Notificações por e-mail
...
general-files-and-attachment-description = Selecione que ficheiros são guardados e onde os mesmos são guardados no seu computador.
general-tags-header = Etiquetas
general-reading-and-viewing-header = Leitura & visualização
general-reading-and-display-header = Leitura e apresentação
general-updates-header = Atualizações
general-network-and-storage-header = Rede e armazenamento
general-search-performance-label = Pesquisa & desempenho
compose-writing-emails-header = Escrita de e-mails
...
compose-message-formatting-title = Formatação da mensagem
compose-address-autocomplete-header = Preenchimento automático de endereços
...
choose-display-language-description = Escolha o idioma usado para menus, botões e notificações.
...
manual-storage-limit-label =
    .label = Definir manualmente limites de armazenamento para ficheiros temporários
    .accesskey = D
clear-temp-files-button =
    .label = Limpar ficheiros temporários
    .accesskey = L
clear-temp-files-shutdown-label =
    .label = Limpar ficheiros temporários quando o { -brand-short-name } fechar
    .accesskey = s
...
show-start-page-label =
    .label = Mostrar a Página Inicial quando o { -brand-short-name } abrir
    .accesskey = M
start-page-label =
...
start-in-tray-label =
    ...
    .accesskey = S
new-message-arrival-legend = Ao chegar uma nova mensagem:
...
mail-play-button =
    .label = Reproduzir
    .accesskey = T
change-dock-icon-description = Emblemas e notificações da aplicação
...
new-email-alert-label =
    .label = Mostrar um alerta para novos e-mails
    .accesskey = M
...
use-custom-sound-label =
    .label = Utilizar som personalizado para alertas
    .accesskey = U
mail-select-audio-button =
    .label = Selecionar áudio…
    .accesskey = a
enable-global-search-label =
    .label = Ativar a pesquisa em todas as contas de e-mail
    .accesskey = e
gloda-results-plain-list-label =
    .label = Mostrar resultados da pesquisa como uma lista simples
    .accesskey = l
...
display-language-legend = Idioma apresentado
allow-graphics-accel =
    .label = Usar aceleração gráfica para deslocamento e desempenho mais suaves
    .accesskey = h
storage-format-label =
    .value = Formato de armazenamento para novas contas:
    .accesskey = t
mbox-store-single-label =
    .label = Ficheiro único por pasta (mbox)
...
enable-autoscroll-label =
    .label = Ativar deslocamento automático
    .accesskey = d
autoscroll-label =
...
hide-titlebar-label =
    ...
    .accesskey = E
hide-titlebar-description = Remove a barra superior que mostra o nome da janela para poupar espaço no ecrã
hide-tabbar-single-tab-label =
    .label = Esconder a barra de separadores apenas quando um separador está aberto
    .accesskey = s
auto-hide-tabbar-second-tab-description = Oculta automaticamente os separadores até que abra um segundo.
system-settings-legend = Definições do sistema
check-email-app-label =
    .label = Verificar sempre se o { -brand-short-name } é a aplicação de e-mail predefinida quando aberto
    .accesskey = V
edit-defaults-apps-button =
    .label = Editar predefinições…
    .accesskey = p
...
update-settings-title = Atualizar definições
install-updates-automatically-label =
    .label = Instalar atualizações automaticamente (recomendado)
    .accesskey = a
install-updates-automatically-description = Mantém o { -brand-short-name } seguro com as últimas correções de segurança.
check-updates-ask-label =
    .label = Procurar atualizações, mas perguntar antes de instalar
    .accesskey = P
...
connection-config-description = Controle como o { -brand-short-name } se liga à Internet.
connection-options-button =
    .label = Opções de ligação…
    .accesskey = s
offline-mode-legend = Modo offline
offline-settings-label = Definições do modo offline
proxy-config-description = Configure o modo de ligação do { -brand-short-name } à Internet.
...
offline-settings-button =
    .label = Offline...
    .accesskey = O
temporary-storage-legend = Armazenamento temporário
offline-compact-remove-deleted =
    .label = Remover dados das pastas quando já foram apagadas para libertar armazenamento
    .accesskey = a
offline-compact-ask-cleanup =
    .label = Perguntar antes de limpar pastas
    .accesskey = a
...
use-cache-before =
    .value = Utilizar até
    .accesskey = U
use-temp-storage-after = MB de espaço para ficheiros temporários
...
underline-text-links-label =
    .label = Sublinhar ligações de texto nas mensagens
    .accesskey = x
...
customize-fonts-button =
    .label = Personalizar tipos de letra…
    .accesskey = l
font-options-button =
    .label = Avançadas...
    .accesskey = A
...
convert-emoticons-label =
    ...
    .accesskey = M
display-text-formatting-label = Formatação de citações
...
search-content-types =
    .placeholder = Pesquisar tipos de conteúdo
...
always-ask-label =
    ...
    .accesskey = a
use-tags-text = Usar etiquetas para categorizar e priorizar mensagens.
...
mark-read-when-opened =
    .label = Imediatamente ao abrir
    .accesskey = o
show-attachments-inline-label =
    .label = Mostrar anexos dentro do corpo da mensagem
    .accesskey = m
mark-read-no-delay =
    .label = Ao exibir
    .accesskey = o
...
mark-read-after-viewing =
    .label = Depois de visualizar durante
    .accesskey = v
...
display-name-only-label =
    .label = Mostrar apenas o nome para os contactos guardados no livro de endereços
    .accesskey = M
...
show-conversation-view-label =
    .label = Mostrar vista de conversação
    .accesskey = c
conversation-view-preview-description = Esta é uma funcionalidade em ante-estreia antecipada. Agrupa mensagens relacionadas, mas pode nem sempre funcionar como esperado.
...
dark-mode-message-appearance = Aparência da mensagem
dark-mode-checkbox-label =
    .label = Utilizar modo escuro para texto da mensagem
    .accesskey = e
dark-mode-message-text-description = Aplica um fundo escuro a todas as mensagens recebidas, mesmo que o remetente as tenha formatado com cores claras.
...
dark-message-mode-toggle-label =
    ...
    .accesskey = t
dark-mode-toggle-description = Permite-lhe mudar rapidamente de volta um email para o modo claro durante a leitura, sem alterar as suas definições principais.
general-folder-settings-header = Definições de pastas
recent-folders-legend = Pastas recentes
recent-folders-description = Controla como aparecem as pastas usadas recentemente ao mover mensagens.
...
as-attachment-label =
    .label = Como anexo
add-file-type-label =
    .label = Adicionar tipo de ficheiro às mensagens anexadas
    .accesskey = e
extension-label =
    .label = adicionar extensão ao nome do ficheiro
    .accesskey = e
forward-messages-label =
    .value = Reencaminhar mensagens como:
    .accesskey = R
forward-inline-label =
    .label = Dentro da mensagem (incorporado)
...
autosave-draft-label =
    .label = Guardar automaticamente um rascunho a cada
    .accesskey = G
...
ignore-sender-styles-label =
    .label = Ignorar tipos de letra e cores do remetente
    .accesskey = r
...
paragraph-spacing-label =
    .label = Premir Enter inicia um novo parágrafo com espaçamento extra
    .accesskey = p
...
compose-format-automatic-description = Enviar texto formatado se adicionar estilos (como negrito ou ligações), ou texto simples se não adicionar.
compose-format-both-option =
    .label = Tanto texto formatado (HTML) como texto simples
compose-format-both-description = Enviar sempre ambas as versões, permitindo que a aplicação de e-mail do destinatário escolha qual apresentar.
compose-format-html-option =
    .label = Apenas texto rico (HTML)
compose-format-html-description = Mantém tipos de letra, cores, e imagens, mas algumas aplicações de e-mail mais antigas poderão não apresentar o conteúdo corretamente.
compose-format-plain-option =
    .label = Apenas texto simples
compose-format-plain-description = Remove toda a formatação, cores, e imagens. Melhor para e-mails de texto simples que funcionam em todo o lado.
autocomplete-matches-description = Ao escrever o nome ou e-mail de um destinatário, procurar correspondências em:
company-network-directory-label =
    .label = Empresa ou pasta de rede
    .accesskey = E
...
collect-outgoing-label =
    .label = Guardar automaticamente endereços de e-mail enviados em:
    .accesskey = G
collect-outgoing-description = Onde os novos contactos são guardados quando criados manualmente ou adicionados a partir de emails.
save-added-contacts-label =
    .value = Guardar contactos adicionados manualmente em:
    .accesskey = m
save-added-contacts-description = Onde são guardados os novos contactos de e-mails.
show-directory-startup-label =
    .value = Mostrar pasta na janela do livro de endereços ao abrir o { -brand-short-name }
    .accesskey = M
...
default-directory-label =
    .value = Livro de endereços inicial predefinido na janela do livro de endereços:
    .accesskey = a
default-last-label =
...
attachment-label =
    ...
    .accesskey = f
edit-keywords-label =
    .label = Editar palavras-chave…
    .accesskey = p
offer-share-large-files-label =
    .label = Oferecer para partilhar ficheiros por ligação quando estes excedem:
...
exceptions-button =
    .label = Exceções
    .accesskey = E
remote-content-privacy-info = Saber mais sobre privacidade e conteúdo remoto
remote-content-info =
...
search-preferences-input2 =
    ...
    .style = width: 15.4em
managed-by-organization-notice = O { -brand-short-name } está a ser gerido por uma organização.
...
accent-color-selection-label =
    .value = Selecionar cor para o botão primário e destaques
accent-color-label =
...
appearance-view-style-select =
    .value = Selecione o estilo de visualização:
appearance-view-style =
    .value = Estilo de visualização:
appearance-radio-table =
    .label = Vista de tabela
appearance-radio-card-view =
    .label = Vista em cartões
card-view-options-legend = Opções da vista em cartões
...
default-message-list-new-folders-description = Selecionar as opções predefinidas de ordenação e threading para as novas pastas
...
default-sort-by-label = Ordenar mensagens por:
...
default-sort-newest-bottom =
    .label = Novas mensagens no fundo
default-sort-new-messages-top =
    .label = Novas mensagens no topo
apply-view-settings-label = Aplicar estas definições de vista a:
apply-view-settings-to-all-folders-button =
    .label = Todas as pastas e subpastas
    .accesskey = T
