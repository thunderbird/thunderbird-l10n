...
default-app-intro = Usar o { -brand-short-name } como aplicação predefinida para:
...
checkbox-net-thunderbird-url-label =
    .label = Ligações personalizadas do Thunderbird (net.thunderbird://)
    .tooltiptext = { unset-default-tooltip }
...
check-on-startup-label =
    ...
    .accesskey = a
system-settings-dialog-title = Definições do sistema
