...
connection-internet-proxy-legend = Ligação à Internet & proxy
connection-proxy-legend = Configurar proxies para aceder à Internet
proxy-type-no =
    .label = Sem proxy
    .accesskey = y
proxy-autodetect-network =
    .label = Detetar proxy de rede automaticamente
    .accesskey = p
proxy-type-wpad =
...
http-port-label =
    ...
    .accesskey = P
proxy-https-sharing =
    .label = Usar este proxy para endereços web seguros (HTTPS)
    .accesskey = s
proxy-http-sharing =
...
proxy-auto-script-url =
    .label = URL do script de configuração automática:
    .accesskey = s
proxy-type-auto =
