...
about-dialog-meadow-logo =
    .alt = { -brand-short-name } emblema nome de código Meadow
    .title = { -brand-short-name } - Nome de código Meadow
...
about-donation = Pretende ajudar? <a data-l10n-name="helpus-donate-link">Faça uma doação</a> or <a data-l10n-name="helpus-get-involved-link">envolva-se!</a>
