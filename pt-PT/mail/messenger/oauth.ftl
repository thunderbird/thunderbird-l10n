...
oauth-reauthorize-title = Reautorizar acesso
...
oauth-reauthorize-description = { $hostname } precisa que confirme o acesso novamente para continuar a sincronizar com a sua conta. Nome de utilizador: { $username }
