...
webext-perms-description-addressBooks = Đọc và chỉnh sửa các sổ địa chỉ và liên hệ của bạn
...
webext-perms-description-messages-send = Tự động gửi hàng loạt email thay mặt bạn mà không cần hiển thị thông tin trực quan. Sử dụng Trình quản lý hoạt động để xem lại lịch sử gửi của tiện ích.
webext-perms-description-messages-save = Lưu thư email dưới dạng bản nháp hoặc mẫu tự động, mà không cần bạn can thiệp.
