...
account-hub-addon-needed = { -brand-full-name } không hỗ trợ máy chủ này một cách tự nhiên. Để truy cập email Exchange, <a data-l10n-name="addon-install"> cài đặt tiện ích của bên thứ ba như Owl (trả phí).</a>
