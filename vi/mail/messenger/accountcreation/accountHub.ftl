...
account-hub-servers-username-label = Tên người dùng:
account-hub-result-server-label = Máy chủ:
account-hub-result-port-label = Cổng:
account-hub-result-security-label = Bảo mật:
account-hub-result-authentication-type-label = Xác thực:
account-hub-result-authentication-none = Không có
    .title = Không có
account-hub-result-authentication-password = Mật khẩu thông thường
    .title = Mật khẩu thông thường
account-hub-result-authentication-encrypted-password = Mật khẩu có mã hoá
    .title = Mật khẩu có mã hoá
...
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = Không có
account-hub-result-auth-password = Mật khẩu thông thường
account-hub-result-auth-encrypted-password = Mật khẩu có mã hoá
...
account-hub-exchange-service-url-label = Nhập URL dịch vụ
...
account-hub-password-label = Mật khẩu
    .accesskey = P
    .title = Tùy chọn, sẽ chỉ được sử dụng để xác thực tên người dùng
account-hub-remember-password = Ghi nhớ mật khẩu
    .accesskey = m
account-hub-exchange-label = Thông tin đăng nhập của bạn
    .accesskey = l
account-hub-installing-addon = Đang tải xuống và cài đặt tiện ích mở rộng…
account-hub-success-addon = Đã cài đặt thành công tiện ích mở rộng
account-hub-success-half-manual = Các cài đặt sau được tìm thấy bằng cách thăm dò máy chủ nhất định:
account-hub-result-security-no-encryption = Không mã hóa
    .title = Không mã hóa
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = Không mã hóa
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = Quá trình xác thực thất bại. Vui lòng kiểm tra tên người dùng và mật khẩu
...
account-hub-exchange-config-unverifiable = Không thể xác minh cấu hình. Nếu tên người dùng và mật khẩu của bạn chính xác, có khả năng quản trị viên máy chủ đã vô hiệu hóa cấu hình đã chọn cho tài khoản của bạn. Hãy thử chọn một giao thức khác.
account-hub-advanced-setup-button = Cấu hình nâng cao
    .accesskey = A
# Variables:
...
account-hub-result-graph-api-description = Sử dụng Microsoft Graph API để đồng bộ hóa thư mục và email của bạn với Microsoft 365
account-hub-result-graph-shortname = Exchange (Graph)
account-hub-result-graph-description = Sử dụng Microsoft Graph API để đồng bộ hóa thư mục và email của bạn
...
account-hub-config-success-title = Cài đặt tài khoản được tìm thấy tự động.
account-hub-config-success-description-db = Thông tin cấu hình được tìm thấy trong Mozilla ISPDB.
account-hub-config-success-description-exchange = Cấu hình được tìm thấy cho máy chủ Microsoft Exchange.
account-hub-config-success-description-guess = Cấu hình được tìm thấy bằng cách thử các tên máy chủ phổ biến.
account-hub-config-success-description-disk = Cấu hình được tìm thấy trong bộ cài đặt { -brand-short-name }.
...
account-hub-select-security-warning = <span data-l10n-name="error-text">Cảnh báo: Phát hiện máy chủ thư không an toàn.</span> Máy chủ này không có mã hóa, làm lộ mật khẩu và dữ liệu của bạn. Liên hệ với quản trị viên của bạn để bảo mật kết nối hoặc tự chịu rủi ro. <a data-l10n-name="error-link">em câu hỏi thường gặp để biết thêm.</a>
...
address-book-add-remote-icon2 =
    .alt = Thêm sổ địa chỉ từ xa
address-book-add-remote-icon =
    .alt = Thêm sổ địa chỉ từ xa mới
address-book-add-remote = Thêm sổ địa chỉ từ xa
address-book-add-remote-carddav-description = Kết nối đến sổ địa chỉ CardDAV
...
address-book-add-ldap-icon2 =
    .alt = Thêm sổ địa chỉ LDAP
address-book-add-ldap-button = Thêm sổ địa chỉ LDAP
...
account-hub-exchange-type-account-type = Loại tài khoản
account-hub-card-graph-title = Microsoft Graph
account-hub-card-graph-description = Microsoft Graph là phương thức kết nối hiện đại dành cho Microsoft 365.
account-hub-card-ews-title = Exchange Web Services
account-hub-card-ews-tag = Hệ thống cũ
account-hub-card-ews-description = Exchange Web Services (EWS) kết nối với Microsoft Exchange để đồng bộ hóa email của bạn.
# This is shown after the type description, so "it" is referring to the type (either Microsoft Graph or Exchange Web Services).
account-hub-card-recommended-description = Nên sử dụng cách này vì nó phù hợp với URL dịch vụ của bạn.
account-hub-exchange-type-username = Tên người dùng
account-hub-exchange-type-username-hint = Thông thường đó là địa chỉ email của bạn hoặc UPN của Active Directory.
account-hub-exchange-type-authentication = Phương thức xác thực
# Checkbox that can be unchecked to use a custom OAuth config.
account-hub-exchange-type-default-oauth = Sử dụng cài đặt xác thực mặc định của Microsoft 365 Copilot
account-hub-exchange-type-oauth-tenant = Tenant ID
account-hub-exchange-type-oauth-app = App ID
account-hub-exchange-type-advanced-config = Cấu hình nâng cao
account-hub-exchange-type-title = Chọn loại tài khoản
