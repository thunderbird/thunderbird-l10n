...
toolbar-spam-label = Thư rác
toolbar-spam =
    .title = Đánh dấu thư đã chọn là thư rác
toolbar-not-spam-label = Không phải thư rác
toolbar-not-spam =
    .title = Đánh dấu thư đã chọn không phải là thư rác
...
toolbar-add-address-book-label = Thêm sổ địa chỉ
