...
folder-pane-header-toggle-full-path =
    .label = Hiển thị đường dẫn đầy đủ
folder-pane-header-hide-local-folders =
    .label = Ẩn thư mục cục bộ
folder-pane-mode-header-all = Tất cả Thư mục
folder-pane-mode-header-unread = Thư mục Chưa đọc
folder-pane-mode-header-favorite = Thư mục Ưa thích
folder-pane-mode-header-recent = Thư mục Gần đây
folder-pane-mode-header-smart = Thư mục Hợp nhất
folder-pane-mode-header-tags = Nhãn
