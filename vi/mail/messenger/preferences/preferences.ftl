...
general-email-notifications-header = Thông báo email
general-language-and-appearance-header = Ngôn ngữ & diện mạo
general-incoming-mail-header = Thư đến:
general-files-and-attachment-header = Tập tin & đính kèm
general-files-and-attachment-description = Chọn những tập tin nào bạn muốn lưu và vị trí lưu chúng trên máy tính của mình.
general-tags-header = Nhãn
general-reading-and-viewing-header = Đọc & xem
general-reading-and-display-header = Đọc & hiển thị
general-updates-header = Cập nhật
general-network-and-storage-header = Mạng và lưu trữ
general-search-performance-label = Tìm kiếm & hiệu năng
compose-writing-emails-header = Viết email
...
compose-message-formatting-title = Định dạng thư
compose-address-autocomplete-header = Tự động điền địa chỉ
...
choose-display-language-description = Chọn ngôn ngữ được sử dụng cho menu, nút bấm và thông báo.
...
manual-storage-limit-label =
    .label = Đặt thủ công giới hạn dung lượng lưu trữ cho các tập tin tạm thời
    .accesskey = M
clear-temp-files-button =
    .label = Xoá các tập tin tạm thời
    .accesskey = C
clear-temp-files-shutdown-label =
    .label = Xoá các tập tin tạm thời khi đóng { -brand-short-name }
    .accesskey = s
...
show-start-page-label =
    .label = Hiển thị Trang bắt đầu khi khởi chạy { -brand-short-name }
    .accesskey = W
start-page-label =
...
start-in-tray-label =
    ...
    .accesskey = S
new-message-arrival-legend = Khi có thư mới đến:
...
use-custom-sound-label =
    .label = Sử dụng âm thanh tùy chỉnh cho thông báo
    .accesskey = U
mail-select-audio-button =
    .label = Chọn âm thanh…
    .accesskey = A
enable-global-search-label =
    .label = Bật chức năng tìm kiếm trên tất cả các tài khoản email
    .accesskey = e
gloda-results-plain-list-label =
    .label = Hiển thị kết quả tìm kiếm dưới dạng danh sách đơn giản
    .accesskey = L
...
gloda-show-results-as-list-label =
    .label = Hiển thị kết quả tìm kiếm chung dưới dạng danh sách theo mặc định
    .accesskey = L
datetime-formatting-legend = Định dạng ngày và giờ
display-language-legend = Ngôn ngữ hiển thị
allow-graphics-accel =
    .label = Sử dụng tăng tốc đồ họa để cuộn mượt mà hơn và cải thiện hiệu năng
    .accesskey = h
storage-format-label =
    .value = Định dạng lưu trữ cho các tài khoản mới:
    .accesskey = T
mbox-store-single-label =
    .label = Mỗi tập tin chứa một thư mục (mbox)
...
hide-titlebar-label =
    .label = Ẩn thanh tiêu đề
    .accesskey = H
hide-titlebar-description = Loại bỏ thanh trên cùng hiển thị tên cửa sổ để tiết kiệm không gian màn hình
hide-tabbar-single-tab-label =
    .label = Ẩn thanh thẻ khi chỉ mở một thẻ
    .accesskey = Ẩ
auto-hide-tabbar-second-tab-description = Tự động ẩn thẻ cho đến khi bạn mở thẻ thứ hai.
system-settings-legend = Cài đặt hệ thống
check-email-app-label =
    .label = Luôn kiểm tra xem { -brand-short-name } có phải là ứng dụng email mặc định hay không khi khởi chạy.
    .accesskey = A
...
update-settings-title = Cài đặt cập nhật
install-updates-automatically-label =
    .label = Tự động cài đặt các bản cập nhật (được đề xuất)
    .accesskey = A
install-updates-automatically-description = Giữ { -brand-short-name } an toàn với các bản vá bảo mật mới nhất.
check-updates-ask-label =
    .label = Kiểm tra các bản cập nhật, nhưng hãy hỏi trước khi cài đặt
    .accesskey = C
...
connection-config-description = Kiểm soát cách { -brand-short-name } kết nối internet.
connection-options-button =
    .label = Cài đặt kết nối…
    .accesskey = S
offline-mode-legend = Chế độ ngoại tuyến
offline-settings-label = Thiết lập ngoại tuyến
...
offline-settings-button =
    .label = Ngoại tuyến…
    .accesskey = O
temporary-storage-legend = Lưu trữ tạm thời
offline-compact-remove-deleted =
    .label = Xoá dữ liệu khỏi các thư mục khi chúng đã bị xoá để giải phóng dung lượng lưu trữ
    .accesskey = a
offline-compact-ask-cleanup =
    .label = Hỏi trước khi dọn dẹp thư mục
    .accesskey = b
...
use-cache-before =
    ...
    .accesskey = U
use-temp-storage-after = MB dung lượng lưu trữ cho các tập tin tạm thời
...
underline-text-links-label =
    .label = Gạch chân các liên kết văn bản trong thư
    .accesskey = k
...
convert-emoticons-label =
    ...
    .accesskey = e
display-text-formatting-label = Định dạng văn bản trích dẫn
...
always-ask-label =
    ...
    .accesskey = A
use-tags-text = Sử dụng tag để phân loại và ưu tiên thư.
...
mark-read-when-opened =
    .label = Ngay khi mở ra
    .accesskey = o
show-attachments-inline-label =
    .label = Hiển thị tập tin đính kèm trong nội dung thư
    .accesskey = m
mark-read-no-delay =
...
display-name-only-label =
    .label = Chỉ hiển thị tên hiển thị cho các liên hệ đã được lưu trong sổ địa chỉ
    .accesskey = S
...
show-conversation-view-label =
    .label = Hiển thị chế độ hội thoại
    .accesskey = c
conversation-view-preview-description = Đây là tính năng trong giai đoạn thử nghiệm. Nó nhóm các thư có liên quan lại với nhau, nhưng có thể không phải lúc nào cũng hoạt động như mong đợi.
...
dark-mode-message-appearance = Diện mạo thư
dark-mode-checkbox-label =
    .label = Sử dụng chế độ tối cho văn bản thư
    .accesskey = d
dark-mode-message-text-description = Áp dụng nền tối cho tất cả các thư đến, ngay cả khi người gửi đã định dạng chúng bằng màu sáng.
...
dark-message-mode-toggle-label =
    ...
    .accesskey = t
dark-mode-toggle-description = Cho phép bạn nhanh chóng chuyển email về chế độ sáng trong khi đọc mà không cần thay đổi cài đặt chính.
general-folder-settings-header = Cài đặt thư mục
recent-folders-legend = Thư mục gần đây
recent-folders-description = Tùy chỉnh cách hiển thị các thư mục được sử dụng gần đây khi di chuyển thư.
dark-message-mode-toggle-description = Hiển thị công tắc trong header thư để nhanh chóng tắt chế độ tối cho thư
general-folder-options-header = Tùy chọn quản lý thư mục
recent-destinations-legend = Điểm đến gần đây
recent-destinations-description = Các tùy chọn để liệt kê và sắp xếp các thư mục nơi thư vừa được chuyển đến.
recent-sort-order-label = Thứ tự sắp xếp:
    .accesskey = S
recent-sort-order-mru =
    .label = Gần đây nhất
recent-sort-order-alphabetic =
    .label = Theo thứ tự chữ cái
max-recent-label = Số lượng tối đa các thư mục gần đây:
    .accesskey = M
...
account-hub-manual-config-checkbox-label =
    .label = Sử dụng quy trình cấu hình thủ công trong Trung tâm tài khoản mới
    .accesskey = c
account-hub-manual-config-checkbox-description = Quy trình cấu hình thủ công trong trung tâm tài khoản mới
new-calendar-legend = Hộp thoại sự kiện lịch mới
new-calendar-checkbox-label =
    .label = Xem các sự kiện lịch trong hộp thoại mới
new-calendar-checkbox-description = Hộp thoại lịch mới mang tính thử nghiệm để xem sự kiện
...
add-file-type-label =
    .label = Thêm loại tập tin vào các thư đính kèm
    .accesskey = e
extension-label =
    .label = thêm phần mở rộng cho tên tập tin
    .accesskey = e
forward-messages-label =
    .value = Chuyển tiếp thư dưới dạng:
    .accesskey = F
forward-inline-label =
    .label = Bên trong thư (nằm cùng dòng)
...
autosave-draft-label =
    .label = Tự động lưu bản nháp sau mỗi
    .accesskey = A
...
spellcheck-while-typing-label =
    .label = Kiểm tra chính tả khi đang gõ
    .accesskey = E
...
ignore-sender-styles-label =
    .label = Bỏ qua phông chữ và màu sắc của người gửi
    .accesskey = d
...
paragraph-spacing-label =
    .label = Nhấn Enter sẽ bắt đầu một đoạn văn mới với khoảng cách rộng hơn
    .accesskey = P
...
compose-format-automatic-option =
    .label = Tự động (đề xuất)
compose-format-automatic-description = Gửi văn bản đã định dạng nếu bạn thêm kiểu (như chữ đậm hoặc liên kết), hoặc văn bản thuần túy nếu bạn không thêm kiểu nào.
compose-format-both-option =
    .label = Cả văn bản định dạng (HTML) và văn bản thuần túy
compose-format-both-description = Luôn gửi cả hai phiên bản để ứng dụng email của người nhận có thể chọn phiên bản nào để hiển thị.
compose-format-html-option =
    .label = Chỉ văn bản định dạng (HTML)
compose-format-html-description = Giữ nguyên phông chữ, màu sắc và hình ảnh tùy chỉnh, nhưng một số ứng dụng email cũ hơn có thể không hiển thị đúng cách.
compose-format-plain-option =
    .label = Chỉ văn bản thuần tuý
compose-format-plain-description = Loại bỏ tất cả định dạng, màu sắc và hình ảnh. Thích hợp nhất cho các email văn bản đơn giản, có thể sử dụng ở mọi nơi.
autocomplete-matches-description = Khi nhập tên hoặc email của người nhận, hãy tìm kết quả phù hợp trong:
company-network-directory-label =
    .label = Danh bạ công ty hoặc mạng
    .accesskey = C
directory-server-label =
    .label = Máy chủ thư mục (Directory server)
    .accesskey = D
...
collect-outgoing-label =
    .label = Tự động lưu địa chỉ email gửi đi vào:
    .accesskey = A
collect-outgoing-description = Nơi lưu trữ các liên hệ mới khi được tạo thủ công hoặc thêm từ email.
save-added-contacts-label =
    .value = Lưu các liên hệ được thêm thủ công vào:
    .accesskey = m
save-added-contacts-description = Nơi lưu trữ các liên hệ mới từ email.
show-directory-startup-label =
    .value = Hiển thị thư mục trong cửa sổ sổ địa chỉ khi mở { -brand-short-name }
    .accesskey = S
...
email-picker-label =
    ...
    .accesskey = A
email-picker-description = Vị trí lưu trữ các liên hệ mới từ thư đã gửi.
default-add-address-book-label =
    .value = Sổ địa chỉ mặc định cho các liên hệ được thêm thủ công:
    .accesskey = D
default-add-address-book-description = Vị trí của các liên hệ mới được lưu từ thư đã nhận.
...
offer-share-large-files-label =
    .label = Đề xuất chia sẻ tập tin bằng liên kết khi dung lượng vượt quá:
...
search-preferences-input2 =
    ...
    .style = width: 15.4em
managed-by-organization-notice = { -brand-short-name } đang được quản lý bởi một tổ chức.
...
accent-color-selection-label =
    .value = Chọn màu cho nút chính và các điểm nhấn
accent-color-label =
...
card-view-options-legend = Cài đặt xem thẻ
...
default-message-list-new-folders-description = Chọn các tùy chọn sắp xếp và phân luồng mặc định cho thư mục mới
...
default-sort-by-label = Sắp xếp thư theo:
...
default-sort-newest-bottom =
    .label = Thư mới nhất ở cuối trang
default-sort-new-messages-top =
    .label = Thư mới nhất ở đầu trang
apply-view-settings-label = Áp dụng các thiết lập hiển thị này cho:
apply-view-settings-to-all-folders-button =
    .label = Tất cả thư mục và thư mục con
    .accesskey = A
