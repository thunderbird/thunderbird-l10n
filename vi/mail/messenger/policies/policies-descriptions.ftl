...
policy-DisableChat = Tắt tính năng Trò chuyện.
policy-DisableCommunity = Không nên hiển thị các tính năng cộng đồng trong giao diện người dùng (như quyên góp, tham gia, chia sẻ ý tưởng, v.v.)
policy-DisableDataCollectionSettings = Ngăn người dùng thay đổi cài đặt thu thập dữ liệu.
...
policy-DisableFileLink = Vô hiệu hóa tính năng Filelink.
...
policy-DisableMessageForwardingFilters = Ngăn chặn bộ lọc thư tự động chuyển tiếp thư.
...
policy-DisableUpdateSettings = Ngăn chặn người dùng thay đổi cài đặt cập nhật ứng dụng.
