...
calendar-context-attendance-occurrence-label =
    .value = Бұл қайталануы
calendar-context-attendance-all-series-label =
    .value = Оқиғалардың барлық қайталанулары
...
calendar-task-input-filter-field =
    .aria-label = Тапсырмаларды сүзгілеу
...
# Variables:
#   $location (String) - The calendar server location.
calendar-auth-enter-user-password-for = { $location } сіздің пайдаланушы атын және паролін сұрап тұр.
