...
calendar-creation-location-placeholder =
    .placeholder = Күнтізбе серверінің URL немесе хост аты
    .default-placeholder = Күнтізбе серверінің URL немесе хост аты
calendar-creation-network-nocredentials =
    .label = Бұл орналасу тіркелу мәлеметтерін сұрамайды
