...
policy-DisableChat = Чат функциясын сөндіру.
policy-DisableCommunity = Пайдаланушы интерфейсінде қауымдастық мүмкіндіктерін көрсетпеу (мысалы, "Демеушілік ету", "Үлес қосу", "Идеялармен бөлісу" және т.б.)
...
policy-DisableFileLink = Filelink мүмкіндігін сөндіру.
...
policy-DisableMessageForwardingFilters = Хабарлама сүзгілеріне хабарламаларды автоматты түрде қайта бағдарлауға жол бермеу.
...
policy-DisableExperimentalFeatures = Thunderbird ішіндегі эксперименттік мүмкіндіктерді сөндіру.
...
policy-DisableUpdateSettings = Пайдаланушының қолданбаны жаңарту параметрлерін өзгертуіне жол бермеу.
