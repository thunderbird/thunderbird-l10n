...
quick-filter-bar-tag-mode-none =
    .label = Тек тегтелмеген
    .title = Тек тегтері жоқ хабарламалар
...
folder-pane-header-toggle-full-path =
    .label = Толық жолды көрсету
folder-pane-header-hide-local-folders =
    .label = Жергілікті бумаларды жасыру
folder-pane-mode-header-all = Барлық бумалар
folder-pane-mode-header-unread = Оқылмаған бумалар
...
folder-pane-mode-header-tags = Тегтер
...
threadpane-column-header-a11y-select =
    .aria-label = Хабарламаларды таңдау
...
folder-pane-context-reset-sort =
    .label = Бумалар ретін қалпына келтіру
    .accesskey = р
# Variables:
