...
account-hub-servers-username-label = Пайдаланушы аты:
account-hub-result-server-label = Сервер:
account-hub-result-port-label = Порт:
account-hub-result-security-label = Қауіпсіздік:
account-hub-result-authentication-type-label = Аутентификация:
account-hub-result-authentication-none = Ешнәрсе
    .title = Ешнәрсе
account-hub-result-authentication-password = Қалыпты пароль
    .title = Қалыпты пароль
account-hub-result-authentication-encrypted-password = Шифрленген пароль
    .title = Шифрленген пароль
account-hub-result-authentication-gssapi = Kerberos
    .title = Kerberos
account-hub-result-authentication-ntlm = NTLM
    .title = NTLM
account-hub-result-authentication-external = Сыртқы
    .title = Сыртқы
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = Ешнәрсе
account-hub-result-auth-password = Қалыпты пароль
account-hub-result-auth-encrypted-password = Шифрленген пароль
account-hub-result-auth-gssapi = Kerberos
account-hub-result-auth-ntlm = NTLM
account-hub-result-auth-external = Сыртқы
...
account-hub-privacy-policy = Жекелік саясаты
account-hub-welcome = Қош келдіңіз
account-hub-welcome-brand = { -brand-short-name }
account-hub-welcome-text = { -brand-short-name } өніміне қош келдіңіз
account-hub-name-warning-icon =
    .title = Атыңызды енгізіңіз
account-hub-email-label = Эл. пошта адресі
    .accesskey = Э
...
account-hub-password-label = Пароль
    ...
    .accesskey = а
account-hub-remember-password = Парольді есте сақтау
    .accesskey = т
account-hub-exchange-label = Сіздің логиніңіз
    .accesskey = л
account-hub-installing-addon = Қосымшаны жүктеп алу және орнату…
account-hub-success-addon = Қосымша сәтті орнатылды.
account-hub-success-half-manual = Келесі баптаулар берілген сервермен байланысып көру арқылы табылды:
account-hub-result-security-no-encryption = Шифрлеусіз
    .title = Шифрлеусіз
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = Шифрлеусіз
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = Аутентификация сәтсіз аяқталды. Пайдаланушы атын мен парольді тексеріңіз
...
account-hub-exchange-config-unverifiable = Баптауларды растау мүмкін емес. Пайдаланушы аты мен пароліңіз дұрыс болса, бұл сервер әкімшісі сіздің тіркелгіңіз үшін таңдалған баптауды сөндіргенін білдіруі мүмкін. Басқа хаттаманы таңдап көріңіз.
account-hub-advanced-setup-button = Кеңейтілген баптаулар
    .accesskey = а
# Variables:
#  $domain (String): The name of the server where the configuration was found, e.g. rackspace.com.
account-hub-exchange-dialog-question = { -brand-short-name } { $domain } жерінде сіздің тіркелгіңіздің баптау ақпаратын тапты. Жалғастырып, тіркеу мәліметтерін жіберуді қалайсыз ба?
account-hub-creation-error-title = Тіркелгіні жасау қатесі
account-hub-error-server-exists = Кіріс пошта сервері бар болып тұр.
account-hub-confirm-advanced-title = Кеңейтілген баптауларды растау
account-hub-confirm-advanced-description = Бұл сұхбат терезесі жабылады және конфигурация дұрыс болмаса да, ағымдағы параметрлермен тіркелгі жасалады. Жалғастырғыңыз келе ме?
account-hub-addon-install-title = Орнату
account-hub-encryption-button = Өтпелі шифрлеу
account-hub-address-books-button = Адрестік кітапшалар
account-hub-calendars-button = Күнтізбелер
...
account-hub-port-help-text = Егер бос қалдырылса, { -brand-short-name } портты табуға әрекет жасайды.
...
account-hub-result-graph-api-description = Бумалар мен электрондық поштаңызды Microsoft 365 арқылы синхрондау үшін Microsoft Graph API пайдалану
account-hub-result-graph-shortname = Exchange (Graph)
account-hub-result-graph-description = Бумалар мен эл. поштаңызды синхрондау үшін Microsoft Graph API пайдалану
...
account-hub-result-ews-expanded-text = Exchange веб-қызметтері
...
account-hub-config-success-title = Тіркелгі параметрлері автоматты түрде табылды.
account-hub-config-success-description-db = Конфигурация Mozilla ISPDB ішінен табылды.
account-hub-config-success-description-exchange = Конфигурация Microsoft Exchange сервері үшін табылды.
account-hub-config-success-description-guess = Конфигурация сервердің жалпы атауларын қолданып көру арқылы табылды.
account-hub-config-success-description-disk = Конфигурация { -brand-short-name } орнатуында табылды.
...
account-hub-select-security-warning = <span data-l10n-name="error-text">Ескерту: Қауіпсіз емес пошта сервері анықталды.</span> Бұл серверде шифрлеу жоқ, бұл сіздің пароліңізді және деректеріңізді ашып көрсетеді. Байланысты қауіпсіздендіру үшін әкімшіге хабарласыңыз немесе өз тәуекеліңізге жалғастырыңыз. <a data-l10n-name="error-link">Қосымша ақпарат алу үшін Жиі қойылатын сұрақтар бөлімін қараңыз.</a>
account-hub-security-warning = <span data-l10n-name="security-warning">Ескерту: Қауіпсіз емес пошта сервері анықталды.</span> Бұл серверде шифрлеу жоқ, бұл сіздің пароліңізді және деректеріңізді ашып көрсетеді. Байланысты қауіпсіздендіру үшін әкімшіге хабарласыңыз немесе өз тәуекеліңізге жалғастырыңыз. <a data-l10n-name="faq-link">Қосымша ақпарат алу үшін Жиі қойылатын сұрақтар бөлімін қараңыз.</a>
...
address-book-add-remote-icon2 =
    .alt = Қашықтағы адрестік кітапшасын қосу
address-book-add-remote-icon =
    .alt = Жаңа қашықтағы адрестік кітапшасын қосу
address-book-add-remote = Қашықтағы адрестік кітапшасын қосу
address-book-add-remote-carddav-description = CardDAV адрестік кітапшасына байланысу
...
address-book-add-ldap-icon2 =
    .alt = LDAP адрестік кітапшасын қосу
address-book-add-ldap-button = LDAP адрестік кітапшасын қосу
