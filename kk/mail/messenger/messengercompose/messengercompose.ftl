...
blocked-content-message =
    { $count ->
        [one] { -brand-short-name } бұл хабарламаға жүктеуден файлды блоктады. Файлды блоктаудан босату нәтижесінде ол жіберілген хабарламаға қосылады.
       *[other] { -brand-short-name } бұл хабарламаға жүктеуден кейбір файлдарды блоктады. Файлды блоктаудан босату нәтижесінде ол жіберілген хабарламаға қосылады.
    }
# Variables:
#   $count - the number keywords
attachment-reminder-keywords-msg =
    { $count ->
        [one] Салынымның кілтсөзі табылды:
       *[other] Салынымның { $count } кілтсөзі табылды:
    }
...
cloudfile-uploading-notification =
    { $count ->
        [one] Сіздің файлыңыз байланыстырылуда. Дайын болған кезде ол хабарламаның денесінде көрсетілетін болады.
       *[other] Сіздің файлдарыңыз байланыстырылуда. Дайын болған кезде олар хабарламаның денесінде көрсетілетін болады.
    }
