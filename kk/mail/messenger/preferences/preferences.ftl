...
general-email-notifications-header = Эл. пошта хабарландырулары
...
general-files-and-attachment-description = Компьютеріңізде қандай файлдар және қайда сақталатынын таңдаңыз.
...
general-network-and-storage-header = Желі және сақтау қоймасы
general-search-performance-label = Іздеу және өнімділік
compose-writing-emails-header = Эл. поштаны жазу
...
compose-message-formatting-title = Хабарламаны пішімдеу
compose-address-autocomplete-header = Адресті автотолтыру
...
gloda-show-results-as-list-label =
    .label = Үнсіз келісім бойынша, глобалды іздеу нәтижелерін тізім ретінде көрсету
    .accesskey = з
...
connection-config-description = { -brand-short-name } интернетке қалай қосылатынын басқару.
connection-options-button =
    .label = Қосылым опциялары…
    .accesskey = с
offline-mode-legend = Желіден тыс жұмыс істеу режимі
offline-settings-label = Желіден тыс режимінің баптаулары
...
offline-settings-button =
    .label = Желіден тыс…
    .accesskey = ы
temporary-storage-legend = Уақытша сақтау қоймасы
offline-compact-remove-deleted =
    .label = Сақтау қоймасын босату үшін әлдеқашан өшірілген деректерді бумалардан өшіру
    .accesskey = а
offline-compact-ask-cleanup =
    .label = Бумаларды тазалау алдында сұрау
    .accesskey = д
...
use-cache-before =
    .value = Дейін қолдану
    .accesskey = о
use-temp-storage-after = уақытша файлдар үшін МБ орын
...
underline-text-links-label =
    .label = Хабарламалардағы мәтіндік сілтемелердің астын сызу
    .accesskey = т
...
convert-emoticons-label =
    ...
    .accesskey = С
display-text-formatting-label = Дәйексөз мәтінін пішімдеу
...
search-content-types =
    .placeholder = Мазмұн түрлерін іздеу
...
always-ask-label =
    ...
    .accesskey = ж
use-tags-text = Хабарламаларды санатта бөлу және оларға басымдық беру үшін тегтерді қолданыңыз.
...
mark-read-when-opened =
    .label = Ашылған кезде бірден
    .accesskey = ш
show-attachments-inline-label =
    .label = Салынымдарды хабарламаның негізгі мәтіні ішінде көрсету
    .accesskey = м
mark-read-no-delay =
...
dark-mode-message-appearance = Хабарламаның сыртқы көрінісі
dark-mode-checkbox-label =
    .label = Хабарлама мәтіні үшін қараңғы режимді қолдану
    .accesskey = р
dark-mode-message-text-description = Жіберуші оларды ашық түстермен пішімдеген болса да, барлық кіріс хабарламаларға қараңғы фонды іске асырады.
...
dark-message-mode-toggle-label =
    ...
    .accesskey = ы
dark-mode-toggle-description = Негізгі баптауларыңызды өзгертпей-ақ, оқу кезінде эл. поштаны ашық режимге жылдам қайтаруға мүмкіндік береді.
general-folder-settings-header = Бума баптаулары
recent-folders-legend = Жуырдағы бумалар
recent-folders-description = Хабарламаларды жылжыту кезінде жуырда қолданылған бумалардың қалай көрінетінін басқарады.
...
general-folder-options-header = Бумаларды басқару параметрлері
recent-destinations-legend = Жуырдағы мақсаттар
recent-destinations-description = Ішіне жақында хабарламалар жылжытылған бумаларды тізіп шығару және сұрыптау опциялары.
recent-sort-order-label = Сұрыптау реті:
    .accesskey = С
recent-sort-order-mru =
    .label = Ең соңғы
recent-sort-order-alphabetic =
    .label = Әліпби бойынша
max-recent-label = Жуырдағы бумалардың ең көп саны:
    .accesskey = м
...
account-hub-manual-config-checkbox-label =
    .label = Тіркелгі орталығындағы жаңа қолмен баптау ағынын пайдаланыңыз
    .accesskey = к
account-hub-manual-config-checkbox-description = Тіркелгі орталығындағы жаңа қолмен конфигурациялау ағыны
new-calendar-legend = Жаңа күнтізбе оқиғасы сұхбат терезесі
new-calendar-checkbox-label =
    .label = Күнтізбе оқиғаларын жаңа сұхбат терезесінде қарау
new-calendar-checkbox-description = Оқиғаларды қарауға арналған эксперименттік жаңа күнтізбе сұхбат терезесі
...
add-file-type-label =
    .label = Тіркелген хабарламаларға файл түрін қосу
    .accesskey = е
extension-label =
...
ignore-sender-styles-label =
    .label = Жіберушінің қаріптері мен түстерін елемеу
    .accesskey = б
...
paragraph-spacing-label =
    .label = Enter пернесін басу қосымша шегінісі бар жаңа абзацты бастайды
    .accesskey = б
...
compose-format-automatic-option =
    .label = Автоматты түрде (ұсынылады)
...
email-picker-label =
    ...
    .accesskey = а
email-picker-description = Жіберілген хабарламалардан сақталған жаңа контактілердің орны.
default-add-address-book-label =
    .value = Қолмен қосылған контактілер үшін негізгі адрестік кітапшасы:
    .accesskey = н
default-add-address-book-description = Алынған хабарламалардан сақталған жаңа контактілердің орны.
...
spam-description = Бастапқы спам баптауларын орнатыңыз. Тіркелгілердің спам баптаулары Тіркелгі баптауларында өзгертуге болады.
spam-marked-label =
...
appearance-view-style-select =
    .value = Көрініс стилін таңдау:
appearance-view-style =
    .value = Қарау стилі:
appearance-radio-table =
    .label = Кесте көрінісі
appearance-radio-card-view =
    .label = Карточка көрінісі
card-view-options-legend = Карточка көрінісінің опциялары
...
default-message-list-new-folders-description = Жаңа бумалар үшін үнсіз келісім бойынша сұрыптау және ағындық көрсету опцияларын таңдау
...
default-sort-by-label = Хабарламаларды сұрыптау реті:
...
default-sort-newest-bottom =
    .label = Ең жаңа хабарламалар төменде
default-sort-new-messages-top =
    .label = Ең жаңа хабарламалар жоғарыда
