...
dark-message-mode-checkbox-description = Хабарлама негізгі бөлігі қараңғы темаға сай болатындай эксперименттік мүмкіндік
...
apply-sort-label = Бұл баптауларды келесілер үшін іске асыру:
