...
connection-internet-proxy-legend = Интернет қосылымы және прокси
...
proxy-autodetect-network =
    .label = Желі проксиін автоматты түрде анықтау
    .accesskey = Ж
proxy-type-wpad =
...
http-port-label =
    ...
    .accesskey = П
proxy-https-sharing =
    .label = Бұл проксиді қауіпсіз веб-адрестер (HTTPS) үшін қолдану
    .accesskey = к
proxy-http-sharing =
...
proxy-auto-script-url =
    .label = Автоматты баптау скриптінің URL-і:
    .accesskey = А
proxy-type-auto =
...
no-proxy-addresses-label =
    .value = Бұл адрестер үшін проксиді қолданбау:
    .accesskey = Б
no-proxy-label =
...
connection-proxy-local-network-desc = Жергілікті желі қосылымдары (localhost сияқты) проксиді ешқашан пайдаланбайды.
proxy-auto-login-saved-password =
    .label = Пароль сақталған болса, автоматты түрде кіру
...
proxy-socks-remote-dns =
    .label = Домендік сұрауларды (DNS) SOCKS v5 проксиі арқылы бағыттау
    .accesskey = Д
# Do not translate "localhost", "127.0.0.1/8" and "::1". (You can translate "and".)
