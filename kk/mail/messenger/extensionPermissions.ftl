...
webext-perms-description-experiment-access = Бұл қосымшада сіздің { -brand-short-name } және компьютеріңізге толық, шектеусіз рұқсаты бар болады.
...
webext-perms-description-messages-send = Көзбен шолу кері байланысынсыз, сіздің атыңыздан электрондық пошта хабарламаларын бағдарламалы түрде жаппай жіберу. Қосымшаның жіберу тарихын қарап шығу үшін Әрекеттер менеджерін пайдаланыңыз.
webext-perms-description-messages-save = Электрондық пошта хабарламаларын сіздің қатысуыңызсыз, бағдарламалы түрде шимайлар немесе үлгілер ретінде сақтау
