...
openpgp-key-gen-key-size-label = Кілт өлшемі
openpgp-key-gen-console-label = Кілтті генерациялау
openpgp-key-gen-key-type-label = Кілт түрі
openpgp-key-gen-key-type-rsa =
    .label = RSA
openpgp-key-gen-key-type-ecc =
    .label = ECC (эллиптикалық қисықтар)
openpgp-generate-key =
    .label = Кілтті генерациялау
...
delete-secret-key =
    ...
    Құпия кілтті өшірсеңіз, енді сол кілт үшін шифрленген хабарламаларды дешифрлей алмайсыз және оны қайта шақыра алмайсыз.
