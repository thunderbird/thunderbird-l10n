...
webext-perms-description-experiment-access = Detta tillägg kommer att ha full, obegränsad åtkomst till { -brand-short-name } och din dator.
...
webext-perms-description-messages-save = Spara e-postmeddelanden som utkast eller mallar programmatiskt, utan din interaktion
...
webext-perms-description-messengerSettings = Läs inställningarna för { -brand-short-name }
