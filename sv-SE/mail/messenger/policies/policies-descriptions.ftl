...
policy-DisableCommunity = Visa inte communityfunktioner i användargränssnittet (såsom donera, engagera dig, dela idéer etc.)
...
policy-DisableFileLink = Inaktivera Filelink-funktionen.
...
policy-DisableMessageForwardingFilters = Förhindra att meddelandefilter automatiskt vidarebefordrar meddelanden.
...
policy-DisableExperimentalFeatures = Inaktivera experimentella funktioner i Thunderbird.
...
policy-DisableUpdateSettings = Förhindra användaren från att ändra inställningar för applikationsuppdateringar.
