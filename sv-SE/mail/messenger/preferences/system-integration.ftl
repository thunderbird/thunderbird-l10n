...
default-app-intro = Använd { -brand-short-name } som standardapp för:
...
checkbox-net-thunderbird-url-label =
    .label = Anpassade Thunderbird-länkar (net.thunderbird://)
    .tooltiptext = { unset-default-tooltip }
...
check-on-startup-label =
    ...
    .accesskey = G
system-settings-dialog-title = Systeminställningar
