...
account-hub-servers-username-label = Användarnamn:
account-hub-result-server-label = Server:
account-hub-result-port-label = Port:
account-hub-result-security-label = Säkerhet:
account-hub-result-authentication-type-label = Autentisering:
account-hub-result-authentication-none = Ingen
    .title = Ingen
account-hub-result-authentication-password = Normalt lösenord
    .title = Normalt lösenord
account-hub-result-authentication-encrypted-password = Krypterat lösenord
    .title = Krypterat lösenord
...
account-hub-result-auth-password = Normalt lösenord
account-hub-result-auth-encrypted-password = Krypterat lösenord
...
account-hub-exchange-service-url-label = Ange tjänstens URL
...
account-hub-password-label = Lösenord
    .accesskey = L
    .title = Valfritt, kommer endast att användas för att validera användarnamnet
account-hub-remember-password = Kom ihåg lösenord
    .accesskey = K
account-hub-exchange-label = Din inloggning
    .accesskey = D
...
account-hub-creation-error-title = Fel vid skapande av konto
account-hub-error-server-exists = Inkommande server finns redan.
account-hub-confirm-advanced-title = Bekräfta avancerad konfiguration
account-hub-confirm-advanced-description = Denna dialogruta stängs och ett konto med de aktuella inställningarna skapas, även om konfigurationen är felaktig. Vill du fortsätta?
account-hub-addon-install-title = Installera
...
account-hub-result-graph-api-description = Använd Microsoft Graph API för att synkronisera dina mappar och e-postmeddelanden med Microsoft 365
account-hub-result-graph-shortname = Exchange (Graph)
account-hub-result-graph-description = Använd Microsoft Graph API för att synkronisera dina mappar och e-postmeddelanden
...
account-hub-result-ews-expanded-text = Exchange-webbtjänster
...
account-hub-config-success-title = Kontoinställningarna hittades automatiskt.
account-hub-config-success-description-db = Konfiguration hittades i Mozillas databas över internetleverantörer
account-hub-config-success-description-exchange = Konfiguration hittades för en Microsoft Exchange-server.
account-hub-config-success-description-guess = Konfiguration hittades genom att prova vanliga servernamn.
account-hub-config-success-description-disk = Konfiguration hittades i { -brand-short-name } installation.
account-hub-config-success-description-isp = Konfigurationen hittades hos e-postleverantören.
account-hub-config-success-description-read-more = Du kan <a data-l10n-name="automated-setup-link">läsa om hur automatisk e-postkonfiguration fungerar.</a>
...
account-hub-select-security-warning = <span data-l10n-name="error-text">Varning: Osäker e-postserver upptäcktes.</span> Denna server saknar kryptering, vilket exponerar ditt lösenord och data. Kontakta din administratör för att säkra anslutningen eller fortsätt på egen risk. <a data-l10n-name="error-link">Se vanliga frågor för mer info.</a>
...
account-hub-card-ews-tag = Föråldrat
