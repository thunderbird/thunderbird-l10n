...
folder-pane-header-toggle-full-path =
    .label = Visa fullständig sökväg
folder-pane-header-hide-local-folders =
    .label = Dölj lokala mappar
folder-pane-mode-header-all = Alla mappar
folder-pane-mode-header-unread = Olästa mappar
folder-pane-mode-header-favorite = Favoritmappar
folder-pane-mode-header-recent = Senaste mappar
