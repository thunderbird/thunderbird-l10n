...
toolbar-spam-label = Skräppost
toolbar-spam =
    .title = Markera de valda meddelandena som skräppost
toolbar-not-spam-label = Inte skräppost
toolbar-not-spam =
    .title = Markera de markerade meddelandena som inte skräppost
...
toolbar-add-address-book-label = Lägg till adressbok
