...
message-header-archived-at = Arkiverad-vid
...
message-header-archived-at-field = Arkiverad-vid<span data-l10n-name="field-separator">:</span>
...
# Direct link to the archived form of an individual email message. RFC 5064.
list-id-archived-at =
    .label = Permalänk till meddelande
    .accesskey = P
