...
calendar-search-options-searchfor =
    .value = innehållande
calendar-properties-dialog-title = Redigera kalender
calendar-server-dialog-name-label =
    .value = Kalendernamn
calendar-publish-dialog-window-title = Publicera kalender
calendar-publish-url-label = URL för publicering
calendar-publish-publish-dialog-button =
    .buttonlabelaccept = Publicera
...
calendar-error-description =
    .value = Beskrivning:
calendar-error-prompt-title = Ett fel har uppstått
...
calendar-auth-enter-user-password-for-calendar = ”{ $calendarName }” ({ $location }) begär ditt användarnamn och lösenord.
# Variables:
