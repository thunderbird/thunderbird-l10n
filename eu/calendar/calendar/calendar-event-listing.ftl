...
calendar-event-listing-column-creation-date =
    .label = Sortua
    .tooltiptext = Sortutako dataren arabera ordenatu
calendar-event-listing-column-last-modified-time =
    .label = Aldatuta
    .tooltiptext = Azkeneko aldaketaren dataren arabera ordenatu
...
calendar-event-listing-interval-future =
    .label = Etorkizuneko gertaera guztiak
calendar-event-listing-interval-all =
    .label = Gertaera guztiak
