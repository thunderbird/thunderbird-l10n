...
looking-for-messages-account = Mezu berrien bila { $accountName } kontuan...
# Feedback message shown in the status bar while we look for new messages in a
# specific folder.
# Variables:
# $folderName (String) - The folder's name.
looking-for-messages-folder = Mezu berrien bila { $folderName } n…
...
deleting-message =
    { $number ->
        [one] { $folderName } karpetatik mezu bat ezabatzen…
