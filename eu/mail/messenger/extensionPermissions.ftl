...
webext-perms-description-messages-send = Bidali mezu elektronikoak masiboki eta programazio bidez zure izenean, inolako ikusizko jakinarazpenik gabe. Erabili Jarduera-kudeatzailea gehigarriaren bidalketa-historiala berrikusteko.
webext-perms-description-messages-save = Gorde posta elektronikoko mezuak zirriborro edo txantiloi gisa programazio bidez, zure parte-hartzerik gabe.
...
webext-perms-description-messengerSettings = Irakurri { -brand-short-name } ezarpenak
