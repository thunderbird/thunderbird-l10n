...
account-hub-config-success-exchange = Microsoft Exchange serbitzarirako konfigurazioa aurkitua
account-hub-config-success-guess = Konfigurazioa aurkitu da ohiko zerbitzari-izenekin saiatzean
account-hub-config-success-disk = Konfigurazioa aurkitu da { -brand-short-name } instalazioan.
account-hub-config-success-isp = Konfigurazioa aurkitu da posta elektronikoaren hornitzailean
account-hub-config-success-unknown = Konfigurazioa aurkitua
