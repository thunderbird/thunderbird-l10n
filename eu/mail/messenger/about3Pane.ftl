...
folder-pane-header-toggle-full-path =
    .label = Helbide osoa ikusi
folder-pane-header-hide-local-folders =
    .label = Ezkutatu karpeta lokalak
folder-pane-mode-header-all = Karpeta guztiak
folder-pane-mode-header-unread = Irakurri gabeko karpetak
folder-pane-mode-header-favorite = Gogoko karpetak
folder-pane-mode-header-recent = Azken karpetak
folder-pane-mode-header-smart = Elkartutako karpetak
folder-pane-mode-header-tags = Etiketak
...
folder-pane-context-compact-all =
    .label = Trinkotu karpeta guztiak
    .accesskey = T
