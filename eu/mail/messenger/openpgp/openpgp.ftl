...
openpgp-use-primary-password = Kendu pasaesaldia eta babestu pasahitz nagusiarekin
...
openpgp-suggest-publishing-key = Gako publikoa gako-zerbitzari batean argitaratzeak besteei ikusteko aukera ematen die.
