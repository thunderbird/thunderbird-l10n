...
oauth-reauthorize-title = Reauthorize access
...
oauth-reauthorize-description = { $hostname } needs you to confirm access again to keep syncing with your account. Username: { $username }
