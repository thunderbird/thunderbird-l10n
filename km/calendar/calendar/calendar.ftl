...
calendar-task-mark-completed =
    .label = សម្គាល់ថាបានបញ្ចប់
    .accesskey = o
    .tooltiptext = សម្គាល់ថាបានបញ្ចប់កិច្ចការដែលបានជ្រើសរើស
...
calendar-completed-tasks-checkbox =
    .label = បង្ហាញកិច្ចការដែលបានបញ្ចប់
    .accesskey = c
calendar-properties-dialog-title = កែសម្រួលប្រតិទិន
...
calendar-error-prompt-title = កំហុសមួយបានកើតឡើង
new-event-input =
    .placeholder = ព្រឹត្តិការណ៍ថ្មី
new-task-input =
    .placeholder = ភារកិច្ចថ្មី
sendandclose-button =
    .label = ផ្ញើ និងបិទ
    .tooltiptext = ជូនដំណឹងដល់អ្នកចូលរួម ហើយបិទ
saveandsend-button =
    .label = រក្សាទុក និងផ្ញើ
    .tooltiptext = រក្សាទុក និងជូនដំណឹងដល់អ្នកចូលរួម
saveandsend-menu =
    .label = រក្សាទុក និងផ្ញើ
sendandclose-menu =
    .label = ផ្ញើ និងបិទ
