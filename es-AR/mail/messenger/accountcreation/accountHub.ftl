...
account-hub-result-host-url-label = URL de extremo de EWS
...
account-hub-config-success-guess = Las siguientes configuraciones fueron encontradas intentando nombres de servidor comunes
account-hub-config-success-disk = Configuración encontrada en la instalación de { -brand-short-name }
account-hub-config-success-isp = Las siguientes configuraciones fueron encontradas en: Proveedor de correo electrónico
