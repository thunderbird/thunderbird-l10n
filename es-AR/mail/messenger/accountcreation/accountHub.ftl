...
account-hub-address-book-username-error-text = Ingresá un nombre de usuario
account-hub-server-label = URL/Hostname
account-hub-server-tip = Thunderbird intentará detectar automáticamente tu nombre de host
