...
account-hub-email-setup-header = Agrega tu correo electrónico
...
account-hub-email-config-found = Elige tu tipo de cuenta de correo electrónico
...
account-hub-test-configuration = Pruebas
