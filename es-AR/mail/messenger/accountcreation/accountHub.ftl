...
account-hub-email-set-up-account-button = Configurar cuenta
account-hub-email-confirm-button = Confirmar
account-hub-email-find-settings-button = Buscar configuración
...
account-hub-result-authentication-type-label = Autenticación:
...
account-hub-exchange-service-url-label = Ingresar URL del servicio
...
account-hub-result-security-no-encryption = Sin cifrar
    .title = Sin cifrar
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = Sin cifrar
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = Falló la autenticación. Verifique el nombre de usuario y la contraseña
...
account-hub-confirm-advanced-description = Este diálogo se cerrará y se creará una cuenta con la configuración actual, aún cuando la configuración sea incorrecta. ¿Quiere continuar?
...
account-hub-manual-config-pop3-title = Configuración de POP3
account-hub-manual-config-review-settings-title = Revisar la configuración actualizada
account-hub-manual-config-incoming-legend = Servidor entrante
account-hub-manual-config-outgoing-legend = Servidor saliente
# Label for checkbox that will hide an outgoing username input if it's the same is the incoming
account-hub-same-username-checkbox = Mismo nombre de usuario que el servidor entrante
account-hub-protocol-imap = Sincronizar todos los dispositivos
...
account-hub-oauth-unsupported-description = { -brand-short-name } no puede configurar automáticamente OAuth2 para este nombre de host. Seleccione Configuración avanzada para crear la cuenta, luego complete la configuración desde Configuración de la cuenta. <a data-l10n-name="oauth-support-link">Obtenga ayuda con la configuración de OAuth2.</a>
...
account-hub-email-connect-settings = Conectar la configuración de correo electrónico
account-hub-email-protocol-select-header = Elegir un tipo de cuenta de correo electrónico
account-hub-email-protocol-select-notification = Se requiere información adicional para configurar esta cuenta
...
account-hub-result-graph-api-description = Usar la API de Microsoft Graph para sincronizar carpetas y correos electrónicos con Microsoft 365
account-hub-result-graph-shortname = Exchange (Graph)
account-hub-result-graph-description = Usar la API de Microsoft Graph para sincronizar carpetas y correos electrónicos
...
account-hub-config-success-title = Configuración de la cuenta encontrada automáticamente.
account-hub-config-success-description-db = Configuración encontrada en Mozilla ISPDB.
account-hub-config-success-description-exchange = Configuración encontrada para un servidor de Microsoft Exchange.
...
account-hub-config-success-description-read-more = Puede <a data-l10n-name="automated-setup-link">leer sobre cómo funciona la configuración automática de correo electrónico.</a>
...
account-hub-manual-config-error-summary = Resuelva los siguientes errores:
...
account-hub-select-security-warning = <span data-l10n-name="error-text">Advertencia: Se detectó un servidor de correo inseguro.</span> Este servidor carece de cifrado, lo que expone su contraseña y datos. Contacte a su administrador para asegurar la conexión o proceda bajo su propio riesgo. <a data-l10n-name="error-link">Para más información, vea las preguntas frecuentes.</a>
...
address-book-add-remote-icon2 =
    .alt = Agregar una libreta de direcciones remota
address-book-add-remote-icon =
    .alt = Agregar una nueva libreta de direcciones remota
address-book-add-remote = Agregar libreta de direcciones remota
address-book-add-remote-carddav-description = Conectar a una libreta de direcciones CardDAV
...
address-book-add-ldap-icon2 =
    .alt = Agregar una libreta de direcciones LDAP
address-book-add-ldap-button = Agregar libreta de direcciones LDAP
...
account-hub-card-ews-description = Exchange Web Services (EWS) se conecta a Microsoft Exchange para sincronizar el correo.
# This is shown after the type description, so "it" is referring to the type (either Microsoft Graph or Exchange Web Services).
account-hub-card-recommended-description = Recomendado porque coincide con la URL del servicio.
account-hub-exchange-type-username = Nombre de usuario
account-hub-exchange-type-username-hint = Normalmente la dirección de correo electrónico o UPN de Active Directory.
account-hub-exchange-type-authentication = Método de autenticación
# Checkbox that can be unchecked to use a custom OAuth config.
account-hub-exchange-type-default-oauth = Usar la configuración de autenticación predeterminada de Microsoft 365 Copilot
account-hub-exchange-type-oauth-tenant = ID de cuenta empresarial
account-hub-exchange-type-oauth-app = ID de aplicación
account-hub-exchange-type-advanced-config = Configuración avanzada
account-hub-exchange-type-title = Elegir un tipo de cuenta
