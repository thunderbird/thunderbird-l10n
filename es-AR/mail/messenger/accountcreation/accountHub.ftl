...
account-hub-exchange-service-url-label = Ingresá la URL del servicio
...
account-hub-protocol-imap = Sincroniza entre dispositivos
...
account-hub-email-protocol-select-header = Elegí un tipo de cuenta de correo electrónico
...
account-hub-result-graph-api-description = Usar la API de Microsoft Graph para sincronizar sus carpetas y correos electrónicos con Microsoft 365
...
account-hub-card-ews-description = Exchange Web Services (EWS) se conecta a Microsoft Exchange para sincronizar su correo.
...
account-hub-exchange-type-username-hint = Normalmente su dirección de correo electrónico o UPN de Active Directory.
