...
policy-DisableChat = Deshabilitar la función de chat.
policy-DisableCommunity = No mostrar las funciones de la comunidad en la interfaz de usuario (como donar, involucrarse, compartir ideas, etc.)
policy-DisableDataCollectionSettings = Evitar que el usuario cambie la configuración de recopilación de datos.
...
policy-DisableFileLink = Deshabilitar la función Filelink.
...
policy-DisableMessageForwardingFilters = Impedir que los filtros de mensajes reenvíen mensajes automáticamente.
...
policy-DisableExperimentalFeatures = Deshabilitar funciones experimentales en Thunderbird.
...
policy-DisableUpdateSettings = Evitar que el usuario cambie la configuración de actualización de la aplicación.
...
policy-InAppNotification = Habilitar o deshabilitar tipos de notificaciones.
