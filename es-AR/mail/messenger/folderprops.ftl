...
folder-props-rebuild-summary =
    ...
    .accesskey = R
    .tooltiptext = Reconstruir índice de archivo resumen
...
folder-props-check-for-new-messages =
    .label = Al buscar nuevos mensajes para esta cuenta, siempre comprobar esta carpeta
    .accesskey = c
...
folder-props-select-for-offline =
    .label = Seleccionar esta carpeta para usar sin conexión
    .accesskey = S
folder-props-download-now =
    .label = Descargar ahora
    .accesskey = D
folder-props-select-newsgroup-for-offline =
    .label = Seleccionar este grupo de noticias para usar sin conexión
    .accesskey = o
...
folder-props-permissions =
    .value = Tiene los siguientes permisos:
