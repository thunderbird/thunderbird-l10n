...
books-pane-create-contact-button = Nuevo contacto
    .title = Crear un nuevo contacto
books-pane-add-book-button =
    .title = Agregar libreta de direcciones
...
about-addressbook-search-all2 =
    .label = Buscar en todas las libretas de direcciones
...
about-addressbook-column-header-a11y-emailaddresses2 =
    .aria-label = Direcciones de correo electrónico
...
about-addressbook-column-header-a11y-addrbook2 =
    .aria-label = Libreta de direcciones
...
about-addressbook-photo-dialog-title =
    .aria-label = Administrar la foto para este contacto.
...
ab-search-dialog-matches-found =
    .value =
        { $count ->
            [one] { $count } coincidencia encontrada
...
ab-search-dialog-delete-button =
    .label = Borrar
    .accesskey = B
ab-search-dialog-title = Búsqueda avanzada en la libreta de direcciones
