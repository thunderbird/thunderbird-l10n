...
webext-perms-description-experiment-access = Este complemento tendrá acceso completo y sin restricciones a { -brand-short-name } y a su computadora.
...
webext-perms-description-messages-send = Envíe mensajes de correo electrónico de forma masiva en su nombre, sin ninguna retroalimentación visual. Use el administrador de actividad para revisar el historial de envíos del complemento.
webext-perms-description-messages-save = Guarde mensajes de correo electrónico como borradores o plantillas programáticamente, sin interacción
