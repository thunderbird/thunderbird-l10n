...
max-count-exceeded = (Nota: { $total } mensajes seleccionados, se muestran los { $shown } primeros)
...
max-thread-count-exceeded = (Nota: { $total } mensajes seleccionados, se muestran los { $shown } primeros)
