...
oauth-reauthorize-title = Reautorizar acceso
...
oauth-reauthorize-description = { $hostname } necesita que confirme el acceso nuevamente para seguir sincronizando con su cuenta. Nombre de usuario: { $username }
