...
oauth-result-footer-text = ¿Necesitás ayuda? Contactá a soporte.

## Successful authentication

oauth-success-title = Está todo listo
oauth-success-subtitle = Tu cuenta se conectó de forma segura a { -brand-short-name }.
