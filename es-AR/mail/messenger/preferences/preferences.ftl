...
allow-graphics-accel =
    .label = Use aceleración de gráficos para un desplazamiento y rendimiento más suaves
    .accesskey = U
...
hide-tabbar-single-tab-label =
    ...
    .accesskey = O
auto-hide-tabbar-second-tab-description = Oculta automáticamente las pestañas hasta que abras una segunda pestaña.
...
update-settings-title = Configuración de la actualización
install-updates-automatically-label =
    .label = Instalar actualizaciones automáticamente (recomendado)
    .accesskey = I
install-updates-automatically-description = Mantiene { -brand-short-name } seguro con las últimas correcciones de seguridad.
