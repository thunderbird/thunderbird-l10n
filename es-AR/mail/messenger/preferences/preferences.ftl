...
collection-community-description = { -brand-short-name } está construido por una comunidad global. Compartir datos de rendimiento anónimos nos ayuda a corregir errores más rápido y hacer que la aplicación sea más rápida para todos.
collection-privacy-policy = Lee nuestra política de privacidad
collection-data-sharing-off = <strong>El uso compartido de datos está desactivado.</strong> Los datos de uso anteriores se eliminarán permanentemente de { -vendor-short-name } servidores en un plazo de 30 días.
...
collection-share-performance =
    ...
    .accesskey = C
collection-share-performance-description = (Incluye información técnica básica como su sistema operativo, uso de memoria y actividad de las funciones. { -brand-short-name } nunca recopila contenido de correo electrónico, contactos o mensajes personales).
