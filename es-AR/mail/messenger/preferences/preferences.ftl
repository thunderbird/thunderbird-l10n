...
dark-message-mode-checkbox-label =
    ...
    .accesskey = H
dark-message-mode-checkbox-description = Función experimental para hacer que el cuerpo del mensaje siga temas oscuros
...
default-message-list-description = Define las opciones predeterminadas de orden y hebra para las carpetas recién creadas.
default-flag-label =
    .value = Enhebrado predeterminado:
