...
general-email-notifications-header = Notificaciones por correo electrónico
...
general-files-and-attachment-description = Seleccione qué archivos se guardarán y dónde se guardarán en su computadora.
general-tags-header = Etiquetas
general-reading-and-viewing-header = Lectura y visualización
general-reading-and-display-header = Lectura y visualización
general-updates-header = Actualizaciones
general-network-and-storage-header = Red y almacenamiento
general-search-performance-label = Búsqueda y rendimiento
compose-writing-emails-header = Escribir correos electrónicos
...
compose-message-formatting-title = Formato del mensaje
compose-address-autocomplete-header = Autocompletar direcciones
...
collection-improve-header = Datos recolectados para mejorar { -brand-short-name }
collection-community-description = { -brand-short-name } está creado por una comunidad global. Compartir datos de rendimiento anónimos nos ayuda a corregir errores más rápido y hacer que la aplicación sea más rápida para todos.
collection-privacy-policy = Lea nuestra política de privacidad
collection-data-sharing-off = <strong>El uso compartido de datos está desactivado.</strong> Los datos de uso anteriores se eliminarán permanentemente de los servidores de { -vendor-short-name } en un plazo de 30 días.
...
collection-share-performance =
    .label = Compartir datos de rendimiento anónimos con { -vendor-short-name }
    .accesskey = r
collection-share-performance-description = (Incluye información técnica básica como el sistema operativo, uso de memoria y actividad de las funciones. { -brand-short-name } nunca recopila contenido de correo electrónico, contactos o mensajes personales).
...
collection-share-crash-data =
    .label = Enviar informes anónimos de fallos a { -vendor-short-name }
    .accesskey = f
...
privacy-security-certificates-title = Certificados de seguridad
...
choose-display-language-description = Seleccionar el idioma usado para menús, botones y notificaciones.
...
manual-storage-limit-label =
    .label = Establecer manualmente límites de almacenamiento para archivos temporales
    .accesskey = m
clear-temp-files-button =
    .label = Borrar archivos temporales
    .accesskey = c
clear-temp-files-shutdown-label =
    .label = Borrar archivos temporales cuando se cierre { -brand-short-name }
    .accesskey = s
...
show-start-page-label =
    .label = Mostrar la página de inicio cuando se abra { -brand-short-name }
    .accesskey = g
start-page-label =
...
close-to-tray-label =
    ...
    .accesskey = C
start-in-tray-label =
    .label = Iniciar { -brand-short-name } en la bandeja del sistema
    .accesskey = s
new-message-arrival-legend = Cuando llegue un nuevo mensaje:
...
mail-play-button =
    .label = Reproducir
    .accesskey = d
change-dock-icon-description = Insignias y notificaciones de la aplicación
...
new-email-alert-label =
    .label = Mostrar una alerta para nuevos correos electrónicos
    .accesskey = s
...
use-custom-sound-label =
    .label = Usar sonido personalizado para alertas
    .accesskey = U
mail-select-audio-button =
    .label = Seleccionar audio…
    .accesskey = a
enable-global-search-label =
    .label = Habilitar la búsqueda en todas las cuentas de correo electrónico
    .accesskey = e
gloda-results-plain-list-label =
    .label = Mostrar resultados de búsqueda como una lista simple
    .accesskey = l
...
gloda-show-results-as-list-label =
    .label = Mostrar  resultados de búsqueda globales como una lista de forma predeterminada
    .accesskey = l
datetime-formatting-legend = Formato de fecha y hora
display-language-legend = Idioma para mostrar
allow-graphics-accel =
    .label = Usar aceleración de gráficos para un desplazamiento más suave y mejor rendimiento
    .accesskey = y
storage-format-label =
    .value = Formato de almacenamiento para cuentas nuevas:
    .accesskey = t
mbox-store-single-label =
    .label = Un solo archivo por carpeta (mbox)
...
enable-autoscroll-label =
    .label = Habilitar desplazamiento automático
    .accesskey = z
autoscroll-label =
...
hide-titlebar-label =
    ...
    .accesskey = u
hide-titlebar-description = Elimina la barra superior que muestra el nombre de la ventana para ahorrar espacio en la pantalla
hide-tabbar-single-tab-label =
    .label = Ocultar la barra de pestañas cuando haya una sola abierta
    .accesskey = t
auto-hide-tabbar-second-tab-description = Oculta automáticamente las pestañas hasta que se abra una segunda pestaña.
system-settings-legend = Configuración del sistema
...
update-settings-title = Configuración de actualización
install-updates-automatically-label =
    .label = Instalar actualizaciones automáticamente (recomendado)
    .accesskey = a
install-updates-automatically-description = Mantiene a { -brand-short-name } seguro con las últimas correcciones de seguridad.
check-updates-ask-label =
    .label = Buscar actualizaciones, pero preguntar antes de instalar
    .accesskey = c
...
connection-config-description = Controlar cómo { -brand-short-name } se conecta a Internet.
connection-options-button =
    .label = Opciones de conexión…
    .accesskey = s
offline-mode-legend = Modo sin conexión a la red
offline-settings-label = Configuración sin conexión
...
offline-settings-button =
    .label = Sin conexión…
    .accesskey = S
temporary-storage-legend = Almacenamiento temporal
offline-compact-remove-deleted =
    .label = Eliminar datos de carpetas cuando ya hayan sido eliminadas para liberar almacenamiento
    .accesskey = a
offline-compact-ask-cleanup =
    .label = Preguntar antes de limpiar carpetas
    .accesskey = u
...
use-cache-before =
    .value = Usar hasta
    .accesskey = U
use-temp-storage-after = MB de espacio para archivos temporales
...
underline-text-links-label =
    .label = Subrayar enlaces de texto en mensajes
    .accesskey = j
...
convert-emoticons-label =
    ...
    .accesskey = g
display-text-formatting-label = Formato de texto citado
...
always-ask-label =
    ...
    .accesskey = P
use-tags-text = Usar etiquetas para categorizar y priorizar mensajes.
...
mark-read-when-opened =
    .label = Inmediatamente al abrir
    .accesskey = b
show-attachments-inline-label =
    .label = Mostrar adjuntos dentro del cuerpo del mensaje
    .accesskey = M
mark-read-no-delay =
...
display-name-only-label =
    .label = Mostrar solo el nombre para mostrar de los contactos guardados en la libreta de direcciones
    .accesskey = s
...
show-conversation-view-label =
    .label = Mostrar vista de conversación
    .accesskey = c
conversation-view-preview-description = Esta es una función de vista previa. Agrupa los mensajes relacionados, pero puede que no siempre funcione como se esperaba.
...
dark-mode-message-appearance = Apariencia del mensaje
dark-mode-checkbox-label =
    .label = Usar modo oscuro para el texto de los mensajes
    .accesskey = d
dark-mode-message-text-description = Aplica un fondo oscuro a todos los mensajes entrantes, incluso si el remitente los formateó en colores claros.
...
dark-message-mode-toggle-label =
    ...
    .accesskey = t
dark-mode-toggle-description = Permite cambiar rápidamente un correo electrónico al modo claro mientras se lees, sin cambiar la configuración principal.
general-folder-settings-header = Configuración de carpetas
recent-folders-legend = Carpetas recientes
recent-folders-description = Controla cómo aparecen las carpetas usadas recientemente al mover mensajes.
...
general-folder-options-header = Opciones de administración de carpetas
recent-destinations-legend = Destinos recientes
recent-destinations-description = Opciones para listar y ordenar las carpetas a las que se movieron los mensajes recientemente.
recent-sort-order-label = Orden:
    .accesskey = O
recent-sort-order-mru =
    .label = Más recientes
recent-sort-order-alphabetic =
    .label = Alfabético
max-recent-label = Número máximo de carpetas recientes:
    .accesskey = m
...
account-hub-manual-config-checkbox-label =
    .label = Usar el nuevo flujo de configuración manual en Centro de cuentas
    .accesskey = c
account-hub-manual-config-checkbox-description = Flujo de configuración manual del centro de cuentas nuevas
new-calendar-legend = Diálogo de nuevo evento del calendario
new-calendar-checkbox-label =
    .label = Ver eventos del calendario en el nuevo diálogo
new-calendar-checkbox-description = Nuevo diálogo experimental de calendario para ver eventos
...
as-attachment-label =
    .label = Como adjunto
add-file-type-label =
    .label = Agregar tipo de archivo a los mensajes adjuntos
    .accesskey = e
extension-label =
    .label = Agregar la extensión al nombre de archivo
    .accesskey = n
forward-messages-label =
    .value = Reenviar mensajes como:
    .accesskey = j
forward-inline-label =
    .label = Dentro del mensaje (inline)
...
autosave-draft-label =
    .label = Guardar automáticamente un borrador cada
    .accesskey = a
...
ignore-sender-styles-label =
    .label = Ignorar fuentes y colores del remitente
    .accesskey = d
...
paragraph-spacing-label =
    .label = Al presionar Enter se comienza un nuevo párrafo con espacio adicional
    .accesskey = p
...
compose-format-automatic-description = Envía texto con formato si se agregan estilos (como negrita o enlaces) o texto sin formato si no se lo hace.
compose-format-both-option =
    .label = Tanto texto enriquecido (HTML) como texto plano
compose-format-both-description = Siempre envía ambas versiones para que la aplicación de correo electrónico del destinatario pueda elegir cuál mostrar.
compose-format-html-option =
    .label = Solo texto enriquecido (HTML)
compose-format-html-description = Mantiene las fuentes, colores e imágenes personalizados, pero es posible que algunas aplicaciones de correo electrónico antiguas no lo muestren correctamente.
compose-format-plain-option =
    .label = Solo texto plano
compose-format-plain-description = Elimina todo el formato, colores e imágenes. Mejor para correos electrónicos de texto simples que funcionan en todas partes.
autocomplete-matches-description = Al escribir el nombre o correo electrónico de un destinatario, buscar coincidencias en:
company-network-directory-label =
    .label = Directorio de la empresa o red
    .accesskey = D
...
manage-directories-label =
    .label = Administrar directorios…
    .accesskey = e
collect-outgoing-label =
    .label = Guardar automáticamente las direcciones de correo electrónico salientes en:
    .accesskey = a
collect-outgoing-description = Donde se guardan los nuevos contactos cuando se crean manualmente o se agregan desde correos electrónicos.
save-added-contacts-label =
    .value = Guardar contactos agregados manualmente en:
    .accesskey = m
save-added-contacts-description = Dónde se guardan los nuevos contactos de los correos electrónicos.
show-directory-startup-label =
    .value = Mostrar directorio en la ventana de la libreta de direcciones al abrir { -brand-short-name }
    .accesskey = s
...
email-picker-label =
    ...
    .accesskey = A
email-picker-description = La ubicación de los nuevos contactos guardados de los mensajes enviados.
default-add-address-book-label =
    .value = Libreta de direcciones predeterminada para contactos agregados manualmente:
    .accesskey = d
default-add-address-book-description = La ubicación de los nuevos contactos guardados de los mensajes recibidos.
...
attachment-label =
    ...
    .accesskey = j
edit-keywords-label =
    .label = Editar palabras clave…
    .accesskey = v
offer-share-large-files-label =
    .label = Ofrecer compartir archivos por enlace cuando superen:
...
exceptions-button =
    .label = Excepciones…
    .accesskey = E
remote-content-privacy-link = Cómo el contenido remoto afecta la privacidad
remote-content-privacy-info = Conozca más sobre los problemas de privacidad del contenido remoto
remote-content-info =
...
third-party-visited-only =
    .label = Solo de los sitios visitados
third-party-visited =
    .label = De visitados
cookies-button =
...
global-privacy-control-label =
    .label = Pedir a los sitios web que no vendan ni compartan datos personales
    .accesskey = P
...
passwords-registered-description = { -brand-short-name } puede guardar contraseñas para cuentas registradas.
view-saved-passwords-button =
    .label = Ver contraseñas guardadas…
    .accesskey = V
primary-password-session-description = Una contraseña maestra protege todas las contraseñas y se ingresa una vez por sesión.
use-primary-password-label =
    .label = Usar contraseña maestra
    .accesskey = U
do-not-track-label =
...
spam-accounts-description = Esta configuración se aplica a todas las cuentas. Las opciones de cuentas individuales se pueden cambiar en la configuración de la cuenta.
...
spam-move-folder-label =
    .label = Mover a la carpeta de correo no deseado
    .accesskey = M
spam-delete-immediately-label =
    .label = Borrar inmediatamente
    .accesskey = B
spam-move-label =
...
spam-marked-manually-label =
    .label = Cuando se marca manualmente
    .accesskey = C
spam-detected-auto-label =
    .label = Cuando sea detectado automáticamente por { -brand-short-name }
    .accesskey = C
spam-log-keep-label =
    .label = Mantener un registro de la detección automática de spam
    .accesskey = M
...
spam-read-auto-label =
    ...
    .accesskey = t
spam-log-label =
    .label = Habilitar registro del filtro adaptivo de spam
    .accesskey = e
spam-log-button =
...
reset-spam-button =
    ...
    .accesskey = r
scam-detection-description = { -brand-short-name } verifica los mensajes en busca de enlaces de phishing y signos comunes de estafas por correo electrónico.
scam-detection-label =
    .label = Avisar al leer un correo electrónico que parezca una estafa
    .accesskey = A
antivirus-check-description = Permite que el software antivirus verifique los mensajes entrantes individualmente antes de guardarlos en su computadora.
antivirus-isolate-label =
    .label = Permitir que el software antivirus aísle los correos electrónicos entrantes infectados
    .accesskey = P
certificate-verify-description = Cuando un servidor pida un certificado para verificar su identidad:
certificate-choose-auto =
    .label = Elegir un certificado automáticamente
    .accesskey = E
certificate-ask-every =
    .label = Preguntar siempre
    .accesskey = P
ocsp-check-label =
    .label = Compruebe los servidores de validación de certificados (OCSP) para confirmar que los certificados siguen siendo correctos.
    .accesskey = C
...
email-e2ee-accounts-info = Los correos electrónicos cifrados solo pueden ser leídos por usted y sus destinatarios. Configurar cuentas de correo electrónico e identidades para el cifrado de extremo a extremo en la <a data-l10n-name="account-settings-url">Configuración de la cuenta</a>.
...
email-e2ee-automatism-intro = { -brand-short-name } puede activar el cifrado si hay claves o certificados aceptados válidos disponibles para todos los destinatarios de un mensaje.
email-e2ee-turn-on =
    .label = Habilitar automáticamente el cifrado cuando sea posible
email-e2ee-turn-off =
...
email-e2ee-automatism-note = Nota: También puede activar o desactivar manualmente el cifrado mientras escribe un mensaje. Responder a un mensaje cifrado siempre activa el cifrado.
...
remote-content-images-label =
    .label = Permitir contenido remoto (imágenes y estilos)
    .accesskey = P
...
preferences-doh-setting-automatic =
    .label = Protección automática (Recomendada)
    .accesskey = P
preferences-doh-automatic-desc = { -brand-short-name } cifra automáticamente las búsquedas de direcciones cuando esté disponible. Vuelve a las búsquedas de red estándar si hay un problema de conexión o si una VPN/red administrada lo requiere.
...
preferences-doh-setting-enabled =
    ...
    .accesskey = i
preferences-doh-increased-desc = Siempre usa el proveedor elegido. Usa conexión estándar solo si falla el proveedor seguro.
...
preferences-doh-setting-maximum =
    ...
    .accesskey = M
preferences-doh-maximum-desc = Estrictamente requiere DNS cifrado. Los sitios web no se cargarán si falla la conexión segura.
...
preferences-doh-setting-off =
    .label = Desactivado
    .accesskey = o
preferences-doh-off-standard-desc = Usa una red o proveedor de Internet estándar para buscar direcciones web
...
preferences-doh-secure-description = El DNS seguro cifra las solicitudes de búsqueda que envía { -brand-short-name } para encontrar sitios web, manteniendo su actividad de navegación privada de cualquier monitoreo de red.
...
search-preferences-input2 =
    ...
    .style = width: 15.4em
managed-by-organization-notice = { -brand-short-name } es administrado por una organización.
...
qr-export-passwords-legend = Contraseñas
qr-export-include-passwords-label = Incluir contraseñas de cuentas en el código QR
qr-export-web-sign-in-note = <strong>Nota:</strong> Las cuentas que usan inicio de sesión web (como Gmail o Yahoo) requieren autenticación nuevamente en tu dispositivo.
qr-export-private-transfer-note = <strong>Transferencia privada:</strong> Tu configuración y contraseñas se mueven directamente desde esta computadora a tu teléfono. Nada se envía ni almacena en los servidores de Mozilla.
qr-export-screen-privacy-tip = <strong>Consejo:</strong> Mantené la pantalla oculta de los demás mientras se muestra el código QR.
...
qr-export-pane-header-mobile = Exportar a { -brand-product-name } móvil
qr-export-description-email-accounts = Transferí tus cuentas de correo electrónico desde esta computadora a { -brand-product-name } en tu teléfono usando un código QR.
...
accent-color-selection-label =
    .value = Seleccionar color para botón primario y resaltados
accent-color-label =
    .value = Definir el color usado para los botones primarios y elementos resaltados:
accent-color-os =
    .label = Seguir configuración del sistema operativo
accent-color-thunderbird =
    .label = Thunderbird azul
accent-color-purple =
    .label = Púrpura
accent-color-orange =
    .label = Naranja
...
appearance-view-style-select =
    .value = Seleccionar estilo de vista:
...
card-view-options-legend = Opciones de vista de tarjeta
...
default-message-list-new-folders-description = Seleccionar opciones predeterminadas de orden y conversaciones para las carpetas nuevas
...
default-sort-by-label = Ordenar mensajes por:
...
default-sort-newest-bottom =
    .label = Los mensajes más nuevos al final
default-sort-new-messages-top =
    .label = Los mensajes más nuevos en la parte superior
apply-view-settings-label = Aplicar esta configuración de vista a:
apply-view-settings-to-all-folders-button =
    .label = Todas las carpetas y subcarpetas
    .accesskey = a
