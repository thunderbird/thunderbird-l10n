...
convert-emoticons-label =
    ...
    .accesskey = g
display-text-formatting-label = Formato del texto citado
...
always-ask-label =
    ...
    .accesskey = P
use-tags-text = Usá etiquetas para categorizar y priorizar mensajes.
...
dark-mode-checkbox-label =
    .label = Usar el modo oscuro para los mensajes de texto
    .accesskey = U
...
dark-message-mode-toggle-label =
    ...
    .accesskey = t
dark-mode-toggle-description = Te permite cambiar rápidamente un correo electrónico al modo ligero mientras lo lees, sin cambiar la configuración principal.
...
compose-format-automatic-description = Envía texto con formato si agregas estilos (como negrita o enlaces) o texto sin formato si no lo haces.
...
compose-format-html-description = Mantiene las fuentes, colores e imágenes personalizados, pero es posible que algunas aplicaciones de correo electrónico antiguas no se muestren correctamente.
