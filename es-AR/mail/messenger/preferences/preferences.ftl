...
antivirus-isolate-label =
    ...
    .accesskey = a
certificate-verify-description = Cuando un servidor pida un certificado para verificar identidad:
...
certificate-ask-every =
    ...
    .accesskey = a
ocsp-check-label =
    .label = Comprobar los servidores de validación de certificados (OCSP) para confirmar que los certificados siguen siendo correctos.
    .accesskey = v
