...
toolbar-spam =
    .title = Marcar los mensajes seleccionados como spam
toolbar-not-spam-label = No es spam
toolbar-not-spam =
    .title = Marcar los mensajes seleccionados como no spam
...
toolbar-add-address-book-label = Agregar libreta de direcciones
