...
calendar-search-options-searchfor =
    .value = што содржат
calendar-properties-dialog-title = Уредување на календар
calendar-server-dialog-title-edit =
    .title = Уредување на календар
calendar-server-dialog-name-label =
    .value = Име на календарот:
calendar-publish-dialog-window-title = Објавување на календар
...
calendar-error-description =
    .value = Опис:
calendar-error-prompt-title = Настана грешка!
