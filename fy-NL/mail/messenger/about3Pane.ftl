...
quick-filter-bar-tag-mode-none =
    .label = Allinnich net-labele
    .title = Allinnich  berjochten sûnder labels
...
threadpane-column-header-a11y-select =
    .aria-label = Berjochten selektearje
