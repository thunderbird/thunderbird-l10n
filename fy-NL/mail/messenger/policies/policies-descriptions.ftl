...
policy-DisableChat = De chatfunksje útskeakelje.
policy-DisableCommunity = Mienskipsfunksjes net yn de brûkersinterface toane (lykas Donearje, Meidwaan, Ideeën diele, ensfh.)
policy-DisableDataCollectionSettings = Foarkomme dat de brûker de ynstellingen foar gegevenssamling wiziget.
...
policy-DisableFileLink = De Filelink-funksje útskeakelje.
...
policy-DisableMessageForwardingFilters = Foarkomme dat berjochtefilters automatysk berjochten trochstjoere.
...
policy-DisableExperimentalFeatures = Eksperimintele funksjes yn Thunderbird útskeakelje.
...
policy-DisableUpdateSettings = Foarkomme dat de brûker de ynstellingen foar tapassingsupdates wiziget.
