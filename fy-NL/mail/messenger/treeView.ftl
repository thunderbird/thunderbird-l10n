...
tree-list-view-row-read-status =
    .alt = Lêzen-statusyndikator
    .title = Berjocht lêzen
tree-list-view-row-not-read-status =
    .alt = Net-lêzen-statusyndikator
    .title = Berjocht net lêzen
