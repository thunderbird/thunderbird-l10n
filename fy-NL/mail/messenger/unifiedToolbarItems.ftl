...
toolbar-spam =
    .title = Selektearre berjochten as net-winske markearje
toolbar-not-spam-label = Gjin net-winske
toolbar-not-spam =
    .title = Selektearre berjochten as gjin net-winske markearje
...
toolbar-add-address-book-label = Adresboek tafoegje
