...
general-email-notifications-header = E-mailnotifikaasjes
...
general-files-and-attachment-description = Selektearje hokker bestannen bewarre wurde moatte en wêr’t se op jo kompjûter bewarre wurde moatte.
general-tags-header = Labels
general-reading-and-viewing-header = Lêze en besjen
general-reading-and-display-header = Lêze en werjefte
general-updates-header = Fernijingen
general-network-and-storage-header = Netwurk en ûnthâld
general-search-performance-label = Sykje en prestaasjes
compose-writing-emails-header = E-mailberjochten opstelle
...
compose-message-formatting-title = Berjochtopmaak
compose-address-autocomplete-header = Automatyske adresoanfolling
...
choose-display-language-description = Kies de taal dy’t brûkt wurdt foar menu’s, knoppen en notifikaasjes.
...
manual-storage-limit-label =
    .label = Hânmjittich ûnthâldlimiten foar tydlike bestannen ynstelle
    .accesskey = H
clear-temp-files-button =
    .label = Tydlike bestannen wiskje
    .accesskey = T
clear-temp-files-shutdown-label =
    .label = Tydlike bestannen wiskje as { -brand-short-name } sletten wurdt
    .accesskey = T
...
show-start-page-label =
    .label = De startside toane by iepenjen fan { -brand-short-name }
    .accesskey = D
start-page-label =
...
start-in-tray-label =
    ...
    .accesskey = b
new-message-arrival-legend = As in nij berjocht binnen komt:
...
mail-play-button =
    .label = Ofspylje
    .accesskey = f
change-dock-icon-description = App-badges en -notifikaasjes
change-dock-icon = Wizigje eigenskippen fan it programmasymboal
app-icon-options =
    .label = Programmasymboalopsjes…
    .accesskey = p
new-email-alert-label =
    .label = In warskôging foar nije e-mailberjochten toane
    .accesskey = I
customize-alerts-label =
    .label = Warskôgingen oanpasse…
    .accesskey = p
...
use-custom-sound-label =
    .label = Oanpast lûd foar warskôgingen brûke
    .accesskey = b
mail-select-audio-button =
    .label = Audio selektearje…
    .accesskey = A
enable-global-search-label =
    .label = Sykje yn alle e-mailaccounts ynskeakelje
    .accesskey = e
gloda-results-plain-list-label =
    .label = Sykresultaten as in list toane
    .accesskey = S
...
gloda-show-results-as-list-label =
    .label = Algemiene sykresultaten standert as list toane
    .accesskey = s
datetime-formatting-legend = Datum- en tiidnotaasje
display-language-legend = Werjeftetaal
allow-graphics-accel =
    .label = Grafyske fersnelling foar soepeler scrolle en prestaasjes brûke
    .accesskey = G
storage-format-label =
    .value = Unthâldyndieling foar nije accounts:
    .accesskey = U
...
enable-autoscroll-label =
    .label = Automatysk scrolle ynskeakelje
    .accesskey = c
autoscroll-label =
...
hide-titlebar-label =
    .label = Titelbalke ferstopje
    .accesskey = f
hide-titlebar-description = Smyt de boppeste balke mei de finsternamme fuort om skermromte te besparjen
hide-tabbar-single-tab-label =
    .label = De ljepblêdenbalke ferstopje as mar ien ljepblêd iepene is
    .accesskey = D
auto-hide-tabbar-second-tab-description = Ferberget automatysk ljepblêden oant jo in twadde ljepblêd iepenje.
system-settings-legend = Systeemynstellingen
check-email-app-label =
    .label = Altyd kontrolearje oft { -brand-short-name } de standert e-mailapp is as it iepene wurdt
    .accesskey = A
edit-defaults-apps-button =
    .label = Standertynstellingen bewurkje…
    .accesskey = S
...
update-settings-title = Ynstellingen bywurkje
install-updates-automatically-label =
    .label = Fernijingen automatysk ynstallearje (oanrekommandearre)
    .accesskey = F
install-updates-automatically-description = Hâldt { -brand-short-name } feilich mei de nijste befeiligingsoplossingen.
check-updates-ask-label =
    .label = Kontrolearje op fernijingen, mar freegje foar ynstallaasje
    .accesskey = K
...
connection-config-description = Bepale hoe’t { -brand-short-name } ferbining makket mei it ynternet.
connection-options-button =
    .label = Ferbiningsopsjes…
    .accesskey = F
offline-mode-legend = Offlinemodus
offline-settings-label = Offline-ynstellingen
...
offline-settings-button =
    ...
    .accesskey = S
temporary-storage-legend = Tydlik ûnthâld
offline-compact-remove-deleted =
    .label = Gegevens út mappen fuortsmite as se al wiske binne om opslachromte frij te meitsjen
    .accesskey = G
offline-compact-ask-cleanup =
    .label = Freegje foar it opromjen fan mappen
    .accesskey = F
...
use-cache-before =
    .value = Oant
    .accesskey = O
use-temp-storage-after = MB romte foar tydlike bestannen
...
underline-text-links-label =
    .label = Tekstkeppelingen yn berjochten ûnderstreekje
    .accesskey = p
...
convert-emoticons-label =
    ...
    .accesskey = m
display-text-formatting-label = Opmaak fan sitearre tekst
...
search-content-types =
    .placeholder = Typen ynhâld sykje
...
always-ask-label =
    ...
    .accesskey = M
use-tags-text = Brûk labels om berjochten te kategorisearjen en te prioritearjen.
...
mark-read-when-opened =
    .label = Daliks by iepenjen
    .accesskey = D
show-attachments-inline-label =
    .label = Bylagen yn de berjochttekst toane
    .accesskey = y
mark-read-no-delay =
...
display-name-only-label =
    .label = Allinnich werjeftenamme toane foar kontakten dy’t yn it adresboek bewarre binne
    .accesskey = A
...
show-conversation-view-label =
    .label = Konversaasjewerjefte toane
    .accesskey = K
conversation-view-preview-description = Dit is in iere foarbyldfunksje. It groepearret relatearre berjochten, mar it wurket miskien net altyd sa’t ferwachte.
...
dark-mode-message-appearance = Berjochtúterlik
dark-mode-checkbox-label =
    .label = Donkere modus brûke foar berjochttekst
    .accesskey = D
dark-mode-message-text-description = Past in donkere eftergrûn ta op alle ynkommende berjochten, sels as de ôfstjoerder se yn ljochte kleuren opmakke hat.
...
dark-message-mode-toggle-label =
    ...
    .accesskey = h
dark-mode-toggle-description = Lit jo in e-mailberjocht by it lêzen fluch weromsette nei ljochte modus, sûnder jo haadynstellingen te wizigjen.
general-folder-settings-header = Mapynstellingen
recent-folders-legend = Resinte mappen
recent-folders-description = Bepaalt hoe koartlyn brûkte mappen ferskine by it ferpleatsen fan berjochten.
...
general-folder-options-header = Opsjes foar mappebehear
recent-destinations-legend = Resinte bestimmingen
recent-destinations-description = Opsjes foar it toanen en sortearjen fan mappen dêr’t koartlyn berjochten nei ferpleatst binne.
recent-sort-order-label = Sortearfolchoarder:
    .accesskey = S
recent-sort-order-mru =
    .label = Meast resint
recent-sort-order-alphabetic =
    .label = Alfabetysk
max-recent-label = Maksimum oantal resinte mappen:
    .accesskey = M
...
account-hub-manual-config-checkbox-label =
    .label = De nije hânmjittige konfiguraasjestream yn Account Hub brûke
    .accesskey = k
account-hub-manual-config-checkbox-description = Hânmjittige-konfiguraasjestream nije accounthub
new-calendar-legend = Dialoochfinster Nije aginda-barren
new-calendar-checkbox-label =
    .label = Aginda-barrens yn it nije dialoochfinster besjen
new-calendar-checkbox-description = Eksperiminteel nij agindadialoochfinster foar it besjen fan barrens
...
as-attachment-label =
    .label = As bylage
add-file-type-label =
    .label = Bestânstype oan tafoege berjochten tafoegje
    .accesskey = y
extension-label =
    .label = Ekstinsje oan bestânsnamme tafoegje
    .accesskey = t
forward-messages-label =
    .value = Berjochten trochstjoere as:
    .accesskey = t
forward-inline-label =
    .label = Yn it berjocht (inline)
...
autosave-draft-label =
    .label = Konsept automatysk bearje om de
    .accesskey = a
...
ignore-sender-styles-label =
    .label = Lettertypen en kleuren fan de ôfstjoerder negearje
    .accesskey = g
...
paragraph-spacing-label =
    .label = Op Enter drukke begjint in nije alinea mei ekstra ôfstân
    .accesskey = d
...
compose-format-automatic-option =
    .label = Automatysk (oanrekommandearre)
compose-format-automatic-description = Opmakke tekst ferstjoere as jo stilen tafoegje (lykas fet of keppelingen), of platte tekst as jo dat net dogge.
compose-format-both-option =
    .label = Sawol RTFtekst (HTML) as platte tekst
compose-format-both-description = Altyd beide ferzjes ferstjoere, sadat de e-mailapp fan de ûntfanger kieze kin hokker werjûn wurde moat.
compose-format-html-option =
    .label = Allinnich opmakke tekst (HTML)
compose-format-html-description = Behâldt oanpaste lettertypen, kleuren en ôfbyldingen, mar guon âldere e-mailapps jouwe it miskien net goed wer.
compose-format-plain-option =
    .label = Allinnich platte tekst
compose-format-plain-description = Smyt alle opmaak, kleuren en ôfbyldingen fuort. It bêste foar ienfâldige tekstberjochten dy’t oeral wurkje.
autocomplete-matches-description = As jo de namme of it e-mailadres fan in ûntfanger ynfiere, sykje dan nei oerienkomsten yn:
company-network-directory-label =
    .label = Bedriuws- of netwurkadresboek
    .accesskey = B
...
manage-directories-label =
    .label = Directories beheare…
    .accesskey = D
collect-outgoing-label =
    .label = E-mailadressen fan útgeande berjochten automatysk tafoegje oan:
    .accesskey = E
collect-outgoing-description = Wêr’t nije kontakten bewarre wurde as se mei de hân oanmakke of tafoege wurde fan e-mailberjochten út.
save-added-contacts-label =
    .value = Hânmjittich tafoege kontakten bewarje yn:
    .accesskey = H
save-added-contacts-description = Wêr’t nije kontakten út e-mailberjochten bewarre wurde.
show-directory-startup-label =
    .value = Map yn it adresboekfinster toane by it iepenjen fan { -brand-short-name }
    .accesskey = M
...
email-picker-label =
    ...
    .accesskey = t
email-picker-description = De lokaasje fan nije bewarre kontakten fan ferstjoerde berjochten út.
default-add-address-book-label =
    .value = Standertadresboek foar hânmjittich tafoege kontakten:
    .accesskey = S
default-add-address-book-description = De lokaasje fan nije bewarre kontakten fan ûntfongen berjochten út.
...
attachment-label =
    ...
    .accesskey = f
edit-keywords-label =
    .label = Trefwurden bewurkje…
    .accesskey = T
offer-share-large-files-label =
    .label = Oanbiede om bestannen fia in keppeling te dielen as se grutter binne as:
...
exceptions-button =
    .label = Utsûnderingen…
    .accesskey = U
remote-content-privacy-info = Mear ynfo oer de privacysaken of ynbedde ynhâld
remote-content-info =
...
away-message-label =
    ...
    .accesskey = O
send-typing-label =
    .label = Typemeldingen ferstjoere yn konversaasjes
    .accesskey = T
...
search-preferences-input2 =
    ...
    .style = width: 15.4em
managed-by-organization-notice = { -brand-short-name } wurdt troch in organisaasje beheard.
...
accent-color-selection-label =
    .value = Selektearje in kleur foar de primêre knop en aksinten
accent-color-label =
...
appearance-view-style-select =
    .value = Selektearje werjeftestyl:
...
appearance-radio-card-view =
    .label = Kaartwerjefte
card-view-options-legend = Opsjes foar kaartwerjefte
...
default-message-list-new-folders-description = Selektearje de standert sortear- en petearopsjes foar nije makke mappen
...
default-sort-by-label = Berjochten sortearje op:
...
default-sort-newest-bottom =
    .label = Nijste berjochten ûnderoan
default-sort-new-messages-top =
    .label = Nijste berjochten boppe-oan
apply-view-settings-label = Dizze werjefte-ynstellingen tapasse op:
apply-view-settings-to-all-folders-button =
    .label = Alle mappen en submappen
    .accesskey = A
select-apply-sort-folders-button =
    .label = Mappen selektearje
    .accesskey = M
