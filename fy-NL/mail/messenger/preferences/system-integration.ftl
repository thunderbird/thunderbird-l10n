...
default-app-intro = { -brand-short-name } as standertapp brûke foar:
...
checkbox-net-thunderbird-url-label =
    .label = Oanpaste Thunderbird-keppelingen (net.thunderbird://)
    .tooltiptext = { unset-default-tooltip }
...
check-default-email-app-label =
    .label = Altyd kontrolearje oft { -brand-short-name } by iepenjen de standert e-mailapp is
    .accesskey = A
check-on-startup-label =
    .label = Dizze kontrole altyd útfiere by it starten fan { -brand-short-name }
    .accesskey = D
system-settings-dialog-title = Systeemynstellingen
