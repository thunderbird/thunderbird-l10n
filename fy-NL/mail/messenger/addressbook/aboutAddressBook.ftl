...
address-book-list =
    .aria-label = List fan adresboeken
...
about-addressbook-export-selected-filename = Kontakten
...
about-addressbook-photo-dialog-title =
    .aria-label = De foto foar dit kontakt beheare.
