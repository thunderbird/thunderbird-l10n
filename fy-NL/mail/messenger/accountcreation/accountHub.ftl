...
account-hub-servers-username-label = Brûkersnamme:
account-hub-result-server-label = Server:
account-hub-result-port-label = Poarte:
account-hub-result-security-label = Befeiliging:
account-hub-result-authentication-type-label = Autentikaasje:
account-hub-result-authentication-none = Gjin
    .title = Gjin
account-hub-result-authentication-password = Normaal wachtwurd
    .title = Normaal wachtwurd
account-hub-result-authentication-encrypted-password = Fersifere wachtwurd
    .title = Fersifere wachtwurd
account-hub-result-authentication-gssapi = Kerberos
    .title = Kerberos
account-hub-result-authentication-ntlm = NTLM
    .title = NTLM
account-hub-result-authentication-external = Ekstern
    .title = Ekstern
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = Gjin
account-hub-result-auth-password = Normaal wachtwurd
account-hub-result-auth-encrypted-password = Fersifere wachtwurd
account-hub-result-auth-gssapi = Kerberos
account-hub-result-auth-ntlm = NTLM
account-hub-result-auth-external = Ekstern
...
account-hub-exchange-service-url-label = Fier de service-URL yn
...
account-hub-password-label = Wachtwurd
    .accesskey = W
    .title = Opsjoneel, wurdt allinnich brûkt om de brûkersnamme te falidearjen
account-hub-remember-password = Wachtwurd ûnthâlde
    .accesskey = w
account-hub-exchange-label = Jo oanmelding
    .accesskey = o
account-hub-installing-addon = Add-on downloade en ynstallearje…
account-hub-success-addon = Add-on is mei sukses ynstallearre
account-hub-success-half-manual = De folgjende ynstellingen binne fûn troch de opjûne server te sykjen:
account-hub-result-security-no-encryption = Gjin fersifering
    .title = Gjin fersifering
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = Gjin fersifering
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = Autentikaasje mislearre. Kontrolearje de brûkersnamme en it wachtwurd
...
account-hub-exchange-config-unverifiable = Konfiguraasje koe net ferifiearre wurde. As jo brûkersnamme en wachtwurd goed binne, is it wierskynlik dat de serverbehearder de selektearre konfiguraasje foar jo account útskeakele hat. Probearje in oar protokol te selektearjen.
account-hub-advanced-setup-button = Wiidweidige konfiguraasje
    .accesskey = W
# Variables:
#  $domain (String): The name of the server where the configuration was found, e.g. rackspace.com.
account-hub-exchange-dialog-question = { -brand-short-name } hat jo accountynstellingen fan { $domain } fûn. Wolle jo trochgean en jo oanmeldgegevens ferstjoere?
account-hub-creation-error-title = Flater by oanmeitsjen fan account
account-hub-error-server-exists = Ynkommende server bestiet al.
account-hub-confirm-advanced-title = Wiidweidige konfiguraasje befêstigje
account-hub-confirm-advanced-description = Dit dialoochfinster sil sluten wurde en der wurdt in account mei de aktuele ynstellingen oanmakke, ek as de konfiguraasje net krekt is. Wolle jo trochgean?
account-hub-addon-install-title = Ynstallearje
...
account-hub-result-graph-api-description = De Microsoft Graph-API brûke om jo mappen en e-mailberjochten te syngronisearjen mei Microsoft 365
account-hub-result-graph-shortname = Exchange (Graph)
account-hub-result-graph-description = Microsoft Graph-API brûke om jo mappen en e-mailberjochten te syngronisearjen
...
account-hub-config-success-title = Accountynstellingen automatysk fûn.
account-hub-config-success-description-db = Konfiguraasje fûn yn de Mozilla-ISPDB.
account-hub-config-success-description-exchange = Konfiguraasje fûn foar in Microsoft Exchange-server.
account-hub-config-success-description-guess = Konfiguraasje fûn troch algemiene servernammen te probearjen.
account-hub-config-success-description-disk = Konfiguraasje fûn yn ynstallaasje fan { -brand-short-name }.
account-hub-config-success-description-isp = Konfiguraasje fûn by e-mailprovider.
account-hub-config-success-description-read-more = Jo kinne <a data-l10n-name="automated-setup-link">lêze oer hoe’t it automatysk ynstellen fan e-mail wurket.</a>
...
address-book-add-remote-icon2 =
    .alt = In ekstern adresboek tafoegje
address-book-add-remote-icon =
    .alt = In nij ekstern adresboek tafoegje
address-book-add-remote = Ekstern adresboek tafoegje
address-book-add-remote-carddav-description = Ferbining meitsje mei in CardDAV-adresboek
...
address-book-add-ldap-icon2 =
    .alt = In LDAP-adresboek tafoegje
address-book-add-ldap-button = LDAP-adresboek tafoegje
...
account-hub-card-graph-description = Microsoft Graph is in moderne ferbiningsmetoade foar Microsoft 365.
account-hub-card-ews-title = Exchange Web Services
account-hub-card-ews-tag = Ferâldere
account-hub-card-ews-description = Exchange Web Services (EWS) makket ferbining mei Microsoft Exchange om jo e-mail te syngronisearjen.
# This is shown after the type description, so "it" is referring to the type (either Microsoft Graph or Exchange Web Services).
account-hub-card-recommended-description = Dizze metoade wurdt oanrekommandearre, omdat dizze oerienkomt mei jo service-URL.
account-hub-exchange-type-username = Brûkersnamme
account-hub-exchange-type-username-hint = Trochgeans jo e-mailadres of Active Directory UPN.
account-hub-exchange-type-authentication = Autentikaasjemetoade
# Checkbox that can be unchecked to use a custom OAuth config.
account-hub-exchange-type-default-oauth = Standert Microsoft 365 Copilot-autentikaasje-ynstellingen brûke
account-hub-exchange-type-oauth-tenant = Tenant-ID
account-hub-exchange-type-oauth-app = App-id
account-hub-exchange-type-advanced-config = Wiidweidige konfiguraasje
account-hub-exchange-type-title = Kies in accounttype
