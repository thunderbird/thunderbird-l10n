...
options-backup-passphrase = Avaimen varmuuskopiointisalasana
...
options-encryption-need-backup-passphrase = Anna varmuuskopioavaimesi salasana protokolla-asetuksiin.
