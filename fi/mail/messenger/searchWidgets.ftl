...
search-attrib-spam-score-origin = Roskapostipisteiden alkuperä
search-attrib-spam-percent = Roskapostiprosentti
search-attrib-attachment-status = Liitteen tila
search-attrib-spam-status = Roskapostin tila
...
rule-action-set-spam-status =
    .label = Aseta roskapostin tilaksi
rule-action-delete =
    .label = Poista viesti
