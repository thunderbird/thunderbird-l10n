...
privacy-spam-header = Roskaposti
...
condensed-addresses-label =
    ...
    .accesskey = N
table-layout-legend = Taulukkonäkymä
...
dark-message-mode-legend = Viestin luennan tyyli
dark-message-mode-checkbox-label =
    .label = Ota tummien viestien tila käyttöön
    .accesskey = t
dark-message-mode-description = Pakota viestin runko noudattamaan tummia teemoja
dark-message-mode-toggle-label =
    .label = Näytä tumma viestitila -kytkin
    .accesskey = t
dark-message-mode-toggle-description = Näytä viestin otsikossa kytkin, jolla voit nopeasti poistaa tumman viestitilan käytöstä
general-folder-options-header = Kansion hallinnan asetukset
recent-destinations-legend = Viimeisimmät kohteet
recent-destinations-description = Vaihtoehdot niiden kansioiden listaamiseen ja lajitteluun, joihin viestejä on viimeksi siirretty.
recent-sort-order-label = Lajittelujärjestys:
    .accesskey = L
recent-sort-order-mru =
    .label = Viimeisimmät
recent-sort-order-alphabetic =
    .label = Aakkosjärjestys
max-recent-label = Viimeisimpien kansioiden enimmäismäärä:
    .accesskey = m
...
spam-description = Muokkaa roskapostisuodattimen oletusasetuksia. Tilikohtaisia asetuksia voi muokata Tilien asetuksista.
spam-marked-label =
    .label = Kun viestit merkitään roskapostiksi:
    .accesskey = i
spam-move-label =
    .label = Siirrä ne tilin roskapostikansioon
    .accesskey = o
spam-read-description = Merkitse viestit luetuiksi
spam-read-manual-label =
    .label = Kun merkitsen sen roskapostiksi
    .accesskey = m
spam-log-label =
    .label = Pidä lokia roskapostisuodattimen toiminnasta
    .accesskey = P
spam-log-button =
    .label = Näytä loki
    .accesskey = N
...
accent-color-label =
    .value = Määritä ensisijaisten painikkeiden ja korostettujen elementtien väri:
accent-color-os =
    .label = Seuraa käyttöjärjestelmää
accent-color-thunderbird =
    .label = Thunderbird-sininen
accent-color-purple =
    .label = Liila
accent-color-orange =
    .label = Oranssi
...
appearance-radio-cards =
    .label = Korttinäkymä
cards-view-legend = Korttinäkymän asetukset
table-view-legend = Taulukkonäkymän asetukset
...
appearance-card-style-2 =
    .label = 2 riviä
default-message-list-sorting-legend = Lajittelu ja ketjutus
default-message-list-description = Määritä uusien kansioiden oletuslajittelu- ja ketjutusasetukset.
default-flag-label =
...
default-flag-grouped =
    .label = Ryhmiteltynä
default-sort-label = Oletusjärjestys:
default-sort-date =
    .label = Päiväys
...
apply-thread-sort-label = Ota käyttöön ketjutus ja lajittelun asetukset:
