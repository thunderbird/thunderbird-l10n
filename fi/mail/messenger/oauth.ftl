...
oauth-reauthorize-title = Valtuuta käyttö uudelleen
...
oauth-reauthorize-description = { $hostname } tarvitsee sinun vahvistavan käyttöoikeutesi uudelleen, jotta synkronointi tilisi kanssa jatkuu. Käyttäjätunnus: { $username }
