...
account-hub-result-incoming-legend = Saapuva
account-hub-result-outgoing-legend = Lähtevä
account-hub-all-servers-legend = Kaikki palvelimet
...
account-hub-servers-username-label = Käyttäjätunnus:
account-hub-result-server-label = Palvelin:
account-hub-result-port-label = Portti:
account-hub-result-security-label = Suojaus:
account-hub-result-authentication-type-label = Todennus:
account-hub-result-authentication-none = Ei mitään
    .title = Ei mitään
account-hub-result-authentication-password = Normaali salasana
    .title = Normaali salasana
account-hub-result-authentication-encrypted-password = Salattu salasana
    .title = Salattu salasana
...
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = Ei mitään
    .title = Ei mitään
account-hub-result-auth-password = Normaali salasana
    .title = Normaali salasana
account-hub-result-auth-encrypted-password = Salattu salasana
    .title = Salattu salasana
...
account-hub-password-label = Salasana
    .accesskey = a
    .title = Valinnainen, käytetään vain käyttäjätunnuksen vahvistamiseen
account-hub-remember-password = Muista salasana
    .accesskey = M
account-hub-exchange-label = Kirjautumistietosi
    .accesskey = i
account-hub-installing-addon = Ladataan ja asennetaan lisäosaa…
account-hub-success-addon = Lisäosa asennettiin onnistuneesti
account-hub-success-half-manual = Löydettiin seuraavat asetukset tutkimalla määritettyä palvelinta:
account-hub-result-security-no-encryption = Ei salausta
    .title = Ei salausta
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = Ei salausta
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = Todennus epäonnistui. Tarkista käyttäjätunnus ja salasana
...
account-hub-confirm-advanced-description = Tämä ikkuna suljetaan ja tili luodaan annetuin asetuksin, vaikka asetukset olisivat väärin. Haluatko jatkaa?
account-hub-addon-install-title = Asenna
...
account-hub-manual-config-incoming-legend = Saapuvan postin palvelin
account-hub-manual-config-outgoing-legend = Lähtevän postin palvelin
