...
toolbar-spam-label = Roskaposti
toolbar-spam =
    .title = Merkitse valitut viestit roskapostiksi
toolbar-not-spam-label = Ei roskapostia
toolbar-not-spam =
    .title = Merkitse etteivät valitut viestit ole roskapostia
...
toolbar-add-address-book-label = Lisää osoitekirja
