...
quick-filter-bar-tag-mode-none =
    .label = Vain ilman tunnistetta olevat
    .title = Vain ilman tunnisteita olevat viestit
...
folder-pane-header-toggle-full-path =
    .label = Näytä koko polku
folder-pane-header-hide-local-folders =
    .label = Piilota paikalliset kansiot
folder-pane-mode-header-all = Kaikki kansiot
folder-pane-mode-header-unread = Kansiot, joissa lukematta
