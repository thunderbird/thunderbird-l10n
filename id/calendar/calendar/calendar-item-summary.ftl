...
calendar-item-summary-status-tentative = Tentatif
calendar-item-summary-status-confirmed = Telah Dikonfirmasi
calendar-item-summary-event-status-cancelled = Dibatalkan
calendar-item-summary-todo-status-cancelled = Dibatalkan
calendar-item-summary-status-needs-action = Butuh Tindakan
calendar-item-summary-status-in-process = Dalam Proses
calendar-item-summary-status-completed = Selesai pada
