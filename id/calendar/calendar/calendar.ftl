...
calendar-search-options-searchfor =
    .value = mengandung
calendar-properties-dialog-title = Ubah Kalender
calendar-server-dialog-name-label =
    .value = Nama Kalender:
calendar-publish-dialog-window-title = Terbitkan Kalender
calendar-publish-url-label = URL Penayangan
calendar-publish-publish-dialog-button =
    .buttonlabelaccept = Tayangkan
...
calendar-error-description =
    .value = Deskripsi:
calendar-error-prompt-title = Terjadi kesalahan
