...
openpgp-keygen-secret-protection = Perlindungan Kunci Rahasia
radio-keygen-no-protection =
    .label = Tidak Terlindungi
radio-keygen-protect-primary-pass =
    .label = Lindungi dengan Sandi Utama
radio-keygen-passphrase-protection =
    .label = Lindungi dengan frasa sandi:
openpgp-passphrase-repeat = Konfirmasikan frasa sandi:
...
openpgp-import-key-list-amount-2 = { -brand-short-name } menemukan { $count } kunci yang dapat diimpor.
...
openpgp-import-keep-passphrases =
    .label = Simpan perlindungan frasa sandi untuk kunci rahasia yang diimpor
