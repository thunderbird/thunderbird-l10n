...
openpgp-has-nested-encrypted-parts = Pesan ini menyertakan bagian terenkripsi tambahan.
openpgp-show-encrypted-parts = Dekripsi dan Tampilkan
openpgp-has-nested-signed-parts = Beberapa bagian dari pesan ini mungkin ditandatangani secara digital.
openpgp-show-signed-parts = Buka dan Tampilkan
