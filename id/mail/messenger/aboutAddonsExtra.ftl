...
add-on-options-button =
    .title = Opsi Pengaya
add-on-search-alternative-button-label = Temukan pengaya alternatif
add-on-learn-more-and-search-alternative-button-label = Pelajari selengkapnya dan temukan add-on alternatif
atn-addons-heading-search-input =
    .placeholder = Cari di addons.thunderbird.net
atn-addons-heading-search-button =
    .title = Cari di addons.thunderbird.net
