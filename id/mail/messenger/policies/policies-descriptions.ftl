...
policy-DisableChat = Nonaktifkan fitur Obrolan.
policy-DisableCommunity = Jangan tampilkan fitur komunitas di UI (seperti Berdonasi, Terlibat, Berbagi Ide, dll.)
policy-DisableDataCollectionSettings = Cegah pengguna mengubah pengaturan pengumpulan data.
...
policy-DisableFileLink = Nonaktifkan fitur Filelink.
...
policy-DisableMessageForwardingFilters = Cegah filter pesan meneruskan pesan secara otomatis.
...
policy-DisableExperimentalFeatures = Nonaktifkan fitur eksperimental di Thunderbird.
policy-DisableQRExport = Nonaktifkan pembuatan kode QR untuk mengekspor kredensial dan pengaturan akun.
...
policy-DisableUpdateSettings = Cegah pengguna mengubah pengaturan pembaruan aplikasi.
...
policy-PrimaryPassword = Memerlukan atau mencegah penggunaan Sandi Utama.
