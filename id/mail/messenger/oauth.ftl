...
oauth-reauthorize-title = Otorisasi ulang akses
...
oauth-reauthorize-description = { $hostname } membutuhkan Anda untuk mengonfirmasi akses lagi untuk tetap menyelaraskan dengan akun Anda. Nama pengguna: { $username }
