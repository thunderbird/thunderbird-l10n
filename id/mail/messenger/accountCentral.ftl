...
address-book-add-label = Buku Alamat
    .aria-label = Tambahkan buku alamat
...
import-paragraph2 = { -brand-short-name } memungkinkan Anda mengimpor pesan surel, entri buku alamat, langganan umpan, pengaturan, dan/atau filter dari program surat lain, dan format umum buku alamat.
import-label = Impor
