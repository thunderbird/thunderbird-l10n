...
account-hub-servers-username-label = Nama pengguna:
account-hub-result-server-label = Server:
account-hub-result-port-label = Port:
account-hub-result-security-label = Keamanan:
account-hub-result-authentication-type-label = Otentikasi:
account-hub-result-authentication-none = Nihil
    .title = Nihil
account-hub-result-authentication-password = Sandi Biasa
    .title = Sandi Biasa
account-hub-result-authentication-encrypted-password = Sandi Terenkripsi
    .title = Sandi Terenkripsi
account-hub-result-authentication-gssapi = Kerberos
    .title = Kerberos
account-hub-result-authentication-ntlm = NTLM
    .title = NTLM
account-hub-result-authentication-external = Eksternal
    .title = Eksternal
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = Nihil
    .title = Nihil
account-hub-result-auth-password = Sandi Biasa
    .title = Sandi Biasa
account-hub-result-auth-encrypted-password = Sandi Terenkripsi
    .title = Sandi Terenkripsi
account-hub-result-auth-gssapi = Kerberos
    .title = Kerberos
account-hub-result-auth-ntlm = NTLM
    .title = NTLM
account-hub-result-auth-external = Eksternal
    .title = Eksternal
...
account-hub-exchange-service-url-label = Masukkan URL layanan
...
account-hub-privacy-policy = Kebijakan Privasi
account-hub-welcome = Selamat datang di
account-hub-welcome-brand = { -brand-short-name }
account-hub-welcome-text = Selamat datang di { -brand-short-name }
account-hub-name-warning-icon =
    .title = Masukkan nama Anda
account-hub-email-label = Alamat surel
    .accesskey = e
...
account-hub-password-label = Kata sandi
    .accesskey = K
    .title = Opsional, hanya akan dipakai untuk memvalidasi nama pengguna
account-hub-remember-password = Ingat sandi
    .accesskey = I
account-hub-exchange-label = Login Anda
    .accesskey = L
account-hub-installing-addon = Mengunduh dan memasang pengaya…
account-hub-success-addon = Berhasil memasang pengaya.
account-hub-success-half-manual = Pengaturan berikut ditemukan dengan memeriksa server yang diberikan:
account-hub-result-security-no-encryption = Tanpa Enkripsi
    .title = Tanpa Enkripsi
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = Tanpa Enkripsi
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = Otentikasi gagal. Silakan periksa nama pengguna dan sandi.
...
account-hub-exchange-config-unverifiable = Konfigurasi tidak dapat diverifikasi. Jika nama pengguna dan sandi Anda benar, mungkin administrator server telah menonaktifkan konfigurasi yang dipilih untuk akun Anda. Coba pilih protokol lain.
account-hub-advanced-setup-button = Konfigurasi lanjut
    .accesskey = a
# Variables:
#  $domain (String): The name of the server where the configuration was found, e.g. rackspace.com.
account-hub-exchange-dialog-question = { -brand-short-name } menemukan informasi pengaturan akun Anda di { $domain }. Apakah Anda ingin melanjutkan dan mengirimkan kredensial Anda?
account-hub-creation-error-title = Kesalahan Saat Membuat Akun
account-hub-error-server-exists = Server masuk sudah ada.
account-hub-confirm-advanced-title = Konfirmasi Konfigurasi Lanjutan
account-hub-confirm-advanced-description = Dialog ini akan ditutup dan akun dengan pengaturan saat ini akan dibuat, bahkan jika konfigurasi salah. Apakah Anda ingin melanjutkan?
account-hub-addon-install-title = Pasang
account-hub-encryption-button = Enkripsi ujung-ke-ujung
account-hub-address-books-button = Buku Alamat
account-hub-calendars-button = Kalender
account-hub-thundermail-button = Masuk dengan Thundermail
...
account-hub-email-protocol-select-notification = Informasi tambahan diperlukan untuk menyiapkan akun ini
...
account-hub-result-ews-expanded-text = Layanan Web Exchange
...
account-hub-config-success-title = Pengaturan akun ditemukan secara otomatis.
account-hub-config-success-description-db = Konfigurasi ditemukan di ISPDB Mozilla
account-hub-config-success-description-exchange = Konfigurasi ditemukan untuk server Microsoft Exchange.
...
account-hub-select-security-warning = <span data-l10n-name="error-text">Peringatan: Server surel tidak aman terdeteksi.</span> Server ini tidak memiliki enkripsi, mengungkap sandi dan data Anda. Hubungi administrator Anda untuk mengamankan sambungan atau lanjutkan dengan risiko Anda sendiri. <a data-l10n-name="error-link">Lihat FAQ untuk informasi lebih lanjut.</a>
