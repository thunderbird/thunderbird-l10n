...
close-to-tray-label =
    .label = Saat { -brand-short-name } ditutup, pindahkan ke baki
    .accesskey = p
start-in-tray-label =
    .label = Mulai { -brand-short-name } di baki
    .accesskey = M
...
gloda-show-results-as-list-label =
    .label = Tampilkan hasil pencarian global sebagai daftar secara baku
    .accesskey = l
...
general-folder-options-header = Opsi Manajemen Folder
recent-destinations-legend = Destinasi Terbaru
recent-destinations-description = Opsi untuk mendaftar dan menyortir folder tempat pesan baru-baru ini dipindahkan.
recent-sort-order-label = Urutan:
    .accesskey = U
recent-sort-order-mru =
    .label = Terbaru
recent-sort-order-alphabetic =
    .label = Abjad
max-recent-label = Jumlah maksimum folder terbaru:
    .accesskey = M
...
account-hub-manual-config-checkbox-label =
    .label = Gunakan alur konfigurasi manual baru pada Pusat Akun
    .accesskey = G
account-hub-manual-config-checkbox-description = Alur konfigurasi manual baru untuk pusat akun
new-calendar-legend = Dialog Acara Kalender Baru
new-calendar-checkbox-label =
    .label = Lihat acara kalender di dialog baru
new-calendar-checkbox-description = Dialog kalender baru eksperimental untuk melihat acara
...
accent-color-legend = Warna Aksen
accent-color-label =
    .value = Tentukan warna yang digunakan untuk tombol utama dan elemen yang disorot:
accent-color-os =
    .label = Ikuti sistem operasi
accent-color-thunderbird =
    .label = Biru Thunderbird
accent-color-purple =
    .label = Ungu
accent-color-orange =
    .label = Oranye
...
accent-color-ink =
    .label = Tinta
accent-color-disabled-description = Warna aksen tidak didukung dalam mode Kontras Tinggi.
