...
openpgp-keygen-secret-protection = 비밀 키 보호
...
radio-keygen-passphrase-protection =
    .label = 암호로 보호:
openpgp-passphrase-repeat = 암호 확인:
...
openpgp-import-key-list-amount-2 = { -brand-short-name }가 가져올 수 있는 { $count }개의 키를 찾았습니다.
