...
openpgp-has-nested-encrypted-parts = 이 메시지에는 추가로 암호화된 부분이 있습니다.
openpgp-show-encrypted-parts = 복호화 및 표시
openpgp-has-nested-signed-parts = 이 메시지의 일부는 디지털로 서명되었을 수 있습니다.
openpgp-show-signed-parts = 열어서 표시
...
openpgp-unexpected-key-for-you = 경고: 이 메시지는 사용자의 이메일 주소 중 하나를 참조하는 알 수 없는 OpenPGP 키를 포함하고 있습니다. 만약 사용자의 키가 아니라면 상대방을 속이려는 시도일 수 있습니다.
