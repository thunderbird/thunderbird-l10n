...
close-to-tray-label =
    .label = { -brand-short-name }가 닫히면 트레이로 이동
    .accesskey = c
start-in-tray-label =
    .label = 트레이에서 { -brand-short-name } 시작
    .accesskey = S
...
dark-message-mode-legend = 메시지 리더 스타일
...
dark-message-mode-toggle-label =
    ...
    .accesskey = t
dark-message-mode-toggle-description = 다크 메시지 모드를 빨리 비활성화하는 토글을 메시지 헤더에 표시
general-folder-options-header = 폴더 관리 옵션
recent-destinations-legend = 최근 대상
recent-destinations-description = 최근에 메시지가 이동된 폴더의 목록 및 정렬 옵션
recent-sort-order-label = 정렬 순서:
    .accesskey = S
recent-sort-order-mru =
    .label = 최신순
recent-sort-order-alphabetic =
    .label = 알파벳순
max-recent-label = 최근 폴더의 최대 갯수:
    .accesskey = M
...
account-hub-manual-config-checkbox-label =
    .label = 계정 허브의 새로운 수동 설정 단계 사용
    .accesskey = c
account-hub-manual-config-checkbox-description = 새 계정 허브의 수동 설정 단계
new-calendar-legend = 새로운 캘린더 이벤트 다이얼로그
new-calendar-checkbox-label =
    .label = 새로운 다이얼로그에서 캘린더 이벤트 보기
new-calendar-checkbox-description = 이벤트 보기용 실험적 캘린더 다이얼로그
...
email-picker-label =
    ...
    .accesskey = A
email-picker-description = 보낸 메시지에서 저장한 새 연락처의 위치입니다.
default-add-address-book-label =
    .value = 수동으로 추가한 연락처의 기본 주소록:
    .accesskey = D
default-add-address-book-description = 받은 메시지에서 저장한 새 연락처의 위치입니다.
...
global-privacy-control-description =
    ...
    .accesskey = n
do-not-track-removal = 더 이상 "추적 안 함" 신호를 지원하지 않음
do-not-track-label =
...
spam-description = 기본 스팸 메일 설정을 해주세요. 각 계정마다 별도로 설정 할 수 있습니다.
spam-marked-label =
...
spam-delete-label =
    .label = 삭제
    .accesskey = D
spam-read-description = 읽은 메시지로 표시
