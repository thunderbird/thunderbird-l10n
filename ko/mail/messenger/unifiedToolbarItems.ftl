...
toolbar-next =
    .title = 다음 메시지로 이동
toolbar-spam-label = 스팸
toolbar-spam =
    .title = 선택한 메시지를 스팸으로 표시
toolbar-not-spam-label = 스팸 아님
toolbar-not-spam =
    .title = 선택한 메시지를 스팸 아님으로 표시
...
toolbar-add-as-task-label = 작업으로 추가
toolbar-add-as-task =
...
toolbar-forward-attachment-label = 첨부 파일로 전달
...
toolbar-throbber =
    .title = 활성도 지시자
toolbar-create-contact-label = 새 연락처
toolbar-create-contact =
    .title = 새 연락처 만들기
toolbar-add-address-book-label = 주소록 추가
toolbar-add-address-book =
    .title = 주소록 추가
toolbar-create-address-book-label = 새 주소록
toolbar-create-address-book =
    .title = 새 주소록 만들기
toolbar-create-list-label = 새 목록
toolbar-create-list =
    .title = 새 메일링 리스트 만들기
