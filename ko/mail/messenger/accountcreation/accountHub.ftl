...
account-hub-sync-success = Thunderbird가 연결된 서비스를 찾았습니다.
account-hub-sync-failure = Thunderbird가 연결된 서비스를 찾지 못했습니다.
account-hub-unable-to-sync-accounts = Thunderbird가 선택한 서비스에 연결할 수 없습니다.
