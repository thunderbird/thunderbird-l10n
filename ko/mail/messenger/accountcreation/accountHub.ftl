...
account-hub-config-success-exchange = Microsoft Exchange 서버용 설정 발견
account-hub-config-success-guess = 일반적인 서버 이름으로 시도하여 다음 설정을 찾았습니다.
account-hub-config-success-disk = { -brand-short-name } 설치에서 설정을 발견했습니다
account-hub-config-success-isp = 계정 설정 제공자로부터 찾았습니다.
account-hub-config-success-unknown = 설정 발견됨
