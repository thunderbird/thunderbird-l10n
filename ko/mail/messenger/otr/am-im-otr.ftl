...
account-otr-description2 = { -brand-short-name }는 OTR을 기반으로 일대일 대화에 종단 간 암호화를 지원합니다. 이는 제3자가 대화를 도청할 수 없게 합니다. 종단 간 암호화는 상대방도 OTR을 지원하는 소프트웨어를 사용하는 경우에만 가능합니다.
...
otr-not-yet-available = 아직 사용할 수 없음
