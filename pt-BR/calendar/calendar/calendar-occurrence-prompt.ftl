...
header-isrepeating-event =
    .label = é evento recorrente
header-isrepeating-task =
    .label = é tarefa recorrente
header-containsrepeating-event =
    .label = contém eventos recorrentes
header-containsrepeating-task =
    .label = contém tarefas recorrentes
header-containsrepeating-mixed =
    .label = contém itens recorrentes de diferentes tipos
...
buttons-single-occurrence-copy =
    .label = Copiar somente esta ocorrência
buttons-single-occurrence-cut =
    .label = Cortar somente esta ocorrência
...
buttons-multiple-occurrence-copy =
    .label = Copiar somente as ocorrências selecionadas
buttons-multiple-occurrence-cut =
    .label = Cortar somente as ocorrências selecionadas
buttons-multiple-occurrence-delete =
    .label = Excluir somente as ocorrências selecionadas
buttons-multiple-occurrence-edit =
    .label = Editar somente as ocorrências selecionadas
...
buttons-single-allfollowing-delete =
    .label = Excluir esta e todas as ocorrências futuras
buttons-single-allfollowing-edit =
    .label = Editar esta e todas as ocorrências futuras
buttons-multiple-allfollowing-copy =
    .label = Copiar as ocorrências selecionadas e todas as futuras
buttons-multiple-allfollowing-cut =
    .label = Cortar as ocorrências selecionadas e todas as futuras
buttons-multiple-allfollowing-delete =
    .label = Excluir as ocorrências selecionadas e todas as futuras
buttons-multiple-allfollowing-edit =
    .label = Editar as ocorrências selecionadas e todas as futuras
...
buttons-multiple-parent-delete =
    .label = Excluir todas as ocorrências dos itens selecionados
