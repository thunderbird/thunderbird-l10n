...
calendar-none =
    .label = Nenhum
imip-bar-unsupported-text = Esta mensagem contém um evento que esta versão do { -brand-short-name } não consegue processar.
# Error strings
# @name UID_NOT_FOUND
# @loc none
...
calendar-search-options-searchfor =
    .value = { " " }contém
calendar-properties-dialog-title = Editar agenda
