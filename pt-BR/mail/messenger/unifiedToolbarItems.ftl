...
toolbar-spam =
    .title = Marcar mensagens selecionadas como spam
toolbar-not-spam-label = Não spam
toolbar-not-spam =
    .title = Marcar mensagens selecionadas como não spam
...
toolbar-add-address-book-label = Adicionar catálogo de endereços
