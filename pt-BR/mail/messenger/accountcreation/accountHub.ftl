...
account-hub-email-button = Configurar conta de email
account-hub-new-email-button = Obter um novo endereço de email
account-hub-calendar-button = Configurar agenda
account-hub-address-book-button = Configurar catálogo de endereços
account-hub-chat-button = Configurar conversa
