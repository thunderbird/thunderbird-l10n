...
account-hub-email-find-settings-button = Procurar configurações
account-hub-result-incoming-legend = Entrada
account-hub-result-outgoing-legend = Saída
...
account-hub-servers-username-label = Nome de usuário:
...
account-hub-result-authentication-none = Nenhuma
    .title = Nenhuma
account-hub-result-authentication-password = Senha normal
    .title = Senha normal
account-hub-result-authentication-encrypted-password = Senha criptografada
...
account-hub-result-authentication-oauth2 = OAuth2
    .title = OAuth2
account-hub-result-auth-none = Nenhuma
    .title = Nenhuma
account-hub-result-auth-password = Senha normal
    .title = Senha normal
account-hub-result-auth-encrypted-password = Senha criptografada
    .title = Senha criptografada
...
account-hub-exchange-service-url-label = Insira a URL do serviço
...
account-hub-privacy-policy = Política de privacidade
account-hub-welcome = Boas-vindas ao
account-hub-welcome-brand = { -brand-short-name }
account-hub-welcome-text = Boas-vindas ao { -brand-short-name }
account-hub-name-warning-icon =
    .title = Digite seu nome
account-hub-email-label = Endereço de email
    .accesskey = E
account-hub-email-input =
    .placeholder = fulano@example.com
account-hub-email-warning-icon =
    .title = Endereço de email inválido
account-hub-password-label = Senha
    .accesskey = S
    .title = Opcional, será usada apenas para validar o nome de usuário
account-hub-remember-password = Memorizar senha
    .accesskey = M
account-hub-exchange-label = Sua conta
    .accesskey = c
account-hub-installing-addon = Baixando e instalando extensão…
account-hub-success-addon = A extensão foi instalada com sucesso
account-hub-success-half-manual = As seguintes configurações foram encontradas ao examinar o servidor indicado:
account-hub-result-security-no-encryption = Sem criptografia
    .title = Sem criptografia
account-hub-result-security-ssl = SSL/TLS
    .title = SSL/TLS
account-hub-result-security-starttls = STARTTLS
    .title = STARTTLS
account-hub-result-no-encryption = Sem criptografia
account-hub-result-ssl = SSL/TLS
account-hub-result-starttls = STARTTLS
account-hub-credentials-wrong = Falha na autenticação. Verifique o nome de usuário e a senha
...
account-hub-thundermail-button = Entrar com Thundermail
# Used as part of a divider between sign in button and a sign in form.
account-hub-thundermail-divider-text = ou
account-hub-manual-config-imap-title = Configurações de IMAP
account-hub-manual-config-pop3-title = Configurações de POP3
account-hub-manual-config-incoming-legend = Servidor de recebimento
account-hub-manual-config-outgoing-legend = Servidor de envio
# Label for checkbox that will hide an outgoing username input if it's the same is the incoming
account-hub-same-username-checkbox = Mesmo nome de usuário do servidor de recebimento
account-hub-protocol-imap = Sincronização entre dispositivos
account-hub-protocol-microsoft = Exchange ou Microsoft 365
account-hub-protocol-pop3 = Baixar no dispositivo
