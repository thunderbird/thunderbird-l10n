...
recent-sort-order-label = Ordenação:
    .accesskey = O
...
account-hub-manual-config-checkbox-label =
    .label = Usar o novo fluxo de configuração manual da central de contas
    .accesskey = c
account-hub-manual-config-checkbox-description = Novo fluxo de configuração manual da central de contas
new-calendar-legend = Diálogo de novo evento na agenda
new-calendar-checkbox-label =
    .label = Ver eventos de agenda no novo diálogo
new-calendar-checkbox-description = Novo diálogo experimental de agenda de exibição de eventos
...
exceptions-button =
    .label = Exceções…
    .accesskey = E
remote-content-privacy-info = Saiba mais sobre os problemas de privacidade de conteúdo remoto
remote-content-info =
...
accent-color-label =
    .value = Defina a cor usada em botões principais e elementos em destaque:
accent-color-os =
...
accent-color-teal =
    .label = Verde-azulado
accent-color-disabled-description = Não há suporte para cores de destaque no modo de alto contraste.
