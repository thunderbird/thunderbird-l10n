...
folder-name-all-mail = Todos os emails
...
menu-file-get-next-n-news-msgs =
    { $count ->
        [one] Receber próxima mensagem
       *[other] Receber próximas { $count } mensagens
    }
# Variables:
...
menu-move-copy-no-recent =
    .label = (nenhum destino recente)
menu-move-copy-no-favorites =
    .label = (nenhum preferido)
...
context-menu-mark-not-junk =
    .aria-label = Marcar como não indesejado
    .tooltiptext = Marcar como não indesejado
...
message-group-older = Mais antigas
message-group-future-date = Futuro
# Different Grouped By Sort thread pane titles
message-group-untagged = Mensagens sem etiquetas
message-group-no-status = Sem status
...
tags-label-2 = Trabalho
tags-label-3 = Pessoal
tags-label-4 = Pendente
tags-label-5 = Mais tarde
tags-add-new =
    .label = Nova etiqueta…
    .accesskey = N
tags-manage =
    ...
    .accesskey = G
tags-remove-all =
    .label = Remover todas as etiquetas
    .accesskey = 0
# Variables:
