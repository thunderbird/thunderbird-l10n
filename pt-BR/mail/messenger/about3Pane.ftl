...
quick-filter-bar-tag-mode-none =
    .label = Somente não etiquetadas
    .title = Só mensagens sem etiqueta
...
folder-pane-mode-header-all = Todas as pastas
folder-pane-mode-header-unread = Pastas não lidas
...
folder-pane-context-reset-sort =
    .label = Redefinir ordem de pastas
    .accesskey = R
# Variables:
