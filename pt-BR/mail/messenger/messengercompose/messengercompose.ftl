...
compose-initialization-error-title = Edição de mensagem
compose-initialization-error = Ocorreu um erro ao criar a janela de edição de mensagem. Tente novamente.
